...
int main(int argc, char *argv[]){
    ...
    101d:	c7 04 24 20 1d 00 00 	movl   $0x1d20,(%esp)
    1024:	e8 9d 09 00 00       	call   19c6 <lock_init>
    ttable.total = 0;
    1029:	c7 05 24 1e 00 00 00 	movl   $0x0,0x1e24
    1030:	00 00 00 

    lock_acquire(&ttable.lock);
    1033:	c7 04 24 20 1d 00 00 	movl   $0x1d20,(%esp)
    103a:	e8 95 09 00 00       	call   19d4 <lock_acquire>
    for(t=ttable.threads;t < &ttable.threads[64];t++){
    103f:	c7 44 24 14 24 1d 00 	movl   $0x1d24,0x14(%esp)
    1046:	00 
    ...
    //find that thread
    lock_acquire(&ttable.lock);
    10df:	c7 04 24 20 1d 00 00 	movl   $0x1d20,(%esp)
    10e6:	e8 e9 08 00 00       	call   19d4 <lock_acquire>
    for(t=ttable.threads;t < &ttable.threads[64];t++){
    10eb:	c7 44 24 14 24 1d 00 	movl   $0x1d24,0x14(%esp)
    10f2:	00 
    ...
    1109:	c7 44 24 04 54 1c 00 	movl   $0x1c54,0x4(%esp)
    1110:	00 
    ...
    1135:	b8 24 1e 00 00       	mov    $0x1e24,%eax
    ...
    lock_release(&ttable.lock);
    1140:	c7 04 24 20 1d 00 00 	movl   $0x1d20,(%esp)
...
void func(void *arg_ptr){
    ...
    lock_acquire(&ttable.lock);
    117a:	c7 04 24 20 1d 00 00 	movl   $0x1d20,(%esp)
    1181:	e8 4e 08 00 00       	call   19d4 <lock_acquire>
    (ttable.threads[ttable.total]).tid = tid;
    1186:	a1 24 1e 00 00       	mov    0x1e24,%eax
    118b:	8b 55 f4             	mov    -0xc(%ebp),%edx
    118e:	89 14 85 24 1d 00 00 	mov    %edx,0x1d24(,%eax,4)
    ttable.total++;
    1195:	a1 24 1e 00 00       	mov    0x1e24,%eax
    119a:	83 c0 01             	add    $0x1,%eax
    119d:	a3 24 1e 00 00       	mov    %eax,0x1e24
    lock_release(&ttable.lock);
    11a2:	c7 04 24 20 1d 00 00 	movl   $0x1d20,(%esp)
    ...
    11b5:	c7 44 24 04 80 1c 00 	movl   $0x1c80,0x4(%esp)
    11bc:	00 
    ...
    11ce:	c7 44 24 04 a3 1c 00 	movl   $0x1ca3,0x4(%esp)
    11d5:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    157e:	0f b6 80 e8 1c 00 00 	movzbl 0x1ce8(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    16dc:	75 27                	jne    1705 <printf+0x120>
          s = "(null)";
    16de:	c7 45 e4 b2 1c 00 00 	movl   $0x1cb2,-0x1c(%ebp)
        while(*s != 0){
...
0000179c <free>:
    ...
    17ab:	a1 08 1d 00 00       	mov    0x1d08,%eax
    ...
    186c:	a3 08 1d 00 00       	mov    %eax,0x1d08
    1871:	c9                   	leave  
    1872:	c3                   	ret    
...
00001873 <morecore>:
    ...
    18c4:	a1 08 1d 00 00       	mov    0x1d08,%eax
    18c9:	c9                   	leave  
    18ca:	c3                   	ret    
...
000018cb <malloc>:
    ...
    18e0:	a1 08 1d 00 00       	mov    0x1d08,%eax
    18e5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    18e8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    18ec:	75 23                	jne    1911 <malloc+0x46>
    18ee:	c7 45 f0 00 1d 00 00 	movl   $0x1d00,-0x10(%ebp)
    18f5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    18f8:	a3 08 1d 00 00       	mov    %eax,0x1d08
    18fd:	a1 08 1d 00 00       	mov    0x1d08,%eax
    1902:	a3 00 1d 00 00       	mov    %eax,0x1d00
    1907:	c7 05 04 1d 00 00 00 	movl   $0x0,0x1d04
    190e:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1a50:	c7 44 24 04 b9 1c 00 	movl   $0x1cb9,0x4(%esp)
    1a57:	00 
    ...
    1a95:	c7 44 24 04 c7 1c 00 	movl   $0x1cc7,0x4(%esp)
    1a9c:	00 
    ...
    1ac1:	c7 44 24 04 d4 1c 00 	movl   $0x1cd4,0x4(%esp)
    1ac8:	00 
...
int random(int max){
    ...
    1adf:	a1 fc 1c 00 00       	mov    0x1cfc,%eax
    1ae4:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1aea:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1aef:	a3 fc 1c 00 00       	mov    %eax,0x1cfc
    return (int)(rands % max);
    1af4:	a1 fc 1c 00 00       	mov    0x1cfc,%eax
    1af9:	8b 4d 08             	mov    0x8(%ebp),%ecx
...
void init_q(struct queue *q){
    1b08:	55                   	push   %ebp
    1b09:	89 e5                	mov    %esp,%ebp
    q->size = 0;
    1b0b:	8b 45 08             	mov    0x8(%ebp),%eax
    1b0e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    1b14:	8b 45 08             	mov    0x8(%ebp),%eax
    1b17:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    1b1e:	8b 45 08             	mov    0x8(%ebp),%eax
    1b21:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    1b28:	5d                   	pop    %ebp
    1b29:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    1b30:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    1b37:	e8 8f fd ff ff       	call   18cb <malloc>
    1b3c:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    1b3f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1b42:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    1b49:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1b4c:	8b 55 0c             	mov    0xc(%ebp),%edx
    1b4f:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    1b51:	8b 45 08             	mov    0x8(%ebp),%eax
    1b54:	8b 40 04             	mov    0x4(%eax),%eax
    1b57:	85 c0                	test   %eax,%eax
    1b59:	75 0b                	jne    1b66 <add_q+0x3c>
        q->head = n;
    1b5b:	8b 45 08             	mov    0x8(%ebp),%eax
    1b5e:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1b61:	89 50 04             	mov    %edx,0x4(%eax)
    1b64:	eb 0c                	jmp    1b72 <add_q+0x48>
    }else{
        q->tail->next = n;
    1b66:	8b 45 08             	mov    0x8(%ebp),%eax
    1b69:	8b 40 08             	mov    0x8(%eax),%eax
    1b6c:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1b6f:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    1b72:	8b 45 08             	mov    0x8(%ebp),%eax
    1b75:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1b78:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    1b7b:	8b 45 08             	mov    0x8(%ebp),%eax
    1b7e:	8b 00                	mov    (%eax),%eax
    1b80:	8d 50 01             	lea    0x1(%eax),%edx
    1b83:	8b 45 08             	mov    0x8(%ebp),%eax
    1b86:	89 10                	mov    %edx,(%eax)
}
    1b88:	c9                   	leave  
    1b89:	c3                   	ret    
...
int empty_q(struct queue *q){
    ...
    1b94:	75 07                	jne    1b9d <empty_q+0x13>
        return 1;
    1b96:	b8 01 00 00 00       	mov    $0x1,%eax
    1b9b:	eb 05                	jmp    1ba2 <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    ...
    1bd3:	8b 50 04             	mov    0x4(%eax),%edx
    1bd6:	8b 45 08             	mov    0x8(%ebp),%eax
    1bd9:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    1bdc:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1bdf:	89 04 24             	mov    %eax,(%esp)
    1be2:	e8 b5 fb ff ff       	call   179c <free>
       q->size--;
    ...
    1bfb:	75 14                	jne    1c11 <pop_q+0x6d>
            q->head = 0;
    1bfd:	8b 45 08             	mov    0x8(%ebp),%eax
    1c00:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    1c07:	8b 45 08             	mov    0x8(%ebp),%eax
    1c0a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    1c11:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1c14:	eb 05                	jmp    1c1b <pop_q+0x77>
    }
    return -1;
    1c16:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    1c1b:	c9                   	leave  
    1c1c:	c3                   	ret    
