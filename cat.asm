...
cat(int fd)
{
  ...
  if(n < 0){
    ...
    104d:	c7 44 24 04 45 1b 00 	movl   $0x1b45,0x4(%esp)
    1054:	00 
...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    10c9:	c7 44 24 04 56 1b 00 	movl   $0x1b56,0x4(%esp)
    10d0:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    14a6:	0f b6 80 a0 1b 00 00 	movzbl 0x1ba0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1604:	75 27                	jne    162d <printf+0x120>
          s = "(null)";
    1606:	c7 45 e4 6b 1b 00 00 	movl   $0x1b6b,-0x1c(%ebp)
        while(*s != 0){
...
000016c4 <free>:
    ...
    16d3:	a1 c8 1b 00 00       	mov    0x1bc8,%eax
    ...
    1794:	a3 c8 1b 00 00       	mov    %eax,0x1bc8
    1799:	c9                   	leave  
    179a:	c3                   	ret    
...
0000179b <morecore>:
    ...
    17ec:	a1 c8 1b 00 00       	mov    0x1bc8,%eax
    17f1:	c9                   	leave  
    17f2:	c3                   	ret    
...
000017f3 <malloc>:
    ...
    1808:	a1 c8 1b 00 00       	mov    0x1bc8,%eax
    180d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1810:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1814:	75 23                	jne    1839 <malloc+0x46>
    1816:	c7 45 f0 c0 1b 00 00 	movl   $0x1bc0,-0x10(%ebp)
    181d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1820:	a3 c8 1b 00 00       	mov    %eax,0x1bc8
    1825:	a1 c8 1b 00 00       	mov    0x1bc8,%eax
    182a:	a3 c0 1b 00 00       	mov    %eax,0x1bc0
    182f:	c7 05 c4 1b 00 00 00 	movl   $0x0,0x1bc4
    1836:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1978:	c7 44 24 04 72 1b 00 	movl   $0x1b72,0x4(%esp)
    197f:	00 
    ...
    19bd:	c7 44 24 04 80 1b 00 	movl   $0x1b80,0x4(%esp)
    19c4:	00 
    ...
    19e9:	c7 44 24 04 8d 1b 00 	movl   $0x1b8d,0x4(%esp)
    19f0:	00 
...
int random(int max){
    ...
    1a07:	a1 b4 1b 00 00       	mov    0x1bb4,%eax
    1a0c:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1a12:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1a17:	a3 b4 1b 00 00       	mov    %eax,0x1bb4
    return (int)(rands % max);
    1a1c:	a1 b4 1b 00 00       	mov    0x1bb4,%eax
    1a21:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1a24:	ba 00 00 00 00       	mov    $0x0,%edx
    1a29:	f7 f1                	div    %ecx
    1a2b:	89 d0                	mov    %edx,%eax
}
    1a2d:	5d                   	pop    %ebp
    1a2e:	c3                   	ret    
    1a2f:	90                   	nop
...
void init_q(struct queue *q){
    ...
    1a36:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    1a3c:	8b 45 08             	mov    0x8(%ebp),%eax
    1a3f:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    1a46:	8b 45 08             	mov    0x8(%ebp),%eax
    1a49:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    1a50:	5d                   	pop    %ebp
    1a51:	c3                   	ret    
...
int empty_q(struct queue *q){
    ...
    1abc:	75 07                	jne    1ac5 <empty_q+0x13>
        return 1;
    1abe:	b8 01 00 00 00       	mov    $0x1,%eax
    1ac3:	eb 05                	jmp    1aca <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    ...
    1acf:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    1ad2:	8b 45 08             	mov    0x8(%ebp),%eax
    1ad5:	89 04 24             	mov    %eax,(%esp)
    1ad8:	e8 d5 ff ff ff       	call   1ab2 <empty_q>
    1add:	85 c0                	test   %eax,%eax
    1adf:	75 5d                	jne    1b3e <pop_q+0x72>
       val = q->head->value; 
