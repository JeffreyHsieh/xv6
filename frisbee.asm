...
//    void * sp;
    ...
    101b:	c7 44 24 04 a0 1e 00 	movl   $0x1ea0,0x4(%esp)
    1022:	00 
    ...
    1178:	c7 44 24 04 b5 1e 00 	movl   $0x1eb5,0x4(%esp)
    117f:	00 
    ...
    1195:	c7 44 24 04 ca 1e 00 	movl   $0x1eca,0x4(%esp)
    119c:	00 
    ...
    11cf:	c7 44 24 04 de 1e 00 	movl   $0x1ede,0x4(%esp)
    11d6:	00 
...
//    sleep(5);
   ...
   // add printf for tid look up.  
    ...
    123e:	c7 44 24 04 f4 1e 00 	movl   $0x1ef4,0x4(%esp)
    1245:	00 
...
void pass_next(void *arg){
   ...
   for(;;){
    ...
    1321:	c7 44 24 04 1c 1f 00 	movl   $0x1f1c,0x4(%esp)
    1328:	00 
...
leaving: 
    ...
    13a9:	c7 44 24 04 68 1f 00 	movl   $0x1f68,0x4(%esp)
    13b0:	00 
    ...
    13f7:	c7 44 24 04 34 1f 00 	movl   $0x1f34,0x4(%esp)
    13fe:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    17fe:	0f b6 80 b4 1f 00 00 	movzbl 0x1fb4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    195c:	75 27                	jne    1985 <printf+0x120>
          s = "(null)";
    195e:	c7 45 e4 7f 1f 00 00 	movl   $0x1f7f,-0x1c(%ebp)
        while(*s != 0){
...
00001a1c <free>:
    ...
    1a2b:	a1 f4 1f 00 00       	mov    0x1ff4,%eax
    ...
    1aec:	a3 f4 1f 00 00       	mov    %eax,0x1ff4
    1af1:	c9                   	leave  
    1af2:	c3                   	ret    
...
00001af3 <morecore>:
    ...
    1b44:	a1 f4 1f 00 00       	mov    0x1ff4,%eax
    1b49:	c9                   	leave  
    1b4a:	c3                   	ret    
...
00001b4b <malloc>:
    ...
    1b60:	a1 f4 1f 00 00       	mov    0x1ff4,%eax
    1b65:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1b68:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1b6c:	75 23                	jne    1b91 <malloc+0x46>
    1b6e:	c7 45 f0 ec 1f 00 00 	movl   $0x1fec,-0x10(%ebp)
    1b75:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1b78:	a3 f4 1f 00 00       	mov    %eax,0x1ff4
    1b7d:	a1 f4 1f 00 00       	mov    0x1ff4,%eax
    1b82:	a3 ec 1f 00 00       	mov    %eax,0x1fec
    1b87:	c7 05 f0 1f 00 00 00 	movl   $0x0,0x1ff0
    1b8e:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1cd0:	c7 44 24 04 86 1f 00 	movl   $0x1f86,0x4(%esp)
    1cd7:	00 
    ...
    1d15:	c7 44 24 04 94 1f 00 	movl   $0x1f94,0x4(%esp)
    1d1c:	00 
    ...
    1d41:	c7 44 24 04 a1 1f 00 	movl   $0x1fa1,0x4(%esp)
    1d48:	00 
...
int random(int max){
    ...
    1d5f:	a1 c8 1f 00 00       	mov    0x1fc8,%eax
    1d64:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1d6a:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1d6f:	a3 c8 1f 00 00       	mov    %eax,0x1fc8
    return (int)(rands % max);
    1d74:	a1 c8 1f 00 00       	mov    0x1fc8,%eax
    1d79:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1d7c:	ba 00 00 00 00       	mov    $0x0,%edx
    1d81:	f7 f1                	div    %ecx
    1d83:	89 d0                	mov    %edx,%eax
}
    1d85:	5d                   	pop    %ebp
    1d86:	c3                   	ret    
    1d87:	90                   	nop
...
void init_q(struct queue *q){
    ...
    1d8e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    1d94:	8b 45 08             	mov    0x8(%ebp),%eax
    1d97:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    1d9e:	8b 45 08             	mov    0x8(%ebp),%eax
    1da1:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    1da8:	5d                   	pop    %ebp
    1da9:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    1dad:	83 ec 28             	sub    $0x28,%esp
    struct node * n = malloc(sizeof(struct node));
    1db0:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    1db7:	e8 8f fd ff ff       	call   1b4b <malloc>
    1dbc:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    1dbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1dc2:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    1dc9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1dcc:	8b 55 0c             	mov    0xc(%ebp),%edx
    1dcf:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    1dd1:	8b 45 08             	mov    0x8(%ebp),%eax
    1dd4:	8b 40 04             	mov    0x4(%eax),%eax
    1dd7:	85 c0                	test   %eax,%eax
    1dd9:	75 0b                	jne    1de6 <add_q+0x3c>
        q->head = n;
    1ddb:	8b 45 08             	mov    0x8(%ebp),%eax
    1dde:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1de1:	89 50 04             	mov    %edx,0x4(%eax)
    1de4:	eb 0c                	jmp    1df2 <add_q+0x48>
    }else{
        q->tail->next = n;
    1de6:	8b 45 08             	mov    0x8(%ebp),%eax
    1de9:	8b 40 08             	mov    0x8(%eax),%eax
    1dec:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1def:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    1df2:	8b 45 08             	mov    0x8(%ebp),%eax
    1df5:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1df8:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    1dfb:	8b 45 08             	mov    0x8(%ebp),%eax
    1dfe:	8b 00                	mov    (%eax),%eax
    1e00:	8d 50 01             	lea    0x1(%eax),%edx
...
int empty_q(struct queue *q){
    ...
    1e14:	75 07                	jne    1e1d <empty_q+0x13>
        return 1;
    1e16:	b8 01 00 00 00       	mov    $0x1,%eax
    1e1b:	eb 05                	jmp    1e22 <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    ...
    1e27:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    1e2a:	8b 45 08             	mov    0x8(%ebp),%eax
    1e2d:	89 04 24             	mov    %eax,(%esp)
    1e30:	e8 d5 ff ff ff       	call   1e0a <empty_q>
    1e35:	85 c0                	test   %eax,%eax
    1e37:	75 5d                	jne    1e96 <pop_q+0x72>
       val = q->head->value; 
    1e39:	8b 45 08             	mov    0x8(%ebp),%eax
    1e3c:	8b 40 04             	mov    0x4(%eax),%eax
    1e3f:	8b 00                	mov    (%eax),%eax
    1e41:	89 45 f0             	mov    %eax,-0x10(%ebp)
       destroy = q->head;
    1e44:	8b 45 08             	mov    0x8(%ebp),%eax
    1e47:	8b 40 04             	mov    0x4(%eax),%eax
    1e4a:	89 45 f4             	mov    %eax,-0xc(%ebp)
       q->head = q->head->next;
    1e4d:	8b 45 08             	mov    0x8(%ebp),%eax
    1e50:	8b 40 04             	mov    0x4(%eax),%eax
    1e53:	8b 50 04             	mov    0x4(%eax),%edx
    1e56:	8b 45 08             	mov    0x8(%ebp),%eax
    1e59:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    1e5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1e5f:	89 04 24             	mov    %eax,(%esp)
    1e62:	e8 b5 fb ff ff       	call   1a1c <free>
       q->size--;
    1e67:	8b 45 08             	mov    0x8(%ebp),%eax
    1e6a:	8b 00                	mov    (%eax),%eax
    1e6c:	8d 50 ff             	lea    -0x1(%eax),%edx
    1e6f:	8b 45 08             	mov    0x8(%ebp),%eax
    1e72:	89 10                	mov    %edx,(%eax)
       if(q->size == 0){
    1e74:	8b 45 08             	mov    0x8(%ebp),%eax
    1e77:	8b 00                	mov    (%eax),%eax
    1e79:	85 c0                	test   %eax,%eax
    1e7b:	75 14                	jne    1e91 <pop_q+0x6d>
            q->head = 0;
    1e7d:	8b 45 08             	mov    0x8(%ebp),%eax
    1e80:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    1e87:	8b 45 08             	mov    0x8(%ebp),%eax
    1e8a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    1e91:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1e94:	eb 05                	jmp    1e9b <pop_q+0x77>
    }
    return -1;
    1e96:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    1e9b:	c9                   	leave  
    1e9c:	c3                   	ret    
