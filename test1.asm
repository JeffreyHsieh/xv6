...
int main(int argc, char *argv[]){
   ...
   int pid = fork();
    ...
    103c:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    1043:	00 
    ...
    1072:	75 19                	jne    108d <main+0x8d>
            printf(1,"thread_create fails\n");
    1074:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    107b:	00 
    ...
    10aa:	75 19                	jne    10c5 <main+0xc5>
            printf(1,"thread_create fails\n");
    10ac:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    10b3:	00 
    ...
    10e2:	75 19                	jne    10fd <main+0xfd>
            printf(1,"thread_create fails\n");
    10e4:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    10eb:	00 
    ...
    111a:	75 19                	jne    1135 <main+0x135>
            printf(1,"thread_create fails\n");
    111c:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    1123:	00 
    ...
    113e:	a1 40 1d 00 00       	mov    0x1d40,%eax
    1143:	89 44 24 08          	mov    %eax,0x8(%esp)
    1147:	c7 44 24 04 da 1c 00 	movl   $0x1cda,0x4(%esp)
    114e:	00 
    ...
    1188:	75 19                	jne    11a3 <main+0x1a3>
            printf(1,"thread_create fails\n");
    118a:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    1191:	00 
    ...
    11c0:	75 19                	jne    11db <main+0x1db>
            printf(1,"thread_create fails\n");
    11c2:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    11c9:	00 
    ...
    11f8:	75 19                	jne    1213 <main+0x213>
            printf(1,"thread_create fails\n");
    11fa:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    1201:	00 
    ...
    1230:	75 19                	jne    124b <main+0x24b>
            printf(1,"thread_create fails\n");
    1232:	c7 44 24 04 c5 1c 00 	movl   $0x1cc5,0x4(%esp)
    1239:	00 
    ...
    1254:	a1 40 1d 00 00       	mov    0x1d40,%eax
    1259:	89 44 24 08          	mov    %eax,0x8(%esp)
    125d:	c7 44 24 04 f2 1c 00 	movl   $0x1cf2,0x4(%esp)
    1264:	00 
...
//    printf(1,"\n n = %d\n",n);
    n++;
    127c:	a1 40 1d 00 00       	mov    0x1d40,%eax
    1281:	83 c0 01             	add    $0x1,%eax
    1284:	a3 40 1d 00 00       	mov    %eax,0x1d40
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1626:	0f b6 80 44 1d 00 00 	movzbl 0x1d44(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1784:	75 27                	jne    17ad <printf+0x120>
          s = "(null)";
    1786:	c7 45 e4 0b 1d 00 00 	movl   $0x1d0b,-0x1c(%ebp)
        while(*s != 0){
...
00001844 <free>:
    ...
    1853:	a1 64 1d 00 00       	mov    0x1d64,%eax
    ...
    1914:	a3 64 1d 00 00       	mov    %eax,0x1d64
    1919:	c9                   	leave  
    191a:	c3                   	ret    
...
0000191b <morecore>:
    ...
    196c:	a1 64 1d 00 00       	mov    0x1d64,%eax
    1971:	c9                   	leave  
    1972:	c3                   	ret    
...
00001973 <malloc>:
    ...
    1988:	a1 64 1d 00 00       	mov    0x1d64,%eax
    198d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1990:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1994:	75 23                	jne    19b9 <malloc+0x46>
    1996:	c7 45 f0 5c 1d 00 00 	movl   $0x1d5c,-0x10(%ebp)
    199d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    19a0:	a3 64 1d 00 00       	mov    %eax,0x1d64
    19a5:	a1 64 1d 00 00       	mov    0x1d64,%eax
    19aa:	a3 5c 1d 00 00       	mov    %eax,0x1d5c
    19af:	c7 05 60 1d 00 00 00 	movl   $0x0,0x1d60
    19b6:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1af8:	c7 44 24 04 12 1d 00 	movl   $0x1d12,0x4(%esp)
    1aff:	00 
    ...
    1b3d:	c7 44 24 04 20 1d 00 	movl   $0x1d20,0x4(%esp)
    1b44:	00 
    ...
    1b69:	c7 44 24 04 2d 1d 00 	movl   $0x1d2d,0x4(%esp)
    1b70:	00 
...
int random(int max){
    ...
    1b87:	a1 58 1d 00 00       	mov    0x1d58,%eax
    1b8c:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1b92:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1b97:	a3 58 1d 00 00       	mov    %eax,0x1d58
    return (int)(rands % max);
    1b9c:	a1 58 1d 00 00       	mov    0x1d58,%eax
    1ba1:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1ba4:	ba 00 00 00 00       	mov    $0x0,%edx
    1ba9:	f7 f1                	div    %ecx
    1bab:	89 d0                	mov    %edx,%eax
}
    1bad:	5d                   	pop    %ebp
    1bae:	c3                   	ret    
    1baf:	90                   	nop
...
void init_q(struct queue *q){
    ...
    1bb6:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    1bbc:	8b 45 08             	mov    0x8(%ebp),%eax
    1bbf:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    1bc6:	8b 45 08             	mov    0x8(%ebp),%eax
    1bc9:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    1bd0:	5d                   	pop    %ebp
    1bd1:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    1bd8:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    1bdf:	e8 8f fd ff ff       	call   1973 <malloc>
    1be4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    1be7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1bea:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    1bf1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1bf4:	8b 55 0c             	mov    0xc(%ebp),%edx
    1bf7:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    1bf9:	8b 45 08             	mov    0x8(%ebp),%eax
    1bfc:	8b 40 04             	mov    0x4(%eax),%eax
    1bff:	85 c0                	test   %eax,%eax
    1c01:	75 0b                	jne    1c0e <add_q+0x3c>
        q->head = n;
    1c03:	8b 45 08             	mov    0x8(%ebp),%eax
    1c06:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1c09:	89 50 04             	mov    %edx,0x4(%eax)
    1c0c:	eb 0c                	jmp    1c1a <add_q+0x48>
    }else{
        q->tail->next = n;
    1c0e:	8b 45 08             	mov    0x8(%ebp),%eax
    1c11:	8b 40 08             	mov    0x8(%eax),%eax
    1c14:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1c17:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    1c1a:	8b 45 08             	mov    0x8(%ebp),%eax
    1c1d:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1c20:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    1c23:	8b 45 08             	mov    0x8(%ebp),%eax
    1c26:	8b 00                	mov    (%eax),%eax
    1c28:	8d 50 01             	lea    0x1(%eax),%edx
    1c2b:	8b 45 08             	mov    0x8(%ebp),%eax
    1c2e:	89 10                	mov    %edx,(%eax)
}
    1c30:	c9                   	leave  
    1c31:	c3                   	ret    
...
int empty_q(struct queue *q){
    ...
    1c3c:	75 07                	jne    1c45 <empty_q+0x13>
        return 1;
    1c3e:	b8 01 00 00 00       	mov    $0x1,%eax
    1c43:	eb 05                	jmp    1c4a <empty_q+0x18>
    else
        return 0;
