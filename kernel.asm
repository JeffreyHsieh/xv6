...
8010003a:	c7 44 24 04 90 85 10 	movl   $0x80108590,0x4(%esp)
80100041:	80 
80100042:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
80100049:	e8 80 4e 00 00       	call   80104ece <initlock>
...
801000bd:	e8 2d 4e 00 00       	call   80104eef <acquire>
...
80100104:	e8 48 4e 00 00       	call   80104f51 <release>
        return b;
...
8010011f:	e8 57 4a 00 00       	call   80104b7b <sleep>
      goto loop;
...
8010017c:	e8 d0 4d 00 00       	call   80104f51 <release>
      return b;
...
80100198:	c7 04 24 97 85 10 80 	movl   $0x80108597,(%esp)
...
801001ed:	75 0c                	jne    801001fb <bwrite+0x1e>
    panic("bwrite");
801001ef:	c7 04 24 a8 85 10 80 	movl   $0x801085a8,(%esp)
...
80100227:	75 0c                	jne    80100235 <brelse+0x1e>
    panic("brelse");
80100229:	c7 04 24 af 85 10 80 	movl   $0x801085af,(%esp)
80100230:	e8 05 03 00 00       	call   8010053a <panic>

  acquire(&bcache.lock);
80100235:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
8010023c:	e8 ae 4c 00 00       	call   80104eef <acquire>
...
8010029d:	e8 1d 4a 00 00       	call   80104cbf <wakeup>

  release(&bcache.lock);
801002a2:	c7 04 24 80 c6 10 80 	movl   $0x8010c680,(%esp)
801002a9:	e8 a3 4c 00 00       	call   80104f51 <release>
}
801002ae:	c9                   	leave  
801002af:	c3                   	ret    
...
801003bb:	e8 2f 4b 00 00       	call   80104eef <acquire>
...
801003c5:	75 0c                	jne    801003d3 <cprintf+0x33>
    panic("null fmt");
801003c7:	c7 04 24 b6 85 10 80 	movl   $0x801085b6,(%esp)
...
801004ae:	75 09                	jne    801004b9 <cprintf+0x119>
        s = "(null)";
801004b0:	c7 45 ec bf 85 10 80 	movl   $0x801085bf,-0x14(%ebp)
      for(; *s; s++)
...
80100533:	e8 19 4a 00 00       	call   80104f51 <release>
}
80100538:	c9                   	leave  
80100539:	c3                   	ret    
...
8010055f:	c7 04 24 c6 85 10 80 	movl   $0x801085c6,(%esp)
...
80100571:	e8 2a fe ff ff       	call   801003a0 <cprintf>
  cprintf("\n");
80100576:	c7 04 24 d5 85 10 80 	movl   $0x801085d5,(%esp)
...
8010058f:	e8 0c 4a 00 00       	call   80104fa0 <getcallerpcs>
  for(i=0; i<10; i++)
...
801005a8:	c7 04 24 d7 85 10 80 	movl   $0x801085d7,(%esp)
...
801006b2:	e8 5e 4b 00 00       	call   80105215 <memmove>
    pos -= 80;
...
801006e1:	e8 60 4a 00 00       	call   80105146 <memset>
  }
...
80100776:	e8 50 64 00 00       	call   80106bcb <uartputc>
8010077b:	c7 04 24 20 00 00 00 	movl   $0x20,(%esp)
80100782:	e8 44 64 00 00       	call   80106bcb <uartputc>
80100787:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
8010078e:	e8 38 64 00 00       	call   80106bcb <uartputc>
80100793:	eb 0b                	jmp    801007a0 <consputc+0x50>
  } else
    uartputc(c);
80100795:	8b 45 08             	mov    0x8(%ebp),%eax
80100798:	89 04 24             	mov    %eax,(%esp)
8010079b:	e8 2b 64 00 00       	call   80106bcb <uartputc>
  cgaputc(c);
...
801007ba:	e8 30 47 00 00       	call   80104eef <acquire>
  while((c = getc()) >= 0){
...
801007e5:	e9 82 00 00 00       	jmp    8010086c <consoleintr+0xbf>
    case C('P'):  // Process listing.
      procdump();
801007ea:	e8 76 45 00 00       	call   80104d65 <procdump>
      break;
...
801008f3:	e8 c7 43 00 00       	call   80104cbf <wakeup>
        }
      }
      break;
...
80100914:	e8 38 46 00 00       	call   80104f51 <release>
}
80100919:	c9                   	leave  
8010091a:	c3                   	ret    
...
80100939:	e8 b1 45 00 00       	call   80104eef <acquire>
  while(n > 0){
...
80100959:	e8 f3 45 00 00       	call   80104f51 <release>
        ilock(ip);
...
80100982:	e8 f4 41 00 00       	call   80104b7b <sleep>
...
801009fe:	e8 4e 45 00 00       	call   80104f51 <release>
  ilock(ip);
...
80100a32:	e8 b8 44 00 00       	call   80104eef <acquire>
  for(i = 0; i < n; i++)
...
80100a6c:	e8 e0 44 00 00       	call   80104f51 <release>
  ilock(ip);
...
80100a87:	c7 44 24 04 db 85 10 	movl   $0x801085db,0x4(%esp)
80100a8e:	80 
80100a8f:	c7 04 24 e0 b5 10 80 	movl   $0x8010b5e0,(%esp)
80100a96:	e8 33 44 00 00       	call   80104ece <initlock>
  initlock(&input.lock, "input");
80100a9b:	c7 44 24 04 e3 85 10 	movl   $0x801085e3,0x4(%esp)
80100aa2:	80 
80100aa3:	c7 04 24 c0 dd 10 80 	movl   $0x8010ddc0,(%esp)
80100aaa:	e8 1f 44 00 00       	call   80104ece <initlock>
...
80100b65:	e9 70 03 00 00       	jmp    80100eda <exec+0x3ea>
  ...
  if((pgdir = setupkvm()) == 0)
80100b6a:	e8 b2 71 00 00       	call   80107d21 <setupkvm>
...
80100c0b:	e8 df 74 00 00       	call   801080ef <allocuvm>
...
80100c49:	e8 b6 73 00 00       	call   80108004 <loaduvm>
...
80100cb2:	e8 38 74 00 00       	call   801080ef <allocuvm>
...
80100ce3:	e8 37 76 00 00       	call   8010831f <clearpteu>
...
80100d19:	e8 92 46 00 00       	call   801053b0 <strlen>
...
80100d42:	e8 69 46 00 00       	call   801053b0 <strlen>
...
80100d72:	e8 6d 77 00 00       	call   801084e4 <copyout>
...
80100e19:	e8 c6 76 00 00       	call   801084e4 <copyout>
...
80100e71:	e8 f0 44 00 00       	call   80105366 <safestrcpy>
...
80100ec3:	e8 4a 6f 00 00       	call   80107e12 <switchuvm>
  freevm(oldpgdir);
80100ec8:	8b 45 d0             	mov    -0x30(%ebp),%eax
80100ecb:	89 04 24             	mov    %eax,(%esp)
80100ece:	e8 b2 73 00 00       	call   80108285 <freevm>
  return 0;
...
80100ee6:	e8 9a 73 00 00       	call   80108285 <freevm>
  if(ip)
...
80100f0a:	c7 44 24 04 e9 85 10 	movl   $0x801085e9,0x4(%esp)
80100f11:	80 
80100f12:	c7 04 24 80 de 10 80 	movl   $0x8010de80,(%esp)
80100f19:	e8 b0 3f 00 00       	call   80104ece <initlock>
}
80100f1e:	c9                   	leave  
80100f1f:	c3                   	ret    
...
80100f2d:	e8 bd 3f 00 00       	call   80104eef <acquire>
...
80100f56:	e8 f6 3f 00 00       	call   80104f51 <release>
      return f;
...
80100f74:	e8 d8 3f 00 00       	call   80104f51 <release>
  return 0;
...
80100f8d:	e8 5d 3f 00 00       	call   80104eef <acquire>
  if(f->ref < 1)
...
80100f9a:	7f 0c                	jg     80100fa8 <filedup+0x28>
    panic("filedup");
80100f9c:	c7 04 24 f0 85 10 80 	movl   $0x801085f0,(%esp)
...
80100fbe:	e8 8e 3f 00 00       	call   80104f51 <release>
  return f;
...
80100fd5:	e8 15 3f 00 00       	call   80104eef <acquire>
  if(f->ref < 1)
...
80100fe2:	7f 0c                	jg     80100ff0 <fileclose+0x28>
    panic("fileclose");
80100fe4:	c7 04 24 f8 85 10 80 	movl   $0x801085f8,(%esp)
...
80101010:	e8 3c 3f 00 00       	call   80104f51 <release>
...
8010105a:	e8 f2 3e 00 00       	call   80104f51 <release>
...
80101199:	eb 0c                	jmp    801011a7 <fileread+0xba>
  ...
  panic("fileread");
8010119b:	c7 04 24 02 86 10 80 	movl   $0x80108602,(%esp)
...
801012a7:	c7 04 24 0b 86 10 80 	movl   $0x8010860b,(%esp)
...
801012d7:	eb 0c                	jmp    801012e5 <filewrite+0x13c>
  ...
  panic("filewrite");
801012d9:	c7 04 24 1b 86 10 80 	movl   $0x8010861b,(%esp)
...
80101320:	e8 f0 3e 00 00       	call   80105215 <memmove>
  brelse(bp);
...
80101366:	e8 db 3d 00 00       	call   80105146 <memset>
  log_write(bp);
...
801014c3:	c7 04 24 25 86 10 80 	movl   $0x80108625,(%esp)
...
80101555:	c7 04 24 3b 86 10 80 	movl   $0x8010863b,(%esp)
...
801015a5:	c7 44 24 04 4e 86 10 	movl   $0x8010864e,0x4(%esp)
801015ac:	80 
801015ad:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
801015b4:	e8 15 39 00 00       	call   80104ece <initlock>
}
801015b9:	c9                   	leave  
801015ba:	c3                   	ret    
...
80101636:	e8 0b 3b 00 00       	call   80105146 <memset>
      dip->type = type;
...
8010168c:	c7 04 24 55 86 10 80 	movl   $0x80108655,(%esp)
...
80101735:	e8 db 3a 00 00       	call   80105215 <memmove>
  log_write(bp);
...
8010175f:	e8 8b 37 00 00       	call   80104eef <acquire>
...
801017a9:	e8 a3 37 00 00       	call   80104f51 <release>
      return ip;
...
801017dc:	c7 04 24 67 86 10 80 	movl   $0x80108667,(%esp)
...
8010181a:	e8 32 37 00 00       	call   80104f51 <release>
...
80101831:	e8 b9 36 00 00       	call   80104eef <acquire>
  ip->ref++;
...
8010184c:	e8 00 37 00 00       	call   80104f51 <release>
  return ip;
...
8010186a:	7f 0c                	jg     80101878 <ilock+0x22>
    panic("ilock");
8010186c:	c7 04 24 77 86 10 80 	movl   $0x80108677,(%esp)
80101873:	e8 c2 ec ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
80101878:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
8010187f:	e8 6b 36 00 00       	call   80104eef <acquire>
...
80101894:	e8 e2 32 00 00       	call   80104b7b <sleep>
...
801018be:	e8 8e 36 00 00       	call   80104f51 <release>
...
80101969:	e8 a7 38 00 00       	call   80105215 <memmove>
    brelse(bp);
...
80101994:	75 0c                	jne    801019a2 <ilock+0x14c>
      panic("ilock: no type");
80101996:	c7 04 24 7d 86 10 80 	movl   $0x8010867d,(%esp)
...
801019c5:	7f 0c                	jg     801019d3 <iunlock+0x2f>
    panic("iunlock");
801019c7:	c7 04 24 8c 86 10 80 	movl   $0x8010868c,(%esp)
801019ce:	e8 67 eb ff ff       	call   8010053a <panic>

  acquire(&icache.lock);
801019d3:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
801019da:	e8 10 35 00 00       	call   80104eef <acquire>
  ip->flags &= ~I_BUSY;
...
801019f6:	e8 c4 32 00 00       	call   80104cbf <wakeup>
  release(&icache.lock);
801019fb:	c7 04 24 80 e8 10 80 	movl   $0x8010e880,(%esp)
80101a02:	e8 4a 35 00 00       	call   80104f51 <release>
}
80101a07:	c9                   	leave  
80101a08:	c3                   	ret    
...
80101a16:	e8 d4 34 00 00       	call   80104eef <acquire>
...
80101a52:	74 0c                	je     80101a60 <iput+0x57>
      panic("iput busy");
80101a54:	c7 04 24 94 86 10 80 	movl   $0x80108694,(%esp)
...
80101a78:	e8 d4 34 00 00       	call   80104f51 <release>
    itrunc(ip);
...
80101aa3:	e8 47 34 00 00       	call   80104eef <acquire>
    ip->flags = 0;
...
80101ab8:	e8 02 32 00 00       	call   80104cbf <wakeup>
  }
  ip->ref--;
...
80101ad3:	e8 79 34 00 00       	call   80104f51 <release>
}
80101ad8:	c9                   	leave  
80101ad9:	c3                   	ret    
...
80101bf3:	c7 04 24 9e 86 10 80 	movl   $0x8010869e,(%esp)
...
80101e94:	e8 7c 33 00 00       	call   80105215 <memmove>
    brelse(bp);
...
80101ff3:	e8 1d 32 00 00       	call   80105215 <memmove>
    log_write(bp);
...
80102071:	e8 42 32 00 00       	call   801052b8 <strncmp>
}
80102076:	c9                   	leave  
80102077:	c3                   	ret    
...
8010208b:	c7 04 24 b1 86 10 80 	movl   $0x801086b1,(%esp)
...
801020c7:	74 0c                	je     801020d5 <dirlookup+0x5d>
      panic("dirlink read");
801020c9:	c7 04 24 c3 86 10 80 	movl   $0x801086c3,(%esp)
...
801021ac:	74 0c                	je     801021ba <dirlink+0x79>
      panic("dirlink read");
801021ae:	c7 04 24 c3 86 10 80 	movl   $0x801086c3,(%esp)
...
801021f3:	e8 16 31 00 00       	call   8010530e <strncpy>
  de.inum = inum;
...
80102223:	74 0c                	je     80102231 <dirlink+0xf0>
    panic("dirlink");
80102225:	c7 04 24 d0 86 10 80 	movl   $0x801086d0,(%esp)
...
801022aa:	e8 66 2f 00 00       	call   80105215 <memmove>
  else {
    memmove(name, s, len);
    name[len] = 0;
  }
...
801022c5:	e8 4b 2f 00 00       	call   80105215 <memmove>
    name[len] = 0;
...
80102517:	c7 44 24 04 d8 86 10 	movl   $0x801086d8,0x4(%esp)
8010251e:	80 
8010251f:	c7 04 24 20 b6 10 80 	movl   $0x8010b620,(%esp)
80102526:	e8 a3 29 00 00       	call   80104ece <initlock>
  picenable(IRQ_IDE);
...
801025c1:	75 0c                	jne    801025cf <idestart+0x18>
    panic("idestart");
801025c3:	c7 04 24 dc 86 10 80 	movl   $0x801086dc,(%esp)
...
801026e9:	e8 01 28 00 00       	call   80104eef <acquire>
  if((b = idequeue) == 0){
...
80102703:	e8 49 28 00 00       	call   80104f51 <release>
...
80102776:	e8 44 25 00 00       	call   80104cbf <wakeup>
...
80102798:	e8 b4 27 00 00       	call   80104f51 <release>
}
8010279d:	c9                   	leave  
8010279e:	c3                   	ret    
...
801027b1:	c7 04 24 e5 86 10 80 	movl   $0x801086e5,(%esp)
...
801027ca:	c7 04 24 f9 86 10 80 	movl   $0x801086f9,(%esp)
...
80102857:	e8 1f 23 00 00       	call   80104b7b <sleep>
  // Start disk if necessary.
  if(idequeue == b)
    idestart(b);
...
80102870:	e8 dc 26 00 00       	call   80104f51 <release>
}
80102875:	c9                   	leave  
80102876:	c3                   	ret    
80102877:	90                   	nop
...
801028ff:	c7 04 24 2c 87 10 80 	movl   $0x8010872c,(%esp)
...
801029bb:	c7 44 24 04 5e 87 10 	movl   $0x8010875e,0x4(%esp)
801029c2:	80 
801029c3:	c7 04 24 60 f8 10 80 	movl   $0x8010f860,(%esp)
801029ca:	e8 ff 24 00 00       	call   80104ece <initlock>
  kmem.use_lock = 0;
...
80102a5c:	81 7d 08 1c 29 11 80 	cmpl   $0x8011291c,0x8(%ebp)
...
80102a75:	76 0c                	jbe    80102a83 <kfree+0x39>
    panic("kfree");
80102a77:	c7 04 24 63 87 10 80 	movl   $0x80108763,(%esp)
...
80102a99:	e8 a8 26 00 00       	call   80105146 <memset>
...
80102aae:	e8 3c 24 00 00       	call   80104eef <acquire>
  r = (struct run*)v;
...
80102adc:	e8 70 24 00 00       	call   80104f51 <release>
}
80102ae1:	c9                   	leave  
80102ae2:	c3                   	ret    
...
80102af9:	e8 f1 23 00 00       	call   80104eef <acquire>
  r = kmem.freelist;
...
80102b26:	e8 26 24 00 00       	call   80104f51 <release>
  return (char*)r;
...
80102e89:	c7 04 24 6c 87 10 80 	movl   $0x8010876c,(%esp)
...
80102fde:	c7 44 24 04 98 87 10 	movl   $0x80108798,0x4(%esp)
80102fe5:	80 
80102fe6:	c7 04 24 a0 f8 10 80 	movl   $0x8010f8a0,(%esp)
80102fed:	e8 dc 1e 00 00       	call   80104ece <initlock>
  readsb(ROOTDEV, &sb);
...
801030a1:	e8 6f 21 00 00       	call   80105215 <memmove>
...
801031f3:	e8 f7 1c 00 00       	call   80104eef <acquire>
  while (log.busy) {
...
80103209:	e8 6d 19 00 00       	call   80104b7b <sleep>
...
80103228:	e8 24 1d 00 00       	call   80104f51 <release>
}
8010322d:	c9                   	leave  
8010322e:	c3                   	ret    
...
801032a9:	c7 04 24 9c 87 10 80 	movl   $0x8010879c,(%esp)
...
801032be:	c7 04 24 b2 87 10 80 	movl   $0x801087b2,(%esp)
...
8010334f:	e8 c1 1e 00 00       	call   80105215 <memmove>
  bwrite(lbuf);
...
80103409:	c7 04 24 c9 87 10 80 	movl   $0x801087c9,(%esp)
...
80103424:	e8 92 36 00 00       	call   80106abb <uartinit>
  pinit();         // process table
80103429:	e8 fa 0b 00 00       	call   80104028 <pinit>
  tvinit();        // trap vectors
8010342e:	e8 37 32 00 00       	call   8010666a <tvinit>
  binit();         // buffer cache
...
80103450:	e8 5d 31 00 00       	call   801065b2 <timerinit>
...
8010347b:	83 ec 08             	sub    $0x8,%esp
  switchkvm(); 
8010347e:	e8 72 49 00 00       	call   80107df5 <switchkvm>
  seginit();
80103483:	e8 e9 42 00 00       	call   80107771 <seginit>
  lapicinit();
...
801034a8:	c7 04 24 e0 87 10 80 	movl   $0x801087e0,(%esp)
801034af:	e8 ec ce ff ff       	call   801003a0 <cprintf>
  idtinit();       // load idt register
801034b4:	e8 25 33 00 00       	call   801067de <idtinit>
...
801034d4:	e8 ce 14 00 00       	call   801049a7 <scheduler>
...
80103506:	e8 0a 1d 00 00       	call   80105215 <memmove>
...
80103688:	00 
80103689:	c7 44 24 04 f4 87 10 	movl   $0x801087f4,0x4(%esp)
80103690:	80 
80103691:	8b 45 f4             	mov    -0xc(%ebp),%eax
80103694:	89 04 24             	mov    %eax,(%esp)
80103697:	e8 21 1b 00 00       	call   801051bd <memcmp>
...
801037c9:	00 
801037ca:	c7 44 24 04 f9 87 10 	movl   $0x801087f9,0x4(%esp)
801037d1:	80 
801037d2:	8b 45 f0             	mov    -0x10(%ebp),%eax
801037d5:	89 04 24             	mov    %eax,(%esp)
801037d8:	e8 e0 19 00 00       	call   801051bd <memcmp>
...
801038a6:	8b 04 85 3c 88 10 80 	mov    -0x7fef77c4(,%eax,4),%eax
...
801038df:	c7 04 24 fe 87 10 80 	movl   $0x801087fe,(%esp)
...
80103972:	c7 04 24 1c 88 10 80 	movl   $0x8010881c,(%esp)
...
80103c70:	c7 44 24 04 50 88 10 	movl   $0x80108850,0x4(%esp)
80103c77:	80 
80103c78:	89 04 24             	mov    %eax,(%esp)
80103c7b:	e8 4e 12 00 00       	call   80104ece <initlock>
  (*f0)->type = FD_PIPE;
...
80103d27:	e8 c3 11 00 00       	call   80104eef <acquire>
  if(writable){
...
80103d4a:	e8 70 0f 00 00       	call   80104cbf <wakeup>
...
80103d69:	e8 51 0f 00 00       	call   80104cbf <wakeup>
  }
...
80103d8e:	e8 be 11 00 00       	call   80104f51 <release>
    kfree((char*)p);
...
80103da6:	e8 a6 11 00 00       	call   80104f51 <release>
}
80103dab:	c9                   	leave  
80103dac:	c3                   	ret    
...
80103db9:	e8 31 11 00 00       	call   80104eef <acquire>
  for(i = 0; i < n; i++){
...
80103dec:	e8 60 11 00 00       	call   80104f51 <release>
        return -1;
...
80103e06:	e8 b4 0e 00 00       	call   80104cbf <wakeup>
...
80103e1e:	e8 58 0d 00 00       	call   80104b7b <sleep>
{
  int i;
...
80103e87:	e8 33 0e 00 00       	call   80104cbf <wakeup>
  release(&p->lock);
80103e8c:	8b 45 08             	mov    0x8(%ebp),%eax
80103e8f:	89 04 24             	mov    %eax,(%esp)
80103e92:	e8 ba 10 00 00       	call   80104f51 <release>
  return n;
...
80103ea9:	e8 41 10 00 00       	call   80104eef <acquire>
...
80103ec3:	e8 89 10 00 00       	call   80104f51 <release>
      return -1;
...
80103ee5:	e8 91 0c 00 00       	call   80104b7b <sleep>
piperead(struct pipe *p, char *addr, int n)
{
  int i;
...
80103f74:	e8 46 0d 00 00       	call   80104cbf <wakeup>
  release(&p->lock);
80103f79:	8b 45 08             	mov    0x8(%ebp),%eax
80103f7c:	89 04 24             	mov    %eax,(%esp)
80103f7f:	e8 cd 0f 00 00       	call   80104f51 <release>
  return i;
...
8010402e:	c7 44 24 04 58 88 10 	movl   $0x80108858,0x4(%esp)
80104035:	80 
80104036:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010403d:	e8 8c 0e 00 00       	call   80104ece <initlock>
}
80104042:	c9                   	leave  
80104043:	c3                   	ret    
...
80104051:	e8 99 0e 00 00       	call   80104eef <acquire>
...
8010408f:	e8 bd 0e 00 00       	call   80104f51 <release>
...
801040a9:	eb 23                	jmp    801040ce <allocproc+0x8a>
{
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801040ab:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
801040b2:	81 7d f4 74 20 11 80 	cmpl   $0x80112074,-0xc(%ebp)
801040b9:	72 a4                	jb     8010405f <allocproc+0x1b>
        if(p->state == UNUSED)
            goto found;
    release(&ptable.lock);
801040bb:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801040c2:	e8 8a 0e 00 00       	call   80104f51 <release>
    return 0;
...
801040fe:	ba 24 66 10 80       	mov    $0x80106624,%edx
...
8010412e:	e8 13 10 00 00       	call   80105146 <memset>
    p->context->eip = (uint)forkret;
80104133:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104136:	8b 40 1c             	mov    0x1c(%eax),%eax
80104139:	ba 4f 4b 10 80       	mov    $0x80104b4f,%edx
...
8010415c:	e8 c0 3b 00 00       	call   80107d21 <setupkvm>
...
80104171:	c7 04 24 5f 88 10 80 	movl   $0x8010885f,(%esp)
...
80104197:	e8 dd 3d 00 00       	call   80107f79 <inituvm>
    p->sz = PGSIZE;
...
801041be:	e8 83 0f 00 00       	call   80105146 <memset>
...
80104237:	00 
80104238:	c7 44 24 04 78 88 10 	movl   $0x80108878,0x4(%esp)
8010423f:	80 
80104240:	89 04 24             	mov    %eax,(%esp)
80104243:	e8 1e 11 00 00       	call   80105366 <safestrcpy>
    p->cwd = namei("/");
80104248:	c7 04 24 81 88 10 80 	movl   $0x80108881,(%esp)
...
8010429c:	e8 4e 3e 00 00       	call   801080ef <allocuvm>
...
801042d6:	e8 ee 3e 00 00       	call   801081c9 <deallocuvm>
...
801042ff:	e8 0e 3b 00 00       	call   80107e12 <switchuvm>
    return 0;
...
80104344:	e8 1c 40 00 00       	call   80108365 <copyuvm>
...
8010446b:	e8 f6 0e 00 00       	call   80105366 <safestrcpy>
    return pid;
...
801045f2:	e8 ed 3e 00 00       	call   801084e4 <copyout>
801045f7:	85 c0                	test   %eax,%eax
801045f9:	79 16                	jns    80104611 <clone+0x196>
        cprintf("push arg fails\n");
801045fb:	c7 04 24 83 88 10 80 	movl   $0x80108883,(%esp)
...
80104646:	e8 c7 37 00 00       	call   80107e12 <switchuvm>

     acquire(&ptable.lock);
8010464b:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104652:	e8 98 08 00 00       	call   80104eef <acquire>
    np->state = RUNNABLE;
...
80104668:	e8 e4 08 00 00       	call   80104f51 <release>
    safestrcpy(np->name, proc->name, sizeof(proc->name));
...
8010468b:	e8 d6 0c 00 00       	call   80105366 <safestrcpy>
...
801046b2:	75 0c                	jne    801046c0 <exit+0x22>
        panic("init exiting");
801046b4:	c7 04 24 93 88 10 80 	movl   $0x80108893,(%esp)
...
80104738:	e8 b2 07 00 00       	call   80104eef <acquire>
...
80104749:	e8 c8 04 00 00       	call   80104c16 <wakeup1>
...
80104786:	e8 8b 04 00 00       	call   80104c16 <wakeup1>
    ...
    // Pass abandoned children to init.
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
8010478b:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104792:	81 7d f4 74 20 11 80 	cmpl   $0x80112074,-0xc(%ebp)
...
801047a1:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
    sched();
801047a8:	e8 95 02 00 00       	call   80104a42 <sched>
    panic("zombie exit");
801047ad:	c7 04 24 a0 88 10 80 	movl   $0x801088a0,(%esp)
...
801047cd:	75 0c                	jne    801047db <texit+0x22>
        panic("init exiting");
801047cf:	c7 04 24 93 88 10 80 	movl   $0x80108893,(%esp)
...
8010486f:	c7 40 0c 05 00 00 00 	movl   $0x5,0xc(%eax)
    sched();
80104876:	e8 c7 01 00 00       	call   80104a42 <sched>
    panic("zombie exit");
8010487b:	c7 04 24 a0 88 10 80 	movl   $0x801088a0,(%esp)
...
8010488a:	83 ec 28             	sub    $0x28,%esp
    ...
    acquire(&ptable.lock);
8010488d:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104894:	e8 56 06 00 00       	call   80104eef <acquire>
    for(;;){
        // Scan through table looking for zombie children.
        havekids = 0;
80104899:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801048a0:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
801048a7:	e9 ab 00 00 00       	jmp    80104957 <wait+0xd0>
...
801048ba:	74 05                	je     801048c1 <wait+0x3a>
                continue;
801048bc:	e9 8f 00 00 00       	jmp    80104950 <wait+0xc9>
            havekids = 1;
...
801048d1:	75 7d                	jne    80104950 <wait+0xc9>
                // Found one.
                pid = p->pid;
...
80104938:	c7 40 24 00 00 00 00 	movl   $0x0,0x24(%eax)
                release(&ptable.lock);
8010493f:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104946:	e8 06 06 00 00       	call   80104f51 <release>
                return pid;
8010494b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010494e:	eb 55                	jmp    801049a5 <wait+0x11e>
    ...
    for(;;){
        ...
        havekids = 0;
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104950:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104957:	81 7d f4 74 20 11 80 	cmpl   $0x80112074,-0xc(%ebp)
8010495e:	0f 82 48 ff ff ff    	jb     801048ac <wait+0x25>
                return pid;
            }
        }
...
80104968:	74 0d                	je     80104977 <wait+0xf0>
8010496a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104970:	8b 40 24             	mov    0x24(%eax),%eax
80104973:	85 c0                	test   %eax,%eax
80104975:	74 13                	je     8010498a <wait+0x103>
            release(&ptable.lock);
80104977:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
8010497e:	e8 ce 05 00 00       	call   80104f51 <release>
            return -1;
80104983:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80104988:	eb 1b                	jmp    801049a5 <wait+0x11e>
        }

        // Wait for children to exit.  (See wakeup1 call in proc_exit.)
        sleep(proc, &ptable.lock);  //DOC: wait-sleep
8010498a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104990:	c7 44 24 04 40 ff 10 	movl   $0x8010ff40,0x4(%esp)
80104997:	80 
80104998:	89 04 24             	mov    %eax,(%esp)
8010499b:	e8 db 01 00 00       	call   80104b7b <sleep>
    }
801049a0:	e9 f4 fe ff ff       	jmp    80104899 <wait+0x12>
}
801049a5:	c9                   	leave  
801049a6:	c3                   	ret    
...
801049aa:	83 ec 28             	sub    $0x28,%esp
    struct proc *p;

    for(;;){
        // Enable interrupts on this processor.
        sti();
801049ad:	e8 ee f5 ff ff       	call   80103fa0 <sti>

        // Loop over process table looking for process to run.
        acquire(&ptable.lock);
801049b2:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
801049b9:	e8 31 05 00 00       	call   80104eef <acquire>
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
801049be:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
801049c5:	eb 61                	jmp    80104a28 <scheduler+0x81>
            if(p->state != RUNNABLE)
801049c7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049ca:	8b 40 0c             	mov    0xc(%eax),%eax
801049cd:	83 f8 03             	cmp    $0x3,%eax
801049d0:	74 02                	je     801049d4 <scheduler+0x2d>
                continue;
801049d2:	eb 4d                	jmp    80104a21 <scheduler+0x7a>
...
801049d7:	65 a3 04 00 00 00    	mov    %eax,%gs:0x4
            switchuvm(p);
801049dd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801049e0:	89 04 24             	mov    %eax,(%esp)
801049e3:	e8 2a 34 00 00       	call   80107e12 <switchuvm>
            p->state = RUNNING;
...
801049fb:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104a02:	83 c2 04             	add    $0x4,%edx
80104a05:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a09:	89 14 24             	mov    %edx,(%esp)
80104a0c:	e8 c7 09 00 00       	call   801053d8 <swtch>
            switchkvm();
80104a11:	e8 df 33 00 00       	call   80107df5 <switchkvm>

            // Process is done running for now.
            // It should have changed its p->state before coming back.
            proc = 0;
80104a16:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80104a1d:	00 00 00 00 
        // Enable interrupts on this processor.
        sti();
        ...
        acquire(&ptable.lock);
        for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104a21:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104a28:	81 7d f4 74 20 11 80 	cmpl   $0x80112074,-0xc(%ebp)
80104a2f:	72 96                	jb     801049c7 <scheduler+0x20>
        ...
        release(&ptable.lock);
80104a31:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104a38:	e8 14 05 00 00       	call   80104f51 <release>

    }
80104a3d:	e9 6b ff ff ff       	jmp    801049ad <scheduler+0x6>
...
80104a48:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104a4f:	e8 c5 05 00 00       	call   80105019 <holding>
80104a54:	85 c0                	test   %eax,%eax
80104a56:	75 0c                	jne    80104a64 <sched+0x22>
        panic("sched ptable.lock");
80104a58:	c7 04 24 ac 88 10 80 	movl   $0x801088ac,(%esp)
80104a5f:	e8 d6 ba ff ff       	call   8010053a <panic>
    if(cpu->ncli != 1){
80104a64:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a6a:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
80104a70:	83 f8 01             	cmp    $0x1,%eax
80104a73:	74 35                	je     80104aaa <sched+0x68>
        cprintf("current proc %d\n cpu->ncli %d\n",proc->pid,cpu->ncli);
80104a75:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104a7b:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
80104a81:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104a87:	8b 40 10             	mov    0x10(%eax),%eax
80104a8a:	89 54 24 08          	mov    %edx,0x8(%esp)
80104a8e:	89 44 24 04          	mov    %eax,0x4(%esp)
80104a92:	c7 04 24 c0 88 10 80 	movl   $0x801088c0,(%esp)
80104a99:	e8 02 b9 ff ff       	call   801003a0 <cprintf>
        panic("sched locks");
80104a9e:	c7 04 24 df 88 10 80 	movl   $0x801088df,(%esp)
...
80104ab3:	83 f8 04             	cmp    $0x4,%eax
80104ab6:	75 0c                	jne    80104ac4 <sched+0x82>
        panic("sched running");
80104ab8:	c7 04 24 eb 88 10 80 	movl   $0x801088eb,(%esp)
80104abf:	e8 76 ba ff ff       	call   8010053a <panic>
    if(readeflags()&FL_IF)
80104ac4:	e8 c7 f4 ff ff       	call   80103f90 <readeflags>
80104ac9:	25 00 02 00 00       	and    $0x200,%eax
80104ace:	85 c0                	test   %eax,%eax
80104ad0:	74 0c                	je     80104ade <sched+0x9c>
        panic("sched interruptible");
80104ad2:	c7 04 24 f9 88 10 80 	movl   $0x801088f9,(%esp)
80104ad9:	e8 5c ba ff ff       	call   8010053a <panic>
    intena = cpu->intena;
80104ade:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104ae4:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
80104aea:	89 45 f4             	mov    %eax,-0xc(%ebp)
    swtch(&proc->context, cpu->scheduler);
80104aed:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104af3:	8b 40 04             	mov    0x4(%eax),%eax
80104af6:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80104afd:	83 c2 1c             	add    $0x1c,%edx
80104b00:	89 44 24 04          	mov    %eax,0x4(%esp)
80104b04:	89 14 24             	mov    %edx,(%esp)
80104b07:	e8 cc 08 00 00       	call   801053d8 <swtch>
    cpu->intena = intena;
80104b0c:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80104b12:	8b 55 f4             	mov    -0xc(%ebp),%edx
80104b15:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80104b1b:	c9                   	leave  
80104b1c:	c3                   	ret    
...
80104b20:	83 ec 18             	sub    $0x18,%esp
    acquire(&ptable.lock);  //DOC: yieldlock
80104b23:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104b2a:	e8 c0 03 00 00       	call   80104eef <acquire>
    proc->state = RUNNABLE;
80104b2f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104b35:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
    sched();
80104b3c:	e8 01 ff ff ff       	call   80104a42 <sched>
    release(&ptable.lock);
80104b41:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104b48:	e8 04 04 00 00       	call   80104f51 <release>
}
80104b4d:	c9                   	leave  
80104b4e:	c3                   	ret    
...
80104b52:	83 ec 18             	sub    $0x18,%esp
    static int first = 1;
    // Still holding ptable.lock from scheduler.
    release(&ptable.lock);
80104b55:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104b5c:	e8 f0 03 00 00       	call   80104f51 <release>

    if (first) {
80104b61:	a1 08 b0 10 80       	mov    0x8010b008,%eax
80104b66:	85 c0                	test   %eax,%eax
80104b68:	74 0f                	je     80104b79 <forkret+0x2a>
        // Some initialization functions must be run in the context
        // of a regular process (e.g., they call sleep), and thus cannot 
        // be run from main().
        first = 0;
80104b6a:	c7 05 08 b0 10 80 00 	movl   $0x0,0x8010b008
80104b71:	00 00 00 
        initlog();
80104b74:	e8 5f e4 ff ff       	call   80102fd8 <initlog>
    }
...
80104b89:	75 0c                	jne    80104b97 <sleep+0x1c>
        panic("sleep");
80104b8b:	c7 04 24 0d 89 10 80 	movl   $0x8010890d,(%esp)
80104b92:	e8 a3 b9 ff ff       	call   8010053a <panic>

    if(lk == 0)
80104b97:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
80104b9b:	75 0c                	jne    80104ba9 <sleep+0x2e>
        panic("sleep without lk");
80104b9d:	c7 04 24 13 89 10 80 	movl   $0x80108913,(%esp)
...
80104ba9:	81 7d 0c 40 ff 10 80 	cmpl   $0x8010ff40,0xc(%ebp)
80104bb0:	74 17                	je     80104bc9 <sleep+0x4e>
        acquire(&ptable.lock);  //DOC: sleeplock1
80104bb2:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104bb9:	e8 31 03 00 00       	call   80104eef <acquire>
        release(lk);
80104bbe:	8b 45 0c             	mov    0xc(%ebp),%eax
80104bc1:	89 04 24             	mov    %eax,(%esp)
80104bc4:	e8 88 03 00 00       	call   80104f51 <release>
    }

    // Go to sleep.
    proc->chan = chan;
80104bc9:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bcf:	8b 55 08             	mov    0x8(%ebp),%edx
80104bd2:	89 50 20             	mov    %edx,0x20(%eax)
    proc->state = SLEEPING;
80104bd5:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bdb:	c7 40 0c 02 00 00 00 	movl   $0x2,0xc(%eax)
    sched();
80104be2:	e8 5b fe ff ff       	call   80104a42 <sched>

    // Tidy up.
    proc->chan = 0;
80104be7:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104bed:	c7 40 20 00 00 00 00 	movl   $0x0,0x20(%eax)

    // Reacquire original lock.
    if(lk != &ptable.lock){  //DOC: sleeplock2
80104bf4:	81 7d 0c 40 ff 10 80 	cmpl   $0x8010ff40,0xc(%ebp)
80104bfb:	74 17                	je     80104c14 <sleep+0x99>
        release(&ptable.lock);
80104bfd:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104c04:	e8 48 03 00 00       	call   80104f51 <release>
        acquire(lk);
80104c09:	8b 45 0c             	mov    0xc(%ebp),%eax
80104c0c:	89 04 24             	mov    %eax,(%esp)
80104c0f:	e8 db 02 00 00       	call   80104eef <acquire>
    }
}
80104c14:	c9                   	leave  
80104c15:	c3                   	ret    
...
80104c19:	83 ec 10             	sub    $0x10,%esp
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104c1c:	c7 45 fc 74 ff 10 80 	movl   $0x8010ff74,-0x4(%ebp)
80104c23:	eb 27                	jmp    80104c4c <wakeup1+0x36>
        if(p->state == SLEEPING && p->chan == chan)
80104c25:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104c28:	8b 40 0c             	mov    0xc(%eax),%eax
80104c2b:	83 f8 02             	cmp    $0x2,%eax
80104c2e:	75 15                	jne    80104c45 <wakeup1+0x2f>
80104c30:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104c33:	8b 40 20             	mov    0x20(%eax),%eax
80104c36:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c39:	75 0a                	jne    80104c45 <wakeup1+0x2f>
            p->state = RUNNABLE;
...
wakeup1(void *chan)
{
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104c45:	81 45 fc 84 00 00 00 	addl   $0x84,-0x4(%ebp)
80104c4c:	81 7d fc 74 20 11 80 	cmpl   $0x80112074,-0x4(%ebp)
80104c53:	72 d0                	jb     80104c25 <wakeup1+0xf>
        if(p->state == SLEEPING && p->chan == chan)
            p->state = RUNNABLE;
}
80104c55:	c9                   	leave  
...
80104c5a:	83 ec 28             	sub    $0x28,%esp
    struct proc *p;
    acquire(&ptable.lock);
80104c5d:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104c64:	e8 86 02 00 00       	call   80104eef <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104c69:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
80104c70:	eb 36                	jmp    80104ca8 <twakeup+0x51>
        if(p->state == SLEEPING && p->pid == tid && p->isthread == 1){
80104c72:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c75:	8b 40 0c             	mov    0xc(%eax),%eax
80104c78:	83 f8 02             	cmp    $0x2,%eax
80104c7b:	75 24                	jne    80104ca1 <twakeup+0x4a>
80104c7d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c80:	8b 40 10             	mov    0x10(%eax),%eax
80104c83:	3b 45 08             	cmp    0x8(%ebp),%eax
80104c86:	75 19                	jne    80104ca1 <twakeup+0x4a>
80104c88:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c8b:	8b 80 80 00 00 00    	mov    0x80(%eax),%eax
80104c91:	83 f8 01             	cmp    $0x1,%eax
80104c94:	75 0b                	jne    80104ca1 <twakeup+0x4a>
            wakeup1(p);
80104c96:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104c99:	89 04 24             	mov    %eax,(%esp)
80104c9c:	e8 75 ff ff ff       	call   80104c16 <wakeup1>
...
twakeup(int tid){
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104ca1:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104ca8:	81 7d f4 74 20 11 80 	cmpl   $0x80112074,-0xc(%ebp)
80104caf:	72 c1                	jb     80104c72 <twakeup+0x1b>
        if(p->state == SLEEPING && p->pid == tid && p->isthread == 1){
            wakeup1(p);
        }
    }
...
80104cb8:	e8 94 02 00 00       	call   80104f51 <release>
}
80104cbd:	c9                   	leave  
80104cbe:	c3                   	ret    
...
80104cc2:	83 ec 18             	sub    $0x18,%esp
    acquire(&ptable.lock);
80104cc5:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104ccc:	e8 1e 02 00 00       	call   80104eef <acquire>
    wakeup1(chan);
80104cd1:	8b 45 08             	mov    0x8(%ebp),%eax
80104cd4:	89 04 24             	mov    %eax,(%esp)
80104cd7:	e8 3a ff ff ff       	call   80104c16 <wakeup1>
    release(&ptable.lock);
80104cdc:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104ce3:	e8 69 02 00 00       	call   80104f51 <release>
}
80104ce8:	c9                   	leave  
80104ce9:	c3                   	ret    
...
80104ced:	83 ec 28             	sub    $0x28,%esp
    struct proc *p;

    acquire(&ptable.lock);
80104cf0:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104cf7:	e8 f3 01 00 00       	call   80104eef <acquire>
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104cfc:	c7 45 f4 74 ff 10 80 	movl   $0x8010ff74,-0xc(%ebp)
80104d03:	eb 44                	jmp    80104d49 <kill+0x5f>
        if(p->pid == pid){
80104d05:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d08:	8b 40 10             	mov    0x10(%eax),%eax
80104d0b:	3b 45 08             	cmp    0x8(%ebp),%eax
80104d0e:	75 32                	jne    80104d42 <kill+0x58>
            p->killed = 1;
80104d10:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d13:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
            // Wake process from sleep if necessary.
            if(p->state == SLEEPING)
80104d1a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d1d:	8b 40 0c             	mov    0xc(%eax),%eax
80104d20:	83 f8 02             	cmp    $0x2,%eax
80104d23:	75 0a                	jne    80104d2f <kill+0x45>
                p->state = RUNNABLE;
80104d25:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104d28:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
            release(&ptable.lock);
80104d2f:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104d36:	e8 16 02 00 00       	call   80104f51 <release>
            return 0;
80104d3b:	b8 00 00 00 00       	mov    $0x0,%eax
80104d40:	eb 21                	jmp    80104d63 <kill+0x79>
kill(int pid)
{
    struct proc *p;
    ...
    acquire(&ptable.lock);
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d42:	81 45 f4 84 00 00 00 	addl   $0x84,-0xc(%ebp)
80104d49:	81 7d f4 74 20 11 80 	cmpl   $0x80112074,-0xc(%ebp)
80104d50:	72 b3                	jb     80104d05 <kill+0x1b>
                p->state = RUNNABLE;
            release(&ptable.lock);
            return 0;
        }
    ...
    release(&ptable.lock);
80104d52:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104d59:	e8 f3 01 00 00       	call   80104f51 <release>
    return -1;
...
80104d68:	83 ec 58             	sub    $0x58,%esp
    int i;
    struct proc *p;
    char *state;
    uint pc[10];
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104d6b:	c7 45 f0 74 ff 10 80 	movl   $0x8010ff74,-0x10(%ebp)
80104d72:	e9 d9 00 00 00       	jmp    80104e50 <procdump+0xeb>
        if(p->state == UNUSED)
80104d77:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d7a:	8b 40 0c             	mov    0xc(%eax),%eax
80104d7d:	85 c0                	test   %eax,%eax
80104d7f:	75 05                	jne    80104d86 <procdump+0x21>
            continue;
80104d81:	e9 c3 00 00 00       	jmp    80104e49 <procdump+0xe4>
        if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104d86:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d89:	8b 40 0c             	mov    0xc(%eax),%eax
80104d8c:	83 f8 05             	cmp    $0x5,%eax
80104d8f:	77 23                	ja     80104db4 <procdump+0x4f>
80104d91:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104d94:	8b 40 0c             	mov    0xc(%eax),%eax
80104d97:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104d9e:	85 c0                	test   %eax,%eax
80104da0:	74 12                	je     80104db4 <procdump+0x4f>
            state = states[p->state];
80104da2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104da5:	8b 40 0c             	mov    0xc(%eax),%eax
80104da8:	8b 04 85 0c b0 10 80 	mov    -0x7fef4ff4(,%eax,4),%eax
80104daf:	89 45 ec             	mov    %eax,-0x14(%ebp)
80104db2:	eb 07                	jmp    80104dbb <procdump+0x56>
        else
            state = "???";
80104db4:	c7 45 ec 24 89 10 80 	movl   $0x80108924,-0x14(%ebp)
        cprintf("%d %s %s", p->pid, state, p->name);
80104dbb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104dbe:	8d 50 6c             	lea    0x6c(%eax),%edx
80104dc1:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104dc4:	8b 40 10             	mov    0x10(%eax),%eax
80104dc7:	89 54 24 0c          	mov    %edx,0xc(%esp)
80104dcb:	8b 55 ec             	mov    -0x14(%ebp),%edx
80104dce:	89 54 24 08          	mov    %edx,0x8(%esp)
80104dd2:	89 44 24 04          	mov    %eax,0x4(%esp)
80104dd6:	c7 04 24 28 89 10 80 	movl   $0x80108928,(%esp)
80104ddd:	e8 be b5 ff ff       	call   801003a0 <cprintf>
        if(p->state == SLEEPING){
80104de2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104de5:	8b 40 0c             	mov    0xc(%eax),%eax
80104de8:	83 f8 02             	cmp    $0x2,%eax
80104deb:	75 50                	jne    80104e3d <procdump+0xd8>
            getcallerpcs((uint*)p->context->ebp+2, pc);
80104ded:	8b 45 f0             	mov    -0x10(%ebp),%eax
80104df0:	8b 40 1c             	mov    0x1c(%eax),%eax
80104df3:	8b 40 0c             	mov    0xc(%eax),%eax
80104df6:	83 c0 08             	add    $0x8,%eax
80104df9:	8d 55 c4             	lea    -0x3c(%ebp),%edx
80104dfc:	89 54 24 04          	mov    %edx,0x4(%esp)
80104e00:	89 04 24             	mov    %eax,(%esp)
80104e03:	e8 98 01 00 00       	call   80104fa0 <getcallerpcs>
            for(i=0; i<10 && pc[i] != 0; i++)
80104e08:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80104e0f:	eb 1b                	jmp    80104e2c <procdump+0xc7>
                cprintf(" %p", pc[i]);
80104e11:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e14:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104e18:	89 44 24 04          	mov    %eax,0x4(%esp)
80104e1c:	c7 04 24 31 89 10 80 	movl   $0x80108931,(%esp)
80104e23:	e8 78 b5 ff ff       	call   801003a0 <cprintf>
        else
            state = "???";
        cprintf("%d %s %s", p->pid, state, p->name);
        if(p->state == SLEEPING){
            getcallerpcs((uint*)p->context->ebp+2, pc);
            for(i=0; i<10 && pc[i] != 0; i++)
80104e28:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80104e2c:	83 7d f4 09          	cmpl   $0x9,-0xc(%ebp)
80104e30:	7f 0b                	jg     80104e3d <procdump+0xd8>
80104e32:	8b 45 f4             	mov    -0xc(%ebp),%eax
80104e35:	8b 44 85 c4          	mov    -0x3c(%ebp,%eax,4),%eax
80104e39:	85 c0                	test   %eax,%eax
80104e3b:	75 d4                	jne    80104e11 <procdump+0xac>
                cprintf(" %p", pc[i]);
        }
        cprintf("\n");
80104e3d:	c7 04 24 35 89 10 80 	movl   $0x80108935,(%esp)
80104e44:	e8 57 b5 ff ff       	call   801003a0 <cprintf>
    ...
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80104e49:	81 45 f0 84 00 00 00 	addl   $0x84,-0x10(%ebp)
80104e50:	81 7d f0 74 20 11 80 	cmpl   $0x80112074,-0x10(%ebp)
80104e57:	0f 82 1a ff ff ff    	jb     80104d77 <procdump+0x12>
            for(i=0; i<10 && pc[i] != 0; i++)
                cprintf(" %p", pc[i]);
        }
        cprintf("\n");
...
80104e62:	83 ec 18             	sub    $0x18,%esp
    
    acquire(&ptable.lock); 
80104e65:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104e6c:	e8 7e 00 00 00       	call   80104eef <acquire>
    sleep(proc, &ptable.lock);
80104e71:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80104e77:	c7 44 24 04 40 ff 10 	movl   $0x8010ff40,0x4(%esp)
80104e7e:	80 
80104e7f:	89 04 24             	mov    %eax,(%esp)
80104e82:	e8 f4 fc ff ff       	call   80104b7b <sleep>
    release(&ptable.lock);
80104e87:	c7 04 24 40 ff 10 80 	movl   $0x8010ff40,(%esp)
80104e8e:	e8 be 00 00 00       	call   80104f51 <release>
...
80104ec0:	8b 4d 08             	mov    0x8(%ebp),%ecx
80104ec3:	f0 87 02             	lock xchg %eax,(%edx)
80104ec6:	89 45 fc             	mov    %eax,-0x4(%ebp)
               "+m" (*addr), "=a" (result) :
               "1" (newval) :
               "cc");
  return result;
...
80104ed4:	8b 55 0c             	mov    0xc(%ebp),%edx
...
80104ee6:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
80104eed:	5d                   	pop    %ebp
80104eee:	c3                   	ret    
...
80104ef5:	e8 49 01 00 00       	call   80105043 <pushcli>
  if(holding(lk))
80104efa:	8b 45 08             	mov    0x8(%ebp),%eax
80104efd:	89 04 24             	mov    %eax,(%esp)
80104f00:	e8 14 01 00 00       	call   80105019 <holding>
80104f05:	85 c0                	test   %eax,%eax
80104f07:	74 0c                	je     80104f15 <acquire+0x26>
    panic("acquire");
80104f09:	c7 04 24 61 89 10 80 	movl   $0x80108961,(%esp)
80104f10:	e8 25 b6 ff ff       	call   8010053a <panic>
...
80104f19:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80104f20:	00 
80104f21:	89 04 24             	mov    %eax,(%esp)
80104f24:	e8 8b ff ff ff       	call   80104eb4 <xchg>
80104f29:	85 c0                	test   %eax,%eax
80104f2b:	75 e9                	jne    80104f16 <acquire+0x27>
    ;

  // Record info about lock acquisition for debugging.
  lk->cpu = cpu;
80104f2d:	8b 45 08             	mov    0x8(%ebp),%eax
80104f30:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80104f37:	89 50 08             	mov    %edx,0x8(%eax)
  getcallerpcs(&lk, lk->pcs);
80104f3a:	8b 45 08             	mov    0x8(%ebp),%eax
80104f3d:	83 c0 0c             	add    $0xc,%eax
80104f40:	89 44 24 04          	mov    %eax,0x4(%esp)
80104f44:	8d 45 08             	lea    0x8(%ebp),%eax
80104f47:	89 04 24             	mov    %eax,(%esp)
80104f4a:	e8 51 00 00 00       	call   80104fa0 <getcallerpcs>
}
80104f4f:	c9                   	leave  
80104f50:	c3                   	ret    
...
80104f5d:	e8 b7 00 00 00       	call   80105019 <holding>
80104f62:	85 c0                	test   %eax,%eax
80104f64:	75 0c                	jne    80104f72 <release+0x21>
    panic("release");
80104f66:	c7 04 24 69 89 10 80 	movl   $0x80108969,(%esp)
80104f6d:	e8 c8 b5 ff ff       	call   8010053a <panic>

  lk->pcs[0] = 0;
80104f72:	8b 45 08             	mov    0x8(%ebp),%eax
80104f75:	c7 40 0c 00 00 00 00 	movl   $0x0,0xc(%eax)
  lk->cpu = 0;
80104f7c:	8b 45 08             	mov    0x8(%ebp),%eax
80104f7f:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
...
80104f89:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80104f90:	00 
80104f91:	89 04 24             	mov    %eax,(%esp)
80104f94:	e8 1b ff ff ff       	call   80104eb4 <xchg>

  popcli();
80104f99:	e8 e9 00 00 00       	call   80105087 <popcli>
}
80104f9e:	c9                   	leave  
80104f9f:	c3                   	ret    
...
80104fa9:	83 e8 08             	sub    $0x8,%eax
80104fac:	89 45 fc             	mov    %eax,-0x4(%ebp)
  for(i = 0; i < 10; i++){
80104faf:	c7 45 f8 00 00 00 00 	movl   $0x0,-0x8(%ebp)
80104fb6:	eb 38                	jmp    80104ff0 <getcallerpcs+0x50>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104fb8:	83 7d fc 00          	cmpl   $0x0,-0x4(%ebp)
80104fbc:	74 38                	je     80104ff6 <getcallerpcs+0x56>
80104fbe:	81 7d fc ff ff ff 7f 	cmpl   $0x7fffffff,-0x4(%ebp)
80104fc5:	76 2f                	jbe    80104ff6 <getcallerpcs+0x56>
80104fc7:	83 7d fc ff          	cmpl   $0xffffffff,-0x4(%ebp)
80104fcb:	74 29                	je     80104ff6 <getcallerpcs+0x56>
      break;
    pcs[i] = ebp[1];     // saved %eip
80104fcd:	8b 45 f8             	mov    -0x8(%ebp),%eax
80104fd0:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
80104fd7:	8b 45 0c             	mov    0xc(%ebp),%eax
80104fda:	01 c2                	add    %eax,%edx
80104fdc:	8b 45 fc             	mov    -0x4(%ebp),%eax
80104fdf:	8b 40 04             	mov    0x4(%eax),%eax
...
80104fe9:	89 45 fc             	mov    %eax,-0x4(%ebp)
{
  ...
  ebp = (uint*)v - 2;
  for(i = 0; i < 10; i++){
80104fec:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80104ff0:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80104ff4:	7e c2                	jle    80104fb8 <getcallerpcs+0x18>
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
      break;
    pcs[i] = ebp[1];     // saved %eip
    ebp = (uint*)ebp[0]; // saved %ebp
  ...
  for(; i < 10; i++)
80104ff6:	eb 19                	jmp    80105011 <getcallerpcs+0x71>
    pcs[i] = 0;
...
80105007:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  ...
  for(; i < 10; i++)
8010500d:	83 45 f8 01          	addl   $0x1,-0x8(%ebp)
80105011:	83 7d f8 09          	cmpl   $0x9,-0x8(%ebp)
80105015:	7e e1                	jle    80104ff8 <getcallerpcs+0x58>
    pcs[i] = 0;
}
80105017:	c9                   	leave  
80105018:	c3                   	ret    
...
80105023:	74 17                	je     8010503c <holding+0x23>
80105025:	8b 45 08             	mov    0x8(%ebp),%eax
80105028:	8b 50 08             	mov    0x8(%eax),%edx
8010502b:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105031:	39 c2                	cmp    %eax,%edx
80105033:	75 07                	jne    8010503c <holding+0x23>
80105035:	b8 01 00 00 00       	mov    $0x1,%eax
8010503a:	eb 05                	jmp    80105041 <holding+0x28>
8010503c:	b8 00 00 00 00       	mov    $0x0,%eax
}
80105041:	5d                   	pop    %ebp
80105042:	c3                   	ret    
...
80105046:	83 ec 10             	sub    $0x10,%esp
  ...
  eflags = readeflags();
80105049:	e8 4a fe ff ff       	call   80104e98 <readeflags>
8010504e:	89 45 fc             	mov    %eax,-0x4(%ebp)
  cli();
80105051:	e8 52 fe ff ff       	call   80104ea8 <cli>
  if(cpu->ncli++ == 0)
80105056:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
8010505d:	8b 82 ac 00 00 00    	mov    0xac(%edx),%eax
80105063:	8d 48 01             	lea    0x1(%eax),%ecx
80105066:	89 8a ac 00 00 00    	mov    %ecx,0xac(%edx)
8010506c:	85 c0                	test   %eax,%eax
8010506e:	75 15                	jne    80105085 <pushcli+0x42>
    cpu->intena = eflags & FL_IF;
80105070:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80105076:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105079:	81 e2 00 02 00 00    	and    $0x200,%edx
8010507f:	89 90 b0 00 00 00    	mov    %edx,0xb0(%eax)
}
80105085:	c9                   	leave  
80105086:	c3                   	ret    
...
8010508a:	83 ec 18             	sub    $0x18,%esp
  if(readeflags()&FL_IF)
8010508d:	e8 06 fe ff ff       	call   80104e98 <readeflags>
80105092:	25 00 02 00 00       	and    $0x200,%eax
80105097:	85 c0                	test   %eax,%eax
80105099:	74 0c                	je     801050a7 <popcli+0x20>
    panic("popcli - interruptible");
8010509b:	c7 04 24 71 89 10 80 	movl   $0x80108971,(%esp)
801050a2:	e8 93 b4 ff ff       	call   8010053a <panic>
  if(--cpu->ncli < 0)
801050a7:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050ad:	8b 90 ac 00 00 00    	mov    0xac(%eax),%edx
801050b3:	83 ea 01             	sub    $0x1,%edx
801050b6:	89 90 ac 00 00 00    	mov    %edx,0xac(%eax)
801050bc:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801050c2:	85 c0                	test   %eax,%eax
801050c4:	79 0c                	jns    801050d2 <popcli+0x4b>
    panic("popcli");
801050c6:	c7 04 24 88 89 10 80 	movl   $0x80108988,(%esp)
801050cd:	e8 68 b4 ff ff       	call   8010053a <panic>
  if(cpu->ncli == 0 && cpu->intena)
801050d2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050d8:	8b 80 ac 00 00 00    	mov    0xac(%eax),%eax
801050de:	85 c0                	test   %eax,%eax
801050e0:	75 15                	jne    801050f7 <popcli+0x70>
801050e2:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801050e8:	8b 80 b0 00 00 00    	mov    0xb0(%eax),%eax
801050ee:	85 c0                	test   %eax,%eax
801050f0:	74 05                	je     801050f7 <popcli+0x70>
    sti();
801050f2:	e8 b7 fd ff ff       	call   80104eae <sti>
}
801050f7:	c9                   	leave  
801050f8:	c3                   	ret    
801050f9:	66 90                	xchg   %ax,%ax
801050fb:	90                   	nop
...
801051cc:	89 45 f8             	mov    %eax,-0x8(%ebp)
  while(n-- > 0){
801051cf:	eb 30                	jmp    80105201 <memcmp+0x44>
    if(*s1 != *s2)
...
801051df:	74 18                	je     801051f9 <memcmp+0x3c>
      return *s1 - *s2;
...
801051f7:	eb 1a                	jmp    80105213 <memcmp+0x56>
    s1++, s2++;
...
8010520c:	75 c3                	jne    801051d1 <memcmp+0x14>
    if(*s1 != *s2)
      return *s1 - *s2;
    s1++, s2++;
  }
...
80105224:	89 45 f8             	mov    %eax,-0x8(%ebp)
  if(s < d && s + n > d){
80105227:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010522a:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010522d:	73 3d                	jae    8010526c <memmove+0x57>
8010522f:	8b 45 10             	mov    0x10(%ebp),%eax
80105232:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105235:	01 d0                	add    %edx,%eax
80105237:	3b 45 f8             	cmp    -0x8(%ebp),%eax
8010523a:	76 30                	jbe    8010526c <memmove+0x57>
    s += n;
8010523c:	8b 45 10             	mov    0x10(%ebp),%eax
8010523f:	01 45 fc             	add    %eax,-0x4(%ebp)
    d += n;
80105242:	8b 45 10             	mov    0x10(%ebp),%eax
80105245:	01 45 f8             	add    %eax,-0x8(%ebp)
    while(n-- > 0)
80105248:	eb 13                	jmp    8010525d <memmove+0x48>
      *--d = *--s;
8010524a:	83 6d f8 01          	subl   $0x1,-0x8(%ebp)
8010524e:	83 6d fc 01          	subl   $0x1,-0x4(%ebp)
80105252:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105255:	0f b6 10             	movzbl (%eax),%edx
80105258:	8b 45 f8             	mov    -0x8(%ebp),%eax
8010525b:	88 10                	mov    %dl,(%eax)
  s = src;
  d = dst;
  if(s < d && s + n > d){
    s += n;
...
80105260:	8d 50 ff             	lea    -0x1(%eax),%edx
80105263:	89 55 10             	mov    %edx,0x10(%ebp)
80105266:	85 c0                	test   %eax,%eax
80105268:	75 e0                	jne    8010524a <memmove+0x35>
  const char *s;
  char *d;
  ...
  d = dst;
  if(s < d && s + n > d){
8010526a:	eb 26                	jmp    80105292 <memmove+0x7d>
    s += n;
    d += n;
    while(n-- > 0)
      *--d = *--s;
    ...
    while(n-- > 0)
8010526c:	eb 17                	jmp    80105285 <memmove+0x70>
      *d++ = *s++;
8010526e:	8b 45 f8             	mov    -0x8(%ebp),%eax
80105271:	8d 50 01             	lea    0x1(%eax),%edx
80105274:	89 55 f8             	mov    %edx,-0x8(%ebp)
80105277:	8b 55 fc             	mov    -0x4(%ebp),%edx
8010527a:	8d 4a 01             	lea    0x1(%edx),%ecx
8010527d:	89 4d fc             	mov    %ecx,-0x4(%ebp)
80105280:	0f b6 12             	movzbl (%edx),%edx
...
80105290:	75 dc                	jne    8010526e <memmove+0x59>
      *d++ = *s++;
...
801052b1:	e8 5f ff ff ff       	call   80105215 <memmove>
}
801052b6:	c9                   	leave  
801052b7:	c3                   	ret    
...
801052b9:	89 e5                	mov    %esp,%ebp
  while(n > 0 && *p && *p == *q)
801052bb:	eb 0c                	jmp    801052c9 <strncmp+0x11>
    n--, p++, q++;
801052bd:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
801052c1:	83 45 08 01          	addl   $0x1,0x8(%ebp)
801052c5:	83 45 0c 01          	addl   $0x1,0xc(%ebp)
}
...
801052e7:	74 d4                	je     801052bd <strncmp+0x5>
    n--, p++, q++;
  if(n == 0)
801052e9:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
801052ed:	75 07                	jne    801052f6 <strncmp+0x3e>
    return 0;
801052ef:	b8 00 00 00 00       	mov    $0x0,%eax
801052f4:	eb 16                	jmp    8010530c <strncmp+0x54>
  return (uchar)*p - (uchar)*q;
801052f6:	8b 45 08             	mov    0x8(%ebp),%eax
801052f9:	0f b6 00             	movzbl (%eax),%eax
801052fc:	0f b6 d0             	movzbl %al,%edx
801052ff:	8b 45 0c             	mov    0xc(%ebp),%eax
80105302:	0f b6 00             	movzbl (%eax),%eax
80105305:	0f b6 c0             	movzbl %al,%eax
80105308:	29 c2                	sub    %eax,%edx
8010530a:	89 d0                	mov    %edx,%eax
}
8010530c:	5d                   	pop    %ebp
8010530d:	c3                   	ret    
...
8010531e:	8d 50 ff             	lea    -0x1(%eax),%edx
80105321:	89 55 10             	mov    %edx,0x10(%ebp)
80105324:	85 c0                	test   %eax,%eax
80105326:	7e 1e                	jle    80105346 <strncpy+0x38>
80105328:	8b 45 08             	mov    0x8(%ebp),%eax
8010532b:	8d 50 01             	lea    0x1(%eax),%edx
8010532e:	89 55 08             	mov    %edx,0x8(%ebp)
80105331:	8b 55 0c             	mov    0xc(%ebp),%edx
80105334:	8d 4a 01             	lea    0x1(%edx),%ecx
80105337:	89 4d 0c             	mov    %ecx,0xc(%ebp)
8010533a:	0f b6 12             	movzbl (%edx),%edx
8010533d:	88 10                	mov    %dl,(%eax)
8010533f:	0f b6 00             	movzbl (%eax),%eax
80105342:	84 c0                	test   %al,%al
80105344:	75 d5                	jne    8010531b <strncpy+0xd>
    ;
  while(n-- > 0)
80105346:	eb 0c                	jmp    80105354 <strncpy+0x46>
    *s++ = 0;
80105348:	8b 45 08             	mov    0x8(%ebp),%eax
8010534b:	8d 50 01             	lea    0x1(%eax),%edx
8010534e:	89 55 08             	mov    %edx,0x8(%ebp)
80105351:	c6 00 00             	movb   $0x0,(%eax)
  char *os;
...
8010535f:	7f e7                	jg     80105348 <strncpy+0x3a>
    *s++ = 0;
  return os;
...
8010536f:	89 45 fc             	mov    %eax,-0x4(%ebp)
  if(n <= 0)
80105372:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105376:	7f 05                	jg     8010537d <safestrcpy+0x17>
    return os;
80105378:	8b 45 fc             	mov    -0x4(%ebp),%eax
8010537b:	eb 31                	jmp    801053ae <safestrcpy+0x48>
  while(--n > 0 && (*s++ = *t++) != 0)
8010537d:	83 6d 10 01          	subl   $0x1,0x10(%ebp)
80105381:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105385:	7e 1e                	jle    801053a5 <safestrcpy+0x3f>
80105387:	8b 45 08             	mov    0x8(%ebp),%eax
8010538a:	8d 50 01             	lea    0x1(%eax),%edx
8010538d:	89 55 08             	mov    %edx,0x8(%ebp)
80105390:	8b 55 0c             	mov    0xc(%ebp),%edx
80105393:	8d 4a 01             	lea    0x1(%edx),%ecx
80105396:	89 4d 0c             	mov    %ecx,0xc(%ebp)
80105399:	0f b6 12             	movzbl (%edx),%edx
8010539c:	88 10                	mov    %dl,(%eax)
8010539e:	0f b6 00             	movzbl (%eax),%eax
801053a1:	84 c0                	test   %al,%al
801053a3:	75 d8                	jne    8010537d <safestrcpy+0x17>
    ;
  *s = 0;
...
801053b3:	83 ec 10             	sub    $0x10,%esp
  ...
  for(n = 0; s[n]; n++)
801053b6:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
801053bd:	eb 04                	jmp    801053c3 <strlen+0x13>
801053bf:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
...
801053d0:	75 ed                	jne    801053bf <strlen+0xf>
    ;
  return n;
...
80105442:	eb 46                	jmp    8010548a <fetchstr+0x60>
  *pp = (char*)addr;
...
80105483:	72 dc                	jb     80105461 <fetchstr+0x37>
    if(*s == 0)
      return s - *pp;
  return -1;
...
8010549b:	8b 50 44             	mov    0x44(%eax),%edx
8010549e:	8b 45 08             	mov    0x8(%ebp),%eax
801054a1:	c1 e0 02             	shl    $0x2,%eax
...
801054b0:	89 14 24             	mov    %edx,(%esp)
801054b3:	e8 38 ff ff ff       	call   801053f0 <fetchint>
}
801054b8:	c9                   	leave  
801054b9:	c3                   	ret    
...
801054bd:	83 ec 18             	sub    $0x18,%esp
  ...
  if(argint(n, &i) < 0)
801054c0:	8d 45 fc             	lea    -0x4(%ebp),%eax
801054c3:	89 44 24 04          	mov    %eax,0x4(%esp)
801054c7:	8b 45 08             	mov    0x8(%ebp),%eax
801054ca:	89 04 24             	mov    %eax,(%esp)
801054cd:	e8 ba ff ff ff       	call   8010548c <argint>
801054d2:	85 c0                	test   %eax,%eax
801054d4:	79 07                	jns    801054dd <argptr+0x23>
    return -1;
801054d6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801054db:	eb 3d                	jmp    8010551a <argptr+0x60>
...
8010554c:	e8 d9 fe ff ff       	call   8010542a <fetchstr>
}
80105551:	c9                   	leave  
80105552:	c3                   	ret    
...
80105557:	83 ec 24             	sub    $0x24,%esp
  int num;

  num = proc->tf->eax;
8010555a:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105560:	8b 40 18             	mov    0x18(%eax),%eax
80105563:	8b 40 1c             	mov    0x1c(%eax),%eax
80105566:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
80105569:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010556d:	7e 30                	jle    8010559f <syscall+0x4c>
8010556f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105572:	83 f8 19             	cmp    $0x19,%eax
80105575:	77 28                	ja     8010559f <syscall+0x4c>
80105577:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010557a:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105581:	85 c0                	test   %eax,%eax
80105583:	74 1a                	je     8010559f <syscall+0x4c>
    proc->tf->eax = syscalls[num]();
80105585:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010558b:	8b 58 18             	mov    0x18(%eax),%ebx
8010558e:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105591:	8b 04 85 40 b0 10 80 	mov    -0x7fef4fc0(,%eax,4),%eax
80105598:	ff d0                	call   *%eax
8010559a:	89 43 1c             	mov    %eax,0x1c(%ebx)
8010559d:	eb 3d                	jmp    801055dc <syscall+0x89>
  } else {
    cprintf("%d %s: unknown sys call %d\n",
            proc->pid, proc->name, num);
8010559f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055a5:	8d 48 6c             	lea    0x6c(%eax),%ecx
801055a8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
  ...
  if(num > 0 && num < NELEM(syscalls) && syscalls[num]) {
    ...
    cprintf("%d %s: unknown sys call %d\n",
801055ae:	8b 40 10             	mov    0x10(%eax),%eax
801055b1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801055b4:	89 54 24 0c          	mov    %edx,0xc(%esp)
801055b8:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801055bc:	89 44 24 04          	mov    %eax,0x4(%esp)
801055c0:	c7 04 24 8f 89 10 80 	movl   $0x8010898f,(%esp)
801055c7:	e8 d4 ad ff ff       	call   801003a0 <cprintf>
            proc->pid, proc->name, num);
    proc->tf->eax = -1;
801055cc:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801055d2:	8b 40 18             	mov    0x18(%eax),%eax
801055d5:	c7 40 1c ff ff ff ff 	movl   $0xffffffff,0x1c(%eax)
  }
}
801055dc:	83 c4 24             	add    $0x24,%esp
801055df:	5b                   	pop    %ebx
801055e0:	5d                   	pop    %ebp
801055e1:	c3                   	ret    
801055e2:	66 90                	xchg   %ax,%ax
...
801055f7:	e8 90 fe ff ff       	call   8010548c <argint>
801055fc:	85 c0                	test   %eax,%eax
801055fe:	79 07                	jns    80105607 <argfd+0x23>
    return -1;
80105600:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105605:	eb 50                	jmp    80105657 <argfd+0x73>
  if(fd < 0 || fd >= NOFILE || (f=proc->ofile[fd]) == 0)
80105607:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010560a:	85 c0                	test   %eax,%eax
8010560c:	78 21                	js     8010562f <argfd+0x4b>
8010560e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105611:	83 f8 0f             	cmp    $0xf,%eax
80105614:	7f 19                	jg     8010562f <argfd+0x4b>
80105616:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010561c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010561f:	83 c2 08             	add    $0x8,%edx
80105622:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105626:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105629:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
8010562d:	75 07                	jne    80105636 <argfd+0x52>
    return -1;
8010562f:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105634:	eb 21                	jmp    80105657 <argfd+0x73>
  if(pfd)
80105636:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
8010563a:	74 08                	je     80105644 <argfd+0x60>
    *pfd = fd;
8010563c:	8b 55 f0             	mov    -0x10(%ebp),%edx
8010563f:	8b 45 0c             	mov    0xc(%ebp),%eax
80105642:	89 10                	mov    %edx,(%eax)
  if(pf)
80105644:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80105648:	74 08                	je     80105652 <argfd+0x6e>
    *pf = f;
...
8010565c:	83 ec 10             	sub    $0x10,%esp
  ...
  for(fd = 0; fd < NOFILE; fd++){
8010565f:	c7 45 fc 00 00 00 00 	movl   $0x0,-0x4(%ebp)
80105666:	eb 30                	jmp    80105698 <fdalloc+0x3f>
    if(proc->ofile[fd] == 0){
80105668:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
8010566e:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105671:	83 c2 08             	add    $0x8,%edx
80105674:	8b 44 90 08          	mov    0x8(%eax,%edx,4),%eax
80105678:	85 c0                	test   %eax,%eax
8010567a:	75 18                	jne    80105694 <fdalloc+0x3b>
      proc->ofile[fd] = f;
8010567c:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105682:	8b 55 fc             	mov    -0x4(%ebp),%edx
80105685:	8d 4a 08             	lea    0x8(%edx),%ecx
80105688:	8b 55 08             	mov    0x8(%ebp),%edx
8010568b:	89 54 88 08          	mov    %edx,0x8(%eax,%ecx,4)
      return fd;
8010568f:	8b 45 fc             	mov    -0x4(%ebp),%eax
80105692:	eb 0f                	jmp    801056a3 <fdalloc+0x4a>
static int
fdalloc(struct file *f)
{
  int fd;
  ...
  for(fd = 0; fd < NOFILE; fd++){
80105694:	83 45 fc 01          	addl   $0x1,-0x4(%ebp)
80105698:	83 7d fc 0f          	cmpl   $0xf,-0x4(%ebp)
8010569c:	7e ca                	jle    80105668 <fdalloc+0xf>
    if(proc->ofile[fd] == 0){
      proc->ofile[fd] = f;
      return fd;
    }
...
801056a8:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int fd;
  
  if(argfd(0, 0, &f) < 0)
801056ab:	8d 45 f0             	lea    -0x10(%ebp),%eax
801056ae:	89 44 24 08          	mov    %eax,0x8(%esp)
801056b2:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801056b9:	00 
801056ba:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801056c1:	e8 1e ff ff ff       	call   801055e4 <argfd>
801056c6:	85 c0                	test   %eax,%eax
801056c8:	79 07                	jns    801056d1 <sys_dup+0x2c>
    return -1;
801056ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056cf:	eb 29                	jmp    801056fa <sys_dup+0x55>
  if((fd=fdalloc(f)) < 0)
801056d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056d4:	89 04 24             	mov    %eax,(%esp)
801056d7:	e8 7d ff ff ff       	call   80105659 <fdalloc>
801056dc:	89 45 f4             	mov    %eax,-0xc(%ebp)
801056df:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801056e3:	79 07                	jns    801056ec <sys_dup+0x47>
    return -1;
801056e5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801056ea:	eb 0e                	jmp    801056fa <sys_dup+0x55>
  filedup(f);
801056ec:	8b 45 f0             	mov    -0x10(%ebp),%eax
801056ef:	89 04 24             	mov    %eax,(%esp)
801056f2:	e8 89 b8 ff ff       	call   80100f80 <filedup>
  return fd;
...
801056ff:	83 ec 28             	sub    $0x28,%esp
  struct file *f;
  int n;
  char *p;

  if(argfd(0, 0, &f) < 0 || argint(2, &n) < 0 || argptr(1, &p, n) < 0)
80105702:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105705:	89 44 24 08          	mov    %eax,0x8(%esp)
80105709:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105710:	00 
80105711:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105718:	e8 c7 fe ff ff       	call   801055e4 <argfd>
8010571d:	85 c0                	test   %eax,%eax
8010571f:	78 35                	js     80105756 <sys_read+0x5a>
80105721:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105724:	89 44 24 04          	mov    %eax,0x4(%esp)
80105728:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
8010572f:	e8 58 fd ff ff       	call   8010548c <argint>
80105734:	85 c0                	test   %eax,%eax
80105736:	78 1e                	js     80105756 <sys_read+0x5a>
80105738:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010573b:	89 44 24 08          	mov    %eax,0x8(%esp)
8010573f:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105742:	89 44 24 04          	mov    %eax,0x4(%esp)
80105746:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
8010574d:	e8 68 fd ff ff       	call   801054ba <argptr>
80105752:	85 c0                	test   %eax,%eax
80105754:	79 07                	jns    8010575d <sys_read+0x61>
    return -1;
80105756:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010575b:	eb 19                	jmp    80105776 <sys_read+0x7a>
  return fileread(f, p, n);
8010575d:	8b 4d f0             	mov    -0x10(%ebp),%ecx
80105760:	8b 55 ec             	mov    -0x14(%ebp),%edx
80105763:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105766:	89 4c 24 08          	mov    %ecx,0x8(%esp)
8010576a:	89 54 24 04          	mov    %edx,0x4(%esp)
8010576e:	89 04 24             	mov    %eax,(%esp)
80105771:	e8 77 b9 ff ff       	call   801010ed <fileread>
}
80105776:	c9                   	leave  
80105777:	c3                   	ret    
...
80105794:	e8 4b fe ff ff       	call   801055e4 <argfd>
80105799:	85 c0                	test   %eax,%eax
8010579b:	78 35                	js     801057d2 <sys_write+0x5a>
8010579d:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057a0:	89 44 24 04          	mov    %eax,0x4(%esp)
801057a4:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
801057ab:	e8 dc fc ff ff       	call   8010548c <argint>
801057b0:	85 c0                	test   %eax,%eax
801057b2:	78 1e                	js     801057d2 <sys_write+0x5a>
801057b4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801057b7:	89 44 24 08          	mov    %eax,0x8(%esp)
801057bb:	8d 45 ec             	lea    -0x14(%ebp),%eax
801057be:	89 44 24 04          	mov    %eax,0x4(%esp)
801057c2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801057c9:	e8 ec fc ff ff       	call   801054ba <argptr>
801057ce:	85 c0                	test   %eax,%eax
801057d0:	79 07                	jns    801057d9 <sys_write+0x61>
    return -1;
801057d2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801057d7:	eb 19                	jmp    801057f2 <sys_write+0x7a>
  return filewrite(f, p, n);
801057d9:	8b 4d f0             	mov    -0x10(%ebp),%ecx
801057dc:	8b 55 ec             	mov    -0x14(%ebp),%edx
801057df:	8b 45 f4             	mov    -0xc(%ebp),%eax
801057e2:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801057e6:	89 54 24 04          	mov    %edx,0x4(%esp)
801057ea:	89 04 24             	mov    %eax,(%esp)
801057ed:	e8 b7 b9 ff ff       	call   801011a9 <filewrite>
}
801057f2:	c9                   	leave  
801057f3:	c3                   	ret    
...
801057f7:	83 ec 28             	sub    $0x28,%esp
  int fd;
  struct file *f;
  
  if(argfd(0, &fd, &f) < 0)
801057fa:	8d 45 f0             	lea    -0x10(%ebp),%eax
801057fd:	89 44 24 08          	mov    %eax,0x8(%esp)
80105801:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105804:	89 44 24 04          	mov    %eax,0x4(%esp)
80105808:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010580f:	e8 d0 fd ff ff       	call   801055e4 <argfd>
80105814:	85 c0                	test   %eax,%eax
80105816:	79 07                	jns    8010581f <sys_close+0x2b>
    return -1;
80105818:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010581d:	eb 24                	jmp    80105843 <sys_close+0x4f>
  proc->ofile[fd] = 0;
8010581f:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80105825:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105828:	83 c2 08             	add    $0x8,%edx
8010582b:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
80105832:	00 
  fileclose(f);
80105833:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105836:	89 04 24             	mov    %eax,(%esp)
80105839:	e8 8a b7 ff ff       	call   80100fc8 <fileclose>
  return 0;
...
80105861:	e8 7e fd ff ff       	call   801055e4 <argfd>
80105866:	85 c0                	test   %eax,%eax
80105868:	78 1f                	js     80105889 <sys_fstat+0x44>
8010586a:	c7 44 24 08 14 00 00 	movl   $0x14,0x8(%esp)
80105871:	00 
80105872:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105875:	89 44 24 04          	mov    %eax,0x4(%esp)
80105879:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105880:	e8 35 fc ff ff       	call   801054ba <argptr>
80105885:	85 c0                	test   %eax,%eax
80105887:	79 07                	jns    80105890 <sys_fstat+0x4b>
    return -1;
80105889:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010588e:	eb 12                	jmp    801058a2 <sys_fstat+0x5d>
  return filestat(f, st);
80105890:	8b 55 f0             	mov    -0x10(%ebp),%edx
80105893:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105896:	89 54 24 04          	mov    %edx,0x4(%esp)
8010589a:	89 04 24             	mov    %eax,(%esp)
8010589d:	e8 fc b7 ff ff       	call   8010109e <filestat>
}
801058a2:	c9                   	leave  
801058a3:	c3                   	ret    
...
801058a7:	83 ec 38             	sub    $0x38,%esp
  char name[DIRSIZ], *new, *old;
  struct inode *dp, *ip;

  if(argstr(0, &old) < 0 || argstr(1, &new) < 0)
801058aa:	8d 45 d8             	lea    -0x28(%ebp),%eax
801058ad:	89 44 24 04          	mov    %eax,0x4(%esp)
801058b1:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801058b8:	e8 5f fc ff ff       	call   8010551c <argstr>
801058bd:	85 c0                	test   %eax,%eax
801058bf:	78 17                	js     801058d8 <sys_link+0x34>
801058c1:	8d 45 dc             	lea    -0x24(%ebp),%eax
801058c4:	89 44 24 04          	mov    %eax,0x4(%esp)
801058c8:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
801058cf:	e8 48 fc ff ff       	call   8010551c <argstr>
801058d4:	85 c0                	test   %eax,%eax
801058d6:	79 0a                	jns    801058e2 <sys_link+0x3e>
    return -1;
801058d8:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058dd:	e9 3d 01 00 00       	jmp    80105a1f <sys_link+0x17b>
  if((ip = namei(old)) == 0)
801058e2:	8b 45 d8             	mov    -0x28(%ebp),%eax
801058e5:	89 04 24             	mov    %eax,(%esp)
801058e8:	e8 14 cb ff ff       	call   80102401 <namei>
801058ed:	89 45 f4             	mov    %eax,-0xc(%ebp)
801058f0:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801058f4:	75 0a                	jne    80105900 <sys_link+0x5c>
    return -1;
801058f6:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801058fb:	e9 1f 01 00 00       	jmp    80105a1f <sys_link+0x17b>

  begin_trans();
80105900:	e8 e1 d8 ff ff       	call   801031e6 <begin_trans>

  ilock(ip);
80105905:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105908:	89 04 24             	mov    %eax,(%esp)
8010590b:	e8 46 bf ff ff       	call   80101856 <ilock>
  if(ip->type == T_DIR){
80105910:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105913:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105917:	66 83 f8 01          	cmp    $0x1,%ax
8010591b:	75 1a                	jne    80105937 <sys_link+0x93>
    iunlockput(ip);
8010591d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105920:	89 04 24             	mov    %eax,(%esp)
80105923:	e8 b2 c1 ff ff       	call   80101ada <iunlockput>
    commit_trans();
80105928:	e8 02 d9 ff ff       	call   8010322f <commit_trans>
    return -1;
8010592d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105932:	e9 e8 00 00 00       	jmp    80105a1f <sys_link+0x17b>
  }
...
8010594e:	e8 47 bd ff ff       	call   8010169a <iupdate>
  iunlock(ip);
80105953:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105956:	89 04 24             	mov    %eax,(%esp)
80105959:	e8 46 c0 ff ff       	call   801019a4 <iunlock>

  if((dp = nameiparent(new, name)) == 0)
8010595e:	8b 45 dc             	mov    -0x24(%ebp),%eax
80105961:	8d 55 e2             	lea    -0x1e(%ebp),%edx
80105964:	89 54 24 04          	mov    %edx,0x4(%esp)
80105968:	89 04 24             	mov    %eax,(%esp)
8010596b:	e8 b3 ca ff ff       	call   80102423 <nameiparent>
80105970:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105973:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105977:	75 02                	jne    8010597b <sys_link+0xd7>
    goto bad;
80105979:	eb 68                	jmp    801059e3 <sys_link+0x13f>
  ilock(dp);
8010597b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010597e:	89 04 24             	mov    %eax,(%esp)
80105981:	e8 d0 be ff ff       	call   80101856 <ilock>
  if(dp->dev != ip->dev || dirlink(dp, name, ip->inum) < 0){
80105986:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105989:	8b 10                	mov    (%eax),%edx
8010598b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010598e:	8b 00                	mov    (%eax),%eax
80105990:	39 c2                	cmp    %eax,%edx
80105992:	75 20                	jne    801059b4 <sys_link+0x110>
80105994:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105997:	8b 40 04             	mov    0x4(%eax),%eax
8010599a:	89 44 24 08          	mov    %eax,0x8(%esp)
8010599e:	8d 45 e2             	lea    -0x1e(%ebp),%eax
801059a1:	89 44 24 04          	mov    %eax,0x4(%esp)
801059a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059a8:	89 04 24             	mov    %eax,(%esp)
801059ab:	e8 91 c7 ff ff       	call   80102141 <dirlink>
801059b0:	85 c0                	test   %eax,%eax
801059b2:	79 0d                	jns    801059c1 <sys_link+0x11d>
    iunlockput(dp);
801059b4:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059b7:	89 04 24             	mov    %eax,(%esp)
801059ba:	e8 1b c1 ff ff       	call   80101ada <iunlockput>
    goto bad;
801059bf:	eb 22                	jmp    801059e3 <sys_link+0x13f>
  }
  iunlockput(dp);
801059c1:	8b 45 f0             	mov    -0x10(%ebp),%eax
801059c4:	89 04 24             	mov    %eax,(%esp)
801059c7:	e8 0e c1 ff ff       	call   80101ada <iunlockput>
  iput(ip);
801059cc:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059cf:	89 04 24             	mov    %eax,(%esp)
801059d2:	e8 32 c0 ff ff       	call   80101a09 <iput>

  commit_trans();
801059d7:	e8 53 d8 ff ff       	call   8010322f <commit_trans>

  return 0;
801059dc:	b8 00 00 00 00       	mov    $0x0,%eax
801059e1:	eb 3c                	jmp    80105a1f <sys_link+0x17b>

bad:
  ilock(ip);
801059e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059e6:	89 04 24             	mov    %eax,(%esp)
801059e9:	e8 68 be ff ff       	call   80101856 <ilock>
  ip->nlink--;
801059ee:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059f1:	0f b7 40 16          	movzwl 0x16(%eax),%eax
801059f5:	8d 50 ff             	lea    -0x1(%eax),%edx
801059f8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801059fb:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
801059ff:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a02:	89 04 24             	mov    %eax,(%esp)
80105a05:	e8 90 bc ff ff       	call   8010169a <iupdate>
  iunlockput(ip);
80105a0a:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a0d:	89 04 24             	mov    %eax,(%esp)
80105a10:	e8 c5 c0 ff ff       	call   80101ada <iunlockput>
  commit_trans();
80105a15:	e8 15 d8 ff ff       	call   8010322f <commit_trans>
  return -1;
...
80105a27:	c7 45 f4 20 00 00 00 	movl   $0x20,-0xc(%ebp)
80105a2e:	eb 4b                	jmp    80105a7b <isdirempty+0x5a>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105a30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105a33:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105a3a:	00 
...
80105a4c:	e8 12 c3 ff ff       	call   80101d63 <readi>
80105a51:	83 f8 10             	cmp    $0x10,%eax
80105a54:	74 0c                	je     80105a62 <isdirempty+0x41>
      panic("isdirempty: readi");
80105a56:	c7 04 24 ab 89 10 80 	movl   $0x801089ab,(%esp)
80105a5d:	e8 d8 aa ff ff       	call   8010053a <panic>
    if(de.inum != 0)
80105a62:	0f b7 45 e4          	movzwl -0x1c(%ebp),%eax
80105a66:	66 85 c0             	test   %ax,%ax
80105a69:	74 07                	je     80105a72 <isdirempty+0x51>
      return 0;
80105a6b:	b8 00 00 00 00       	mov    $0x0,%eax
80105a70:	eb 1b                	jmp    80105a8d <isdirempty+0x6c>
isdirempty(struct inode *dp)
{
  int off;
  struct dirent de;
...
80105a75:	83 c0 10             	add    $0x10,%eax
80105a78:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105a7b:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105a7e:	8b 45 08             	mov    0x8(%ebp),%eax
80105a81:	8b 40 18             	mov    0x18(%eax),%eax
80105a84:	39 c2                	cmp    %eax,%edx
80105a86:	72 a8                	jb     80105a30 <isdirempty+0xf>
    if(readi(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
      panic("isdirempty: readi");
    if(de.inum != 0)
      return 0;
  ...
  return 1;
80105a88:	b8 01 00 00 00       	mov    $0x1,%eax
}
80105a8d:	c9                   	leave  
80105a8e:	c3                   	ret    
...
80105a92:	83 ec 48             	sub    $0x48,%esp
  struct inode *ip, *dp;
  struct dirent de;
  ...
  if(argstr(0, &path) < 0)
80105a95:	8d 45 cc             	lea    -0x34(%ebp),%eax
80105a98:	89 44 24 04          	mov    %eax,0x4(%esp)
80105a9c:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105aa3:	e8 74 fa ff ff       	call   8010551c <argstr>
80105aa8:	85 c0                	test   %eax,%eax
80105aaa:	79 0a                	jns    80105ab6 <sys_unlink+0x27>
    return -1;
80105aac:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ab1:	e9 aa 01 00 00       	jmp    80105c60 <sys_unlink+0x1d1>
  if((dp = nameiparent(path, name)) == 0)
80105ab6:	8b 45 cc             	mov    -0x34(%ebp),%eax
80105ab9:	8d 55 d2             	lea    -0x2e(%ebp),%edx
80105abc:	89 54 24 04          	mov    %edx,0x4(%esp)
80105ac0:	89 04 24             	mov    %eax,(%esp)
80105ac3:	e8 5b c9 ff ff       	call   80102423 <nameiparent>
80105ac8:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105acb:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105acf:	75 0a                	jne    80105adb <sys_unlink+0x4c>
    return -1;
80105ad1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ad6:	e9 85 01 00 00       	jmp    80105c60 <sys_unlink+0x1d1>

  begin_trans();
80105adb:	e8 06 d7 ff ff       	call   801031e6 <begin_trans>

  ilock(dp);
80105ae0:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ae3:	89 04 24             	mov    %eax,(%esp)
80105ae6:	e8 6b bd ff ff       	call   80101856 <ilock>

  // Cannot unlink "." or "..".
  if(namecmp(name, ".") == 0 || namecmp(name, "..") == 0)
80105aeb:	c7 44 24 04 bd 89 10 	movl   $0x801089bd,0x4(%esp)
80105af2:	80 
80105af3:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105af6:	89 04 24             	mov    %eax,(%esp)
80105af9:	e8 58 c5 ff ff       	call   80102056 <namecmp>
80105afe:	85 c0                	test   %eax,%eax
80105b00:	0f 84 45 01 00 00    	je     80105c4b <sys_unlink+0x1bc>
80105b06:	c7 44 24 04 bf 89 10 	movl   $0x801089bf,0x4(%esp)
80105b0d:	80 
80105b0e:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105b11:	89 04 24             	mov    %eax,(%esp)
80105b14:	e8 3d c5 ff ff       	call   80102056 <namecmp>
80105b19:	85 c0                	test   %eax,%eax
80105b1b:	0f 84 2a 01 00 00    	je     80105c4b <sys_unlink+0x1bc>
    goto bad;

  if((ip = dirlookup(dp, name, &off)) == 0)
80105b21:	8d 45 c8             	lea    -0x38(%ebp),%eax
80105b24:	89 44 24 08          	mov    %eax,0x8(%esp)
80105b28:	8d 45 d2             	lea    -0x2e(%ebp),%eax
80105b2b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105b2f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105b32:	89 04 24             	mov    %eax,(%esp)
80105b35:	e8 3e c5 ff ff       	call   80102078 <dirlookup>
80105b3a:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105b3d:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105b41:	75 05                	jne    80105b48 <sys_unlink+0xb9>
    goto bad;
80105b43:	e9 03 01 00 00       	jmp    80105c4b <sys_unlink+0x1bc>
  ilock(ip);
80105b48:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b4b:	89 04 24             	mov    %eax,(%esp)
80105b4e:	e8 03 bd ff ff       	call   80101856 <ilock>

  if(ip->nlink < 1)
80105b53:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b56:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105b5a:	66 85 c0             	test   %ax,%ax
80105b5d:	7f 0c                	jg     80105b6b <sys_unlink+0xdc>
    panic("unlink: nlink < 1");
80105b5f:	c7 04 24 c2 89 10 80 	movl   $0x801089c2,(%esp)
80105b66:	e8 cf a9 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR && !isdirempty(ip)){
80105b6b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b6e:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105b72:	66 83 f8 01          	cmp    $0x1,%ax
80105b76:	75 1f                	jne    80105b97 <sys_unlink+0x108>
80105b78:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b7b:	89 04 24             	mov    %eax,(%esp)
80105b7e:	e8 9e fe ff ff       	call   80105a21 <isdirempty>
80105b83:	85 c0                	test   %eax,%eax
80105b85:	75 10                	jne    80105b97 <sys_unlink+0x108>
    iunlockput(ip);
80105b87:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105b8a:	89 04 24             	mov    %eax,(%esp)
80105b8d:	e8 48 bf ff ff       	call   80101ada <iunlockput>
    goto bad;
80105b92:	e9 b4 00 00 00       	jmp    80105c4b <sys_unlink+0x1bc>
  }

  memset(&de, 0, sizeof(de));
80105b97:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
80105b9e:	00 
80105b9f:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80105ba6:	00 
80105ba7:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105baa:	89 04 24             	mov    %eax,(%esp)
80105bad:	e8 94 f5 ff ff       	call   80105146 <memset>
  if(writei(dp, (char*)&de, off, sizeof(de)) != sizeof(de))
80105bb2:	8b 45 c8             	mov    -0x38(%ebp),%eax
80105bb5:	c7 44 24 0c 10 00 00 	movl   $0x10,0xc(%esp)
80105bbc:	00 
80105bbd:	89 44 24 08          	mov    %eax,0x8(%esp)
80105bc1:	8d 45 e0             	lea    -0x20(%ebp),%eax
80105bc4:	89 44 24 04          	mov    %eax,0x4(%esp)
80105bc8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bcb:	89 04 24             	mov    %eax,(%esp)
80105bce:	e8 f4 c2 ff ff       	call   80101ec7 <writei>
80105bd3:	83 f8 10             	cmp    $0x10,%eax
80105bd6:	74 0c                	je     80105be4 <sys_unlink+0x155>
    panic("unlink: writei");
80105bd8:	c7 04 24 d4 89 10 80 	movl   $0x801089d4,(%esp)
80105bdf:	e8 56 a9 ff ff       	call   8010053a <panic>
  if(ip->type == T_DIR){
80105be4:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105be7:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105beb:	66 83 f8 01          	cmp    $0x1,%ax
80105bef:	75 1c                	jne    80105c0d <sys_unlink+0x17e>
    dp->nlink--;
80105bf1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105bf4:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105bf8:	8d 50 ff             	lea    -0x1(%eax),%edx
...
80105c08:	e8 8d ba ff ff       	call   8010169a <iupdate>
  }
  iunlockput(dp);
80105c0d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c10:	89 04 24             	mov    %eax,(%esp)
80105c13:	e8 c2 be ff ff       	call   80101ada <iunlockput>

  ip->nlink--;
80105c18:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c1b:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105c1f:	8d 50 ff             	lea    -0x1(%eax),%edx
80105c22:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c25:	66 89 50 16          	mov    %dx,0x16(%eax)
  iupdate(ip);
80105c29:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c2c:	89 04 24             	mov    %eax,(%esp)
80105c2f:	e8 66 ba ff ff       	call   8010169a <iupdate>
  iunlockput(ip);
80105c34:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105c37:	89 04 24             	mov    %eax,(%esp)
80105c3a:	e8 9b be ff ff       	call   80101ada <iunlockput>

  commit_trans();
80105c3f:	e8 eb d5 ff ff       	call   8010322f <commit_trans>

  return 0;
80105c44:	b8 00 00 00 00       	mov    $0x0,%eax
80105c49:	eb 15                	jmp    80105c60 <sys_unlink+0x1d1>

bad:
  iunlockput(dp);
80105c4b:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105c4e:	89 04 24             	mov    %eax,(%esp)
80105c51:	e8 84 be ff ff       	call   80101ada <iunlockput>
  commit_trans();
80105c56:	e8 d4 d5 ff ff       	call   8010322f <commit_trans>
  return -1;
...
80105c65:	83 ec 48             	sub    $0x48,%esp
80105c68:	8b 4d 0c             	mov    0xc(%ebp),%ecx
80105c6b:	8b 55 10             	mov    0x10(%ebp),%edx
80105c6e:	8b 45 14             	mov    0x14(%ebp),%eax
80105c71:	66 89 4d d4          	mov    %cx,-0x2c(%ebp)
80105c75:	66 89 55 d0          	mov    %dx,-0x30(%ebp)
80105c79:	66 89 45 cc          	mov    %ax,-0x34(%ebp)
  uint off;
  struct inode *ip, *dp;
  char name[DIRSIZ];
...
80105c8a:	e8 94 c7 ff ff       	call   80102423 <nameiparent>
80105c8f:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105c92:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105c96:	75 0a                	jne    80105ca2 <create+0x40>
    return 0;
80105c98:	b8 00 00 00 00       	mov    $0x0,%eax
80105c9d:	e9 7e 01 00 00       	jmp    80105e20 <create+0x1be>
  ilock(dp);
80105ca2:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ca5:	89 04 24             	mov    %eax,(%esp)
80105ca8:	e8 a9 bb ff ff       	call   80101856 <ilock>

  if((ip = dirlookup(dp, name, &off)) != 0){
80105cad:	8d 45 ec             	lea    -0x14(%ebp),%eax
80105cb0:	89 44 24 08          	mov    %eax,0x8(%esp)
80105cb4:	8d 45 de             	lea    -0x22(%ebp),%eax
80105cb7:	89 44 24 04          	mov    %eax,0x4(%esp)
80105cbb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cbe:	89 04 24             	mov    %eax,(%esp)
80105cc1:	e8 b2 c3 ff ff       	call   80102078 <dirlookup>
80105cc6:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105cc9:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105ccd:	74 47                	je     80105d16 <create+0xb4>
    iunlockput(dp);
80105ccf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105cd2:	89 04 24             	mov    %eax,(%esp)
80105cd5:	e8 00 be ff ff       	call   80101ada <iunlockput>
    ilock(ip);
80105cda:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cdd:	89 04 24             	mov    %eax,(%esp)
80105ce0:	e8 71 bb ff ff       	call   80101856 <ilock>
    if(type == T_FILE && ip->type == T_FILE)
80105ce5:	66 83 7d d4 02       	cmpw   $0x2,-0x2c(%ebp)
80105cea:	75 15                	jne    80105d01 <create+0x9f>
80105cec:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cef:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105cf3:	66 83 f8 02          	cmp    $0x2,%ax
80105cf7:	75 08                	jne    80105d01 <create+0x9f>
      return ip;
80105cf9:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105cfc:	e9 1f 01 00 00       	jmp    80105e20 <create+0x1be>
    iunlockput(ip);
80105d01:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d04:	89 04 24             	mov    %eax,(%esp)
80105d07:	e8 ce bd ff ff       	call   80101ada <iunlockput>
    return 0;
80105d0c:	b8 00 00 00 00       	mov    $0x0,%eax
80105d11:	e9 0a 01 00 00       	jmp    80105e20 <create+0x1be>
  }
...
80105d26:	e8 90 b8 ff ff       	call   801015bb <ialloc>
80105d2b:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105d2e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105d32:	75 0c                	jne    80105d40 <create+0xde>
    panic("create: ialloc");
80105d34:	c7 04 24 e3 89 10 80 	movl   $0x801089e3,(%esp)
80105d3b:	e8 fa a7 ff ff       	call   8010053a <panic>

  ilock(ip);
80105d40:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d43:	89 04 24             	mov    %eax,(%esp)
80105d46:	e8 0b bb ff ff       	call   80101856 <ilock>
  ip->major = major;
80105d4b:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d4e:	0f b7 55 d0          	movzwl -0x30(%ebp),%edx
80105d52:	66 89 50 12          	mov    %dx,0x12(%eax)
  ip->minor = minor;
80105d56:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d59:	0f b7 55 cc          	movzwl -0x34(%ebp),%edx
80105d5d:	66 89 50 14          	mov    %dx,0x14(%eax)
  ip->nlink = 1;
80105d61:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d64:	66 c7 40 16 01 00    	movw   $0x1,0x16(%eax)
  iupdate(ip);
80105d6a:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d6d:	89 04 24             	mov    %eax,(%esp)
80105d70:	e8 25 b9 ff ff       	call   8010169a <iupdate>

  if(type == T_DIR){  // Create . and .. entries.
80105d75:	66 83 7d d4 01       	cmpw   $0x1,-0x2c(%ebp)
80105d7a:	75 6a                	jne    80105de6 <create+0x184>
    dp->nlink++;  // for ".."
80105d7c:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d7f:	0f b7 40 16          	movzwl 0x16(%eax),%eax
80105d83:	8d 50 01             	lea    0x1(%eax),%edx
80105d86:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d89:	66 89 50 16          	mov    %dx,0x16(%eax)
    iupdate(dp);
80105d8d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105d90:	89 04 24             	mov    %eax,(%esp)
80105d93:	e8 02 b9 ff ff       	call   8010169a <iupdate>
    // No ip->nlink++ for ".": avoid cyclic ref count.
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80105d98:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105d9b:	8b 40 04             	mov    0x4(%eax),%eax
80105d9e:	89 44 24 08          	mov    %eax,0x8(%esp)
80105da2:	c7 44 24 04 bd 89 10 	movl   $0x801089bd,0x4(%esp)
80105da9:	80 
80105daa:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dad:	89 04 24             	mov    %eax,(%esp)
80105db0:	e8 8c c3 ff ff       	call   80102141 <dirlink>
80105db5:	85 c0                	test   %eax,%eax
80105db7:	78 21                	js     80105dda <create+0x178>
80105db9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dbc:	8b 40 04             	mov    0x4(%eax),%eax
80105dbf:	89 44 24 08          	mov    %eax,0x8(%esp)
80105dc3:	c7 44 24 04 bf 89 10 	movl   $0x801089bf,0x4(%esp)
80105dca:	80 
80105dcb:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105dce:	89 04 24             	mov    %eax,(%esp)
80105dd1:	e8 6b c3 ff ff       	call   80102141 <dirlink>
80105dd6:	85 c0                	test   %eax,%eax
80105dd8:	79 0c                	jns    80105de6 <create+0x184>
      panic("create dots");
80105dda:	c7 04 24 f2 89 10 80 	movl   $0x801089f2,(%esp)
80105de1:	e8 54 a7 ff ff       	call   8010053a <panic>
  }

  if(dirlink(dp, name, ip->inum) < 0)
80105de6:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105de9:	8b 40 04             	mov    0x4(%eax),%eax
80105dec:	89 44 24 08          	mov    %eax,0x8(%esp)
80105df0:	8d 45 de             	lea    -0x22(%ebp),%eax
80105df3:	89 44 24 04          	mov    %eax,0x4(%esp)
80105df7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105dfa:	89 04 24             	mov    %eax,(%esp)
80105dfd:	e8 3f c3 ff ff       	call   80102141 <dirlink>
80105e02:	85 c0                	test   %eax,%eax
80105e04:	79 0c                	jns    80105e12 <create+0x1b0>
    panic("create: dirlink");
80105e06:	c7 04 24 fe 89 10 80 	movl   $0x801089fe,(%esp)
80105e0d:	e8 28 a7 ff ff       	call   8010053a <panic>

  iunlockput(dp);
80105e12:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105e15:	89 04 24             	mov    %eax,(%esp)
80105e18:	e8 bd bc ff ff       	call   80101ada <iunlockput>
...
80105e25:	83 ec 38             	sub    $0x38,%esp
  char *path;
  int fd, omode;
  struct file *f;
  struct inode *ip;
...
80105e28:	8d 45 e8             	lea    -0x18(%ebp),%eax
80105e2b:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e2f:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105e36:	e8 e1 f6 ff ff       	call   8010551c <argstr>
80105e3b:	85 c0                	test   %eax,%eax
80105e3d:	78 17                	js     80105e56 <sys_open+0x34>
80105e3f:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80105e42:	89 44 24 04          	mov    %eax,0x4(%esp)
80105e46:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80105e4d:	e8 3a f6 ff ff       	call   8010548c <argint>
80105e52:	85 c0                	test   %eax,%eax
80105e54:	79 0a                	jns    80105e60 <sys_open+0x3e>
    return -1;
80105e56:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105e5b:	e9 48 01 00 00       	jmp    80105fa8 <sys_open+0x186>
  if(omode & O_CREATE){
80105e60:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105e63:	25 00 02 00 00       	and    $0x200,%eax
80105e68:	85 c0                	test   %eax,%eax
80105e6a:	74 40                	je     80105eac <sys_open+0x8a>
    begin_trans();
80105e6c:	e8 75 d3 ff ff       	call   801031e6 <begin_trans>
    ip = create(path, T_FILE, 0, 0);
80105e71:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105e74:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105e7b:	00 
80105e7c:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105e83:	00 
80105e84:	c7 44 24 04 02 00 00 	movl   $0x2,0x4(%esp)
80105e8b:	00 
80105e8c:	89 04 24             	mov    %eax,(%esp)
80105e8f:	e8 ce fd ff ff       	call   80105c62 <create>
80105e94:	89 45 f4             	mov    %eax,-0xc(%ebp)
    commit_trans();
80105e97:	e8 93 d3 ff ff       	call   8010322f <commit_trans>
    if(ip == 0)
80105e9c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ea0:	75 5c                	jne    80105efe <sys_open+0xdc>
      return -1;
80105ea2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ea7:	e9 fc 00 00 00       	jmp    80105fa8 <sys_open+0x186>
  } else {
    if((ip = namei(path)) == 0)
80105eac:	8b 45 e8             	mov    -0x18(%ebp),%eax
80105eaf:	89 04 24             	mov    %eax,(%esp)
80105eb2:	e8 4a c5 ff ff       	call   80102401 <namei>
80105eb7:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105eba:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ebe:	75 0a                	jne    80105eca <sys_open+0xa8>
      return -1;
80105ec0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ec5:	e9 de 00 00 00       	jmp    80105fa8 <sys_open+0x186>
    ilock(ip);
80105eca:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ecd:	89 04 24             	mov    %eax,(%esp)
80105ed0:	e8 81 b9 ff ff       	call   80101856 <ilock>
    if(ip->type == T_DIR && omode != O_RDONLY){
80105ed5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105ed8:	0f b7 40 10          	movzwl 0x10(%eax),%eax
80105edc:	66 83 f8 01          	cmp    $0x1,%ax
80105ee0:	75 1c                	jne    80105efe <sys_open+0xdc>
80105ee2:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105ee5:	85 c0                	test   %eax,%eax
80105ee7:	74 15                	je     80105efe <sys_open+0xdc>
      iunlockput(ip);
80105ee9:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105eec:	89 04 24             	mov    %eax,(%esp)
80105eef:	e8 e6 bb ff ff       	call   80101ada <iunlockput>
      return -1;
80105ef4:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105ef9:	e9 aa 00 00 00       	jmp    80105fa8 <sys_open+0x186>
    }
  }

  if((f = filealloc()) == 0 || (fd = fdalloc(f)) < 0){
80105efe:	e8 1d b0 ff ff       	call   80100f20 <filealloc>
80105f03:	89 45 f0             	mov    %eax,-0x10(%ebp)
80105f06:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f0a:	74 14                	je     80105f20 <sys_open+0xfe>
80105f0c:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f0f:	89 04 24             	mov    %eax,(%esp)
80105f12:	e8 42 f7 ff ff       	call   80105659 <fdalloc>
80105f17:	89 45 ec             	mov    %eax,-0x14(%ebp)
80105f1a:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80105f1e:	79 23                	jns    80105f43 <sys_open+0x121>
    if(f)
80105f20:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80105f24:	74 0b                	je     80105f31 <sys_open+0x10f>
      fileclose(f);
80105f26:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f29:	89 04 24             	mov    %eax,(%esp)
80105f2c:	e8 97 b0 ff ff       	call   80100fc8 <fileclose>
    iunlockput(ip);
80105f31:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f34:	89 04 24             	mov    %eax,(%esp)
80105f37:	e8 9e bb ff ff       	call   80101ada <iunlockput>
    return -1;
80105f3c:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80105f41:	eb 65                	jmp    80105fa8 <sys_open+0x186>
  }
  iunlock(ip);
80105f43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80105f46:	89 04 24             	mov    %eax,(%esp)
80105f49:	e8 56 ba ff ff       	call   801019a4 <iunlock>

  f->type = FD_INODE;
80105f4e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f51:	c7 00 02 00 00 00    	movl   $0x2,(%eax)
  f->ip = ip;
80105f57:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f5a:	8b 55 f4             	mov    -0xc(%ebp),%edx
80105f5d:	89 50 10             	mov    %edx,0x10(%eax)
  f->off = 0;
80105f60:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f63:	c7 40 14 00 00 00 00 	movl   $0x0,0x14(%eax)
  f->readable = !(omode & O_WRONLY);
80105f6a:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f6d:	83 e0 01             	and    $0x1,%eax
80105f70:	85 c0                	test   %eax,%eax
80105f72:	0f 94 c0             	sete   %al
80105f75:	89 c2                	mov    %eax,%edx
80105f77:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105f7a:	88 50 08             	mov    %dl,0x8(%eax)
  f->writable = (omode & O_WRONLY) || (omode & O_RDWR);
80105f7d:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f80:	83 e0 01             	and    $0x1,%eax
80105f83:	85 c0                	test   %eax,%eax
80105f85:	75 0a                	jne    80105f91 <sys_open+0x16f>
80105f87:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80105f8a:	83 e0 02             	and    $0x2,%eax
80105f8d:	85 c0                	test   %eax,%eax
80105f8f:	74 07                	je     80105f98 <sys_open+0x176>
80105f91:	b8 01 00 00 00       	mov    $0x1,%eax
80105f96:	eb 05                	jmp    80105f9d <sys_open+0x17b>
80105f98:	b8 00 00 00 00       	mov    $0x0,%eax
80105f9d:	89 c2                	mov    %eax,%edx
80105f9f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fa2:	88 50 09             	mov    %dl,0x9(%eax)
  return fd;
80105fa5:	8b 45 ec             	mov    -0x14(%ebp),%eax
}
80105fa8:	c9                   	leave  
80105fa9:	c3                   	ret    
...
80105fad:	83 ec 28             	sub    $0x28,%esp
  char *path;
  struct inode *ip;

  begin_trans();
80105fb0:	e8 31 d2 ff ff       	call   801031e6 <begin_trans>
  if(argstr(0, &path) < 0 || (ip = create(path, T_DIR, 0, 0)) == 0){
80105fb5:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105fb8:	89 44 24 04          	mov    %eax,0x4(%esp)
80105fbc:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80105fc3:	e8 54 f5 ff ff       	call   8010551c <argstr>
80105fc8:	85 c0                	test   %eax,%eax
80105fca:	78 2c                	js     80105ff8 <sys_mkdir+0x4e>
80105fcc:	8b 45 f0             	mov    -0x10(%ebp),%eax
80105fcf:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
80105fd6:	00 
80105fd7:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80105fde:	00 
80105fdf:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80105fe6:	00 
80105fe7:	89 04 24             	mov    %eax,(%esp)
80105fea:	e8 73 fc ff ff       	call   80105c62 <create>
80105fef:	89 45 f4             	mov    %eax,-0xc(%ebp)
80105ff2:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80105ff6:	75 0c                	jne    80106004 <sys_mkdir+0x5a>
    commit_trans();
80105ff8:	e8 32 d2 ff ff       	call   8010322f <commit_trans>
    return -1;
80105ffd:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106002:	eb 15                	jmp    80106019 <sys_mkdir+0x6f>
  }
  iunlockput(ip);
80106004:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106007:	89 04 24             	mov    %eax,(%esp)
8010600a:	e8 cb ba ff ff       	call   80101ada <iunlockput>
  commit_trans();
8010600f:	e8 1b d2 ff ff       	call   8010322f <commit_trans>
  return 0;
...
8010601e:	83 ec 38             	sub    $0x38,%esp
  struct inode *ip;
  char *path;
  int len;
  int major, minor;
  ...
  begin_trans();
80106021:	e8 c0 d1 ff ff       	call   801031e6 <begin_trans>
  if((len=argstr(0, &path)) < 0 ||
80106026:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106029:	89 44 24 04          	mov    %eax,0x4(%esp)
8010602d:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106034:	e8 e3 f4 ff ff       	call   8010551c <argstr>
80106039:	89 45 f4             	mov    %eax,-0xc(%ebp)
8010603c:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80106040:	78 5e                	js     801060a0 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
80106042:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106045:	89 44 24 04          	mov    %eax,0x4(%esp)
80106049:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106050:	e8 37 f4 ff ff       	call   8010548c <argint>
  char *path;
  int len;
  int major, minor;
...
80106057:	78 47                	js     801060a0 <sys_mknod+0x85>
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
80106059:	8d 45 e4             	lea    -0x1c(%ebp),%eax
8010605c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106060:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106067:	e8 20 f4 ff ff       	call   8010548c <argint>
  int len;
  int major, minor;
...
8010606e:	78 30                	js     801060a0 <sys_mknod+0x85>
     argint(2, &minor) < 0 ||
     (ip = create(path, T_DEV, major, minor)) == 0){
80106070:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106073:	0f bf c8             	movswl %ax,%ecx
80106076:	8b 45 e8             	mov    -0x18(%ebp),%eax
80106079:	0f bf d0             	movswl %ax,%edx
8010607c:	8b 45 ec             	mov    -0x14(%ebp),%eax
  int major, minor;
  ...
  if((len=argstr(0, &path)) < 0 ||
     argint(1, &major) < 0 ||
     argint(2, &minor) < 0 ||
8010607f:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
80106083:	89 54 24 08          	mov    %edx,0x8(%esp)
80106087:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
8010608e:	00 
8010608f:	89 04 24             	mov    %eax,(%esp)
80106092:	e8 cb fb ff ff       	call   80105c62 <create>
80106097:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010609a:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
8010609e:	75 0c                	jne    801060ac <sys_mknod+0x91>
     (ip = create(path, T_DEV, major, minor)) == 0){
    commit_trans();
801060a0:	e8 8a d1 ff ff       	call   8010322f <commit_trans>
    return -1;
801060a5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801060aa:	eb 15                	jmp    801060c1 <sys_mknod+0xa6>
  }
  iunlockput(ip);
801060ac:	8b 45 f0             	mov    -0x10(%ebp),%eax
801060af:	89 04 24             	mov    %eax,(%esp)
801060b2:	e8 23 ba ff ff       	call   80101ada <iunlockput>
  commit_trans();
801060b7:	e8 73 d1 ff ff       	call   8010322f <commit_trans>
  return 0;
...
80106157:	81 ec a8 00 00 00    	sub    $0xa8,%esp
...
8010616b:	e8 ac f3 ff ff       	call   8010551c <argstr>
80106170:	85 c0                	test   %eax,%eax
80106172:	78 1a                	js     8010618e <sys_exec+0x3a>
80106174:	8d 85 6c ff ff ff    	lea    -0x94(%ebp),%eax
8010617a:	89 44 24 04          	mov    %eax,0x4(%esp)
8010617e:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106185:	e8 02 f3 ff ff       	call   8010548c <argint>
8010618a:	85 c0                	test   %eax,%eax
8010618c:	79 0a                	jns    80106198 <sys_exec+0x44>
    return -1;
8010618e:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106193:	e9 c8 00 00 00       	jmp    80106260 <sys_exec+0x10c>
  }
  memset(argv, 0, sizeof(argv));
80106198:	c7 44 24 08 80 00 00 	movl   $0x80,0x8(%esp)
8010619f:	00 
801061a0:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
801061a7:	00 
801061a8:	8d 85 70 ff ff ff    	lea    -0x90(%ebp),%eax
801061ae:	89 04 24             	mov    %eax,(%esp)
801061b1:	e8 90 ef ff ff       	call   80105146 <memset>
  for(i=0;; i++){
801061b6:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
    if(i >= NELEM(argv))
801061bd:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061c0:	83 f8 1f             	cmp    $0x1f,%eax
801061c3:	76 0a                	jbe    801061cf <sys_exec+0x7b>
      return -1;
801061c5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061ca:	e9 91 00 00 00       	jmp    80106260 <sys_exec+0x10c>
    if(fetchint(uargv+4*i, (int*)&uarg) < 0)
801061cf:	8b 45 f4             	mov    -0xc(%ebp),%eax
801061d2:	c1 e0 02             	shl    $0x2,%eax
801061d5:	89 c2                	mov    %eax,%edx
801061d7:	8b 85 6c ff ff ff    	mov    -0x94(%ebp),%eax
801061dd:	01 c2                	add    %eax,%edx
801061df:	8d 85 68 ff ff ff    	lea    -0x98(%ebp),%eax
801061e5:	89 44 24 04          	mov    %eax,0x4(%esp)
801061e9:	89 14 24             	mov    %edx,(%esp)
801061ec:	e8 ff f1 ff ff       	call   801053f0 <fetchint>
801061f1:	85 c0                	test   %eax,%eax
801061f3:	79 07                	jns    801061fc <sys_exec+0xa8>
      return -1;
801061f5:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801061fa:	eb 64                	jmp    80106260 <sys_exec+0x10c>
    if(uarg == 0){
801061fc:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106202:	85 c0                	test   %eax,%eax
80106204:	75 26                	jne    8010622c <sys_exec+0xd8>
      argv[i] = 0;
80106206:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106209:	c7 84 85 70 ff ff ff 	movl   $0x0,-0x90(%ebp,%eax,4)
...
80106218:	8d 95 70 ff ff ff    	lea    -0x90(%ebp),%edx
8010621e:	89 54 24 04          	mov    %edx,0x4(%esp)
80106222:	89 04 24             	mov    %eax,(%esp)
80106225:	e8 c6 a8 ff ff       	call   80100af0 <exec>
8010622a:	eb 34                	jmp    80106260 <sys_exec+0x10c>
      return -1;
    if(uarg == 0){
      argv[i] = 0;
      break;
...
80106235:	c1 e2 02             	shl    $0x2,%edx
80106238:	01 c2                	add    %eax,%edx
8010623a:	8b 85 68 ff ff ff    	mov    -0x98(%ebp),%eax
80106240:	89 54 24 04          	mov    %edx,0x4(%esp)
80106244:	89 04 24             	mov    %eax,(%esp)
80106247:	e8 de f1 ff ff       	call   8010542a <fetchstr>
8010624c:	85 c0                	test   %eax,%eax
8010624e:	79 07                	jns    80106257 <sys_exec+0x103>
      return -1;
80106250:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106255:	eb 09                	jmp    80106260 <sys_exec+0x10c>
  ...
  memset(argv, 0, sizeof(argv));
  for(i=0;; i++){
80106257:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
      argv[i] = 0;
      break;
    }
    if(fetchstr(uarg, &argv[i]) < 0)
...
8010625b:	e9 5d ff ff ff       	jmp    801061bd <sys_exec+0x69>
  return exec(path, argv);
}
80106260:	c9                   	leave  
80106261:	c3                   	ret    
...
80106265:	83 ec 38             	sub    $0x38,%esp
  int *fd;
  struct file *rf, *wf;
  int fd0, fd1;

  if(argptr(0, (void*)&fd, 2*sizeof(fd[0])) < 0)
80106268:	c7 44 24 08 08 00 00 	movl   $0x8,0x8(%esp)
8010626f:	00 
80106270:	8d 45 ec             	lea    -0x14(%ebp),%eax
80106273:	89 44 24 04          	mov    %eax,0x4(%esp)
80106277:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
8010627e:	e8 37 f2 ff ff       	call   801054ba <argptr>
80106283:	85 c0                	test   %eax,%eax
80106285:	79 0a                	jns    80106291 <sys_pipe+0x2f>
    return -1;
80106287:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010628c:	e9 9b 00 00 00       	jmp    8010632c <sys_pipe+0xca>
  if(pipealloc(&rf, &wf) < 0)
80106291:	8d 45 e4             	lea    -0x1c(%ebp),%eax
80106294:	89 44 24 04          	mov    %eax,0x4(%esp)
80106298:	8d 45 e8             	lea    -0x18(%ebp),%eax
8010629b:	89 04 24             	mov    %eax,(%esp)
8010629e:	e8 35 d9 ff ff       	call   80103bd8 <pipealloc>
801062a3:	85 c0                	test   %eax,%eax
801062a5:	79 07                	jns    801062ae <sys_pipe+0x4c>
    return -1;
801062a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801062ac:	eb 7e                	jmp    8010632c <sys_pipe+0xca>
  fd0 = -1;
801062ae:	c7 45 f4 ff ff ff ff 	movl   $0xffffffff,-0xc(%ebp)
  if((fd0 = fdalloc(rf)) < 0 || (fd1 = fdalloc(wf)) < 0){
801062b5:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062b8:	89 04 24             	mov    %eax,(%esp)
801062bb:	e8 99 f3 ff ff       	call   80105659 <fdalloc>
801062c0:	89 45 f4             	mov    %eax,-0xc(%ebp)
801062c3:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062c7:	78 14                	js     801062dd <sys_pipe+0x7b>
801062c9:	8b 45 e4             	mov    -0x1c(%ebp),%eax
801062cc:	89 04 24             	mov    %eax,(%esp)
801062cf:	e8 85 f3 ff ff       	call   80105659 <fdalloc>
801062d4:	89 45 f0             	mov    %eax,-0x10(%ebp)
801062d7:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
801062db:	79 37                	jns    80106314 <sys_pipe+0xb2>
    if(fd0 >= 0)
801062dd:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
801062e1:	78 14                	js     801062f7 <sys_pipe+0x95>
      proc->ofile[fd0] = 0;
801062e3:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801062e9:	8b 55 f4             	mov    -0xc(%ebp),%edx
801062ec:	83 c2 08             	add    $0x8,%edx
801062ef:	c7 44 90 08 00 00 00 	movl   $0x0,0x8(%eax,%edx,4)
801062f6:	00 
    fileclose(rf);
801062f7:	8b 45 e8             	mov    -0x18(%ebp),%eax
801062fa:	89 04 24             	mov    %eax,(%esp)
801062fd:	e8 c6 ac ff ff       	call   80100fc8 <fileclose>
    fileclose(wf);
80106302:	8b 45 e4             	mov    -0x1c(%ebp),%eax
80106305:	89 04 24             	mov    %eax,(%esp)
80106308:	e8 bb ac ff ff       	call   80100fc8 <fileclose>
    return -1;
8010630d:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106312:	eb 18                	jmp    8010632c <sys_pipe+0xca>
  }
  fd[0] = fd0;
80106314:	8b 45 ec             	mov    -0x14(%ebp),%eax
80106317:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010631a:	89 10                	mov    %edx,(%eax)
  fd[1] = fd1;
8010631c:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010631f:	8d 50 04             	lea    0x4(%eax),%edx
80106322:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106325:	89 02                	mov    %eax,(%edx)
  return 0;
80106327:	b8 00 00 00 00       	mov    $0x0,%eax
}
8010632c:	c9                   	leave  
8010632d:	c3                   	ret    
...
80106333:	83 ec 08             	sub    $0x8,%esp
  return fork();
80106336:	e8 d0 df ff ff       	call   8010430b <fork>
}
8010633b:	c9                   	leave  
8010633c:	c3                   	ret    
...
80106341:	83 ec 24             	sub    $0x24,%esp
    int stack;
    int size;
    int routine;
    int arg;
...
8010634b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
80106352:	e8 35 f1 ff ff       	call   8010548c <argint>
80106357:	85 c0                	test   %eax,%eax
80106359:	78 4c                	js     801063a7 <sys_clone+0x6a>
8010635b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010635e:	85 c0                	test   %eax,%eax
80106360:	7e 45                	jle    801063a7 <sys_clone+0x6a>
80106362:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106365:	89 44 24 04          	mov    %eax,0x4(%esp)
80106369:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106370:	e8 17 f1 ff ff       	call   8010548c <argint>
80106375:	85 c0                	test   %eax,%eax
80106377:	78 2e                	js     801063a7 <sys_clone+0x6a>
            argint(2,&routine) < 0 || argint(3,&arg)<0){
80106379:	8d 45 ec             	lea    -0x14(%ebp),%eax
8010637c:	89 44 24 04          	mov    %eax,0x4(%esp)
80106380:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
80106387:	e8 00 f1 ff ff       	call   8010548c <argint>
    int stack;
    int size;
    int routine;
    int arg;
...
8010638e:	78 17                	js     801063a7 <sys_clone+0x6a>
            argint(2,&routine) < 0 || argint(3,&arg)<0){
80106390:	8d 45 e8             	lea    -0x18(%ebp),%eax
80106393:	89 44 24 04          	mov    %eax,0x4(%esp)
80106397:	c7 04 24 03 00 00 00 	movl   $0x3,(%esp)
8010639e:	e8 e9 f0 ff ff       	call   8010548c <argint>
801063a3:	85 c0                	test   %eax,%eax
801063a5:	79 07                	jns    801063ae <sys_clone+0x71>
        return -1;
801063a7:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801063ac:	eb 20                	jmp    801063ce <sys_clone+0x91>
    }
    return clone(stack,size,routine,arg);
801063ae:	8b 5d e8             	mov    -0x18(%ebp),%ebx
801063b1:	8b 4d ec             	mov    -0x14(%ebp),%ecx
801063b4:	8b 55 f0             	mov    -0x10(%ebp),%edx
801063b7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801063ba:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
801063be:	89 4c 24 08          	mov    %ecx,0x8(%esp)
801063c2:	89 54 24 04          	mov    %edx,0x4(%esp)
801063c6:	89 04 24             	mov    %eax,(%esp)
801063c9:	e8 ad e0 ff ff       	call   8010447b <clone>
}
801063ce:	83 c4 24             	add    $0x24,%esp
801063d1:	5b                   	pop    %ebx
801063d2:	5d                   	pop    %ebp
801063d3:	c3                   	ret    
...
801063d7:	83 ec 08             	sub    $0x8,%esp
  exit();
801063da:	e8 bf e2 ff ff       	call   8010469e <exit>
...
801063e9:	83 ec 08             	sub    $0x8,%esp
    texit();
801063ec:	e8 c8 e3 ff ff       	call   801047b9 <texit>
    return 0;
801063f1:	b8 00 00 00 00       	mov    $0x0,%eax
}
801063f6:	c9                   	leave  
801063f7:	c3                   	ret    
...
801063fb:	83 ec 08             	sub    $0x8,%esp
  return wait();
801063fe:	e8 84 e4 ff ff       	call   80104887 <wait>
}
80106403:	c9                   	leave  
80106404:	c3                   	ret    
...
80106419:	e8 6e f0 ff ff       	call   8010548c <argint>
8010641e:	85 c0                	test   %eax,%eax
80106420:	79 07                	jns    80106429 <sys_kill+0x24>
    return -1;
80106422:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106427:	eb 0b                	jmp    80106434 <sys_kill+0x2f>
  return kill(pid);
80106429:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010642c:	89 04 24             	mov    %eax,(%esp)
8010642f:	e8 b6 e8 ff ff       	call   80104cea <kill>
}
80106434:	c9                   	leave  
80106435:	c3                   	ret    
...
80106447:	83 ec 28             	sub    $0x28,%esp
  int addr;
  int n;
...
80106451:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106458:	e8 2f f0 ff ff       	call   8010548c <argint>
8010645d:	85 c0                	test   %eax,%eax
8010645f:	79 07                	jns    80106468 <sys_sbrk+0x24>
    return -1;
80106461:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106466:	eb 24                	jmp    8010648c <sys_sbrk+0x48>
  addr = proc->sz;
...
80106479:	e8 e8 dd ff ff       	call   80104266 <growproc>
8010647e:	85 c0                	test   %eax,%eax
80106480:	79 07                	jns    80106489 <sys_sbrk+0x45>
    return -1;
80106482:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106487:	eb 03                	jmp    8010648c <sys_sbrk+0x48>
  return addr;
...
801064a2:	e8 e5 ef ff ff       	call   8010548c <argint>
801064a7:	85 c0                	test   %eax,%eax
801064a9:	79 07                	jns    801064b2 <sys_sleep+0x24>
    return -1;
801064ab:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064b0:	eb 6c                	jmp    8010651e <sys_sleep+0x90>
  acquire(&tickslock);
801064b2:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
801064b9:	e8 31 ea ff ff       	call   80104eef <acquire>
  ticks0 = ticks;
801064be:	a1 c0 28 11 80       	mov    0x801128c0,%eax
801064c3:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(ticks - ticks0 < n){
801064c6:	eb 34                	jmp    801064fc <sys_sleep+0x6e>
    if(proc->killed){
801064c8:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801064ce:	8b 40 24             	mov    0x24(%eax),%eax
801064d1:	85 c0                	test   %eax,%eax
801064d3:	74 13                	je     801064e8 <sys_sleep+0x5a>
      release(&tickslock);
801064d5:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
801064dc:	e8 70 ea ff ff       	call   80104f51 <release>
      return -1;
801064e1:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801064e6:	eb 36                	jmp    8010651e <sys_sleep+0x90>
    }
    sleep(&ticks, &tickslock);
801064e8:	c7 44 24 04 80 20 11 	movl   $0x80112080,0x4(%esp)
801064ef:	80 
801064f0:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
801064f7:	e8 7f e6 ff ff       	call   80104b7b <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801064fc:	a1 c0 28 11 80       	mov    0x801128c0,%eax
80106501:	2b 45 f4             	sub    -0xc(%ebp),%eax
80106504:	89 c2                	mov    %eax,%edx
80106506:	8b 45 f0             	mov    -0x10(%ebp),%eax
80106509:	39 c2                	cmp    %eax,%edx
8010650b:	72 bb                	jb     801064c8 <sys_sleep+0x3a>
      release(&tickslock);
      return -1;
    }
    sleep(&ticks, &tickslock);
  ...
  release(&tickslock);
8010650d:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
80106514:	e8 38 ea ff ff       	call   80104f51 <release>
  return 0;
...
80106523:	83 ec 28             	sub    $0x28,%esp
  ...
  acquire(&tickslock);
80106526:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
8010652d:	e8 bd e9 ff ff       	call   80104eef <acquire>
  xticks = ticks;
80106532:	a1 c0 28 11 80       	mov    0x801128c0,%eax
80106537:	89 45 f4             	mov    %eax,-0xc(%ebp)
  release(&tickslock);
8010653a:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
80106541:	e8 0b ea ff ff       	call   80104f51 <release>
  return xticks;
...
8010654e:	83 ec 08             	sub    $0x8,%esp
    tsleep();
80106551:	e8 09 e9 ff ff       	call   80104e5f <tsleep>
    return 0;
...
80106560:	83 ec 28             	sub    $0x28,%esp
    int tid;
    if(argint(0,&tid) < 0){
80106563:	8d 45 f4             	lea    -0xc(%ebp),%eax
80106566:	89 44 24 04          	mov    %eax,0x4(%esp)
8010656a:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
80106571:	e8 16 ef ff ff       	call   8010548c <argint>
80106576:	85 c0                	test   %eax,%eax
80106578:	79 07                	jns    80106581 <sys_twakeup+0x24>
        return -1;
8010657a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
8010657f:	eb 10                	jmp    80106591 <sys_twakeup+0x34>
    }
        twakeup(tid);
80106581:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106584:	89 04 24             	mov    %eax,(%esp)
80106587:	e8 cb e6 ff ff       	call   80104c57 <twakeup>
        return 0;
...
801065fb:	e8 69 d4 ff ff       	call   80103a69 <picenable>
}
80106600:	c9                   	leave  
80106601:	c3                   	ret    
...
8010661c:	e8 d9 01 00 00       	call   801067fa <trap>
...
80106677:	e9 c3 00 00 00       	jmp    8010673f <tvinit+0xd5>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
8010667c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010667f:	8b 04 85 a8 b0 10 80 	mov    -0x7fef4f58(,%eax,4),%eax
80106686:	89 c2                	mov    %eax,%edx
80106688:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010668b:	66 89 14 c5 c0 20 11 	mov    %dx,-0x7feedf40(,%eax,8)
80106692:	80 
80106693:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106696:	66 c7 04 c5 c2 20 11 	movw   $0x8,-0x7feedf3e(,%eax,8)
8010669d:	80 08 00 
801066a0:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066a3:	0f b6 14 c5 c4 20 11 	movzbl -0x7feedf3c(,%eax,8),%edx
801066aa:	80 
801066ab:	83 e2 e0             	and    $0xffffffe0,%edx
801066ae:	88 14 c5 c4 20 11 80 	mov    %dl,-0x7feedf3c(,%eax,8)
801066b5:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066b8:	0f b6 14 c5 c4 20 11 	movzbl -0x7feedf3c(,%eax,8),%edx
801066bf:	80 
801066c0:	83 e2 1f             	and    $0x1f,%edx
801066c3:	88 14 c5 c4 20 11 80 	mov    %dl,-0x7feedf3c(,%eax,8)
801066ca:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066cd:	0f b6 14 c5 c5 20 11 	movzbl -0x7feedf3b(,%eax,8),%edx
801066d4:	80 
801066d5:	83 e2 f0             	and    $0xfffffff0,%edx
801066d8:	83 ca 0e             	or     $0xe,%edx
801066db:	88 14 c5 c5 20 11 80 	mov    %dl,-0x7feedf3b(,%eax,8)
801066e2:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066e5:	0f b6 14 c5 c5 20 11 	movzbl -0x7feedf3b(,%eax,8),%edx
801066ec:	80 
801066ed:	83 e2 ef             	and    $0xffffffef,%edx
801066f0:	88 14 c5 c5 20 11 80 	mov    %dl,-0x7feedf3b(,%eax,8)
801066f7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801066fa:	0f b6 14 c5 c5 20 11 	movzbl -0x7feedf3b(,%eax,8),%edx
80106701:	80 
80106702:	83 e2 9f             	and    $0xffffff9f,%edx
80106705:	88 14 c5 c5 20 11 80 	mov    %dl,-0x7feedf3b(,%eax,8)
8010670c:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010670f:	0f b6 14 c5 c5 20 11 	movzbl -0x7feedf3b(,%eax,8),%edx
80106716:	80 
80106717:	83 ca 80             	or     $0xffffff80,%edx
8010671a:	88 14 c5 c5 20 11 80 	mov    %dl,-0x7feedf3b(,%eax,8)
80106721:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106724:	8b 04 85 a8 b0 10 80 	mov    -0x7fef4f58(,%eax,4),%eax
8010672b:	c1 e8 10             	shr    $0x10,%eax
8010672e:	89 c2                	mov    %eax,%edx
80106730:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106733:	66 89 14 c5 c6 20 11 	mov    %dx,-0x7feedf3a(,%eax,8)
8010673a:	80 
void
tvinit(void)
{
  ...
  for(i = 0; i < 256; i++)
8010673b:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
8010673f:	81 7d f4 ff 00 00 00 	cmpl   $0xff,-0xc(%ebp)
80106746:	0f 8e 30 ff ff ff    	jle    8010667c <tvinit+0x12>
    SETGATE(idt[i], 0, SEG_KCODE<<3, vectors[i], 0);
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010674c:	a1 a8 b1 10 80       	mov    0x8010b1a8,%eax
80106751:	66 a3 c0 22 11 80    	mov    %ax,0x801122c0
80106757:	66 c7 05 c2 22 11 80 	movw   $0x8,0x801122c2
8010675e:	08 00 
80106760:	0f b6 05 c4 22 11 80 	movzbl 0x801122c4,%eax
80106767:	83 e0 e0             	and    $0xffffffe0,%eax
8010676a:	a2 c4 22 11 80       	mov    %al,0x801122c4
8010676f:	0f b6 05 c4 22 11 80 	movzbl 0x801122c4,%eax
80106776:	83 e0 1f             	and    $0x1f,%eax
80106779:	a2 c4 22 11 80       	mov    %al,0x801122c4
8010677e:	0f b6 05 c5 22 11 80 	movzbl 0x801122c5,%eax
80106785:	83 c8 0f             	or     $0xf,%eax
80106788:	a2 c5 22 11 80       	mov    %al,0x801122c5
8010678d:	0f b6 05 c5 22 11 80 	movzbl 0x801122c5,%eax
80106794:	83 e0 ef             	and    $0xffffffef,%eax
80106797:	a2 c5 22 11 80       	mov    %al,0x801122c5
8010679c:	0f b6 05 c5 22 11 80 	movzbl 0x801122c5,%eax
801067a3:	83 c8 60             	or     $0x60,%eax
801067a6:	a2 c5 22 11 80       	mov    %al,0x801122c5
801067ab:	0f b6 05 c5 22 11 80 	movzbl 0x801122c5,%eax
801067b2:	83 c8 80             	or     $0xffffff80,%eax
801067b5:	a2 c5 22 11 80       	mov    %al,0x801122c5
801067ba:	a1 a8 b1 10 80       	mov    0x8010b1a8,%eax
801067bf:	c1 e8 10             	shr    $0x10,%eax
801067c2:	66 a3 c6 22 11 80    	mov    %ax,0x801122c6
  
  initlock(&tickslock, "time");
801067c8:	c7 44 24 04 10 8a 10 	movl   $0x80108a10,0x4(%esp)
801067cf:	80 
801067d0:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
801067d7:	e8 f2 e6 ff ff       	call   80104ece <initlock>
}
801067dc:	c9                   	leave  
801067dd:	c3                   	ret    
...
801067e1:	83 ec 08             	sub    $0x8,%esp
  lidt(idt, sizeof(idt));
801067e4:	c7 44 24 04 00 08 00 	movl   $0x800,0x4(%esp)
801067eb:	00 
801067ec:	c7 04 24 c0 20 11 80 	movl   $0x801120c0,(%esp)
801067f3:	e8 38 fe ff ff       	call   80106630 <lidt>
}
801067f8:	c9                   	leave  
801067f9:	c3                   	ret    
...
80106800:	83 ec 3c             	sub    $0x3c,%esp
  if(tf->trapno == T_SYSCALL){
80106803:	8b 45 08             	mov    0x8(%ebp),%eax
80106806:	8b 40 30             	mov    0x30(%eax),%eax
80106809:	83 f8 40             	cmp    $0x40,%eax
8010680c:	75 3f                	jne    8010684d <trap+0x53>
    if(proc->killed)
8010680e:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106814:	8b 40 24             	mov    0x24(%eax),%eax
80106817:	85 c0                	test   %eax,%eax
80106819:	74 05                	je     80106820 <trap+0x26>
      exit();
8010681b:	e8 7e de ff ff       	call   8010469e <exit>
    proc->tf = tf;
80106820:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106826:	8b 55 08             	mov    0x8(%ebp),%edx
80106829:	89 50 18             	mov    %edx,0x18(%eax)
    syscall();
8010682c:	e8 22 ed ff ff       	call   80105553 <syscall>
    if(proc->killed)
80106831:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106837:	8b 40 24             	mov    0x24(%eax),%eax
8010683a:	85 c0                	test   %eax,%eax
8010683c:	74 0a                	je     80106848 <trap+0x4e>
      exit();
8010683e:	e8 5b de ff ff       	call   8010469e <exit>
    return;
80106843:	e9 2d 02 00 00       	jmp    80106a75 <trap+0x27b>
80106848:	e9 28 02 00 00       	jmp    80106a75 <trap+0x27b>
  }

  switch(tf->trapno){
8010684d:	8b 45 08             	mov    0x8(%ebp),%eax
80106850:	8b 40 30             	mov    0x30(%eax),%eax
80106853:	83 e8 20             	sub    $0x20,%eax
80106856:	83 f8 1f             	cmp    $0x1f,%eax
80106859:	0f 87 bc 00 00 00    	ja     8010691b <trap+0x121>
8010685f:	8b 04 85 b8 8a 10 80 	mov    -0x7fef7548(,%eax,4),%eax
80106866:	ff e0                	jmp    *%eax
  case T_IRQ0 + IRQ_TIMER:
    if(cpu->id == 0){
80106868:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010686e:	0f b6 00             	movzbl (%eax),%eax
80106871:	84 c0                	test   %al,%al
80106873:	75 31                	jne    801068a6 <trap+0xac>
      acquire(&tickslock);
80106875:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
8010687c:	e8 6e e6 ff ff       	call   80104eef <acquire>
      ticks++;
80106881:	a1 c0 28 11 80       	mov    0x801128c0,%eax
80106886:	83 c0 01             	add    $0x1,%eax
80106889:	a3 c0 28 11 80       	mov    %eax,0x801128c0
      wakeup(&ticks);
8010688e:	c7 04 24 c0 28 11 80 	movl   $0x801128c0,(%esp)
80106895:	e8 25 e4 ff ff       	call   80104cbf <wakeup>
      release(&tickslock);
8010689a:	c7 04 24 80 20 11 80 	movl   $0x80112080,(%esp)
801068a1:	e8 ab e6 ff ff       	call   80104f51 <release>
    }
    lapiceoi();
801068a6:	e8 09 c6 ff ff       	call   80102eb4 <lapiceoi>
    break;
801068ab:	e9 41 01 00 00       	jmp    801069f1 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE:
    ideintr();
801068b0:	e8 27 be ff ff       	call   801026dc <ideintr>
    lapiceoi();
801068b5:	e8 fa c5 ff ff       	call   80102eb4 <lapiceoi>
    break;
801068ba:	e9 32 01 00 00       	jmp    801069f1 <trap+0x1f7>
  case T_IRQ0 + IRQ_IDE+1:
    // Bochs generates spurious IDE1 interrupts.
    break;
  case T_IRQ0 + IRQ_KBD:
    kbdintr();
801068bf:	e8 dc c3 ff ff       	call   80102ca0 <kbdintr>
    lapiceoi();
801068c4:	e8 eb c5 ff ff       	call   80102eb4 <lapiceoi>
    break;
801068c9:	e9 23 01 00 00       	jmp    801069f1 <trap+0x1f7>
  case T_IRQ0 + IRQ_COM1:
    uartintr();
801068ce:	e8 9a 03 00 00       	call   80106c6d <uartintr>
    lapiceoi();
801068d3:	e8 dc c5 ff ff       	call   80102eb4 <lapiceoi>
    break;
801068d8:	e9 14 01 00 00       	jmp    801069f1 <trap+0x1f7>
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068dd:	8b 45 08             	mov    0x8(%ebp),%eax
801068e0:	8b 48 38             	mov    0x38(%eax),%ecx
            cpu->id, tf->cs, tf->eip);
801068e3:	8b 45 08             	mov    0x8(%ebp),%eax
801068e6:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068ea:	0f b7 d0             	movzwl %ax,%edx
            cpu->id, tf->cs, tf->eip);
801068ed:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
801068f3:	0f b6 00             	movzbl (%eax),%eax
    uartintr();
    lapiceoi();
    break;
  case T_IRQ0 + 7:
  case T_IRQ0 + IRQ_SPURIOUS:
    cprintf("cpu%d: spurious interrupt at %x:%x\n",
801068f6:	0f b6 c0             	movzbl %al,%eax
801068f9:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801068fd:	89 54 24 08          	mov    %edx,0x8(%esp)
80106901:	89 44 24 04          	mov    %eax,0x4(%esp)
80106905:	c7 04 24 18 8a 10 80 	movl   $0x80108a18,(%esp)
8010690c:	e8 8f 9a ff ff       	call   801003a0 <cprintf>
            cpu->id, tf->cs, tf->eip);
    lapiceoi();
80106911:	e8 9e c5 ff ff       	call   80102eb4 <lapiceoi>
    break;
80106916:	e9 d6 00 00 00       	jmp    801069f1 <trap+0x1f7>
...
80106923:	74 11                	je     80106936 <trap+0x13c>
80106925:	8b 45 08             	mov    0x8(%ebp),%eax
80106928:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
8010692c:	0f b7 c0             	movzwl %ax,%eax
8010692f:	83 e0 03             	and    $0x3,%eax
80106932:	85 c0                	test   %eax,%eax
80106934:	75 46                	jne    8010697c <trap+0x182>
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80106936:	e8 1e fd ff ff       	call   80106659 <rcr2>
8010693b:	8b 55 08             	mov    0x8(%ebp),%edx
8010693e:	8b 5a 38             	mov    0x38(%edx),%ebx
              tf->trapno, cpu->id, tf->eip, rcr2());
80106941:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80106948:	0f b6 12             	movzbl (%edx),%edx
  ...
  default:
    if(proc == 0 || (tf->cs&3) == 0){
      // In kernel, it must be our mistake.
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
8010694b:	0f b6 ca             	movzbl %dl,%ecx
8010694e:	8b 55 08             	mov    0x8(%ebp),%edx
80106951:	8b 52 30             	mov    0x30(%edx),%edx
80106954:	89 44 24 10          	mov    %eax,0x10(%esp)
80106958:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
8010695c:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80106960:	89 54 24 04          	mov    %edx,0x4(%esp)
80106964:	c7 04 24 3c 8a 10 80 	movl   $0x80108a3c,(%esp)
8010696b:	e8 30 9a ff ff       	call   801003a0 <cprintf>
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
80106970:	c7 04 24 6e 8a 10 80 	movl   $0x80108a6e,(%esp)
80106977:	e8 be 9b ff ff       	call   8010053a <panic>
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
8010697c:	e8 d8 fc ff ff       	call   80106659 <rcr2>
80106981:	89 c2                	mov    %eax,%edx
80106983:	8b 45 08             	mov    0x8(%ebp),%eax
80106986:	8b 78 38             	mov    0x38(%eax),%edi
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
80106989:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
8010698f:	0f b6 00             	movzbl (%eax),%eax
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
              tf->trapno, cpu->id, tf->eip, rcr2());
      panic("trap");
    }
    // In user space, assume process misbehaved.
    cprintf("pid %d %s: trap %d err %d on cpu %d "
80106992:	0f b6 f0             	movzbl %al,%esi
80106995:	8b 45 08             	mov    0x8(%ebp),%eax
80106998:	8b 58 34             	mov    0x34(%eax),%ebx
8010699b:	8b 45 08             	mov    0x8(%ebp),%eax
8010699e:	8b 48 30             	mov    0x30(%eax),%ecx
            "eip 0x%x addr 0x%x--kill proc\n",
            proc->pid, proc->name, tf->trapno, tf->err, cpu->id, tf->eip, 
801069a1:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
801069a7:	83 c0 6c             	add    $0x6c,%eax
801069aa:	89 45 e4             	mov    %eax,-0x1c(%ebp)
...
801069b6:	89 54 24 1c          	mov    %edx,0x1c(%esp)
801069ba:	89 7c 24 18          	mov    %edi,0x18(%esp)
801069be:	89 74 24 14          	mov    %esi,0x14(%esp)
801069c2:	89 5c 24 10          	mov    %ebx,0x10(%esp)
801069c6:	89 4c 24 0c          	mov    %ecx,0xc(%esp)
801069ca:	8b 75 e4             	mov    -0x1c(%ebp),%esi
801069cd:	89 74 24 08          	mov    %esi,0x8(%esp)
801069d1:	89 44 24 04          	mov    %eax,0x4(%esp)
801069d5:	c7 04 24 74 8a 10 80 	movl   $0x80108a74,(%esp)
...
801069e7:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
801069ee:	eb 01                	jmp    801069f1 <trap+0x1f7>
    ideintr();
    lapiceoi();
    break;
  case T_IRQ0 + IRQ_IDE+1:
...
801069f9:	74 24                	je     80106a1f <trap+0x225>
801069fb:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a01:	8b 40 24             	mov    0x24(%eax),%eax
80106a04:	85 c0                	test   %eax,%eax
80106a06:	74 17                	je     80106a1f <trap+0x225>
...
80106a15:	83 f8 03             	cmp    $0x3,%eax
80106a18:	75 05                	jne    80106a1f <trap+0x225>
    exit();
80106a1a:	e8 7f dc ff ff       	call   8010469e <exit>
...
80106a27:	74 1e                	je     80106a47 <trap+0x24d>
80106a29:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a2f:	8b 40 0c             	mov    0xc(%eax),%eax
80106a32:	83 f8 04             	cmp    $0x4,%eax
80106a35:	75 10                	jne    80106a47 <trap+0x24d>
80106a37:	8b 45 08             	mov    0x8(%ebp),%eax
80106a3a:	8b 40 30             	mov    0x30(%eax),%eax
80106a3d:	83 f8 20             	cmp    $0x20,%eax
80106a40:	75 05                	jne    80106a47 <trap+0x24d>
    yield();
80106a42:	e8 d6 e0 ff ff       	call   80104b1d <yield>

  // Check if the process has been killed since we yielded
  if(proc && proc->killed && (tf->cs&3) == DPL_USER)
80106a47:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a4d:	85 c0                	test   %eax,%eax
80106a4f:	74 24                	je     80106a75 <trap+0x27b>
80106a51:	65 a1 04 00 00 00    	mov    %gs:0x4,%eax
80106a57:	8b 40 24             	mov    0x24(%eax),%eax
80106a5a:	85 c0                	test   %eax,%eax
80106a5c:	74 17                	je     80106a75 <trap+0x27b>
80106a5e:	8b 45 08             	mov    0x8(%ebp),%eax
80106a61:	0f b7 40 3c          	movzwl 0x3c(%eax),%eax
80106a65:	0f b7 c0             	movzwl %ax,%eax
80106a68:	83 e0 03             	and    $0x3,%eax
80106a6b:	83 f8 03             	cmp    $0x3,%eax
80106a6e:	75 05                	jne    80106a75 <trap+0x27b>
    exit();
80106a70:	e8 29 dc ff ff       	call   8010469e <exit>
}
80106a75:	83 c4 3c             	add    $0x3c,%esp
80106a78:	5b                   	pop    %ebx
80106a79:	5e                   	pop    %esi
80106a7a:	5f                   	pop    %edi
80106a7b:	5d                   	pop    %ebp
...
80106a89:	66 89 45 ec          	mov    %ax,-0x14(%ebp)
  uchar data;

  asm volatile("in %1,%0" : "=a" (data) : "d" (port));
80106a8d:	0f b7 45 ec          	movzwl -0x14(%ebp),%eax
80106a91:	89 c2                	mov    %eax,%edx
80106a93:	ec                   	in     (%dx),%al
80106a94:	88 45 ff             	mov    %al,-0x1(%ebp)
  return data;
80106a97:	0f b6 45 ff          	movzbl -0x1(%ebp),%eax
}
80106a9b:	c9                   	leave  
80106a9c:	c3                   	ret    
...
80106aa3:	8b 55 08             	mov    0x8(%ebp),%edx
80106aa6:	8b 45 0c             	mov    0xc(%ebp),%eax
80106aa9:	66 89 55 fc          	mov    %dx,-0x4(%ebp)
80106aad:	88 45 f8             	mov    %al,-0x8(%ebp)
  asm volatile("out %0,%1" : : "a" (data), "d" (port));
80106ab0:	0f b6 45 f8          	movzbl -0x8(%ebp),%eax
80106ab4:	0f b7 55 fc          	movzwl -0x4(%ebp),%edx
80106ab8:	ee                   	out    %al,(%dx)
}
80106ab9:	c9                   	leave  
80106aba:	c3                   	ret    
...
80106abe:	83 ec 28             	sub    $0x28,%esp
  ...
  // Turn off the FIFO
  outb(COM1+2, 0);
80106ac1:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106ac8:	00 
80106ac9:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106ad0:	e8 c8 ff ff ff       	call   80106a9d <outb>
  
  // 9600 baud, 8 data bits, 1 stop bit, parity off.
  outb(COM1+3, 0x80);    // Unlock divisor
80106ad5:	c7 44 24 04 80 00 00 	movl   $0x80,0x4(%esp)
80106adc:	00 
80106add:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106ae4:	e8 b4 ff ff ff       	call   80106a9d <outb>
  outb(COM1+0, 115200/9600);
80106ae9:	c7 44 24 04 0c 00 00 	movl   $0xc,0x4(%esp)
80106af0:	00 
80106af1:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106af8:	e8 a0 ff ff ff       	call   80106a9d <outb>
  outb(COM1+1, 0);
80106afd:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b04:	00 
80106b05:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b0c:	e8 8c ff ff ff       	call   80106a9d <outb>
  outb(COM1+3, 0x03);    // Lock divisor, 8 data bits.
80106b11:	c7 44 24 04 03 00 00 	movl   $0x3,0x4(%esp)
80106b18:	00 
80106b19:	c7 04 24 fb 03 00 00 	movl   $0x3fb,(%esp)
80106b20:	e8 78 ff ff ff       	call   80106a9d <outb>
  outb(COM1+4, 0);
80106b25:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b2c:	00 
80106b2d:	c7 04 24 fc 03 00 00 	movl   $0x3fc,(%esp)
80106b34:	e8 64 ff ff ff       	call   80106a9d <outb>
  outb(COM1+1, 0x01);    // Enable receive interrupts.
80106b39:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
80106b40:	00 
80106b41:	c7 04 24 f9 03 00 00 	movl   $0x3f9,(%esp)
80106b48:	e8 50 ff ff ff       	call   80106a9d <outb>

  // If status is 0xFF, no serial port.
  if(inb(COM1+5) == 0xFF)
80106b4d:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106b54:	e8 27 ff ff ff       	call   80106a80 <inb>
80106b59:	3c ff                	cmp    $0xff,%al
80106b5b:	75 02                	jne    80106b5f <uartinit+0xa4>
    return;
80106b5d:	eb 6a                	jmp    80106bc9 <uartinit+0x10e>
  uart = 1;
80106b5f:	c7 05 6c b6 10 80 01 	movl   $0x1,0x8010b66c
80106b66:	00 00 00 

  // Acknowledge pre-existing interrupt conditions;
  // enable interrupts.
  inb(COM1+2);
80106b69:	c7 04 24 fa 03 00 00 	movl   $0x3fa,(%esp)
80106b70:	e8 0b ff ff ff       	call   80106a80 <inb>
  inb(COM1+0);
80106b75:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106b7c:	e8 ff fe ff ff       	call   80106a80 <inb>
  picenable(IRQ_COM1);
80106b81:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b88:	e8 dc ce ff ff       	call   80103a69 <picenable>
  ioapicenable(IRQ_COM1, 0);
80106b8d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80106b94:	00 
80106b95:	c7 04 24 04 00 00 00 	movl   $0x4,(%esp)
80106b9c:	e8 bb bd ff ff       	call   8010295c <ioapicenable>
  
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106ba1:	c7 45 f4 38 8b 10 80 	movl   $0x80108b38,-0xc(%ebp)
80106ba8:	eb 15                	jmp    80106bbf <uartinit+0x104>
    uartputc(*p);
80106baa:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bad:	0f b6 00             	movzbl (%eax),%eax
80106bb0:	0f be c0             	movsbl %al,%eax
80106bb3:	89 04 24             	mov    %eax,(%esp)
80106bb6:	e8 10 00 00 00       	call   80106bcb <uartputc>
  inb(COM1+0);
  picenable(IRQ_COM1);
  ioapicenable(IRQ_COM1, 0);
  ...
  // Announce that we're here.
  for(p="xv6...\n"; *p; p++)
80106bbb:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106bbf:	8b 45 f4             	mov    -0xc(%ebp),%eax
80106bc2:	0f b6 00             	movzbl (%eax),%eax
80106bc5:	84 c0                	test   %al,%al
80106bc7:	75 e1                	jne    80106baa <uartinit+0xef>
    uartputc(*p);
}
80106bc9:	c9                   	leave  
80106bca:	c3                   	ret    
...
80106bce:	83 ec 28             	sub    $0x28,%esp
  int i;

  if(!uart)
80106bd1:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80106bd6:	85 c0                	test   %eax,%eax
80106bd8:	75 02                	jne    80106bdc <uartputc+0x11>
    return;
80106bda:	eb 4b                	jmp    80106c27 <uartputc+0x5c>
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106bdc:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
80106be3:	eb 10                	jmp    80106bf5 <uartputc+0x2a>
    microdelay(10);
80106be5:	c7 04 24 0a 00 00 00 	movl   $0xa,(%esp)
80106bec:	e8 e8 c2 ff ff       	call   80102ed9 <microdelay>
{
  int i;
  ...
  if(!uart)
    return;
  for(i = 0; i < 128 && !(inb(COM1+5) & 0x20); i++)
80106bf1:	83 45 f4 01          	addl   $0x1,-0xc(%ebp)
80106bf5:	83 7d f4 7f          	cmpl   $0x7f,-0xc(%ebp)
80106bf9:	7f 16                	jg     80106c11 <uartputc+0x46>
80106bfb:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c02:	e8 79 fe ff ff       	call   80106a80 <inb>
80106c07:	0f b6 c0             	movzbl %al,%eax
80106c0a:	83 e0 20             	and    $0x20,%eax
80106c0d:	85 c0                	test   %eax,%eax
80106c0f:	74 d4                	je     80106be5 <uartputc+0x1a>
    microdelay(10);
  outb(COM1+0, c);
80106c11:	8b 45 08             	mov    0x8(%ebp),%eax
80106c14:	0f b6 c0             	movzbl %al,%eax
80106c17:	89 44 24 04          	mov    %eax,0x4(%esp)
80106c1b:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c22:	e8 76 fe ff ff       	call   80106a9d <outb>
}
80106c27:	c9                   	leave  
80106c28:	c3                   	ret    
...
80106c2c:	83 ec 04             	sub    $0x4,%esp
  if(!uart)
80106c2f:	a1 6c b6 10 80       	mov    0x8010b66c,%eax
80106c34:	85 c0                	test   %eax,%eax
80106c36:	75 07                	jne    80106c3f <uartgetc+0x16>
    return -1;
80106c38:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c3d:	eb 2c                	jmp    80106c6b <uartgetc+0x42>
  if(!(inb(COM1+5) & 0x01))
80106c3f:	c7 04 24 fd 03 00 00 	movl   $0x3fd,(%esp)
80106c46:	e8 35 fe ff ff       	call   80106a80 <inb>
80106c4b:	0f b6 c0             	movzbl %al,%eax
80106c4e:	83 e0 01             	and    $0x1,%eax
80106c51:	85 c0                	test   %eax,%eax
80106c53:	75 07                	jne    80106c5c <uartgetc+0x33>
    return -1;
80106c55:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80106c5a:	eb 0f                	jmp    80106c6b <uartgetc+0x42>
  return inb(COM1+0);
80106c5c:	c7 04 24 f8 03 00 00 	movl   $0x3f8,(%esp)
80106c63:	e8 18 fe ff ff       	call   80106a80 <inb>
...
80106c73:	c7 04 24 29 6c 10 80 	movl   $0x80106c29,(%esp)
80106c7a:	e8 2e 9b ff ff       	call   801007ad <consoleintr>
}
80106c7f:	c9                   	leave  
80106c80:	c3                   	ret    
80106c81:	66 90                	xchg   %ax,%ax
80106c83:	90                   	nop

80106c84 <vector0>:
80106c84:	6a 00                	push   $0x0
80106c86:	6a 00                	push   $0x0
80106c88:	e9 77 f9 ff ff       	jmp    80106604 <alltraps>

80106c8d <vector1>:
80106c8d:	6a 00                	push   $0x0
80106c8f:	6a 01                	push   $0x1
80106c91:	e9 6e f9 ff ff       	jmp    80106604 <alltraps>

80106c96 <vector2>:
80106c96:	6a 00                	push   $0x0
80106c98:	6a 02                	push   $0x2
80106c9a:	e9 65 f9 ff ff       	jmp    80106604 <alltraps>

80106c9f <vector3>:
80106c9f:	6a 00                	push   $0x0
80106ca1:	6a 03                	push   $0x3
80106ca3:	e9 5c f9 ff ff       	jmp    80106604 <alltraps>

80106ca8 <vector4>:
80106ca8:	6a 00                	push   $0x0
80106caa:	6a 04                	push   $0x4
80106cac:	e9 53 f9 ff ff       	jmp    80106604 <alltraps>

80106cb1 <vector5>:
80106cb1:	6a 00                	push   $0x0
80106cb3:	6a 05                	push   $0x5
80106cb5:	e9 4a f9 ff ff       	jmp    80106604 <alltraps>

80106cba <vector6>:
80106cba:	6a 00                	push   $0x0
80106cbc:	6a 06                	push   $0x6
80106cbe:	e9 41 f9 ff ff       	jmp    80106604 <alltraps>

80106cc3 <vector7>:
80106cc3:	6a 00                	push   $0x0
80106cc5:	6a 07                	push   $0x7
80106cc7:	e9 38 f9 ff ff       	jmp    80106604 <alltraps>

80106ccc <vector8>:
80106ccc:	6a 08                	push   $0x8
80106cce:	e9 31 f9 ff ff       	jmp    80106604 <alltraps>

80106cd3 <vector9>:
80106cd3:	6a 00                	push   $0x0
80106cd5:	6a 09                	push   $0x9
80106cd7:	e9 28 f9 ff ff       	jmp    80106604 <alltraps>

80106cdc <vector10>:
80106cdc:	6a 0a                	push   $0xa
80106cde:	e9 21 f9 ff ff       	jmp    80106604 <alltraps>

80106ce3 <vector11>:
80106ce3:	6a 0b                	push   $0xb
80106ce5:	e9 1a f9 ff ff       	jmp    80106604 <alltraps>

80106cea <vector12>:
80106cea:	6a 0c                	push   $0xc
80106cec:	e9 13 f9 ff ff       	jmp    80106604 <alltraps>

80106cf1 <vector13>:
80106cf1:	6a 0d                	push   $0xd
80106cf3:	e9 0c f9 ff ff       	jmp    80106604 <alltraps>

80106cf8 <vector14>:
80106cf8:	6a 0e                	push   $0xe
80106cfa:	e9 05 f9 ff ff       	jmp    80106604 <alltraps>

80106cff <vector15>:
80106cff:	6a 00                	push   $0x0
80106d01:	6a 0f                	push   $0xf
80106d03:	e9 fc f8 ff ff       	jmp    80106604 <alltraps>

80106d08 <vector16>:
80106d08:	6a 00                	push   $0x0
80106d0a:	6a 10                	push   $0x10
80106d0c:	e9 f3 f8 ff ff       	jmp    80106604 <alltraps>

80106d11 <vector17>:
80106d11:	6a 11                	push   $0x11
80106d13:	e9 ec f8 ff ff       	jmp    80106604 <alltraps>

80106d18 <vector18>:
80106d18:	6a 00                	push   $0x0
80106d1a:	6a 12                	push   $0x12
80106d1c:	e9 e3 f8 ff ff       	jmp    80106604 <alltraps>

80106d21 <vector19>:
80106d21:	6a 00                	push   $0x0
80106d23:	6a 13                	push   $0x13
80106d25:	e9 da f8 ff ff       	jmp    80106604 <alltraps>

80106d2a <vector20>:
80106d2a:	6a 00                	push   $0x0
80106d2c:	6a 14                	push   $0x14
80106d2e:	e9 d1 f8 ff ff       	jmp    80106604 <alltraps>

80106d33 <vector21>:
80106d33:	6a 00                	push   $0x0
80106d35:	6a 15                	push   $0x15
80106d37:	e9 c8 f8 ff ff       	jmp    80106604 <alltraps>

80106d3c <vector22>:
80106d3c:	6a 00                	push   $0x0
80106d3e:	6a 16                	push   $0x16
80106d40:	e9 bf f8 ff ff       	jmp    80106604 <alltraps>

80106d45 <vector23>:
80106d45:	6a 00                	push   $0x0
80106d47:	6a 17                	push   $0x17
80106d49:	e9 b6 f8 ff ff       	jmp    80106604 <alltraps>

80106d4e <vector24>:
80106d4e:	6a 00                	push   $0x0
80106d50:	6a 18                	push   $0x18
80106d52:	e9 ad f8 ff ff       	jmp    80106604 <alltraps>

80106d57 <vector25>:
80106d57:	6a 00                	push   $0x0
80106d59:	6a 19                	push   $0x19
80106d5b:	e9 a4 f8 ff ff       	jmp    80106604 <alltraps>

80106d60 <vector26>:
80106d60:	6a 00                	push   $0x0
80106d62:	6a 1a                	push   $0x1a
80106d64:	e9 9b f8 ff ff       	jmp    80106604 <alltraps>

80106d69 <vector27>:
80106d69:	6a 00                	push   $0x0
80106d6b:	6a 1b                	push   $0x1b
80106d6d:	e9 92 f8 ff ff       	jmp    80106604 <alltraps>

80106d72 <vector28>:
80106d72:	6a 00                	push   $0x0
80106d74:	6a 1c                	push   $0x1c
80106d76:	e9 89 f8 ff ff       	jmp    80106604 <alltraps>

80106d7b <vector29>:
80106d7b:	6a 00                	push   $0x0
80106d7d:	6a 1d                	push   $0x1d
80106d7f:	e9 80 f8 ff ff       	jmp    80106604 <alltraps>

80106d84 <vector30>:
80106d84:	6a 00                	push   $0x0
80106d86:	6a 1e                	push   $0x1e
80106d88:	e9 77 f8 ff ff       	jmp    80106604 <alltraps>

80106d8d <vector31>:
80106d8d:	6a 00                	push   $0x0
80106d8f:	6a 1f                	push   $0x1f
80106d91:	e9 6e f8 ff ff       	jmp    80106604 <alltraps>

80106d96 <vector32>:
80106d96:	6a 00                	push   $0x0
80106d98:	6a 20                	push   $0x20
80106d9a:	e9 65 f8 ff ff       	jmp    80106604 <alltraps>

80106d9f <vector33>:
80106d9f:	6a 00                	push   $0x0
80106da1:	6a 21                	push   $0x21
80106da3:	e9 5c f8 ff ff       	jmp    80106604 <alltraps>

80106da8 <vector34>:
80106da8:	6a 00                	push   $0x0
80106daa:	6a 22                	push   $0x22
80106dac:	e9 53 f8 ff ff       	jmp    80106604 <alltraps>

80106db1 <vector35>:
80106db1:	6a 00                	push   $0x0
80106db3:	6a 23                	push   $0x23
80106db5:	e9 4a f8 ff ff       	jmp    80106604 <alltraps>

80106dba <vector36>:
80106dba:	6a 00                	push   $0x0
80106dbc:	6a 24                	push   $0x24
80106dbe:	e9 41 f8 ff ff       	jmp    80106604 <alltraps>

80106dc3 <vector37>:
80106dc3:	6a 00                	push   $0x0
80106dc5:	6a 25                	push   $0x25
80106dc7:	e9 38 f8 ff ff       	jmp    80106604 <alltraps>

80106dcc <vector38>:
80106dcc:	6a 00                	push   $0x0
80106dce:	6a 26                	push   $0x26
80106dd0:	e9 2f f8 ff ff       	jmp    80106604 <alltraps>

80106dd5 <vector39>:
80106dd5:	6a 00                	push   $0x0
80106dd7:	6a 27                	push   $0x27
80106dd9:	e9 26 f8 ff ff       	jmp    80106604 <alltraps>

80106dde <vector40>:
80106dde:	6a 00                	push   $0x0
80106de0:	6a 28                	push   $0x28
80106de2:	e9 1d f8 ff ff       	jmp    80106604 <alltraps>

80106de7 <vector41>:
80106de7:	6a 00                	push   $0x0
80106de9:	6a 29                	push   $0x29
80106deb:	e9 14 f8 ff ff       	jmp    80106604 <alltraps>

80106df0 <vector42>:
80106df0:	6a 00                	push   $0x0
80106df2:	6a 2a                	push   $0x2a
80106df4:	e9 0b f8 ff ff       	jmp    80106604 <alltraps>

80106df9 <vector43>:
80106df9:	6a 00                	push   $0x0
80106dfb:	6a 2b                	push   $0x2b
80106dfd:	e9 02 f8 ff ff       	jmp    80106604 <alltraps>

80106e02 <vector44>:
80106e02:	6a 00                	push   $0x0
80106e04:	6a 2c                	push   $0x2c
80106e06:	e9 f9 f7 ff ff       	jmp    80106604 <alltraps>

80106e0b <vector45>:
80106e0b:	6a 00                	push   $0x0
80106e0d:	6a 2d                	push   $0x2d
80106e0f:	e9 f0 f7 ff ff       	jmp    80106604 <alltraps>

80106e14 <vector46>:
80106e14:	6a 00                	push   $0x0
80106e16:	6a 2e                	push   $0x2e
80106e18:	e9 e7 f7 ff ff       	jmp    80106604 <alltraps>

80106e1d <vector47>:
80106e1d:	6a 00                	push   $0x0
80106e1f:	6a 2f                	push   $0x2f
80106e21:	e9 de f7 ff ff       	jmp    80106604 <alltraps>

80106e26 <vector48>:
80106e26:	6a 00                	push   $0x0
80106e28:	6a 30                	push   $0x30
80106e2a:	e9 d5 f7 ff ff       	jmp    80106604 <alltraps>

80106e2f <vector49>:
80106e2f:	6a 00                	push   $0x0
80106e31:	6a 31                	push   $0x31
80106e33:	e9 cc f7 ff ff       	jmp    80106604 <alltraps>

80106e38 <vector50>:
80106e38:	6a 00                	push   $0x0
80106e3a:	6a 32                	push   $0x32
80106e3c:	e9 c3 f7 ff ff       	jmp    80106604 <alltraps>

80106e41 <vector51>:
80106e41:	6a 00                	push   $0x0
80106e43:	6a 33                	push   $0x33
80106e45:	e9 ba f7 ff ff       	jmp    80106604 <alltraps>

80106e4a <vector52>:
80106e4a:	6a 00                	push   $0x0
80106e4c:	6a 34                	push   $0x34
80106e4e:	e9 b1 f7 ff ff       	jmp    80106604 <alltraps>

80106e53 <vector53>:
80106e53:	6a 00                	push   $0x0
80106e55:	6a 35                	push   $0x35
80106e57:	e9 a8 f7 ff ff       	jmp    80106604 <alltraps>

80106e5c <vector54>:
80106e5c:	6a 00                	push   $0x0
80106e5e:	6a 36                	push   $0x36
80106e60:	e9 9f f7 ff ff       	jmp    80106604 <alltraps>

80106e65 <vector55>:
80106e65:	6a 00                	push   $0x0
80106e67:	6a 37                	push   $0x37
80106e69:	e9 96 f7 ff ff       	jmp    80106604 <alltraps>

80106e6e <vector56>:
80106e6e:	6a 00                	push   $0x0
80106e70:	6a 38                	push   $0x38
80106e72:	e9 8d f7 ff ff       	jmp    80106604 <alltraps>

80106e77 <vector57>:
80106e77:	6a 00                	push   $0x0
80106e79:	6a 39                	push   $0x39
80106e7b:	e9 84 f7 ff ff       	jmp    80106604 <alltraps>

80106e80 <vector58>:
80106e80:	6a 00                	push   $0x0
80106e82:	6a 3a                	push   $0x3a
80106e84:	e9 7b f7 ff ff       	jmp    80106604 <alltraps>

80106e89 <vector59>:
80106e89:	6a 00                	push   $0x0
80106e8b:	6a 3b                	push   $0x3b
80106e8d:	e9 72 f7 ff ff       	jmp    80106604 <alltraps>

80106e92 <vector60>:
80106e92:	6a 00                	push   $0x0
80106e94:	6a 3c                	push   $0x3c
80106e96:	e9 69 f7 ff ff       	jmp    80106604 <alltraps>

80106e9b <vector61>:
80106e9b:	6a 00                	push   $0x0
80106e9d:	6a 3d                	push   $0x3d
80106e9f:	e9 60 f7 ff ff       	jmp    80106604 <alltraps>

80106ea4 <vector62>:
80106ea4:	6a 00                	push   $0x0
80106ea6:	6a 3e                	push   $0x3e
80106ea8:	e9 57 f7 ff ff       	jmp    80106604 <alltraps>

80106ead <vector63>:
80106ead:	6a 00                	push   $0x0
80106eaf:	6a 3f                	push   $0x3f
80106eb1:	e9 4e f7 ff ff       	jmp    80106604 <alltraps>

80106eb6 <vector64>:
80106eb6:	6a 00                	push   $0x0
80106eb8:	6a 40                	push   $0x40
80106eba:	e9 45 f7 ff ff       	jmp    80106604 <alltraps>

80106ebf <vector65>:
80106ebf:	6a 00                	push   $0x0
80106ec1:	6a 41                	push   $0x41
80106ec3:	e9 3c f7 ff ff       	jmp    80106604 <alltraps>

80106ec8 <vector66>:
80106ec8:	6a 00                	push   $0x0
80106eca:	6a 42                	push   $0x42
80106ecc:	e9 33 f7 ff ff       	jmp    80106604 <alltraps>

80106ed1 <vector67>:
80106ed1:	6a 00                	push   $0x0
80106ed3:	6a 43                	push   $0x43
80106ed5:	e9 2a f7 ff ff       	jmp    80106604 <alltraps>

80106eda <vector68>:
80106eda:	6a 00                	push   $0x0
80106edc:	6a 44                	push   $0x44
80106ede:	e9 21 f7 ff ff       	jmp    80106604 <alltraps>

80106ee3 <vector69>:
80106ee3:	6a 00                	push   $0x0
80106ee5:	6a 45                	push   $0x45
80106ee7:	e9 18 f7 ff ff       	jmp    80106604 <alltraps>

80106eec <vector70>:
80106eec:	6a 00                	push   $0x0
80106eee:	6a 46                	push   $0x46
80106ef0:	e9 0f f7 ff ff       	jmp    80106604 <alltraps>

80106ef5 <vector71>:
80106ef5:	6a 00                	push   $0x0
80106ef7:	6a 47                	push   $0x47
80106ef9:	e9 06 f7 ff ff       	jmp    80106604 <alltraps>

80106efe <vector72>:
80106efe:	6a 00                	push   $0x0
80106f00:	6a 48                	push   $0x48
80106f02:	e9 fd f6 ff ff       	jmp    80106604 <alltraps>

80106f07 <vector73>:
80106f07:	6a 00                	push   $0x0
80106f09:	6a 49                	push   $0x49
80106f0b:	e9 f4 f6 ff ff       	jmp    80106604 <alltraps>

80106f10 <vector74>:
80106f10:	6a 00                	push   $0x0
80106f12:	6a 4a                	push   $0x4a
80106f14:	e9 eb f6 ff ff       	jmp    80106604 <alltraps>

80106f19 <vector75>:
80106f19:	6a 00                	push   $0x0
80106f1b:	6a 4b                	push   $0x4b
80106f1d:	e9 e2 f6 ff ff       	jmp    80106604 <alltraps>

80106f22 <vector76>:
80106f22:	6a 00                	push   $0x0
80106f24:	6a 4c                	push   $0x4c
80106f26:	e9 d9 f6 ff ff       	jmp    80106604 <alltraps>

80106f2b <vector77>:
80106f2b:	6a 00                	push   $0x0
80106f2d:	6a 4d                	push   $0x4d
80106f2f:	e9 d0 f6 ff ff       	jmp    80106604 <alltraps>

80106f34 <vector78>:
80106f34:	6a 00                	push   $0x0
80106f36:	6a 4e                	push   $0x4e
80106f38:	e9 c7 f6 ff ff       	jmp    80106604 <alltraps>

80106f3d <vector79>:
80106f3d:	6a 00                	push   $0x0
80106f3f:	6a 4f                	push   $0x4f
80106f41:	e9 be f6 ff ff       	jmp    80106604 <alltraps>

80106f46 <vector80>:
80106f46:	6a 00                	push   $0x0
80106f48:	6a 50                	push   $0x50
80106f4a:	e9 b5 f6 ff ff       	jmp    80106604 <alltraps>

80106f4f <vector81>:
80106f4f:	6a 00                	push   $0x0
80106f51:	6a 51                	push   $0x51
80106f53:	e9 ac f6 ff ff       	jmp    80106604 <alltraps>

80106f58 <vector82>:
80106f58:	6a 00                	push   $0x0
80106f5a:	6a 52                	push   $0x52
80106f5c:	e9 a3 f6 ff ff       	jmp    80106604 <alltraps>

80106f61 <vector83>:
80106f61:	6a 00                	push   $0x0
80106f63:	6a 53                	push   $0x53
80106f65:	e9 9a f6 ff ff       	jmp    80106604 <alltraps>

80106f6a <vector84>:
80106f6a:	6a 00                	push   $0x0
80106f6c:	6a 54                	push   $0x54
80106f6e:	e9 91 f6 ff ff       	jmp    80106604 <alltraps>

80106f73 <vector85>:
80106f73:	6a 00                	push   $0x0
80106f75:	6a 55                	push   $0x55
80106f77:	e9 88 f6 ff ff       	jmp    80106604 <alltraps>

80106f7c <vector86>:
80106f7c:	6a 00                	push   $0x0
80106f7e:	6a 56                	push   $0x56
80106f80:	e9 7f f6 ff ff       	jmp    80106604 <alltraps>

80106f85 <vector87>:
80106f85:	6a 00                	push   $0x0
80106f87:	6a 57                	push   $0x57
80106f89:	e9 76 f6 ff ff       	jmp    80106604 <alltraps>

80106f8e <vector88>:
80106f8e:	6a 00                	push   $0x0
80106f90:	6a 58                	push   $0x58
80106f92:	e9 6d f6 ff ff       	jmp    80106604 <alltraps>

80106f97 <vector89>:
80106f97:	6a 00                	push   $0x0
80106f99:	6a 59                	push   $0x59
80106f9b:	e9 64 f6 ff ff       	jmp    80106604 <alltraps>

80106fa0 <vector90>:
80106fa0:	6a 00                	push   $0x0
80106fa2:	6a 5a                	push   $0x5a
80106fa4:	e9 5b f6 ff ff       	jmp    80106604 <alltraps>

80106fa9 <vector91>:
80106fa9:	6a 00                	push   $0x0
80106fab:	6a 5b                	push   $0x5b
80106fad:	e9 52 f6 ff ff       	jmp    80106604 <alltraps>

80106fb2 <vector92>:
80106fb2:	6a 00                	push   $0x0
80106fb4:	6a 5c                	push   $0x5c
80106fb6:	e9 49 f6 ff ff       	jmp    80106604 <alltraps>

80106fbb <vector93>:
80106fbb:	6a 00                	push   $0x0
80106fbd:	6a 5d                	push   $0x5d
80106fbf:	e9 40 f6 ff ff       	jmp    80106604 <alltraps>

80106fc4 <vector94>:
80106fc4:	6a 00                	push   $0x0
80106fc6:	6a 5e                	push   $0x5e
80106fc8:	e9 37 f6 ff ff       	jmp    80106604 <alltraps>

80106fcd <vector95>:
80106fcd:	6a 00                	push   $0x0
80106fcf:	6a 5f                	push   $0x5f
80106fd1:	e9 2e f6 ff ff       	jmp    80106604 <alltraps>

80106fd6 <vector96>:
80106fd6:	6a 00                	push   $0x0
80106fd8:	6a 60                	push   $0x60
80106fda:	e9 25 f6 ff ff       	jmp    80106604 <alltraps>

80106fdf <vector97>:
80106fdf:	6a 00                	push   $0x0
80106fe1:	6a 61                	push   $0x61
80106fe3:	e9 1c f6 ff ff       	jmp    80106604 <alltraps>

80106fe8 <vector98>:
80106fe8:	6a 00                	push   $0x0
80106fea:	6a 62                	push   $0x62
80106fec:	e9 13 f6 ff ff       	jmp    80106604 <alltraps>

80106ff1 <vector99>:
80106ff1:	6a 00                	push   $0x0
80106ff3:	6a 63                	push   $0x63
80106ff5:	e9 0a f6 ff ff       	jmp    80106604 <alltraps>

80106ffa <vector100>:
80106ffa:	6a 00                	push   $0x0
80106ffc:	6a 64                	push   $0x64
80106ffe:	e9 01 f6 ff ff       	jmp    80106604 <alltraps>

80107003 <vector101>:
80107003:	6a 00                	push   $0x0
80107005:	6a 65                	push   $0x65
80107007:	e9 f8 f5 ff ff       	jmp    80106604 <alltraps>

8010700c <vector102>:
8010700c:	6a 00                	push   $0x0
8010700e:	6a 66                	push   $0x66
80107010:	e9 ef f5 ff ff       	jmp    80106604 <alltraps>

80107015 <vector103>:
80107015:	6a 00                	push   $0x0
80107017:	6a 67                	push   $0x67
80107019:	e9 e6 f5 ff ff       	jmp    80106604 <alltraps>

8010701e <vector104>:
8010701e:	6a 00                	push   $0x0
80107020:	6a 68                	push   $0x68
80107022:	e9 dd f5 ff ff       	jmp    80106604 <alltraps>

80107027 <vector105>:
80107027:	6a 00                	push   $0x0
80107029:	6a 69                	push   $0x69
8010702b:	e9 d4 f5 ff ff       	jmp    80106604 <alltraps>

80107030 <vector106>:
80107030:	6a 00                	push   $0x0
80107032:	6a 6a                	push   $0x6a
80107034:	e9 cb f5 ff ff       	jmp    80106604 <alltraps>

80107039 <vector107>:
80107039:	6a 00                	push   $0x0
8010703b:	6a 6b                	push   $0x6b
8010703d:	e9 c2 f5 ff ff       	jmp    80106604 <alltraps>

80107042 <vector108>:
80107042:	6a 00                	push   $0x0
80107044:	6a 6c                	push   $0x6c
80107046:	e9 b9 f5 ff ff       	jmp    80106604 <alltraps>

8010704b <vector109>:
8010704b:	6a 00                	push   $0x0
8010704d:	6a 6d                	push   $0x6d
8010704f:	e9 b0 f5 ff ff       	jmp    80106604 <alltraps>

80107054 <vector110>:
80107054:	6a 00                	push   $0x0
80107056:	6a 6e                	push   $0x6e
80107058:	e9 a7 f5 ff ff       	jmp    80106604 <alltraps>

8010705d <vector111>:
8010705d:	6a 00                	push   $0x0
8010705f:	6a 6f                	push   $0x6f
80107061:	e9 9e f5 ff ff       	jmp    80106604 <alltraps>

80107066 <vector112>:
80107066:	6a 00                	push   $0x0
80107068:	6a 70                	push   $0x70
8010706a:	e9 95 f5 ff ff       	jmp    80106604 <alltraps>

8010706f <vector113>:
8010706f:	6a 00                	push   $0x0
80107071:	6a 71                	push   $0x71
80107073:	e9 8c f5 ff ff       	jmp    80106604 <alltraps>

80107078 <vector114>:
80107078:	6a 00                	push   $0x0
8010707a:	6a 72                	push   $0x72
8010707c:	e9 83 f5 ff ff       	jmp    80106604 <alltraps>

80107081 <vector115>:
80107081:	6a 00                	push   $0x0
80107083:	6a 73                	push   $0x73
80107085:	e9 7a f5 ff ff       	jmp    80106604 <alltraps>

8010708a <vector116>:
8010708a:	6a 00                	push   $0x0
8010708c:	6a 74                	push   $0x74
8010708e:	e9 71 f5 ff ff       	jmp    80106604 <alltraps>

80107093 <vector117>:
80107093:	6a 00                	push   $0x0
80107095:	6a 75                	push   $0x75
80107097:	e9 68 f5 ff ff       	jmp    80106604 <alltraps>

8010709c <vector118>:
8010709c:	6a 00                	push   $0x0
8010709e:	6a 76                	push   $0x76
801070a0:	e9 5f f5 ff ff       	jmp    80106604 <alltraps>

801070a5 <vector119>:
801070a5:	6a 00                	push   $0x0
801070a7:	6a 77                	push   $0x77
801070a9:	e9 56 f5 ff ff       	jmp    80106604 <alltraps>

801070ae <vector120>:
801070ae:	6a 00                	push   $0x0
801070b0:	6a 78                	push   $0x78
801070b2:	e9 4d f5 ff ff       	jmp    80106604 <alltraps>

801070b7 <vector121>:
801070b7:	6a 00                	push   $0x0
801070b9:	6a 79                	push   $0x79
801070bb:	e9 44 f5 ff ff       	jmp    80106604 <alltraps>

801070c0 <vector122>:
801070c0:	6a 00                	push   $0x0
801070c2:	6a 7a                	push   $0x7a
801070c4:	e9 3b f5 ff ff       	jmp    80106604 <alltraps>

801070c9 <vector123>:
801070c9:	6a 00                	push   $0x0
801070cb:	6a 7b                	push   $0x7b
801070cd:	e9 32 f5 ff ff       	jmp    80106604 <alltraps>

801070d2 <vector124>:
801070d2:	6a 00                	push   $0x0
801070d4:	6a 7c                	push   $0x7c
801070d6:	e9 29 f5 ff ff       	jmp    80106604 <alltraps>

801070db <vector125>:
801070db:	6a 00                	push   $0x0
801070dd:	6a 7d                	push   $0x7d
801070df:	e9 20 f5 ff ff       	jmp    80106604 <alltraps>

801070e4 <vector126>:
801070e4:	6a 00                	push   $0x0
801070e6:	6a 7e                	push   $0x7e
801070e8:	e9 17 f5 ff ff       	jmp    80106604 <alltraps>

801070ed <vector127>:
801070ed:	6a 00                	push   $0x0
801070ef:	6a 7f                	push   $0x7f
801070f1:	e9 0e f5 ff ff       	jmp    80106604 <alltraps>

801070f6 <vector128>:
801070f6:	6a 00                	push   $0x0
801070f8:	68 80 00 00 00       	push   $0x80
801070fd:	e9 02 f5 ff ff       	jmp    80106604 <alltraps>

80107102 <vector129>:
80107102:	6a 00                	push   $0x0
80107104:	68 81 00 00 00       	push   $0x81
80107109:	e9 f6 f4 ff ff       	jmp    80106604 <alltraps>

8010710e <vector130>:
8010710e:	6a 00                	push   $0x0
80107110:	68 82 00 00 00       	push   $0x82
80107115:	e9 ea f4 ff ff       	jmp    80106604 <alltraps>

8010711a <vector131>:
8010711a:	6a 00                	push   $0x0
8010711c:	68 83 00 00 00       	push   $0x83
80107121:	e9 de f4 ff ff       	jmp    80106604 <alltraps>

80107126 <vector132>:
80107126:	6a 00                	push   $0x0
80107128:	68 84 00 00 00       	push   $0x84
8010712d:	e9 d2 f4 ff ff       	jmp    80106604 <alltraps>

80107132 <vector133>:
80107132:	6a 00                	push   $0x0
80107134:	68 85 00 00 00       	push   $0x85
80107139:	e9 c6 f4 ff ff       	jmp    80106604 <alltraps>

8010713e <vector134>:
8010713e:	6a 00                	push   $0x0
80107140:	68 86 00 00 00       	push   $0x86
80107145:	e9 ba f4 ff ff       	jmp    80106604 <alltraps>

8010714a <vector135>:
8010714a:	6a 00                	push   $0x0
8010714c:	68 87 00 00 00       	push   $0x87
80107151:	e9 ae f4 ff ff       	jmp    80106604 <alltraps>

80107156 <vector136>:
80107156:	6a 00                	push   $0x0
80107158:	68 88 00 00 00       	push   $0x88
8010715d:	e9 a2 f4 ff ff       	jmp    80106604 <alltraps>

80107162 <vector137>:
80107162:	6a 00                	push   $0x0
80107164:	68 89 00 00 00       	push   $0x89
80107169:	e9 96 f4 ff ff       	jmp    80106604 <alltraps>

8010716e <vector138>:
8010716e:	6a 00                	push   $0x0
80107170:	68 8a 00 00 00       	push   $0x8a
80107175:	e9 8a f4 ff ff       	jmp    80106604 <alltraps>

8010717a <vector139>:
8010717a:	6a 00                	push   $0x0
8010717c:	68 8b 00 00 00       	push   $0x8b
80107181:	e9 7e f4 ff ff       	jmp    80106604 <alltraps>

80107186 <vector140>:
80107186:	6a 00                	push   $0x0
80107188:	68 8c 00 00 00       	push   $0x8c
8010718d:	e9 72 f4 ff ff       	jmp    80106604 <alltraps>

80107192 <vector141>:
80107192:	6a 00                	push   $0x0
80107194:	68 8d 00 00 00       	push   $0x8d
80107199:	e9 66 f4 ff ff       	jmp    80106604 <alltraps>

8010719e <vector142>:
8010719e:	6a 00                	push   $0x0
801071a0:	68 8e 00 00 00       	push   $0x8e
801071a5:	e9 5a f4 ff ff       	jmp    80106604 <alltraps>

801071aa <vector143>:
801071aa:	6a 00                	push   $0x0
801071ac:	68 8f 00 00 00       	push   $0x8f
801071b1:	e9 4e f4 ff ff       	jmp    80106604 <alltraps>

801071b6 <vector144>:
801071b6:	6a 00                	push   $0x0
801071b8:	68 90 00 00 00       	push   $0x90
801071bd:	e9 42 f4 ff ff       	jmp    80106604 <alltraps>

801071c2 <vector145>:
801071c2:	6a 00                	push   $0x0
801071c4:	68 91 00 00 00       	push   $0x91
801071c9:	e9 36 f4 ff ff       	jmp    80106604 <alltraps>

801071ce <vector146>:
801071ce:	6a 00                	push   $0x0
801071d0:	68 92 00 00 00       	push   $0x92
801071d5:	e9 2a f4 ff ff       	jmp    80106604 <alltraps>

801071da <vector147>:
801071da:	6a 00                	push   $0x0
801071dc:	68 93 00 00 00       	push   $0x93
801071e1:	e9 1e f4 ff ff       	jmp    80106604 <alltraps>

801071e6 <vector148>:
801071e6:	6a 00                	push   $0x0
801071e8:	68 94 00 00 00       	push   $0x94
801071ed:	e9 12 f4 ff ff       	jmp    80106604 <alltraps>

801071f2 <vector149>:
801071f2:	6a 00                	push   $0x0
801071f4:	68 95 00 00 00       	push   $0x95
801071f9:	e9 06 f4 ff ff       	jmp    80106604 <alltraps>

801071fe <vector150>:
801071fe:	6a 00                	push   $0x0
80107200:	68 96 00 00 00       	push   $0x96
80107205:	e9 fa f3 ff ff       	jmp    80106604 <alltraps>

8010720a <vector151>:
8010720a:	6a 00                	push   $0x0
8010720c:	68 97 00 00 00       	push   $0x97
80107211:	e9 ee f3 ff ff       	jmp    80106604 <alltraps>

80107216 <vector152>:
80107216:	6a 00                	push   $0x0
80107218:	68 98 00 00 00       	push   $0x98
8010721d:	e9 e2 f3 ff ff       	jmp    80106604 <alltraps>

80107222 <vector153>:
80107222:	6a 00                	push   $0x0
80107224:	68 99 00 00 00       	push   $0x99
80107229:	e9 d6 f3 ff ff       	jmp    80106604 <alltraps>

8010722e <vector154>:
8010722e:	6a 00                	push   $0x0
80107230:	68 9a 00 00 00       	push   $0x9a
80107235:	e9 ca f3 ff ff       	jmp    80106604 <alltraps>

8010723a <vector155>:
8010723a:	6a 00                	push   $0x0
8010723c:	68 9b 00 00 00       	push   $0x9b
80107241:	e9 be f3 ff ff       	jmp    80106604 <alltraps>

80107246 <vector156>:
80107246:	6a 00                	push   $0x0
80107248:	68 9c 00 00 00       	push   $0x9c
8010724d:	e9 b2 f3 ff ff       	jmp    80106604 <alltraps>

80107252 <vector157>:
80107252:	6a 00                	push   $0x0
80107254:	68 9d 00 00 00       	push   $0x9d
80107259:	e9 a6 f3 ff ff       	jmp    80106604 <alltraps>

8010725e <vector158>:
8010725e:	6a 00                	push   $0x0
80107260:	68 9e 00 00 00       	push   $0x9e
80107265:	e9 9a f3 ff ff       	jmp    80106604 <alltraps>

8010726a <vector159>:
8010726a:	6a 00                	push   $0x0
8010726c:	68 9f 00 00 00       	push   $0x9f
80107271:	e9 8e f3 ff ff       	jmp    80106604 <alltraps>

80107276 <vector160>:
80107276:	6a 00                	push   $0x0
80107278:	68 a0 00 00 00       	push   $0xa0
8010727d:	e9 82 f3 ff ff       	jmp    80106604 <alltraps>

80107282 <vector161>:
80107282:	6a 00                	push   $0x0
80107284:	68 a1 00 00 00       	push   $0xa1
80107289:	e9 76 f3 ff ff       	jmp    80106604 <alltraps>

8010728e <vector162>:
8010728e:	6a 00                	push   $0x0
80107290:	68 a2 00 00 00       	push   $0xa2
80107295:	e9 6a f3 ff ff       	jmp    80106604 <alltraps>

8010729a <vector163>:
8010729a:	6a 00                	push   $0x0
8010729c:	68 a3 00 00 00       	push   $0xa3
801072a1:	e9 5e f3 ff ff       	jmp    80106604 <alltraps>

801072a6 <vector164>:
801072a6:	6a 00                	push   $0x0
801072a8:	68 a4 00 00 00       	push   $0xa4
801072ad:	e9 52 f3 ff ff       	jmp    80106604 <alltraps>

801072b2 <vector165>:
801072b2:	6a 00                	push   $0x0
801072b4:	68 a5 00 00 00       	push   $0xa5
801072b9:	e9 46 f3 ff ff       	jmp    80106604 <alltraps>

801072be <vector166>:
801072be:	6a 00                	push   $0x0
801072c0:	68 a6 00 00 00       	push   $0xa6
801072c5:	e9 3a f3 ff ff       	jmp    80106604 <alltraps>

801072ca <vector167>:
801072ca:	6a 00                	push   $0x0
801072cc:	68 a7 00 00 00       	push   $0xa7
801072d1:	e9 2e f3 ff ff       	jmp    80106604 <alltraps>

801072d6 <vector168>:
801072d6:	6a 00                	push   $0x0
801072d8:	68 a8 00 00 00       	push   $0xa8
801072dd:	e9 22 f3 ff ff       	jmp    80106604 <alltraps>

801072e2 <vector169>:
801072e2:	6a 00                	push   $0x0
801072e4:	68 a9 00 00 00       	push   $0xa9
801072e9:	e9 16 f3 ff ff       	jmp    80106604 <alltraps>

801072ee <vector170>:
801072ee:	6a 00                	push   $0x0
801072f0:	68 aa 00 00 00       	push   $0xaa
801072f5:	e9 0a f3 ff ff       	jmp    80106604 <alltraps>

801072fa <vector171>:
801072fa:	6a 00                	push   $0x0
801072fc:	68 ab 00 00 00       	push   $0xab
80107301:	e9 fe f2 ff ff       	jmp    80106604 <alltraps>

80107306 <vector172>:
80107306:	6a 00                	push   $0x0
80107308:	68 ac 00 00 00       	push   $0xac
8010730d:	e9 f2 f2 ff ff       	jmp    80106604 <alltraps>

80107312 <vector173>:
80107312:	6a 00                	push   $0x0
80107314:	68 ad 00 00 00       	push   $0xad
80107319:	e9 e6 f2 ff ff       	jmp    80106604 <alltraps>

8010731e <vector174>:
8010731e:	6a 00                	push   $0x0
80107320:	68 ae 00 00 00       	push   $0xae
80107325:	e9 da f2 ff ff       	jmp    80106604 <alltraps>

8010732a <vector175>:
8010732a:	6a 00                	push   $0x0
8010732c:	68 af 00 00 00       	push   $0xaf
80107331:	e9 ce f2 ff ff       	jmp    80106604 <alltraps>

80107336 <vector176>:
80107336:	6a 00                	push   $0x0
80107338:	68 b0 00 00 00       	push   $0xb0
8010733d:	e9 c2 f2 ff ff       	jmp    80106604 <alltraps>

80107342 <vector177>:
80107342:	6a 00                	push   $0x0
80107344:	68 b1 00 00 00       	push   $0xb1
80107349:	e9 b6 f2 ff ff       	jmp    80106604 <alltraps>

8010734e <vector178>:
8010734e:	6a 00                	push   $0x0
80107350:	68 b2 00 00 00       	push   $0xb2
80107355:	e9 aa f2 ff ff       	jmp    80106604 <alltraps>

8010735a <vector179>:
8010735a:	6a 00                	push   $0x0
8010735c:	68 b3 00 00 00       	push   $0xb3
80107361:	e9 9e f2 ff ff       	jmp    80106604 <alltraps>

80107366 <vector180>:
80107366:	6a 00                	push   $0x0
80107368:	68 b4 00 00 00       	push   $0xb4
8010736d:	e9 92 f2 ff ff       	jmp    80106604 <alltraps>

80107372 <vector181>:
80107372:	6a 00                	push   $0x0
80107374:	68 b5 00 00 00       	push   $0xb5
80107379:	e9 86 f2 ff ff       	jmp    80106604 <alltraps>

8010737e <vector182>:
8010737e:	6a 00                	push   $0x0
80107380:	68 b6 00 00 00       	push   $0xb6
80107385:	e9 7a f2 ff ff       	jmp    80106604 <alltraps>

8010738a <vector183>:
8010738a:	6a 00                	push   $0x0
8010738c:	68 b7 00 00 00       	push   $0xb7
80107391:	e9 6e f2 ff ff       	jmp    80106604 <alltraps>

80107396 <vector184>:
80107396:	6a 00                	push   $0x0
80107398:	68 b8 00 00 00       	push   $0xb8
8010739d:	e9 62 f2 ff ff       	jmp    80106604 <alltraps>

801073a2 <vector185>:
801073a2:	6a 00                	push   $0x0
801073a4:	68 b9 00 00 00       	push   $0xb9
801073a9:	e9 56 f2 ff ff       	jmp    80106604 <alltraps>

801073ae <vector186>:
801073ae:	6a 00                	push   $0x0
801073b0:	68 ba 00 00 00       	push   $0xba
801073b5:	e9 4a f2 ff ff       	jmp    80106604 <alltraps>

801073ba <vector187>:
801073ba:	6a 00                	push   $0x0
801073bc:	68 bb 00 00 00       	push   $0xbb
801073c1:	e9 3e f2 ff ff       	jmp    80106604 <alltraps>

801073c6 <vector188>:
801073c6:	6a 00                	push   $0x0
801073c8:	68 bc 00 00 00       	push   $0xbc
801073cd:	e9 32 f2 ff ff       	jmp    80106604 <alltraps>

801073d2 <vector189>:
801073d2:	6a 00                	push   $0x0
801073d4:	68 bd 00 00 00       	push   $0xbd
801073d9:	e9 26 f2 ff ff       	jmp    80106604 <alltraps>

801073de <vector190>:
801073de:	6a 00                	push   $0x0
801073e0:	68 be 00 00 00       	push   $0xbe
801073e5:	e9 1a f2 ff ff       	jmp    80106604 <alltraps>

801073ea <vector191>:
801073ea:	6a 00                	push   $0x0
801073ec:	68 bf 00 00 00       	push   $0xbf
801073f1:	e9 0e f2 ff ff       	jmp    80106604 <alltraps>

801073f6 <vector192>:
801073f6:	6a 00                	push   $0x0
801073f8:	68 c0 00 00 00       	push   $0xc0
801073fd:	e9 02 f2 ff ff       	jmp    80106604 <alltraps>

80107402 <vector193>:
80107402:	6a 00                	push   $0x0
80107404:	68 c1 00 00 00       	push   $0xc1
80107409:	e9 f6 f1 ff ff       	jmp    80106604 <alltraps>

8010740e <vector194>:
8010740e:	6a 00                	push   $0x0
80107410:	68 c2 00 00 00       	push   $0xc2
80107415:	e9 ea f1 ff ff       	jmp    80106604 <alltraps>

8010741a <vector195>:
8010741a:	6a 00                	push   $0x0
8010741c:	68 c3 00 00 00       	push   $0xc3
80107421:	e9 de f1 ff ff       	jmp    80106604 <alltraps>

80107426 <vector196>:
80107426:	6a 00                	push   $0x0
80107428:	68 c4 00 00 00       	push   $0xc4
8010742d:	e9 d2 f1 ff ff       	jmp    80106604 <alltraps>

80107432 <vector197>:
80107432:	6a 00                	push   $0x0
80107434:	68 c5 00 00 00       	push   $0xc5
80107439:	e9 c6 f1 ff ff       	jmp    80106604 <alltraps>

8010743e <vector198>:
8010743e:	6a 00                	push   $0x0
80107440:	68 c6 00 00 00       	push   $0xc6
80107445:	e9 ba f1 ff ff       	jmp    80106604 <alltraps>

8010744a <vector199>:
8010744a:	6a 00                	push   $0x0
8010744c:	68 c7 00 00 00       	push   $0xc7
80107451:	e9 ae f1 ff ff       	jmp    80106604 <alltraps>

80107456 <vector200>:
80107456:	6a 00                	push   $0x0
80107458:	68 c8 00 00 00       	push   $0xc8
8010745d:	e9 a2 f1 ff ff       	jmp    80106604 <alltraps>

80107462 <vector201>:
80107462:	6a 00                	push   $0x0
80107464:	68 c9 00 00 00       	push   $0xc9
80107469:	e9 96 f1 ff ff       	jmp    80106604 <alltraps>

8010746e <vector202>:
8010746e:	6a 00                	push   $0x0
80107470:	68 ca 00 00 00       	push   $0xca
80107475:	e9 8a f1 ff ff       	jmp    80106604 <alltraps>

8010747a <vector203>:
8010747a:	6a 00                	push   $0x0
8010747c:	68 cb 00 00 00       	push   $0xcb
80107481:	e9 7e f1 ff ff       	jmp    80106604 <alltraps>

80107486 <vector204>:
80107486:	6a 00                	push   $0x0
80107488:	68 cc 00 00 00       	push   $0xcc
8010748d:	e9 72 f1 ff ff       	jmp    80106604 <alltraps>

80107492 <vector205>:
80107492:	6a 00                	push   $0x0
80107494:	68 cd 00 00 00       	push   $0xcd
80107499:	e9 66 f1 ff ff       	jmp    80106604 <alltraps>

8010749e <vector206>:
8010749e:	6a 00                	push   $0x0
801074a0:	68 ce 00 00 00       	push   $0xce
801074a5:	e9 5a f1 ff ff       	jmp    80106604 <alltraps>

801074aa <vector207>:
801074aa:	6a 00                	push   $0x0
801074ac:	68 cf 00 00 00       	push   $0xcf
801074b1:	e9 4e f1 ff ff       	jmp    80106604 <alltraps>

801074b6 <vector208>:
801074b6:	6a 00                	push   $0x0
801074b8:	68 d0 00 00 00       	push   $0xd0
801074bd:	e9 42 f1 ff ff       	jmp    80106604 <alltraps>

801074c2 <vector209>:
801074c2:	6a 00                	push   $0x0
801074c4:	68 d1 00 00 00       	push   $0xd1
801074c9:	e9 36 f1 ff ff       	jmp    80106604 <alltraps>

801074ce <vector210>:
801074ce:	6a 00                	push   $0x0
801074d0:	68 d2 00 00 00       	push   $0xd2
801074d5:	e9 2a f1 ff ff       	jmp    80106604 <alltraps>

801074da <vector211>:
801074da:	6a 00                	push   $0x0
801074dc:	68 d3 00 00 00       	push   $0xd3
801074e1:	e9 1e f1 ff ff       	jmp    80106604 <alltraps>

801074e6 <vector212>:
801074e6:	6a 00                	push   $0x0
801074e8:	68 d4 00 00 00       	push   $0xd4
801074ed:	e9 12 f1 ff ff       	jmp    80106604 <alltraps>

801074f2 <vector213>:
801074f2:	6a 00                	push   $0x0
801074f4:	68 d5 00 00 00       	push   $0xd5
801074f9:	e9 06 f1 ff ff       	jmp    80106604 <alltraps>

801074fe <vector214>:
801074fe:	6a 00                	push   $0x0
80107500:	68 d6 00 00 00       	push   $0xd6
80107505:	e9 fa f0 ff ff       	jmp    80106604 <alltraps>

8010750a <vector215>:
8010750a:	6a 00                	push   $0x0
8010750c:	68 d7 00 00 00       	push   $0xd7
80107511:	e9 ee f0 ff ff       	jmp    80106604 <alltraps>

80107516 <vector216>:
80107516:	6a 00                	push   $0x0
80107518:	68 d8 00 00 00       	push   $0xd8
8010751d:	e9 e2 f0 ff ff       	jmp    80106604 <alltraps>

80107522 <vector217>:
80107522:	6a 00                	push   $0x0
80107524:	68 d9 00 00 00       	push   $0xd9
80107529:	e9 d6 f0 ff ff       	jmp    80106604 <alltraps>

8010752e <vector218>:
8010752e:	6a 00                	push   $0x0
80107530:	68 da 00 00 00       	push   $0xda
80107535:	e9 ca f0 ff ff       	jmp    80106604 <alltraps>

8010753a <vector219>:
8010753a:	6a 00                	push   $0x0
8010753c:	68 db 00 00 00       	push   $0xdb
80107541:	e9 be f0 ff ff       	jmp    80106604 <alltraps>

80107546 <vector220>:
80107546:	6a 00                	push   $0x0
80107548:	68 dc 00 00 00       	push   $0xdc
8010754d:	e9 b2 f0 ff ff       	jmp    80106604 <alltraps>

80107552 <vector221>:
80107552:	6a 00                	push   $0x0
80107554:	68 dd 00 00 00       	push   $0xdd
80107559:	e9 a6 f0 ff ff       	jmp    80106604 <alltraps>

8010755e <vector222>:
8010755e:	6a 00                	push   $0x0
80107560:	68 de 00 00 00       	push   $0xde
80107565:	e9 9a f0 ff ff       	jmp    80106604 <alltraps>

8010756a <vector223>:
8010756a:	6a 00                	push   $0x0
8010756c:	68 df 00 00 00       	push   $0xdf
80107571:	e9 8e f0 ff ff       	jmp    80106604 <alltraps>

80107576 <vector224>:
80107576:	6a 00                	push   $0x0
80107578:	68 e0 00 00 00       	push   $0xe0
8010757d:	e9 82 f0 ff ff       	jmp    80106604 <alltraps>

80107582 <vector225>:
80107582:	6a 00                	push   $0x0
80107584:	68 e1 00 00 00       	push   $0xe1
80107589:	e9 76 f0 ff ff       	jmp    80106604 <alltraps>

8010758e <vector226>:
8010758e:	6a 00                	push   $0x0
80107590:	68 e2 00 00 00       	push   $0xe2
80107595:	e9 6a f0 ff ff       	jmp    80106604 <alltraps>

8010759a <vector227>:
8010759a:	6a 00                	push   $0x0
8010759c:	68 e3 00 00 00       	push   $0xe3
801075a1:	e9 5e f0 ff ff       	jmp    80106604 <alltraps>

801075a6 <vector228>:
801075a6:	6a 00                	push   $0x0
801075a8:	68 e4 00 00 00       	push   $0xe4
801075ad:	e9 52 f0 ff ff       	jmp    80106604 <alltraps>

801075b2 <vector229>:
801075b2:	6a 00                	push   $0x0
801075b4:	68 e5 00 00 00       	push   $0xe5
801075b9:	e9 46 f0 ff ff       	jmp    80106604 <alltraps>

801075be <vector230>:
801075be:	6a 00                	push   $0x0
801075c0:	68 e6 00 00 00       	push   $0xe6
801075c5:	e9 3a f0 ff ff       	jmp    80106604 <alltraps>

801075ca <vector231>:
801075ca:	6a 00                	push   $0x0
801075cc:	68 e7 00 00 00       	push   $0xe7
801075d1:	e9 2e f0 ff ff       	jmp    80106604 <alltraps>

801075d6 <vector232>:
801075d6:	6a 00                	push   $0x0
801075d8:	68 e8 00 00 00       	push   $0xe8
801075dd:	e9 22 f0 ff ff       	jmp    80106604 <alltraps>

801075e2 <vector233>:
801075e2:	6a 00                	push   $0x0
801075e4:	68 e9 00 00 00       	push   $0xe9
801075e9:	e9 16 f0 ff ff       	jmp    80106604 <alltraps>

801075ee <vector234>:
801075ee:	6a 00                	push   $0x0
801075f0:	68 ea 00 00 00       	push   $0xea
801075f5:	e9 0a f0 ff ff       	jmp    80106604 <alltraps>

801075fa <vector235>:
801075fa:	6a 00                	push   $0x0
801075fc:	68 eb 00 00 00       	push   $0xeb
80107601:	e9 fe ef ff ff       	jmp    80106604 <alltraps>

80107606 <vector236>:
80107606:	6a 00                	push   $0x0
80107608:	68 ec 00 00 00       	push   $0xec
8010760d:	e9 f2 ef ff ff       	jmp    80106604 <alltraps>

80107612 <vector237>:
80107612:	6a 00                	push   $0x0
80107614:	68 ed 00 00 00       	push   $0xed
80107619:	e9 e6 ef ff ff       	jmp    80106604 <alltraps>

8010761e <vector238>:
8010761e:	6a 00                	push   $0x0
80107620:	68 ee 00 00 00       	push   $0xee
80107625:	e9 da ef ff ff       	jmp    80106604 <alltraps>

8010762a <vector239>:
8010762a:	6a 00                	push   $0x0
8010762c:	68 ef 00 00 00       	push   $0xef
80107631:	e9 ce ef ff ff       	jmp    80106604 <alltraps>

80107636 <vector240>:
80107636:	6a 00                	push   $0x0
80107638:	68 f0 00 00 00       	push   $0xf0
8010763d:	e9 c2 ef ff ff       	jmp    80106604 <alltraps>

80107642 <vector241>:
80107642:	6a 00                	push   $0x0
80107644:	68 f1 00 00 00       	push   $0xf1
80107649:	e9 b6 ef ff ff       	jmp    80106604 <alltraps>

8010764e <vector242>:
8010764e:	6a 00                	push   $0x0
80107650:	68 f2 00 00 00       	push   $0xf2
80107655:	e9 aa ef ff ff       	jmp    80106604 <alltraps>

8010765a <vector243>:
8010765a:	6a 00                	push   $0x0
8010765c:	68 f3 00 00 00       	push   $0xf3
80107661:	e9 9e ef ff ff       	jmp    80106604 <alltraps>

80107666 <vector244>:
80107666:	6a 00                	push   $0x0
80107668:	68 f4 00 00 00       	push   $0xf4
8010766d:	e9 92 ef ff ff       	jmp    80106604 <alltraps>

80107672 <vector245>:
80107672:	6a 00                	push   $0x0
80107674:	68 f5 00 00 00       	push   $0xf5
80107679:	e9 86 ef ff ff       	jmp    80106604 <alltraps>

8010767e <vector246>:
8010767e:	6a 00                	push   $0x0
80107680:	68 f6 00 00 00       	push   $0xf6
80107685:	e9 7a ef ff ff       	jmp    80106604 <alltraps>

8010768a <vector247>:
8010768a:	6a 00                	push   $0x0
8010768c:	68 f7 00 00 00       	push   $0xf7
80107691:	e9 6e ef ff ff       	jmp    80106604 <alltraps>

80107696 <vector248>:
80107696:	6a 00                	push   $0x0
80107698:	68 f8 00 00 00       	push   $0xf8
8010769d:	e9 62 ef ff ff       	jmp    80106604 <alltraps>

801076a2 <vector249>:
801076a2:	6a 00                	push   $0x0
801076a4:	68 f9 00 00 00       	push   $0xf9
801076a9:	e9 56 ef ff ff       	jmp    80106604 <alltraps>

801076ae <vector250>:
801076ae:	6a 00                	push   $0x0
801076b0:	68 fa 00 00 00       	push   $0xfa
801076b5:	e9 4a ef ff ff       	jmp    80106604 <alltraps>

801076ba <vector251>:
801076ba:	6a 00                	push   $0x0
801076bc:	68 fb 00 00 00       	push   $0xfb
801076c1:	e9 3e ef ff ff       	jmp    80106604 <alltraps>

801076c6 <vector252>:
801076c6:	6a 00                	push   $0x0
801076c8:	68 fc 00 00 00       	push   $0xfc
801076cd:	e9 32 ef ff ff       	jmp    80106604 <alltraps>

801076d2 <vector253>:
801076d2:	6a 00                	push   $0x0
801076d4:	68 fd 00 00 00       	push   $0xfd
801076d9:	e9 26 ef ff ff       	jmp    80106604 <alltraps>

801076de <vector254>:
801076de:	6a 00                	push   $0x0
801076e0:	68 fe 00 00 00       	push   $0xfe
801076e5:	e9 1a ef ff ff       	jmp    80106604 <alltraps>

801076ea <vector255>:
801076ea:	6a 00                	push   $0x0
801076ec:	68 ff 00 00 00       	push   $0xff
801076f1:	e9 0e ef ff ff       	jmp    80106604 <alltraps>
801076f6:	66 90                	xchg   %ax,%ax
...
801076fb:	83 ec 10             	sub    $0x10,%esp
  volatile ushort pd[3];

  pd[0] = size-1;
801076fe:	8b 45 0c             	mov    0xc(%ebp),%eax
80107701:	83 e8 01             	sub    $0x1,%eax
80107704:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
80107708:	8b 45 08             	mov    0x8(%ebp),%eax
8010770b:	66 89 45 fc          	mov    %ax,-0x4(%ebp)
  pd[2] = (uint)p >> 16;
8010770f:	8b 45 08             	mov    0x8(%ebp),%eax
80107712:	c1 e8 10             	shr    $0x10,%eax
80107715:	66 89 45 fe          	mov    %ax,-0x2(%ebp)

  asm volatile("lgdt (%0)" : : "r" (pd));
80107719:	8d 45 fa             	lea    -0x6(%ebp),%eax
8010771c:	0f 01 10             	lgdtl  (%eax)
}
8010771f:	c9                   	leave  
80107720:	c3                   	ret    
...
80107775:	83 ec 24             	sub    $0x24,%esp
  ...
  c = &cpus[cpunum()];
80107778:	e8 df b6 ff ff       	call   80102e5c <cpunum>
8010777d:	69 c0 bc 00 00 00    	imul   $0xbc,%eax,%eax
80107783:	05 40 f9 10 80       	add    $0x8010f940,%eax
80107788:	89 45 f4             	mov    %eax,-0xc(%ebp)
  c->gdt[SEG_KCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, 0);
8010778b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010778e:	66 c7 40 78 ff ff    	movw   $0xffff,0x78(%eax)
80107794:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107797:	66 c7 40 7a 00 00    	movw   $0x0,0x7a(%eax)
8010779d:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077a0:	c6 40 7c 00          	movb   $0x0,0x7c(%eax)
801077a4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077a7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801077ab:	83 e2 f0             	and    $0xfffffff0,%edx
801077ae:	83 ca 0a             	or     $0xa,%edx
801077b1:	88 50 7d             	mov    %dl,0x7d(%eax)
801077b4:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077b7:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801077bb:	83 ca 10             	or     $0x10,%edx
801077be:	88 50 7d             	mov    %dl,0x7d(%eax)
801077c1:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077c4:	0f b6 50 7d          	movzbl 0x7d(%eax),%edx
801077c8:	83 e2 9f             	and    $0xffffff9f,%edx
...
801077de:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801077e2:	83 ca 0f             	or     $0xf,%edx
801077e5:	88 50 7e             	mov    %dl,0x7e(%eax)
801077e8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801077eb:	0f b6 50 7e          	movzbl 0x7e(%eax),%edx
801077ef:	83 e2 ef             	and    $0xffffffef,%edx
801077f2:	88 50 7e             	mov    %dl,0x7e(%eax)
...
8010781f:	c6 40 7f 00          	movb   $0x0,0x7f(%eax)
  c->gdt[SEG_KDATA] = SEG(STA_W, 0, 0xffffffff, 0);
80107823:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107826:	66 c7 80 80 00 00 00 	movw   $0xffff,0x80(%eax)
8010782d:	ff ff 
8010782f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107832:	66 c7 80 82 00 00 00 	movw   $0x0,0x82(%eax)
80107839:	00 00 
8010783b:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010783e:	c6 80 84 00 00 00 00 	movb   $0x0,0x84(%eax)
80107845:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107848:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
8010784f:	83 e2 f0             	and    $0xfffffff0,%edx
80107852:	83 ca 02             	or     $0x2,%edx
...
80107878:	83 e2 9f             	and    $0xffffff9f,%edx
8010787b:	88 90 85 00 00 00    	mov    %dl,0x85(%eax)
80107881:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107884:	0f b6 90 85 00 00 00 	movzbl 0x85(%eax),%edx
...
801078b1:	83 e2 ef             	and    $0xffffffef,%edx
...
801078f6:	c6 80 87 00 00 00 00 	movb   $0x0,0x87(%eax)
  c->gdt[SEG_UCODE] = SEG(STA_X|STA_R, 0, 0xffffffff, DPL_USER);
801078fd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107900:	66 c7 80 90 00 00 00 	movw   $0xffff,0x90(%eax)
80107907:	ff ff 
80107909:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010790c:	66 c7 80 92 00 00 00 	movw   $0x0,0x92(%eax)
80107913:	00 00 
80107915:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107918:	c6 80 94 00 00 00 00 	movb   $0x0,0x94(%eax)
8010791f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107922:	0f b6 90 95 00 00 00 	movzbl 0x95(%eax),%edx
80107929:	83 e2 f0             	and    $0xfffffff0,%edx
8010792c:	83 ca 0a             	or     $0xa,%edx
...
8010799e:	83 e2 df             	and    $0xffffffdf,%edx
...
801079d0:	c6 80 97 00 00 00 00 	movb   $0x0,0x97(%eax)
  c->gdt[SEG_UDATA] = SEG(STA_W, 0, 0xffffffff, DPL_USER);
801079d7:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079da:	66 c7 80 98 00 00 00 	movw   $0xffff,0x98(%eax)
801079e1:	ff ff 
801079e3:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079e6:	66 c7 80 9a 00 00 00 	movw   $0x0,0x9a(%eax)
801079ed:	00 00 
801079ef:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079f2:	c6 80 9c 00 00 00 00 	movb   $0x0,0x9c(%eax)
801079f9:	8b 45 f4             	mov    -0xc(%ebp),%eax
801079fc:	0f b6 90 9d 00 00 00 	movzbl 0x9d(%eax),%edx
80107a03:	83 e2 f0             	and    $0xfffffff0,%edx
80107a06:	83 ca 02             	or     $0x2,%edx
...
80107a78:	83 e2 df             	and    $0xffffffdf,%edx
...
80107aaa:	c6 80 9f 00 00 00 00 	movb   $0x0,0x9f(%eax)

  // Map cpu, and curproc
  c->gdt[SEG_KCPU] = SEG(STA_W, &c->cpu, 8, 0);
80107ab1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ab4:	05 b4 00 00 00       	add    $0xb4,%eax
80107ab9:	89 c3                	mov    %eax,%ebx
80107abb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107abe:	05 b4 00 00 00       	add    $0xb4,%eax
80107ac3:	c1 e8 10             	shr    $0x10,%eax
80107ac6:	89 c1                	mov    %eax,%ecx
80107ac8:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107acb:	05 b4 00 00 00       	add    $0xb4,%eax
80107ad0:	c1 e8 18             	shr    $0x18,%eax
80107ad3:	89 c2                	mov    %eax,%edx
80107ad5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ad8:	66 c7 80 88 00 00 00 	movw   $0x0,0x88(%eax)
80107adf:	00 00 
80107ae1:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107ae4:	66 89 98 8a 00 00 00 	mov    %bx,0x8a(%eax)
80107aeb:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107aee:	88 88 8c 00 00 00    	mov    %cl,0x8c(%eax)
80107af4:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107af7:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107afe:	83 e1 f0             	and    $0xfffffff0,%ecx
80107b01:	83 c9 02             	or     $0x2,%ecx
...
80107b27:	83 e1 9f             	and    $0xffffff9f,%ecx
80107b2a:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b30:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b33:	0f b6 88 8d 00 00 00 	movzbl 0x8d(%eax),%ecx
80107b3a:	83 c9 80             	or     $0xffffff80,%ecx
80107b3d:	88 88 8d 00 00 00    	mov    %cl,0x8d(%eax)
80107b43:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107b46:	0f b6 88 8e 00 00 00 	movzbl 0x8e(%eax),%ecx
80107b4d:	83 e1 f0             	and    $0xfffffff0,%ecx
...
80107b60:	83 e1 ef             	and    $0xffffffef,%ecx
...
80107b73:	83 e1 df             	and    $0xffffffdf,%ecx
...
80107ba5:	88 90 8f 00 00 00    	mov    %dl,0x8f(%eax)

  lgdt(c->gdt, sizeof(c->gdt));
80107bab:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bae:	83 c0 70             	add    $0x70,%eax
80107bb1:	c7 44 24 04 38 00 00 	movl   $0x38,0x4(%esp)
80107bb8:	00 
80107bb9:	89 04 24             	mov    %eax,(%esp)
80107bbc:	e8 37 fb ff ff       	call   801076f8 <lgdt>
  loadgs(SEG_KCPU << 3);
80107bc1:	c7 04 24 18 00 00 00 	movl   $0x18,(%esp)
80107bc8:	e8 6a fb ff ff       	call   80107737 <loadgs>
  
  // Initialize cpu-local storage.
  cpu = c;
80107bcd:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107bd0:	65 a3 00 00 00 00    	mov    %eax,%gs:0x0
  proc = 0;
80107bd6:	65 c7 05 04 00 00 00 	movl   $0x0,%gs:0x4
80107bdd:	00 00 00 00 
}
80107be1:	83 c4 24             	add    $0x24,%esp
80107be4:	5b                   	pop    %ebx
80107be5:	5d                   	pop    %ebp
80107be6:	c3                   	ret    
...
80107bf0:	c1 e8 16             	shr    $0x16,%eax
80107bf3:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107c0c:	74 17                	je     80107c25 <walkpgdir+0x3e>
    pgtab = (pte_t*)p2v(PTE_ADDR(*pde));
80107c0e:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107c11:	8b 00                	mov    (%eax),%eax
80107c13:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107c18:	89 04 24             	mov    %eax,(%esp)
80107c1b:	e8 44 fb ff ff       	call   80107764 <p2v>
80107c20:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c23:	eb 4b                	jmp    80107c70 <walkpgdir+0x89>
  } else {
    if(!alloc || (pgtab = (pte_t*)kalloc()) == 0)
80107c25:	83 7d 10 00          	cmpl   $0x0,0x10(%ebp)
80107c29:	74 0e                	je     80107c39 <walkpgdir+0x52>
80107c2b:	e8 b3 ae ff ff       	call   80102ae3 <kalloc>
80107c30:	89 45 f4             	mov    %eax,-0xc(%ebp)
80107c33:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80107c37:	75 07                	jne    80107c40 <walkpgdir+0x59>
      return 0;
80107c39:	b8 00 00 00 00       	mov    $0x0,%eax
80107c3e:	eb 47                	jmp    80107c87 <walkpgdir+0xa0>
...
80107c56:	e8 eb d4 ff ff       	call   80105146 <memset>
...
80107c61:	e8 f1 fa ff ff       	call   80107757 <v2p>
80107c66:	83 c8 07             	or     $0x7,%eax
...
80107c73:	c1 e8 0c             	shr    $0xc,%eax
80107c76:	25 ff 03 00 00       	and    $0x3ff,%eax
80107c7b:	8d 14 85 00 00 00 00 	lea    0x0(,%eax,4),%edx
...
80107c8c:	83 ec 28             	sub    $0x28,%esp
  char *a, *last;
  pte_t *pte;
  
  a = (char*)PGROUNDDOWN((uint)va);
80107c8f:	8b 45 0c             	mov    0xc(%ebp),%eax
...
80107ca2:	83 e8 01             	sub    $0x1,%eax
80107ca5:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80107caa:	89 45 f0             	mov    %eax,-0x10(%ebp)
  for(;;){
    if((pte = walkpgdir(pgdir, a, 1)) == 0)
80107cad:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
80107cb4:	00 
80107cb5:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107cb8:	89 44 24 04          	mov    %eax,0x4(%esp)
80107cbc:	8b 45 08             	mov    0x8(%ebp),%eax
80107cbf:	89 04 24             	mov    %eax,(%esp)
80107cc2:	e8 20 ff ff ff       	call   80107be7 <walkpgdir>
80107cc7:	89 45 ec             	mov    %eax,-0x14(%ebp)
80107cca:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
80107cce:	75 07                	jne    80107cd7 <mappages+0x4e>
      return -1;
80107cd0:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80107cd5:	eb 48                	jmp    80107d1f <mappages+0x96>
    if(*pte & PTE_P)
80107cd7:	8b 45 ec             	mov    -0x14(%ebp),%eax
80107cda:	8b 00                	mov    (%eax),%eax
80107cdc:	83 e0 01             	and    $0x1,%eax
80107cdf:	85 c0                	test   %eax,%eax
80107ce1:	74 0c                	je     80107cef <mappages+0x66>
      panic("remap");
80107ce3:	c7 04 24 40 8b 10 80 	movl   $0x80108b40,(%esp)
80107cea:	e8 4b 88 ff ff       	call   8010053a <panic>
    *pte = pa | perm | PTE_P;
...
80107d05:	75 08                	jne    80107d0f <mappages+0x86>
      break;
80107d07:	90                   	nop
    a += PGSIZE;
    pa += PGSIZE;
...
80107d0d:	eb 10                	jmp    80107d1f <mappages+0x96>
    if(*pte & PTE_P)
      panic("remap");
    *pte = pa | perm | PTE_P;
    if(a == last)
...
80107d0f:	81 45 f4 00 10 00 00 	addl   $0x1000,-0xc(%ebp)
    pa += PGSIZE;
80107d16:	81 45 14 00 10 00 00 	addl   $0x1000,0x14(%ebp)
  }
80107d1d:	eb 8e                	jmp    80107cad <mappages+0x24>
  return 0;
}
80107d1f:	c9                   	leave  
80107d20:	c3                   	ret    
...
80107d25:	83 ec 34             	sub    $0x34,%esp
  pde_t *pgdir;
  struct kmap *k;

  if((pgdir = (pde_t*)kalloc()) == 0)
80107d28:	e8 b6 ad ff ff       	call   80102ae3 <kalloc>
80107d2d:	89 45 f0             	mov    %eax,-0x10(%ebp)
80107d30:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80107d34:	75 0a                	jne    80107d40 <setupkvm+0x1f>
    return 0;
80107d36:	b8 00 00 00 00       	mov    $0x0,%eax
80107d3b:	e9 98 00 00 00       	jmp    80107dd8 <setupkvm+0xb7>
  memset(pgdir, 0, PGSIZE);
80107d40:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80107d47:	00 
80107d48:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80107d4f:	00 
80107d50:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107d53:	89 04 24             	mov    %eax,(%esp)
80107d56:	e8 eb d3 ff ff       	call   80105146 <memset>
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
80107d5b:	c7 04 24 00 00 00 0e 	movl   $0xe000000,(%esp)
80107d62:	e8 fd f9 ff ff       	call   80107764 <p2v>
80107d67:	3d 00 00 00 fe       	cmp    $0xfe000000,%eax
80107d6c:	76 0c                	jbe    80107d7a <setupkvm+0x59>
    panic("PHYSTOP too high");
80107d6e:	c7 04 24 46 8b 10 80 	movl   $0x80108b46,(%esp)
80107d75:	e8 c0 87 ff ff       	call   8010053a <panic>
  for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
80107d7a:	c7 45 f4 c0 b4 10 80 	movl   $0x8010b4c0,-0xc(%ebp)
80107d81:	eb 49                	jmp    80107dcc <setupkvm+0xab>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
80107d83:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d86:	8b 48 0c             	mov    0xc(%eax),%ecx
80107d89:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d8c:	8b 50 04             	mov    0x4(%eax),%edx
80107d8f:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d92:	8b 58 08             	mov    0x8(%eax),%ebx
80107d95:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107d98:	8b 40 04             	mov    0x4(%eax),%eax
80107d9b:	29 c3                	sub    %eax,%ebx
80107d9d:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107da0:	8b 00                	mov    (%eax),%eax
80107da2:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80107da6:	89 54 24 0c          	mov    %edx,0xc(%esp)
80107daa:	89 5c 24 08          	mov    %ebx,0x8(%esp)
80107dae:	89 44 24 04          	mov    %eax,0x4(%esp)
80107db2:	8b 45 f0             	mov    -0x10(%ebp),%eax
80107db5:	89 04 24             	mov    %eax,(%esp)
80107db8:	e8 cc fe ff ff       	call   80107c89 <mappages>
80107dbd:	85 c0                	test   %eax,%eax
80107dbf:	79 07                	jns    80107dc8 <setupkvm+0xa7>
                (uint)k->phys_start, k->perm) < 0)
      return 0;
80107dc1:	b8 00 00 00 00       	mov    $0x0,%eax
80107dc6:	eb 10                	jmp    80107dd8 <setupkvm+0xb7>
  if((pgdir = (pde_t*)kalloc()) == 0)
    return 0;
  memset(pgdir, 0, PGSIZE);
  if (p2v(PHYSTOP) > (void*)DEVSPACE)
...
80107dcc:	81 7d f4 00 b5 10 80 	cmpl   $0x8010b500,-0xc(%ebp)
80107dd3:	72 ae                	jb     80107d83 <setupkvm+0x62>
    if(mappages(pgdir, k->virt, k->phys_end - k->phys_start, 
                (uint)k->phys_start, k->perm) < 0)
      return 0;
  return pgdir;
...
80107dd8:	83 c4 34             	add    $0x34,%esp
80107ddb:	5b                   	pop    %ebx
80107ddc:	5d                   	pop    %ebp
80107ddd:	c3                   	ret    
...
80107de1:	83 ec 08             	sub    $0x8,%esp
  kpgdir = setupkvm();
80107de4:	e8 38 ff ff ff       	call   80107d21 <setupkvm>
80107de9:	a3 18 29 11 80       	mov    %eax,0x80112918
  switchkvm();
80107dee:	e8 02 00 00 00       	call   80107df5 <switchkvm>
}
80107df3:	c9                   	leave  
80107df4:	c3                   	ret    
...
80107dfb:	a1 18 29 11 80       	mov    0x80112918,%eax
80107e00:	89 04 24             	mov    %eax,(%esp)
80107e03:	e8 4f f9 ff ff       	call   80107757 <v2p>
80107e08:	89 04 24             	mov    %eax,(%esp)
80107e0b:	e8 3c f9 ff ff       	call   8010774c <lcr3>
}
80107e10:	c9                   	leave  
80107e11:	c3                   	ret    
...
80107e16:	83 ec 14             	sub    $0x14,%esp
  pushcli();
80107e19:	e8 25 d2 ff ff       	call   80105043 <pushcli>
  cpu->gdt[SEG_TSS] = SEG16(STS_T32A, &cpu->ts, sizeof(cpu->ts)-1, 0);
80107e1e:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107e24:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e2b:	83 c2 08             	add    $0x8,%edx
80107e2e:	89 d3                	mov    %edx,%ebx
80107e30:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e37:	83 c2 08             	add    $0x8,%edx
80107e3a:	c1 ea 10             	shr    $0x10,%edx
80107e3d:	89 d1                	mov    %edx,%ecx
80107e3f:	65 8b 15 00 00 00 00 	mov    %gs:0x0,%edx
80107e46:	83 c2 08             	add    $0x8,%edx
80107e49:	c1 ea 18             	shr    $0x18,%edx
80107e4c:	66 c7 80 a0 00 00 00 	movw   $0x67,0xa0(%eax)
80107e53:	67 00 
80107e55:	66 89 98 a2 00 00 00 	mov    %bx,0xa2(%eax)
80107e5c:	88 88 a4 00 00 00    	mov    %cl,0xa4(%eax)
80107e62:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e69:	83 e1 f0             	and    $0xfffffff0,%ecx
80107e6c:	83 c9 09             	or     $0x9,%ecx
80107e6f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e75:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e7c:	83 c9 10             	or     $0x10,%ecx
80107e7f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e85:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e8c:	83 e1 9f             	and    $0xffffff9f,%ecx
80107e8f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107e95:	0f b6 88 a5 00 00 00 	movzbl 0xa5(%eax),%ecx
80107e9c:	83 c9 80             	or     $0xffffff80,%ecx
80107e9f:	88 88 a5 00 00 00    	mov    %cl,0xa5(%eax)
80107ea5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107eac:	83 e1 f0             	and    $0xfffffff0,%ecx
80107eaf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107eb5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107ebc:	83 e1 ef             	and    $0xffffffef,%ecx
80107ebf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ec5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107ecc:	83 e1 df             	and    $0xffffffdf,%ecx
80107ecf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ed5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107edc:	83 c9 40             	or     $0x40,%ecx
80107edf:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ee5:	0f b6 88 a6 00 00 00 	movzbl 0xa6(%eax),%ecx
80107eec:	83 e1 7f             	and    $0x7f,%ecx
80107eef:	88 88 a6 00 00 00    	mov    %cl,0xa6(%eax)
80107ef5:	88 90 a7 00 00 00    	mov    %dl,0xa7(%eax)
  cpu->gdt[SEG_TSS].s = 0;
80107efb:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f01:	0f b6 90 a5 00 00 00 	movzbl 0xa5(%eax),%edx
...
80107f17:	66 c7 40 10 10 00    	movw   $0x10,0x10(%eax)
  cpu->ts.esp0 = (uint)proc->kstack + KSTACKSIZE;
80107f1d:	65 a1 00 00 00 00    	mov    %gs:0x0,%eax
80107f23:	65 8b 15 04 00 00 00 	mov    %gs:0x4,%edx
80107f2a:	8b 52 08             	mov    0x8(%edx),%edx
80107f2d:	81 c2 00 10 00 00    	add    $0x1000,%edx
80107f33:	89 50 0c             	mov    %edx,0xc(%eax)
  ltr(SEG_TSS << 3);
80107f36:	c7 04 24 30 00 00 00 	movl   $0x30,(%esp)
80107f3d:	e8 df f7 ff ff       	call   80107721 <ltr>
  if(p->pgdir == 0)
80107f42:	8b 45 08             	mov    0x8(%ebp),%eax
80107f45:	8b 40 04             	mov    0x4(%eax),%eax
80107f48:	85 c0                	test   %eax,%eax
80107f4a:	75 0c                	jne    80107f58 <switchuvm+0x146>
    panic("switchuvm: no pgdir");
80107f4c:	c7 04 24 57 8b 10 80 	movl   $0x80108b57,(%esp)
80107f53:	e8 e2 85 ff ff       	call   8010053a <panic>
  lcr3(v2p(p->pgdir));  // switch to new address space
80107f58:	8b 45 08             	mov    0x8(%ebp),%eax
80107f5b:	8b 40 04             	mov    0x4(%eax),%eax
80107f5e:	89 04 24             	mov    %eax,(%esp)
80107f61:	e8 f1 f7 ff ff       	call   80107757 <v2p>
80107f66:	89 04 24             	mov    %eax,(%esp)
80107f69:	e8 de f7 ff ff       	call   8010774c <lcr3>
  popcli();
80107f6e:	e8 14 d1 ff ff       	call   80105087 <popcli>
}
80107f73:	83 c4 14             	add    $0x14,%esp
80107f76:	5b                   	pop    %ebx
80107f77:	5d                   	pop    %ebp
80107f78:	c3                   	ret    
...
80107f88:	c7 04 24 6b 8b 10 80 	movl   $0x80108b6b,(%esp)
80107f8f:	e8 a6 85 ff ff       	call   8010053a <panic>
  mem = kalloc();
80107f94:	e8 4a ab ff ff       	call   80102ae3 <kalloc>
...
80107fb2:	e8 8f d1 ff ff       	call   80105146 <memset>
  mappages(pgdir, 0, PGSIZE, v2p(mem), PTE_W|PTE_U);
80107fb7:	8b 45 f4             	mov    -0xc(%ebp),%eax
80107fba:	89 04 24             	mov    %eax,(%esp)
80107fbd:	e8 95 f7 ff ff       	call   80107757 <v2p>
...
80107fe4:	e8 a0 fc ff ff       	call   80107c89 <mappages>
  memmove(mem, init, sz);
...
80107ffd:	e8 13 d2 ff ff       	call   80105215 <memmove>
}
80108002:	c9                   	leave  
80108003:	c3                   	ret    
...
8010806d:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(sz - i < PGSIZE)
80108070:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108073:	8b 55 18             	mov    0x18(%ebp),%edx
80108076:	29 c2                	sub    %eax,%edx
80108078:	89 d0                	mov    %edx,%eax
8010807a:	3d ff 0f 00 00       	cmp    $0xfff,%eax
8010807f:	77 0f                	ja     80108090 <loaduvm+0x8c>
      n = sz - i;
80108081:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108084:	8b 55 18             	mov    0x18(%ebp),%edx
80108087:	29 c2                	sub    %eax,%edx
80108089:	89 d0                	mov    %edx,%eax
8010808b:	89 45 f0             	mov    %eax,-0x10(%ebp)
8010808e:	eb 07                	jmp    80108097 <loaduvm+0x93>
    else
      n = PGSIZE;
80108090:	c7 45 f0 00 10 00 00 	movl   $0x1000,-0x10(%ebp)
    if(readi(ip, p2v(pa), offset+i, n) != n)
80108097:	8b 45 f4             	mov    -0xc(%ebp),%eax
8010809a:	8b 55 14             	mov    0x14(%ebp),%edx
8010809d:	8d 1c 02             	lea    (%edx,%eax,1),%ebx
801080a0:	8b 45 e8             	mov    -0x18(%ebp),%eax
801080a3:	89 04 24             	mov    %eax,(%esp)
801080a6:	e8 b9 f6 ff ff       	call   80107764 <p2v>
801080ab:	8b 55 f0             	mov    -0x10(%ebp),%edx
801080ae:	89 54 24 0c          	mov    %edx,0xc(%esp)
801080b2:	89 5c 24 08          	mov    %ebx,0x8(%esp)
801080b6:	89 44 24 04          	mov    %eax,0x4(%esp)
801080ba:	8b 45 10             	mov    0x10(%ebp),%eax
801080bd:	89 04 24             	mov    %eax,(%esp)
801080c0:	e8 9e 9c ff ff       	call   80101d63 <readi>
801080c5:	3b 45 f0             	cmp    -0x10(%ebp),%eax
801080c8:	74 07                	je     801080d1 <loaduvm+0xcd>
      return -1;
801080ca:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
801080cf:	eb 18                	jmp    801080e9 <loaduvm+0xe5>
  uint i, pa, n;
  pte_t *pte;
...
801080db:	3b 45 18             	cmp    0x18(%ebp),%eax
801080de:	0f 82 4b ff ff ff    	jb     8010802f <loaduvm+0x2b>
    else
      n = PGSIZE;
    if(readi(ip, p2v(pa), offset+i, n) != n)
      return -1;
...
801080e9:	83 c4 24             	add    $0x24,%esp
801080ec:	5b                   	pop    %ebx
801080ed:	5d                   	pop    %ebp
801080ee:	c3                   	ret    
...
801080f2:	83 ec 38             	sub    $0x38,%esp
  ...
  if(newsz >= KERNBASE)
801080f5:	8b 45 10             	mov    0x10(%ebp),%eax
801080f8:	85 c0                	test   %eax,%eax
801080fa:	79 0a                	jns    80108106 <allocuvm+0x17>
    return 0;
801080fc:	b8 00 00 00 00       	mov    $0x0,%eax
80108101:	e9 c1 00 00 00       	jmp    801081c7 <allocuvm+0xd8>
  if(newsz < oldsz)
80108106:	8b 45 10             	mov    0x10(%ebp),%eax
80108109:	3b 45 0c             	cmp    0xc(%ebp),%eax
8010810c:	73 08                	jae    80108116 <allocuvm+0x27>
    return oldsz;
8010810e:	8b 45 0c             	mov    0xc(%ebp),%eax
80108111:	e9 b1 00 00 00       	jmp    801081c7 <allocuvm+0xd8>

  a = PGROUNDUP(oldsz);
80108116:	8b 45 0c             	mov    0xc(%ebp),%eax
80108119:	05 ff 0f 00 00       	add    $0xfff,%eax
8010811e:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108123:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(; a < newsz; a += PGSIZE){
80108126:	e9 8d 00 00 00       	jmp    801081b8 <allocuvm+0xc9>
    mem = kalloc();
8010812b:	e8 b3 a9 ff ff       	call   80102ae3 <kalloc>
80108130:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(mem == 0){
80108133:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108137:	75 2c                	jne    80108165 <allocuvm+0x76>
      cprintf("allocuvm out of memory\n");
80108139:	c7 04 24 c9 8b 10 80 	movl   $0x80108bc9,(%esp)
80108140:	e8 5b 82 ff ff       	call   801003a0 <cprintf>
...
80108159:	e8 6b 00 00 00       	call   801081c9 <deallocuvm>
      return 0;
8010815e:	b8 00 00 00 00       	mov    $0x0,%eax
80108163:	eb 62                	jmp    801081c7 <allocuvm+0xd8>
    }
    memset(mem, 0, PGSIZE);
80108165:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
8010816c:	00 
8010816d:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
80108174:	00 
80108175:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108178:	89 04 24             	mov    %eax,(%esp)
8010817b:	e8 c6 cf ff ff       	call   80105146 <memset>
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
80108180:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108183:	89 04 24             	mov    %eax,(%esp)
80108186:	e8 cc f5 ff ff       	call   80107757 <v2p>
8010818b:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010818e:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80108195:	00 
80108196:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010819a:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
801081a1:	00 
801081a2:	89 54 24 04          	mov    %edx,0x4(%esp)
801081a6:	8b 45 08             	mov    0x8(%ebp),%eax
801081a9:	89 04 24             	mov    %eax,(%esp)
801081ac:	e8 d8 fa ff ff       	call   80107c89 <mappages>
    return 0;
  if(newsz < oldsz)
    return oldsz;
...
801081be:	0f 82 67 ff ff ff    	jb     8010812b <allocuvm+0x3c>
      return 0;
    }
    memset(mem, 0, PGSIZE);
    mappages(pgdir, (char*)a, PGSIZE, v2p(mem), PTE_W|PTE_U);
...
801081da:	e9 a4 00 00 00       	jmp    80108283 <deallocuvm+0xba>
...
801081ef:	e9 80 00 00 00       	jmp    80108274 <deallocuvm+0xab>
...
80108209:	e8 d9 f9 ff ff       	call   80107be7 <walkpgdir>
8010820e:	89 45 f0             	mov    %eax,-0x10(%ebp)
    if(!pte)
80108211:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108215:	75 09                	jne    80108220 <deallocuvm+0x57>
      a += (NPTENTRIES - 1) * PGSIZE;
80108217:	81 45 f4 00 f0 3f 00 	addl   $0x3ff000,-0xc(%ebp)
8010821e:	eb 4d                	jmp    8010826d <deallocuvm+0xa4>
    else if((*pte & PTE_P) != 0){
80108220:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108223:	8b 00                	mov    (%eax),%eax
80108225:	83 e0 01             	and    $0x1,%eax
80108228:	85 c0                	test   %eax,%eax
8010822a:	74 41                	je     8010826d <deallocuvm+0xa4>
      pa = PTE_ADDR(*pte);
8010822c:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010822f:	8b 00                	mov    (%eax),%eax
80108231:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80108236:	89 45 ec             	mov    %eax,-0x14(%ebp)
      if(pa == 0)
80108239:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
8010823d:	75 0c                	jne    8010824b <deallocuvm+0x82>
        panic("kfree");
8010823f:	c7 04 24 e1 8b 10 80 	movl   $0x80108be1,(%esp)
80108246:	e8 ef 82 ff ff       	call   8010053a <panic>
      char *v = p2v(pa);
8010824b:	8b 45 ec             	mov    -0x14(%ebp),%eax
8010824e:	89 04 24             	mov    %eax,(%esp)
80108251:	e8 0e f5 ff ff       	call   80107764 <p2v>
80108256:	89 45 e8             	mov    %eax,-0x18(%ebp)
      kfree(v);
80108259:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010825c:	89 04 24             	mov    %eax,(%esp)
8010825f:	e8 e6 a7 ff ff       	call   80102a4a <kfree>
      *pte = 0;
80108264:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108267:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
...
8010827a:	0f 82 74 ff ff ff    	jb     801081f4 <deallocuvm+0x2b>
      char *v = p2v(pa);
      kfree(v);
      *pte = 0;
    }
...
80108288:	83 ec 28             	sub    $0x28,%esp
  ...
  if(pgdir == 0)
8010828b:	83 7d 08 00          	cmpl   $0x0,0x8(%ebp)
8010828f:	75 0c                	jne    8010829d <freevm+0x18>
    panic("freevm: no pgdir");
80108291:	c7 04 24 e7 8b 10 80 	movl   $0x80108be7,(%esp)
80108298:	e8 9d 82 ff ff       	call   8010053a <panic>
  deallocuvm(pgdir, KERNBASE, 0);
8010829d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
801082a4:	00 
801082a5:	c7 44 24 04 00 00 00 	movl   $0x80000000,0x4(%esp)
801082ac:	80 
801082ad:	8b 45 08             	mov    0x8(%ebp),%eax
801082b0:	89 04 24             	mov    %eax,(%esp)
801082b3:	e8 11 ff ff ff       	call   801081c9 <deallocuvm>
  for(i = 0; i < NPDENTRIES; i++){
801082b8:	c7 45 f4 00 00 00 00 	movl   $0x0,-0xc(%ebp)
801082bf:	eb 48                	jmp    80108309 <freevm+0x84>
    if(pgdir[i] & PTE_P){
...
801082d7:	74 2c                	je     80108305 <freevm+0x80>
...
80108310:	76 af                	jbe    801082c1 <freevm+0x3c>
    if(pgdir[i] & PTE_P){
      char * v = p2v(PTE_ADDR(pgdir[i]));
      kfree(v);
    }
...
80108318:	e8 2d a7 ff ff       	call   80102a4a <kfree>
}
8010831d:	c9                   	leave  
8010831e:	c3                   	ret    
...
80108322:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
80108325:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
8010832c:	00 
...
8010833a:	e8 a8 f8 ff ff       	call   80107be7 <walkpgdir>
8010833f:	89 45 f4             	mov    %eax,-0xc(%ebp)
  if(pte == 0)
80108342:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
80108346:	75 0c                	jne    80108354 <clearpteu+0x35>
    panic("clearpteu");
80108348:	c7 04 24 f8 8b 10 80 	movl   $0x80108bf8,(%esp)
8010834f:	e8 e6 81 ff ff       	call   8010053a <panic>
  *pte &= ~PTE_U;
80108354:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108357:	8b 00                	mov    (%eax),%eax
80108359:	83 e0 fb             	and    $0xfffffffb,%eax
...
80108369:	83 ec 44             	sub    $0x44,%esp
  pde_t *d;
  pte_t *pte;
  uint pa, i, flags;
  char *mem;
  ...
  if((d = setupkvm()) == 0)
8010836c:	e8 b0 f9 ff ff       	call   80107d21 <setupkvm>
80108371:	89 45 f0             	mov    %eax,-0x10(%ebp)
80108374:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
80108378:	75 0a                	jne    80108384 <copyuvm+0x1f>
    return 0;
8010837a:	b8 00 00 00 00       	mov    $0x0,%eax
8010837f:	e9 fd 00 00 00       	jmp    80108481 <copyuvm+0x11c>
  for(i = PGSIZE; i < sz; i += PGSIZE){
80108384:	c7 45 f4 00 10 00 00 	movl   $0x1000,-0xc(%ebp)
8010838b:	e9 d0 00 00 00       	jmp    80108460 <copyuvm+0xfb>
...
801083a5:	e8 3d f8 ff ff       	call   80107be7 <walkpgdir>
801083aa:	89 45 ec             	mov    %eax,-0x14(%ebp)
801083ad:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
801083b1:	75 0c                	jne    801083bf <copyuvm+0x5a>
      panic("copyuvm: pte should exist");
801083b3:	c7 04 24 02 8c 10 80 	movl   $0x80108c02,(%esp)
801083ba:	e8 7b 81 ff ff       	call   8010053a <panic>
    if(!(*pte & PTE_P))
801083bf:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083c2:	8b 00                	mov    (%eax),%eax
801083c4:	83 e0 01             	and    $0x1,%eax
801083c7:	85 c0                	test   %eax,%eax
801083c9:	75 0c                	jne    801083d7 <copyuvm+0x72>
      panic("copyuvm: page not present");
801083cb:	c7 04 24 1c 8c 10 80 	movl   $0x80108c1c,(%esp)
801083d2:	e8 63 81 ff ff       	call   8010053a <panic>
    pa = PTE_ADDR(*pte);
801083d7:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083da:	8b 00                	mov    (%eax),%eax
801083dc:	25 00 f0 ff ff       	and    $0xfffff000,%eax
801083e1:	89 45 e8             	mov    %eax,-0x18(%ebp)
    flags = PTE_FLAGS(*pte);
801083e4:	8b 45 ec             	mov    -0x14(%ebp),%eax
801083e7:	8b 00                	mov    (%eax),%eax
801083e9:	25 ff 0f 00 00       	and    $0xfff,%eax
801083ee:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
801083f1:	e8 ed a6 ff ff       	call   80102ae3 <kalloc>
801083f6:	89 45 e0             	mov    %eax,-0x20(%ebp)
801083f9:	83 7d e0 00          	cmpl   $0x0,-0x20(%ebp)
801083fd:	75 02                	jne    80108401 <copyuvm+0x9c>
      goto bad;
801083ff:	eb 70                	jmp    80108471 <copyuvm+0x10c>
    memmove(mem, (char*)p2v(pa), PGSIZE);
80108401:	8b 45 e8             	mov    -0x18(%ebp),%eax
80108404:	89 04 24             	mov    %eax,(%esp)
80108407:	e8 58 f3 ff ff       	call   80107764 <p2v>
8010840c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108413:	00 
80108414:	89 44 24 04          	mov    %eax,0x4(%esp)
80108418:	8b 45 e0             	mov    -0x20(%ebp),%eax
8010841b:	89 04 24             	mov    %eax,(%esp)
8010841e:	e8 f2 cd ff ff       	call   80105215 <memmove>
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
80108423:	8b 5d e4             	mov    -0x1c(%ebp),%ebx
80108426:	8b 45 e0             	mov    -0x20(%ebp),%eax
80108429:	89 04 24             	mov    %eax,(%esp)
8010842c:	e8 26 f3 ff ff       	call   80107757 <v2p>
80108431:	8b 55 f4             	mov    -0xc(%ebp),%edx
80108434:	89 5c 24 10          	mov    %ebx,0x10(%esp)
80108438:	89 44 24 0c          	mov    %eax,0xc(%esp)
8010843c:	c7 44 24 08 00 10 00 	movl   $0x1000,0x8(%esp)
80108443:	00 
80108444:	89 54 24 04          	mov    %edx,0x4(%esp)
80108448:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010844b:	89 04 24             	mov    %eax,(%esp)
8010844e:	e8 36 f8 ff ff       	call   80107c89 <mappages>
80108453:	85 c0                	test   %eax,%eax
80108455:	79 02                	jns    80108459 <copyuvm+0xf4>
      goto bad;
80108457:	eb 18                	jmp    80108471 <copyuvm+0x10c>
  uint pa, i, flags;
  char *mem;
...
80108466:	0f 82 24 ff ff ff    	jb     80108390 <copyuvm+0x2b>
      goto bad;
    memmove(mem, (char*)p2v(pa), PGSIZE);
    if(mappages(d, (void*)i, PGSIZE, v2p(mem), flags) < 0)
      goto bad;
...
8010846f:	eb 10                	jmp    80108481 <copyuvm+0x11c>

bad:
  freevm(d);
80108471:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108474:	89 04 24             	mov    %eax,(%esp)
80108477:	e8 09 fe ff ff       	call   80108285 <freevm>
  return 0;
8010847c:	b8 00 00 00 00       	mov    $0x0,%eax
}
80108481:	83 c4 44             	add    $0x44,%esp
80108484:	5b                   	pop    %ebx
80108485:	5d                   	pop    %ebp
80108486:	c3                   	ret    
...
8010848a:	83 ec 28             	sub    $0x28,%esp
  pte_t *pte;

  pte = walkpgdir(pgdir, uva, 0);
8010848d:	c7 44 24 08 00 00 00 	movl   $0x0,0x8(%esp)
80108494:	00 
80108495:	8b 45 0c             	mov    0xc(%ebp),%eax
80108498:	89 44 24 04          	mov    %eax,0x4(%esp)
8010849c:	8b 45 08             	mov    0x8(%ebp),%eax
8010849f:	89 04 24             	mov    %eax,(%esp)
801084a2:	e8 40 f7 ff ff       	call   80107be7 <walkpgdir>
...
801084dd:	e8 82 f2 ff ff       	call   80107764 <p2v>
}
801084e2:	c9                   	leave  
801084e3:	c3                   	ret    
...
801084e7:	83 ec 28             	sub    $0x28,%esp
  char *buf, *pa0;
  uint n, va0;
...
801084ed:	89 45 f4             	mov    %eax,-0xc(%ebp)
  while(len > 0){
801084f0:	e9 87 00 00 00       	jmp    8010857c <copyout+0x98>
...
80108503:	89 44 24 04          	mov    %eax,0x4(%esp)
80108507:	8b 45 08             	mov    0x8(%ebp),%eax
8010850a:	89 04 24             	mov    %eax,(%esp)
8010850d:	e8 75 ff ff ff       	call   80108487 <uva2ka>
80108512:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(pa0 == 0)
80108515:	83 7d e8 00          	cmpl   $0x0,-0x18(%ebp)
80108519:	75 07                	jne    80108522 <copyout+0x3e>
      return -1;
8010851b:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80108520:	eb 69                	jmp    8010858b <copyout+0xa7>
    n = PGSIZE - (va - va0);
80108522:	8b 45 0c             	mov    0xc(%ebp),%eax
80108525:	8b 55 ec             	mov    -0x14(%ebp),%edx
80108528:	29 c2                	sub    %eax,%edx
8010852a:	89 d0                	mov    %edx,%eax
...
8010853a:	76 06                	jbe    80108542 <copyout+0x5e>
      n = len;
8010853c:	8b 45 14             	mov    0x14(%ebp),%eax
8010853f:	89 45 f0             	mov    %eax,-0x10(%ebp)
    memmove(pa0 + (va - va0), buf, n);
80108542:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108545:	8b 55 0c             	mov    0xc(%ebp),%edx
80108548:	29 c2                	sub    %eax,%edx
8010854a:	8b 45 e8             	mov    -0x18(%ebp),%eax
8010854d:	01 c2                	add    %eax,%edx
8010854f:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108552:	89 44 24 08          	mov    %eax,0x8(%esp)
80108556:	8b 45 f4             	mov    -0xc(%ebp),%eax
80108559:	89 44 24 04          	mov    %eax,0x4(%esp)
8010855d:	89 14 24             	mov    %edx,(%esp)
80108560:	e8 b0 cc ff ff       	call   80105215 <memmove>
    len -= n;
80108565:	8b 45 f0             	mov    -0x10(%ebp),%eax
80108568:	29 45 14             	sub    %eax,0x14(%ebp)
    buf += n;
8010856b:	8b 45 f0             	mov    -0x10(%ebp),%eax
8010856e:	01 45 f4             	add    %eax,-0xc(%ebp)
    va = va0 + PGSIZE;
80108571:	8b 45 ec             	mov    -0x14(%ebp),%eax
80108574:	05 00 10 00 00       	add    $0x1000,%eax
80108579:	89 45 0c             	mov    %eax,0xc(%ebp)
{
  char *buf, *pa0;
  uint n, va0;
  ...
  buf = (char*)p;
  while(len > 0){
8010857c:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
80108580:	0f 85 6f ff ff ff    	jne    801084f5 <copyout+0x11>
    memmove(pa0 + (va - va0), buf, n);
    len -= n;
    buf += n;
    va = va0 + PGSIZE;
