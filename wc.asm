...
00001000 <wc>:
    ...
    108f:	00 
    1090:	c7 44 24 04 a0 1c 00 	movl   $0x1ca0,0x4(%esp)
    1097:	00 
    ...
    10b6:	c7 44 24 04 ff 1b 00 	movl   $0x1bff,0x4(%esp)
    10bd:	00 
    ...
    10eb:	c7 44 24 04 0f 1c 00 	movl   $0x1c0f,0x4(%esp)
    10f2:	00 
...
00001101 <main>:
    ...
    1110:	c7 44 24 04 1c 1c 00 	movl   $0x1c1c,0x4(%esp)
    1117:	00 
    ...
    116a:	c7 44 24 04 1d 1c 00 	movl   $0x1c1d,0x4(%esp)
    1171:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    155a:	0f b6 80 64 1c 00 00 	movzbl 0x1c64(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    16b8:	75 27                	jne    16e1 <printf+0x120>
          s = "(null)";
    16ba:	c7 45 e4 31 1c 00 00 	movl   $0x1c31,-0x1c(%ebp)
        while(*s != 0){
...
00001778 <free>:
    ...
    1787:	a1 88 1c 00 00       	mov    0x1c88,%eax
    ...
    1848:	a3 88 1c 00 00       	mov    %eax,0x1c88
    184d:	c9                   	leave  
    184e:	c3                   	ret    
...
0000184f <morecore>:
    ...
    18a0:	a1 88 1c 00 00       	mov    0x1c88,%eax
    18a5:	c9                   	leave  
    18a6:	c3                   	ret    
...
000018a7 <malloc>:
    ...
    18bc:	a1 88 1c 00 00       	mov    0x1c88,%eax
    18c1:	89 45 f0             	mov    %eax,-0x10(%ebp)
    18c4:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    18c8:	75 23                	jne    18ed <malloc+0x46>
    18ca:	c7 45 f0 80 1c 00 00 	movl   $0x1c80,-0x10(%ebp)
    18d1:	8b 45 f0             	mov    -0x10(%ebp),%eax
    18d4:	a3 88 1c 00 00       	mov    %eax,0x1c88
    18d9:	a1 88 1c 00 00       	mov    0x1c88,%eax
    18de:	a3 80 1c 00 00       	mov    %eax,0x1c80
    18e3:	c7 05 84 1c 00 00 00 	movl   $0x0,0x1c84
    18ea:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1a2c:	c7 44 24 04 38 1c 00 	movl   $0x1c38,0x4(%esp)
    1a33:	00 
    ...
    1a71:	c7 44 24 04 46 1c 00 	movl   $0x1c46,0x4(%esp)
    1a78:	00 
    ...
    1a9d:	c7 44 24 04 53 1c 00 	movl   $0x1c53,0x4(%esp)
    1aa4:	00 
...
int random(int max){
    ...
    1abb:	a1 78 1c 00 00       	mov    0x1c78,%eax
    1ac0:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1ac6:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1acb:	a3 78 1c 00 00       	mov    %eax,0x1c78
    return (int)(rands % max);
    1ad0:	a1 78 1c 00 00       	mov    0x1c78,%eax
    1ad5:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1ad8:	ba 00 00 00 00       	mov    $0x0,%edx
    1add:	f7 f1                	div    %ecx
    1adf:	89 d0                	mov    %edx,%eax
}
    1ae1:	5d                   	pop    %ebp
    1ae2:	c3                   	ret    
    1ae3:	90                   	nop
...
void init_q(struct queue *q){
    ...
    1aea:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    1af0:	8b 45 08             	mov    0x8(%ebp),%eax
    1af3:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    1afa:	8b 45 08             	mov    0x8(%ebp),%eax
    1afd:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    1b04:	5d                   	pop    %ebp
    1b05:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    1b0c:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    1b13:	e8 8f fd ff ff       	call   18a7 <malloc>
    1b18:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    1b1b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1b1e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    ...
    1b35:	75 0b                	jne    1b42 <add_q+0x3c>
        q->head = n;
    1b37:	8b 45 08             	mov    0x8(%ebp),%eax
    1b3a:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1b3d:	89 50 04             	mov    %edx,0x4(%eax)
    1b40:	eb 0c                	jmp    1b4e <add_q+0x48>
    }else{
        q->tail->next = n;
    1b42:	8b 45 08             	mov    0x8(%ebp),%eax
    1b45:	8b 40 08             	mov    0x8(%eax),%eax
    1b48:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1b4b:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    1b4e:	8b 45 08             	mov    0x8(%ebp),%eax
    1b51:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1b54:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    1b57:	8b 45 08             	mov    0x8(%ebp),%eax
    1b5a:	8b 00                	mov    (%eax),%eax
    1b5c:	8d 50 01             	lea    0x1(%eax),%edx
    1b5f:	8b 45 08             	mov    0x8(%ebp),%eax
    1b62:	89 10                	mov    %edx,(%eax)
}
    1b64:	c9                   	leave  
    1b65:	c3                   	ret    
...
int pop_q(struct queue *q){
    ...
    1b83:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    1b86:	8b 45 08             	mov    0x8(%ebp),%eax
    1b89:	89 04 24             	mov    %eax,(%esp)
    1b8c:	e8 d5 ff ff ff       	call   1b66 <empty_q>
    1b91:	85 c0                	test   %eax,%eax
    1b93:	75 5d                	jne    1bf2 <pop_q+0x72>
       val = q->head->value; 
    1b95:	8b 45 08             	mov    0x8(%ebp),%eax
    1b98:	8b 40 04             	mov    0x4(%eax),%eax
    1b9b:	8b 00                	mov    (%eax),%eax
    1b9d:	89 45 f0             	mov    %eax,-0x10(%ebp)
       destroy = q->head;
    1ba0:	8b 45 08             	mov    0x8(%ebp),%eax
    1ba3:	8b 40 04             	mov    0x4(%eax),%eax
    1ba6:	89 45 f4             	mov    %eax,-0xc(%ebp)
       q->head = q->head->next;
    1ba9:	8b 45 08             	mov    0x8(%ebp),%eax
    1bac:	8b 40 04             	mov    0x4(%eax),%eax
    1baf:	8b 50 04             	mov    0x4(%eax),%edx
    1bb2:	8b 45 08             	mov    0x8(%ebp),%eax
    1bb5:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    1bb8:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1bbb:	89 04 24             	mov    %eax,(%esp)
    1bbe:	e8 b5 fb ff ff       	call   1778 <free>
       q->size--;
    1bc3:	8b 45 08             	mov    0x8(%ebp),%eax
    1bc6:	8b 00                	mov    (%eax),%eax
    1bc8:	8d 50 ff             	lea    -0x1(%eax),%edx
    1bcb:	8b 45 08             	mov    0x8(%ebp),%eax
    1bce:	89 10                	mov    %edx,(%eax)
       if(q->size == 0){
    1bd0:	8b 45 08             	mov    0x8(%ebp),%eax
    1bd3:	8b 00                	mov    (%eax),%eax
    1bd5:	85 c0                	test   %eax,%eax
    1bd7:	75 14                	jne    1bed <pop_q+0x6d>
            q->head = 0;
    1bd9:	8b 45 08             	mov    0x8(%ebp),%eax
    1bdc:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    1be3:	8b 45 08             	mov    0x8(%ebp),%eax
    1be6:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    1bed:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1bf0:	eb 05                	jmp    1bf7 <pop_q+0x77>
    }
    return -1;
    1bf2:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    1bf7:	c9                   	leave  
    1bf8:	c3                   	ret    
