...
grep(char *pattern, int fd)
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
    ...
    p = buf;
    1018:	c7 45 f0 40 1e 00 00 	movl   $0x1e40,-0x10(%ebp)
    while((q = strchr(p, '\n')) != 0){
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
    ...
    if(p == buf)
    1090:	81 7d f0 40 1e 00 00 	cmpl   $0x1e40,-0x10(%ebp)
    ...
    10a4:	7e 2b                	jle    10d1 <grep+0xd1>
      m -= p - buf;
    10a6:	ba 40 1e 00 00       	mov    $0x1e40,%edx
    ...
    10c5:	c7 04 24 40 1e 00 00 	movl   $0x1e40,(%esp)
    10cc:	e8 9d 04 00 00       	call   156e <memmove>
{
  ...
  while((n = read(fd, buf+m, sizeof(buf)-m)) > 0){
    ...
    10e2:	81 c2 40 1e 00 00    	add    $0x1e40,%edx
...
main(int argc, char *argv[])
{
  ...
  if(argc <= 1){
    ...
    1119:	c7 44 24 04 88 1d 00 	movl   $0x1d88,0x4(%esp)
    1120:	00 
  ...
  for(i = 2; i < argc; i++){
    ...
    119e:	c7 44 24 04 a8 1d 00 	movl   $0x1da8,0x4(%esp)
    11a5:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    16e6:	0f b6 80 f4 1d 00 00 	movzbl 0x1df4(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1844:	75 27                	jne    186d <printf+0x120>
          s = "(null)";
    1846:	c7 45 e4 be 1d 00 00 	movl   $0x1dbe,-0x1c(%ebp)
        while(*s != 0){
...
00001904 <free>:
    ...
    1913:	a1 28 1e 00 00       	mov    0x1e28,%eax
    ...
    19d4:	a3 28 1e 00 00       	mov    %eax,0x1e28
    19d9:	c9                   	leave  
    19da:	c3                   	ret    
...
000019db <morecore>:
    ...
    1a2c:	a1 28 1e 00 00       	mov    0x1e28,%eax
    1a31:	c9                   	leave  
    1a32:	c3                   	ret    
...
00001a33 <malloc>:
    ...
    1a48:	a1 28 1e 00 00       	mov    0x1e28,%eax
    1a4d:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1a50:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1a54:	75 23                	jne    1a79 <malloc+0x46>
    1a56:	c7 45 f0 20 1e 00 00 	movl   $0x1e20,-0x10(%ebp)
    1a5d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1a60:	a3 28 1e 00 00       	mov    %eax,0x1e28
    1a65:	a1 28 1e 00 00       	mov    0x1e28,%eax
    1a6a:	a3 20 1e 00 00       	mov    %eax,0x1e20
    1a6f:	c7 05 24 1e 00 00 00 	movl   $0x0,0x1e24
    1a76:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1bb8:	c7 44 24 04 c5 1d 00 	movl   $0x1dc5,0x4(%esp)
    1bbf:	00 
    ...
    1bfd:	c7 44 24 04 d3 1d 00 	movl   $0x1dd3,0x4(%esp)
    1c04:	00 
    ...
    1c29:	c7 44 24 04 e0 1d 00 	movl   $0x1de0,0x4(%esp)
    1c30:	00 
...
int random(int max){
    ...
    1c47:	a1 08 1e 00 00       	mov    0x1e08,%eax
    1c4c:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1c52:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1c57:	a3 08 1e 00 00       	mov    %eax,0x1e08
    return (int)(rands % max);
    1c5c:	a1 08 1e 00 00       	mov    0x1e08,%eax
    1c61:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1c64:	ba 00 00 00 00       	mov    $0x0,%edx
    1c69:	f7 f1                	div    %ecx
    1c6b:	89 d0                	mov    %edx,%eax
}
    1c6d:	5d                   	pop    %ebp
    1c6e:	c3                   	ret    
    1c6f:	90                   	nop
...
void init_q(struct queue *q){
    ...
    1c76:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    1c7c:	8b 45 08             	mov    0x8(%ebp),%eax
    1c7f:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    1c86:	8b 45 08             	mov    0x8(%ebp),%eax
    1c89:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    1c90:	5d                   	pop    %ebp
    1c91:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    1c95:	83 ec 28             	sub    $0x28,%esp
    struct node * n = malloc(sizeof(struct node));
    1c98:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    1c9f:	e8 8f fd ff ff       	call   1a33 <malloc>
    1ca4:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    1ca7:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1caa:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    1cb1:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1cb4:	8b 55 0c             	mov    0xc(%ebp),%edx
    1cb7:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    1cb9:	8b 45 08             	mov    0x8(%ebp),%eax
    1cbc:	8b 40 04             	mov    0x4(%eax),%eax
    1cbf:	85 c0                	test   %eax,%eax
    1cc1:	75 0b                	jne    1cce <add_q+0x3c>
        q->head = n;
    1cc3:	8b 45 08             	mov    0x8(%ebp),%eax
    1cc6:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1cc9:	89 50 04             	mov    %edx,0x4(%eax)
    1ccc:	eb 0c                	jmp    1cda <add_q+0x48>
    }else{
        q->tail->next = n;
    1cce:	8b 45 08             	mov    0x8(%ebp),%eax
    1cd1:	8b 40 08             	mov    0x8(%eax),%eax
    1cd4:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1cd7:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    1cda:	8b 45 08             	mov    0x8(%ebp),%eax
    1cdd:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1ce0:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    1ce3:	8b 45 08             	mov    0x8(%ebp),%eax
    1ce6:	8b 00                	mov    (%eax),%eax
    1ce8:	8d 50 01             	lea    0x1(%eax),%edx
    1ceb:	8b 45 08             	mov    0x8(%ebp),%eax
    1cee:	89 10                	mov    %edx,(%eax)
}
    1cf0:	c9                   	leave  
    1cf1:	c3                   	ret    
...
int empty_q(struct queue *q){
    1cf2:	55                   	push   %ebp
    1cf3:	89 e5                	mov    %esp,%ebp
    if(q->size == 0)
    1cf5:	8b 45 08             	mov    0x8(%ebp),%eax
    1cf8:	8b 00                	mov    (%eax),%eax
    1cfa:	85 c0                	test   %eax,%eax
    1cfc:	75 07                	jne    1d05 <empty_q+0x13>
        return 1;
    1cfe:	b8 01 00 00 00       	mov    $0x1,%eax
    1d03:	eb 05                	jmp    1d0a <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    ...
    1d0f:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    1d12:	8b 45 08             	mov    0x8(%ebp),%eax
    1d15:	89 04 24             	mov    %eax,(%esp)
    1d18:	e8 d5 ff ff ff       	call   1cf2 <empty_q>
    1d1d:	85 c0                	test   %eax,%eax
    1d1f:	75 5d                	jne    1d7e <pop_q+0x72>
       val = q->head->value; 
    1d21:	8b 45 08             	mov    0x8(%ebp),%eax
    1d24:	8b 40 04             	mov    0x4(%eax),%eax
    1d27:	8b 00                	mov    (%eax),%eax
    1d29:	89 45 f0             	mov    %eax,-0x10(%ebp)
       destroy = q->head;
    1d2c:	8b 45 08             	mov    0x8(%ebp),%eax
    1d2f:	8b 40 04             	mov    0x4(%eax),%eax
    1d32:	89 45 f4             	mov    %eax,-0xc(%ebp)
       q->head = q->head->next;
    1d35:	8b 45 08             	mov    0x8(%ebp),%eax
    1d38:	8b 40 04             	mov    0x4(%eax),%eax
    1d3b:	8b 50 04             	mov    0x4(%eax),%edx
    1d3e:	8b 45 08             	mov    0x8(%ebp),%eax
    1d41:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    1d44:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1d47:	89 04 24             	mov    %eax,(%esp)
    1d4a:	e8 b5 fb ff ff       	call   1904 <free>
       q->size--;
    1d4f:	8b 45 08             	mov    0x8(%ebp),%eax
    1d52:	8b 00                	mov    (%eax),%eax
    1d54:	8d 50 ff             	lea    -0x1(%eax),%edx
