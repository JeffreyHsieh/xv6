...
runcmd(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    101b:	8b 04 85 5c 27 00 00 	mov    0x275c(,%eax,4),%eax
    1022:	ff e0                	jmp    *%eax
  default:
    panic("runcmd");
    1024:	c7 04 24 30 27 00 00 	movl   $0x2730,(%esp)
  ...
  case EXEC:
    ...
    1067:	c7 44 24 04 37 27 00 	movl   $0x2737,0x4(%esp)
    106e:	00 
  ...
  case REDIR:
    ...
    10ba:	c7 44 24 04 47 27 00 	movl   $0x2747,0x4(%esp)
    10c1:	00 
  ...
  case PIPE:
    ...
    112e:	79 0c                	jns    113c <runcmd+0x13c>
      panic("pipe");
    1130:	c7 04 24 57 27 00 00 	movl   $0x2757,(%esp)
...
getcmd(char *buf, int nbuf)
{
  ...
  printf(2, "$ ");
    120e:	c7 44 24 04 74 27 00 	movl   $0x2774,0x4(%esp)
    1215:	00 
    ...
    1285:	e9 ae 00 00 00       	jmp    1338 <main+0xd2>
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
    ...
    1291:	00 
    1292:	c7 04 24 77 27 00 00 	movl   $0x2777,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    12ae:	0f b6 05 80 28 00 00 	movzbl 0x2880,%eax
    12b5:	3c 63                	cmp    $0x63,%al
    12b7:	75 5a                	jne    1313 <main+0xad>
    12b9:	0f b6 05 81 28 00 00 	movzbl 0x2881,%eax
    12c0:	3c 64                	cmp    $0x64,%al
    12c2:	75 4f                	jne    1313 <main+0xad>
    12c4:	0f b6 05 82 28 00 00 	movzbl 0x2882,%eax
    12cb:	3c 20                	cmp    $0x20,%al
    12cd:	75 44                	jne    1313 <main+0xad>
      // Clumsy but will have to do for now.
      // Chdir has no effect on the parent if run in the child.
      buf[strlen(buf)-1] = 0;  // chop \n
    12cf:	c7 04 24 80 28 00 00 	movl   $0x2880,(%esp)
    12d6:	e8 b6 0a 00 00       	call   1d91 <strlen>
    12db:	83 e8 01             	sub    $0x1,%eax
    12de:	c6 80 80 28 00 00 00 	movb   $0x0,0x2880(%eax)
      if(chdir(buf+3) < 0)
    12e5:	c7 04 24 83 28 00 00 	movl   $0x2883,(%esp)
    12ec:	e8 db 0c 00 00       	call   1fcc <chdir>
    12f1:	85 c0                	test   %eax,%eax
    12f3:	79 42                	jns    1337 <main+0xd1>
        printf(2, "cannot cd %s\n", buf+3);
    12f5:	c7 44 24 08 83 28 00 	movl   $0x2883,0x8(%esp)
    12fc:	00 
    12fd:	c7 44 24 04 7f 27 00 	movl   $0x277f,0x4(%esp)
    1304:	00 
    ...
    131a:	75 14                	jne    1330 <main+0xca>
      runcmd(parsecmd(buf));
    131c:	c7 04 24 80 28 00 00 	movl   $0x2880,(%esp)
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    133f:	00 
    1340:	c7 04 24 80 28 00 00 	movl   $0x2880,(%esp)
...
panic(char *s)
{
  ...
  printf(2, "%s\n", s);
    ...
    1366:	c7 44 24 04 8d 27 00 	movl   $0x278d,0x4(%esp)
    136d:	00 
...
fork1(void)
{
  ...
  if(pid == -1)
    ...
    panic("fork");
    1393:	c7 04 24 91 27 00 00 	movl   $0x2791,(%esp)
    ...
    1544:	83 45 f0 01          	addl   $0x1,-0x10(%ebp)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    155d:	c7 04 24 54 28 00 00 	movl   $0x2854,(%esp)
  ...
  default:
    ...
    1600:	c7 04 24 54 28 00 00 	movl   $0x2854,(%esp)
    ...
    161d:	c7 04 24 5a 28 00 00 	movl   $0x285a,(%esp)
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    165c:	c7 04 24 54 28 00 00 	movl   $0x2854,(%esp)
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
    ...
    16a2:	c7 04 24 54 28 00 00 	movl   $0x2854,(%esp)
...
parsecmd(char *s)
{
  ...
  peek(&s, es, "");
    171e:	c7 44 24 08 96 27 00 	movl   $0x2796,0x8(%esp)
    1725:	00 
  ...
  if(s != es){
    ...
    1747:	c7 44 24 04 97 27 00 	movl   $0x2797,0x4(%esp)
    174e:	00 
    174f:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
    1756:	e8 9a 09 00 00       	call   20f5 <printf>
    panic("syntax");
    175b:	c7 04 24 a6 27 00 00 	movl   $0x27a6,(%esp)
...
parseline(char **ps, char *es)
{
  ...
  cmd = parsepipe(ps, es);
  while(peek(ps, es, "&")){
    17c8:	c7 44 24 08 ad 27 00 	movl   $0x27ad,0x8(%esp)
    17cf:	00 
  ...
  if(peek(ps, es, ";")){
    17e6:	c7 44 24 08 af 27 00 	movl   $0x27af,0x8(%esp)
    17ed:	00 
...
parsepipe(char **ps, char *es)
{
  ...
  if(peek(ps, es, "|")){
    186a:	c7 44 24 08 b1 27 00 	movl   $0x27b1,0x8(%esp)
    1871:	00 
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    ...
    1928:	c7 04 24 b3 27 00 00 	movl   $0x27b3,(%esp)
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
    19d3:	c7 44 24 08 d0 27 00 	movl   $0x27d0,0x8(%esp)
    19da:	00 
...
parseblock(char **ps, char *es)
{
  ...
  if(!peek(ps, es, "("))
    1a00:	c7 44 24 08 d3 27 00 	movl   $0x27d3,0x8(%esp)
    1a07:	00 
    ...
    panic("parseblock");
    1a1e:	c7 04 24 d5 27 00 00 	movl   $0x27d5,(%esp)
  ...
  if(!peek(ps, es, ")"))
    1a61:	c7 44 24 08 e0 27 00 	movl   $0x27e0,0x8(%esp)
    1a68:	00 
    ...
    1a7f:	c7 04 24 e2 27 00 00 	movl   $0x27e2,(%esp)
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
    1ad4:	c7 44 24 08 d3 27 00 	movl   $0x27d3,0x8(%esp)
    1adb:	00 
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    1b70:	74 0c                	je     1b7e <parseexec+0xb0>
      panic("syntax");
    1b72:	c7 04 24 a6 27 00 00 	movl   $0x27a6,(%esp)
    ...
    1ba3:	7e 0c                	jle    1bb1 <parseexec+0xe3>
      panic("too many args");
    1ba5:	c7 04 24 f5 27 00 00 	movl   $0x27f5,(%esp)
  ...
  ret = parseredirs(ret, ps, es);
  while(!peek(ps, es, "|)&;")){
    1bcd:	c7 44 24 08 03 28 00 	movl   $0x2803,0x8(%esp)
    1bd4:	00 
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
    ...
    1c3a:	8b 04 85 08 28 00 00 	mov    0x2808(,%eax,4),%eax
    1c41:	ff e0                	jmp    *%eax
  case EXEC:
    ecmd = (struct execcmd*)cmd;
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    208e:	0f b6 80 64 28 00 00 	movzbl 0x2864(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    21ec:	75 27                	jne    2215 <printf+0x120>
          s = "(null)";
    21ee:	c7 45 e4 20 28 00 00 	movl   $0x2820,-0x1c(%ebp)
        while(*s != 0){
...
000022ac <free>:
    ...
    22bb:	a1 ec 28 00 00       	mov    0x28ec,%eax
    ...
    237c:	a3 ec 28 00 00       	mov    %eax,0x28ec
    2381:	c9                   	leave  
    2382:	c3                   	ret    
...
00002383 <morecore>:
    ...
    23d4:	a1 ec 28 00 00       	mov    0x28ec,%eax
    23d9:	c9                   	leave  
    23da:	c3                   	ret    
...
000023db <malloc>:
    ...
    23f0:	a1 ec 28 00 00       	mov    0x28ec,%eax
    23f5:	89 45 f0             	mov    %eax,-0x10(%ebp)
    23f8:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    23fc:	75 23                	jne    2421 <malloc+0x46>
    23fe:	c7 45 f0 e4 28 00 00 	movl   $0x28e4,-0x10(%ebp)
    2405:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2408:	a3 ec 28 00 00       	mov    %eax,0x28ec
    240d:	a1 ec 28 00 00       	mov    0x28ec,%eax
    2412:	a3 e4 28 00 00       	mov    %eax,0x28e4
    2417:	c7 05 e8 28 00 00 00 	movl   $0x0,0x28e8
    241e:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    2560:	c7 44 24 04 27 28 00 	movl   $0x2827,0x4(%esp)
    2567:	00 
    ...
    25a5:	c7 44 24 04 35 28 00 	movl   $0x2835,0x4(%esp)
    25ac:	00 
    ...
    25d1:	c7 44 24 04 42 28 00 	movl   $0x2842,0x4(%esp)
    25d8:	00 
...
int random(int max){
    ...
    25ef:	a1 78 28 00 00       	mov    0x2878,%eax
    25f4:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    25fa:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    25ff:	a3 78 28 00 00       	mov    %eax,0x2878
    return (int)(rands % max);
    2604:	a1 78 28 00 00       	mov    0x2878,%eax
    2609:	8b 4d 08             	mov    0x8(%ebp),%ecx
    260c:	ba 00 00 00 00       	mov    $0x0,%edx
    2611:	f7 f1                	div    %ecx
...
void init_q(struct queue *q){
    2618:	55                   	push   %ebp
    2619:	89 e5                	mov    %esp,%ebp
    q->size = 0;
    261b:	8b 45 08             	mov    0x8(%ebp),%eax
    261e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    2624:	8b 45 08             	mov    0x8(%ebp),%eax
    2627:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    262e:	8b 45 08             	mov    0x8(%ebp),%eax
    2631:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    2638:	5d                   	pop    %ebp
    2639:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    263a:	55                   	push   %ebp
    263b:	89 e5                	mov    %esp,%ebp
    263d:	83 ec 28             	sub    $0x28,%esp
    struct node * n = malloc(sizeof(struct node));
    2640:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    2647:	e8 8f fd ff ff       	call   23db <malloc>
    264c:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    264f:	8b 45 f4             	mov    -0xc(%ebp),%eax
    2652:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    2659:	8b 45 f4             	mov    -0xc(%ebp),%eax
    265c:	8b 55 0c             	mov    0xc(%ebp),%edx
    265f:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    2661:	8b 45 08             	mov    0x8(%ebp),%eax
    2664:	8b 40 04             	mov    0x4(%eax),%eax
    2667:	85 c0                	test   %eax,%eax
    2669:	75 0b                	jne    2676 <add_q+0x3c>
        q->head = n;
    266b:	8b 45 08             	mov    0x8(%ebp),%eax
    266e:	8b 55 f4             	mov    -0xc(%ebp),%edx
    2671:	89 50 04             	mov    %edx,0x4(%eax)
    2674:	eb 0c                	jmp    2682 <add_q+0x48>
    }else{
        q->tail->next = n;
    2676:	8b 45 08             	mov    0x8(%ebp),%eax
    2679:	8b 40 08             	mov    0x8(%eax),%eax
    267c:	8b 55 f4             	mov    -0xc(%ebp),%edx
    267f:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    2682:	8b 45 08             	mov    0x8(%ebp),%eax
    2685:	8b 55 f4             	mov    -0xc(%ebp),%edx
    2688:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    268b:	8b 45 08             	mov    0x8(%ebp),%eax
    268e:	8b 00                	mov    (%eax),%eax
    2690:	8d 50 01             	lea    0x1(%eax),%edx
    2693:	8b 45 08             	mov    0x8(%ebp),%eax
    2696:	89 10                	mov    %edx,(%eax)
}
    2698:	c9                   	leave  
    2699:	c3                   	ret    
...
int empty_q(struct queue *q){
    269a:	55                   	push   %ebp
    269b:	89 e5                	mov    %esp,%ebp
    if(q->size == 0)
    269d:	8b 45 08             	mov    0x8(%ebp),%eax
    26a0:	8b 00                	mov    (%eax),%eax
    26a2:	85 c0                	test   %eax,%eax
    26a4:	75 07                	jne    26ad <empty_q+0x13>
        return 1;
    26a6:	b8 01 00 00 00       	mov    $0x1,%eax
    26ab:	eb 05                	jmp    26b2 <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    26b4:	55                   	push   %ebp
    26b5:	89 e5                	mov    %esp,%ebp
    26b7:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    26ba:	8b 45 08             	mov    0x8(%ebp),%eax
    26bd:	89 04 24             	mov    %eax,(%esp)
    26c0:	e8 d5 ff ff ff       	call   269a <empty_q>
    26c5:	85 c0                	test   %eax,%eax
    26c7:	75 5d                	jne    2726 <pop_q+0x72>
       val = q->head->value; 
    26c9:	8b 45 08             	mov    0x8(%ebp),%eax
    26cc:	8b 40 04             	mov    0x4(%eax),%eax
    26cf:	8b 00                	mov    (%eax),%eax
    26d1:	89 45 f0             	mov    %eax,-0x10(%ebp)
       destroy = q->head;
    26d4:	8b 45 08             	mov    0x8(%ebp),%eax
    26d7:	8b 40 04             	mov    0x4(%eax),%eax
    26da:	89 45 f4             	mov    %eax,-0xc(%ebp)
       q->head = q->head->next;
    26dd:	8b 45 08             	mov    0x8(%ebp),%eax
    26e0:	8b 40 04             	mov    0x4(%eax),%eax
    26e3:	8b 50 04             	mov    0x4(%eax),%edx
    26e6:	8b 45 08             	mov    0x8(%ebp),%eax
    26e9:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    26ec:	8b 45 f4             	mov    -0xc(%ebp),%eax
    26ef:	89 04 24             	mov    %eax,(%esp)
    26f2:	e8 b5 fb ff ff       	call   22ac <free>
       q->size--;
    26f7:	8b 45 08             	mov    0x8(%ebp),%eax
    26fa:	8b 00                	mov    (%eax),%eax
    26fc:	8d 50 ff             	lea    -0x1(%eax),%edx
    ...
    270b:	75 14                	jne    2721 <pop_q+0x6d>
            q->head = 0;
    270d:	8b 45 08             	mov    0x8(%ebp),%eax
    2710:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    2717:	8b 45 08             	mov    0x8(%ebp),%eax
    271a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    2721:	8b 45 f0             	mov    -0x10(%ebp),%eax
    2724:	eb 05                	jmp    272b <pop_q+0x77>
    }
    return -1;
    2726:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    272b:	c9                   	leave  
    272c:	c3                   	ret    
