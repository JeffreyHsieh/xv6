...
main(int argc, char *argv[])
{
  ...
  if(argc != 3){
    ...
    100f:	c7 44 24 04 b1 1a 00 	movl   $0x1ab1,0x4(%esp)
    1016:	00 
  ...
  if(link(argv[1], argv[2]) < 0)
    ...
    1060:	c7 44 24 04 c4 1a 00 	movl   $0x1ac4,0x4(%esp)
    1067:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1412:	0f b6 80 0c 1b 00 00 	movzbl 0x1b0c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1570:	75 27                	jne    1599 <printf+0x120>
          s = "(null)";
    1572:	c7 45 e4 d8 1a 00 00 	movl   $0x1ad8,-0x1c(%ebp)
        while(*s != 0){
...
00001630 <free>:
    ...
    163f:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    ...
    1700:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
    1705:	c9                   	leave  
    1706:	c3                   	ret    
...
00001707 <morecore>:
    ...
    1758:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    175d:	c9                   	leave  
    175e:	c3                   	ret    
...
0000175f <malloc>:
    ...
    1774:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    1779:	89 45 f0             	mov    %eax,-0x10(%ebp)
    177c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1780:	75 23                	jne    17a5 <malloc+0x46>
    1782:	c7 45 f0 24 1b 00 00 	movl   $0x1b24,-0x10(%ebp)
    1789:	8b 45 f0             	mov    -0x10(%ebp),%eax
    178c:	a3 2c 1b 00 00       	mov    %eax,0x1b2c
    1791:	a1 2c 1b 00 00       	mov    0x1b2c,%eax
    1796:	a3 24 1b 00 00       	mov    %eax,0x1b24
    179b:	c7 05 28 1b 00 00 00 	movl   $0x0,0x1b28
    17a2:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    18e4:	c7 44 24 04 df 1a 00 	movl   $0x1adf,0x4(%esp)
    18eb:	00 
    ...
    1929:	c7 44 24 04 ed 1a 00 	movl   $0x1aed,0x4(%esp)
    1930:	00 
...
int random(int max){
    ...
    1973:	a1 20 1b 00 00       	mov    0x1b20,%eax
    1978:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    197e:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1983:	a3 20 1b 00 00       	mov    %eax,0x1b20
    return (int)(rands % max);
    1988:	a1 20 1b 00 00       	mov    0x1b20,%eax
...
void add_q(struct queue *q, int v){
    ...
    19cb:	e8 8f fd ff ff       	call   175f <malloc>
...
int pop_q(struct queue *q){
    ...
    1a76:	e8 b5 fb ff ff       	call   1630 <free>
       q->size--;
