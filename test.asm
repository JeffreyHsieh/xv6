...
int main(int argc, char *argv[]){
   ...
   if(tid <= 0){
    ...
    1061:	c7 44 24 04 4d 1b 00 	movl   $0x1b4d,0x4(%esp)
    1068:	00 
   ...
   while(wait()>= 0)
   printf(1,"\nback to parent n = %d\n",n);
    107a:	a1 bc 1b 00 00       	mov    0x1bbc,%eax
    107f:	89 44 24 08          	mov    %eax,0x8(%esp)
    1083:	c7 44 24 04 5a 1b 00 	movl   $0x1b5a,0x4(%esp)
    108a:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1476:	0f b6 80 c0 1b 00 00 	movzbl 0x1bc0(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    15d4:	75 27                	jne    15fd <printf+0x120>
          s = "(null)";
    15d6:	c7 45 e4 88 1b 00 00 	movl   $0x1b88,-0x1c(%ebp)
        while(*s != 0){
...
00001694 <free>:
    ...
    16a3:	a1 e0 1b 00 00       	mov    0x1be0,%eax
    ...
    1764:	a3 e0 1b 00 00       	mov    %eax,0x1be0
    1769:	c9                   	leave  
    176a:	c3                   	ret    
...
0000176b <morecore>:
    ...
    17bc:	a1 e0 1b 00 00       	mov    0x1be0,%eax
    17c1:	c9                   	leave  
    17c2:	c3                   	ret    
...
000017c3 <malloc>:
    ...
    17d8:	a1 e0 1b 00 00       	mov    0x1be0,%eax
    17dd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    17e0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    17e4:	75 23                	jne    1809 <malloc+0x46>
    17e6:	c7 45 f0 d8 1b 00 00 	movl   $0x1bd8,-0x10(%ebp)
    17ed:	8b 45 f0             	mov    -0x10(%ebp),%eax
    17f0:	a3 e0 1b 00 00       	mov    %eax,0x1be0
    17f5:	a1 e0 1b 00 00       	mov    0x1be0,%eax
    17fa:	a3 d8 1b 00 00       	mov    %eax,0x1bd8
    17ff:	c7 05 dc 1b 00 00 00 	movl   $0x0,0x1bdc
    1806:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1948:	c7 44 24 04 8f 1b 00 	movl   $0x1b8f,0x4(%esp)
    194f:	00 
    ...
    198d:	c7 44 24 04 9d 1b 00 	movl   $0x1b9d,0x4(%esp)
    1994:	00 
    ...
    19b9:	c7 44 24 04 aa 1b 00 	movl   $0x1baa,0x4(%esp)
    19c0:	00 
...
int random(int max){
    ...
    19d7:	a1 d4 1b 00 00       	mov    0x1bd4,%eax
    19dc:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    19e2:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    19e7:	a3 d4 1b 00 00       	mov    %eax,0x1bd4
    return (int)(rands % max);
    19ec:	a1 d4 1b 00 00       	mov    0x1bd4,%eax
...
void add_q(struct queue *q, int v){
    ...
    1a2f:	e8 8f fd ff ff       	call   17c3 <malloc>
...
int pop_q(struct queue *q){
    ...
    1ada:	e8 b5 fb ff ff       	call   1694 <free>
       q->size--;
