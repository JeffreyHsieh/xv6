...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13ba:	0f b6 80 8c 1a 00 00 	movzbl 0x1a8c(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1518:	75 27                	jne    1541 <printf+0x120>
          s = "(null)";
    151a:	c7 45 e4 59 1a 00 00 	movl   $0x1a59,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    15e7:	a1 ac 1a 00 00       	mov    0x1aac,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16a8:	a3 ac 1a 00 00       	mov    %eax,0x1aac
}
    16ad:	c9                   	leave  
    16ae:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1700:	a1 ac 1a 00 00       	mov    0x1aac,%eax
}
    1705:	c9                   	leave  
    1706:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    171c:	a1 ac 1a 00 00       	mov    0x1aac,%eax
    1721:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1724:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1728:	75 23                	jne    174d <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    172a:	c7 45 f0 a4 1a 00 00 	movl   $0x1aa4,-0x10(%ebp)
    1731:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1734:	a3 ac 1a 00 00       	mov    %eax,0x1aac
    1739:	a1 ac 1a 00 00       	mov    0x1aac,%eax
    173e:	a3 a4 1a 00 00       	mov    %eax,0x1aa4
    base.s.size = 0;
    1743:	c7 05 a8 1a 00 00 00 	movl   $0x0,0x1aa8
    174a:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17a0:	a3 ac 1a 00 00       	mov    %eax,0x1aac
      return (void*)(p + 1);
    ...
    if(p == freep)
    17ad:	a1 ac 1a 00 00       	mov    0x1aac,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    188c:	c7 44 24 04 60 1a 00 	movl   $0x1a60,0x4(%esp)
    1893:	00 
    ...
    18d1:	c7 44 24 04 6e 1a 00 	movl   $0x1a6e,0x4(%esp)
    18d8:	00 
    ...
    18fd:	c7 44 24 04 7b 1a 00 	movl   $0x1a7b,0x4(%esp)
    1904:	00 
...
int random(int max){
    ...
    191b:	a1 a0 1a 00 00       	mov    0x1aa0,%eax
    1920:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1926:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    192b:	a3 a0 1a 00 00       	mov    %eax,0x1aa0
    return (int)(rands % max);
    1930:	a1 a0 1a 00 00       	mov    0x1aa0,%eax
    1935:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1938:	ba 00 00 00 00       	mov    $0x0,%edx
    193d:	f7 f1                	div    %ecx
    193f:	89 d0                	mov    %edx,%eax
}
    1941:	5d                   	pop    %ebp
    1942:	c3                   	ret    
    1943:	90                   	nop
...
void init_q(struct queue *q){
    ...
    1953:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    195a:	8b 45 08             	mov    0x8(%ebp),%eax
    195d:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    1964:	5d                   	pop    %ebp
    1965:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    1966:	55                   	push   %ebp
    1967:	89 e5                	mov    %esp,%ebp
    1969:	83 ec 28             	sub    $0x28,%esp
    struct node * n = malloc(sizeof(struct node));
    196c:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    1973:	e8 8f fd ff ff       	call   1707 <malloc>
    1978:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    197b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    197e:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    1985:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1988:	8b 55 0c             	mov    0xc(%ebp),%edx
    198b:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    198d:	8b 45 08             	mov    0x8(%ebp),%eax
    1990:	8b 40 04             	mov    0x4(%eax),%eax
    1993:	85 c0                	test   %eax,%eax
    1995:	75 0b                	jne    19a2 <add_q+0x3c>
        q->head = n;
    1997:	8b 45 08             	mov    0x8(%ebp),%eax
    199a:	8b 55 f4             	mov    -0xc(%ebp),%edx
    199d:	89 50 04             	mov    %edx,0x4(%eax)
    19a0:	eb 0c                	jmp    19ae <add_q+0x48>
    }else{
        q->tail->next = n;
    19a2:	8b 45 08             	mov    0x8(%ebp),%eax
    19a5:	8b 40 08             	mov    0x8(%eax),%eax
    19a8:	8b 55 f4             	mov    -0xc(%ebp),%edx
    19ab:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    19ae:	8b 45 08             	mov    0x8(%ebp),%eax
    19b1:	8b 55 f4             	mov    -0xc(%ebp),%edx
    19b4:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    19b7:	8b 45 08             	mov    0x8(%ebp),%eax
    19ba:	8b 00                	mov    (%eax),%eax
    19bc:	8d 50 01             	lea    0x1(%eax),%edx
    19bf:	8b 45 08             	mov    0x8(%ebp),%eax
    19c2:	89 10                	mov    %edx,(%eax)
}
    19c4:	c9                   	leave  
    19c5:	c3                   	ret    
...
int empty_q(struct queue *q){
    ...
    19d0:	75 07                	jne    19d9 <empty_q+0x13>
        return 1;
    19d2:	b8 01 00 00 00       	mov    $0x1,%eax
    19d7:	eb 05                	jmp    19de <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    ...
    19ec:	e8 d5 ff ff ff       	call   19c6 <empty_q>
    19f1:	85 c0                	test   %eax,%eax
    19f3:	75 5d                	jne    1a52 <pop_q+0x72>
       val = q->head->value; 
    ...
    1a37:	75 14                	jne    1a4d <pop_q+0x6d>
            q->head = 0;
    1a39:	8b 45 08             	mov    0x8(%ebp),%eax
    1a3c:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    1a43:	8b 45 08             	mov    0x8(%ebp),%eax
    1a46:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    1a4d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1a50:	eb 05                	jmp    1a57 <pop_q+0x77>
    }
    return -1;
