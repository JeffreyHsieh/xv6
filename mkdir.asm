...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    105a:	c7 44 24 04 d0 1a 00 	movl   $0x1ad0,0x4(%esp)
    1061:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    141a:	0f b6 80 20 1b 00 00 	movzbl 0x1b20(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1578:	75 27                	jne    15a1 <printf+0x120>
          s = "(null)";
    157a:	c7 45 e4 ec 1a 00 00 	movl   $0x1aec,-0x1c(%ebp)
        while(*s != 0){
...
00001638 <free>:
    ...
    1647:	a1 40 1b 00 00       	mov    0x1b40,%eax
    ...
    1708:	a3 40 1b 00 00       	mov    %eax,0x1b40
    170d:	c9                   	leave  
    170e:	c3                   	ret    
...
0000170f <morecore>:
    ...
    1760:	a1 40 1b 00 00       	mov    0x1b40,%eax
    1765:	c9                   	leave  
    1766:	c3                   	ret    
...
00001767 <malloc>:
    ...
    177c:	a1 40 1b 00 00       	mov    0x1b40,%eax
    1781:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1784:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1788:	75 23                	jne    17ad <malloc+0x46>
    178a:	c7 45 f0 38 1b 00 00 	movl   $0x1b38,-0x10(%ebp)
    1791:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1794:	a3 40 1b 00 00       	mov    %eax,0x1b40
    1799:	a1 40 1b 00 00       	mov    0x1b40,%eax
    179e:	a3 38 1b 00 00       	mov    %eax,0x1b38
    17a3:	c7 05 3c 1b 00 00 00 	movl   $0x0,0x1b3c
    17aa:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    18ec:	c7 44 24 04 f3 1a 00 	movl   $0x1af3,0x4(%esp)
    18f3:	00 
    ...
    1931:	c7 44 24 04 01 1b 00 	movl   $0x1b01,0x4(%esp)
    1938:	00 
    ...
    195d:	c7 44 24 04 0e 1b 00 	movl   $0x1b0e,0x4(%esp)
    1964:	00 
...
int random(int max){
    ...
    197b:	a1 34 1b 00 00       	mov    0x1b34,%eax
    1980:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1986:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    198b:	a3 34 1b 00 00       	mov    %eax,0x1b34
    return (int)(rands % max);
    1990:	a1 34 1b 00 00       	mov    0x1b34,%eax
