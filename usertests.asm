...
opentest(void)
{
  ...
  printf(stdout, "open test\n");
    1006:	a1 04 6b 00 00       	mov    0x6b04,%eax
    100b:	c7 44 24 04 0e 54 00 	movl   $0x540e,0x4(%esp)
    1012:	00 
    1013:	89 04 24             	mov    %eax,(%esp)
    1016:	e8 a2 3d 00 00       	call   4dbd <printf>
  fd = open("echo", 0);
  ...
  if(fd < 0){
    ...
    1038:	a1 04 6b 00 00       	mov    0x6b04,%eax
    103d:	c7 44 24 04 19 54 00 	movl   $0x5419,0x4(%esp)
    1044:	00 
    1045:	89 04 24             	mov    %eax,(%esp)
    1048:	e8 70 3d 00 00       	call   4dbd <printf>
    exit();
...
writetest(void)
{
  ...
  printf(stdout, "small file test\n");
    10b1:	a1 04 6b 00 00       	mov    0x6b04,%eax
    10b6:	c7 44 24 04 65 54 00 	movl   $0x5465,0x4(%esp)
    10bd:	00 
    10be:	89 04 24             	mov    %eax,(%esp)
    10c1:	e8 f7 3c 00 00       	call   4dbd <printf>
  ...
  if(fd >= 0){
    ...
    10e3:	a1 04 6b 00 00       	mov    0x6b04,%eax
    10e8:	c7 44 24 04 7c 54 00 	movl   $0x547c,0x4(%esp)
    10ef:	00 
    10f0:	89 04 24             	mov    %eax,(%esp)
    10f3:	e8 c5 3c 00 00       	call   4dbd <printf>
  } else {
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: creat small failed!\n");
    1104:	a1 04 6b 00 00       	mov    0x6b04,%eax
    1109:	c7 44 24 04 97 54 00 	movl   $0x5497,0x4(%esp)
    1110:	00 
    1111:	89 04 24             	mov    %eax,(%esp)
    1114:	e8 a4 3c 00 00       	call   4dbd <printf>
    exit();
  ...
  for(i = 0; i < 100; i++){
    ...
    113e:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    1155:	e8 63 3c 00 00       	call   4dbd <printf>
      exit();
    ...
    117f:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    1196:	e8 22 3c 00 00       	call   4dbd <printf>
      exit();
  ...
  printf(stdout, "writes ok\n");
    11ae:	a1 04 6b 00 00       	mov    0x6b04,%eax
    11b3:	c7 44 24 04 14 55 00 	movl   $0x5514,0x4(%esp)
    11ba:	00 
    11bb:	89 04 24             	mov    %eax,(%esp)
    11be:	e8 fa 3b 00 00       	call   4dbd <printf>
  close(fd);
  ...
  if(fd >= 0){
    ...
    11eb:	a1 04 6b 00 00       	mov    0x6b04,%eax
    11f0:	c7 44 24 04 1f 55 00 	movl   $0x551f,0x4(%esp)
    11f7:	00 
    11f8:	89 04 24             	mov    %eax,(%esp)
    11fb:	e8 bd 3b 00 00       	call   4dbd <printf>
  } else {
  ...
  i = read(fd, buf, 2000);
    ...
    1207:	00 
    1208:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    120f:	00 
  ...
  if(fd >= 0){
    ...
    printf(stdout, "error: open small failed!\n");
    1229:	a1 04 6b 00 00       	mov    0x6b04,%eax
    122e:	c7 44 24 04 38 55 00 	movl   $0x5538,0x4(%esp)
    1235:	00 
    1236:	89 04 24             	mov    %eax,(%esp)
    1239:	e8 7f 3b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(i == 2000){
    ...
    1243:	a1 04 6b 00 00       	mov    0x6b04,%eax
    1248:	c7 44 24 04 53 55 00 	movl   $0x5553,0x4(%esp)
    124f:	00 
    1250:	89 04 24             	mov    %eax,(%esp)
    1253:	e8 65 3b 00 00       	call   4dbd <printf>
  } else {
  ...
  if(i == 2000){
    ...
    printf(stdout, "read failed\n");
    1275:	a1 04 6b 00 00       	mov    0x6b04,%eax
    127a:	c7 44 24 04 66 55 00 	movl   $0x5566,0x4(%esp)
    1281:	00 
    1282:	89 04 24             	mov    %eax,(%esp)
    1285:	e8 33 3b 00 00       	call   4dbd <printf>
    exit();
...
writetest1(void)
{
  ...
  printf(stdout, "big files test\n");
    12c6:	a1 04 6b 00 00       	mov    0x6b04,%eax
    12cb:	c7 44 24 04 9c 55 00 	movl   $0x559c,0x4(%esp)
    12d2:	00 
    12d3:	89 04 24             	mov    %eax,(%esp)
    12d6:	e8 e2 3a 00 00       	call   4dbd <printf>
  ...
  if(fd < 0){
    ...
    12f8:	a1 04 6b 00 00       	mov    0x6b04,%eax
    12fd:	c7 44 24 04 b0 55 00 	movl   $0x55b0,0x4(%esp)
    1304:	00 
    1305:	89 04 24             	mov    %eax,(%esp)
    1308:	e8 b0 3a 00 00       	call   4dbd <printf>
    exit();
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    1347:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    135e:	e8 5a 3a 00 00       	call   4dbd <printf>
      exit();
  ...
  if(fd < 0){
    ...
    139e:	a1 04 6b 00 00       	mov    0x6b04,%eax
    13a3:	c7 44 24 04 e8 55 00 	movl   $0x55e8,0x4(%esp)
    13aa:	00 
    13ab:	89 04 24             	mov    %eax,(%esp)
    13ae:	e8 0a 3a 00 00       	call   4dbd <printf>
    exit();
  ...
  for(;;){
    ...
    13c6:	00 
    13c7:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    13ce:	00 
    ...
    13f0:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    1407:	e8 b1 39 00 00       	call   4dbd <printf>
        exit();
    ...
    141a:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    144e:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    1469:	e8 4f 39 00 00       	call   4dbd <printf>
             n, ((int*)buf)[0]);
      exit();
...
createtest(void)
{
  ...
  printf(stdout, "many creates, followed by unlink test\n");
    14cf:	a1 04 6b 00 00       	mov    0x6b04,%eax
    14d4:	c7 44 24 04 74 56 00 	movl   $0x5674,0x4(%esp)
    14db:	00 
    14dc:	89 04 24             	mov    %eax,(%esp)
    14df:	e8 d9 38 00 00       	call   4dbd <printf>

  name[0] = 'a';
    14e4:	c6 05 00 b3 00 00 61 	movb   $0x61,0xb300
  name[2] = '\0';
    14eb:	c6 05 02 b3 00 00 00 	movb   $0x0,0xb302
  for(i = 0; i < 52; i++){
    ...
    1501:	a2 01 b3 00 00       	mov    %al,0xb301
    fd = open(name, O_CREATE|O_RDWR);
    1506:	c7 44 24 04 02 02 00 	movl   $0x202,0x4(%esp)
    150d:	00 
    150e:	c7 04 24 00 b3 00 00 	movl   $0xb300,(%esp)
  ...
  name[0] = 'a';
    1532:	c6 05 00 b3 00 00 61 	movb   $0x61,0xb300
  name[2] = '\0';
    1539:	c6 05 02 b3 00 00 00 	movb   $0x0,0xb302
  for(i = 0; i < 52; i++){
    ...
    154f:	a2 01 b3 00 00       	mov    %al,0xb301
    unlink(name);
    1554:	c7 04 24 00 b3 00 00 	movl   $0xb300,(%esp)
  ...
  printf(stdout, "many creates, followed by unlink; ok\n");
    156a:	a1 04 6b 00 00       	mov    0x6b04,%eax
    156f:	c7 44 24 04 9c 56 00 	movl   $0x569c,0x4(%esp)
    1576:	00 
    1577:	89 04 24             	mov    %eax,(%esp)
    157a:	e8 3e 38 00 00       	call   4dbd <printf>
}
    157f:	c9                   	leave  
    1580:	c3                   	ret    
...
void dirtest(void)
{
  ...
  printf(stdout, "mkdir test\n");
    1587:	a1 04 6b 00 00       	mov    0x6b04,%eax
    158c:	c7 44 24 04 c2 56 00 	movl   $0x56c2,0x4(%esp)
    1593:	00 
    1594:	89 04 24             	mov    %eax,(%esp)
    1597:	e8 21 38 00 00       	call   4dbd <printf>
  ...
  if(mkdir("dir0") < 0){
    ...
    15ac:	a1 04 6b 00 00       	mov    0x6b04,%eax
    15b1:	c7 44 24 04 d3 56 00 	movl   $0x56d3,0x4(%esp)
    15b8:	00 
    15b9:	89 04 24             	mov    %eax,(%esp)
    15bc:	e8 fc 37 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("dir0") < 0){
    ...
    15d6:	a1 04 6b 00 00       	mov    0x6b04,%eax
    15db:	c7 44 24 04 e1 56 00 	movl   $0x56e1,0x4(%esp)
    15e2:	00 
    15e3:	89 04 24             	mov    %eax,(%esp)
    15e6:	e8 d2 37 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("..") < 0){
    ...
    1600:	a1 04 6b 00 00       	mov    0x6b04,%eax
    1605:	c7 44 24 04 f7 56 00 	movl   $0x56f7,0x4(%esp)
    160c:	00 
    160d:	89 04 24             	mov    %eax,(%esp)
    1610:	e8 a8 37 00 00       	call   4dbd <printf>
    exit();
...
exectest(void)
{
  ...
  printf(stdout, "exec test\n");
    1661:	a1 04 6b 00 00       	mov    0x6b04,%eax
    1666:	c7 44 24 04 1c 57 00 	movl   $0x571c,0x4(%esp)
    166d:	00 
    166e:	89 04 24             	mov    %eax,(%esp)
    1671:	e8 47 37 00 00       	call   4dbd <printf>
  if(exec("echo", echoargv) < 0){
    1676:	c7 44 24 04 f0 6a 00 	movl   $0x6af0,0x4(%esp)
    167d:	00 
    ...
    168e:	a1 04 6b 00 00       	mov    0x6b04,%eax
    1693:	c7 44 24 04 27 57 00 	movl   $0x5727,0x4(%esp)
    169a:	00 
    169b:	89 04 24             	mov    %eax,(%esp)
    169e:	e8 1a 37 00 00       	call   4dbd <printf>
    exit();
...
pipe1(void)
{
  ...
  if(pipe(fds) != 0){
    ...
    16ce:	e8 ea 36 00 00       	call   4dbd <printf>
    exit();
  ...
  if(pid == 0){
    ...
    1714:	88 90 00 93 00 00    	mov    %dl,0x9300(%eax)
  ...
  if(pid == 0){
    ...
    1735:	00 
    1736:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    173d:	00 
    ...
    175c:	e8 5c 36 00 00       	call   4dbd <printf>
        exit();
  ...
  if(pid == 0){
    ...
    17a6:	0f b6 80 00 93 00 00 	movzbl 0x9300(%eax),%eax
    ...
    17d4:	e8 e4 35 00 00       	call   4dbd <printf>
          return;
    ...
    180e:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    1815:	00 
    ...
    184a:	e8 6e 35 00 00       	call   4dbd <printf>
      exit();
  ...
  printf(1, "pipe1 ok\n");
    ...
    1873:	e8 45 35 00 00       	call   4dbd <printf>
    ...
    1889:	e8 2f 35 00 00       	call   4dbd <printf>
    exit();
...
preempt(void)
{
  ...
  printf(1, "preempt: ");
    ...
    18aa:	e8 0e 35 00 00       	call   4dbd <printf>
  pid1 = fork();
  ...
  if(pid3 == 0){
    ...
    1922:	e8 96 34 00 00       	call   4dbd <printf>
    close(pfds[1]);
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    1949:	00 
    194a:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    1951:	00 
    ...
    196e:	e8 4a 34 00 00       	call   4dbd <printf>
    return;
  ...
  printf(1, "kill... ");
    ...
    198f:	e8 29 34 00 00       	call   4dbd <printf>
  kill(pid1);
  ...
  printf(1, "wait... ");
    ...
    19c4:	e8 f4 33 00 00       	call   4dbd <printf>
  wait();
  ...
  printf(1, "preempt ok\n");
    ...
    19e7:	e8 d1 33 00 00       	call   4dbd <printf>
}
    19ec:	c9                   	leave  
    19ed:	c3                   	ret    
...
exitwait(void)
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1a1a:	e8 9e 33 00 00       	call   4dbd <printf>
      return;
    ...
    1a40:	e8 78 33 00 00       	call   4dbd <printf>
        return;
...
exitwait(void)
{
  ...
  printf(1, "exitwait ok\n");
    ...
    1a65:	e8 53 33 00 00       	call   4dbd <printf>
}
    1a6a:	c9                   	leave  
    1a6b:	c3                   	ret    
...
mem(void)
{
  ...
  printf(1, "mem test\n");
    ...
    1a81:	e8 37 33 00 00       	call   4dbd <printf>
  ppid = getpid();
  ...
  if((pid = fork()) == 0){
    ...
    1b11:	e8 a7 32 00 00       	call   4dbd <printf>
      kill(ppid);
    ...
    1b40:	e8 78 32 00 00       	call   4dbd <printf>
    exit();
...
sharedfd(void)
{
  ...
  printf(1, "sharedfd test\n");
    ...
    1b66:	e8 52 32 00 00       	call   4dbd <printf>
  ...
  if(fd < 0){
    ...
    1ba3:	e8 15 32 00 00       	call   4dbd <printf>
    return;
  ...
  for(i = 0; i < 1000; i++){
    ...
    1c15:	e8 a3 31 00 00       	call   4dbd <printf>
      break;
  ...
  if(fd < 0){
    ...
    1c70:	e8 48 31 00 00       	call   4dbd <printf>
    return;
  ...
  if(nc == 10000 && np == 10000){
    ...
    1d19:	e8 9f 30 00 00       	call   4dbd <printf>
        np++;
    }
  }
  close(fd);
  ...
  if(nc == 10000 && np == 10000){
    ...
    1d3e:	e8 7a 30 00 00       	call   4dbd <printf>
    exit();
...
twofiles(void)
{
  ...
  printf(1, "twofiles test\n");
    ...
    1d5f:	e8 59 30 00 00       	call   4dbd <printf>
  ...
  if(pid < 0){
    ...
    1d99:	e8 1f 30 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    1de3:	e8 d5 2f 00 00       	call   4dbd <printf>
    exit();
  ...
  memset(buf, pid?'p':'c', 512);
    ...
    1e0b:	c7 04 24 00 93 00 00 	movl   $0x9300,(%esp)
  ...
  for(i = 0; i < 12; i++){
    ...
    1e27:	00 
    1e28:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    1e2f:	00 
    ...
    1e5d:	e8 5b 2f 00 00       	call   4dbd <printf>
      exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1ed2:	0f b6 80 00 93 00 00 	movzbl 0x9300(%eax),%eax
    ...
    1f01:	e8 b7 2e 00 00       	call   4dbd <printf>
          exit();
  ...
  for(i = 0; i < 2; i++){
    ...
    1f24:	00 
    1f25:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    1f2c:	00 
    ...
    1f6b:	e8 4d 2e 00 00       	call   4dbd <printf>
      exit();
  ...
  printf(1, "twofiles ok\n");
    ...
    1faa:	e8 0e 2e 00 00       	call   4dbd <printf>
}
    1faf:	c9                   	leave  
    1fb0:	c3                   	ret    
...
createdelete(void)
{
  ...
  printf(1, "createdelete test\n");
    ...
    1fc6:	e8 f2 2d 00 00       	call   4dbd <printf>
  pid = fork();
  ...
  if(pid < 0){
    ...
    1fe8:	e8 d0 2d 00 00       	call   4dbd <printf>
    exit();
  ...
  for(i = 0; i < N; i++){
    ...
    204b:	e8 6d 2d 00 00       	call   4dbd <printf>
      exit();
    ...
    20a1:	e8 17 2d 00 00       	call   4dbd <printf>
        exit();
  ...
  for(i = 0; i < N; i++){
    ...
    2120:	e8 98 2c 00 00       	call   4dbd <printf>
      exit();
    ...
    2152:	e8 66 2c 00 00       	call   4dbd <printf>
      exit();
    ...
    21b8:	e8 00 2c 00 00       	call   4dbd <printf>
      exit();
    ...
    21ea:	e8 ce 2b 00 00       	call   4dbd <printf>
      exit();
  ...
  printf(1, "createdelete ok\n");
    ...
    225c:	e8 5c 2b 00 00       	call   4dbd <printf>
}
    2261:	c9                   	leave  
    2262:	c3                   	ret    
...
unlinkread(void)
{
  ...
  printf(1, "unlinkread test\n");
    ...
    2278:	e8 40 2b 00 00       	call   4dbd <printf>
  ...
  if(fd < 0){
    ...
    22a9:	e8 0f 2b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2305:	e8 b3 2a 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("unlinkread") != 0){
    ...
    232e:	e8 8a 2a 00 00       	call   4dbd <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    237c:	00 
    237d:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    2384:	00 
    ...
    23a4:	e8 14 2a 00 00       	call   4dbd <printf>
    exit();
    23a9:	e8 6e 28 00 00       	call   4c1c <exit>
  }
  if(buf[0] != 'h'){
    23ae:	0f b6 05 00 93 00 00 	movzbl 0x9300,%eax
    ...
    23c8:	e8 f0 29 00 00       	call   4dbd <printf>
    exit();
  ...
  if(write(fd, buf, 10) != 10){
    ...
    23d9:	00 
    23da:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    23e1:	00 
    ...
    2401:	e8 b7 29 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "unlinkread ok\n");
    ...
    2431:	e8 87 29 00 00       	call   4dbd <printf>
}
    2436:	c9                   	leave  
    2437:	c3                   	ret    
...
linktest(void)
{
  ...
  printf(1, "linktest\n");
    ...
    244d:	e8 6b 29 00 00       	call   4dbd <printf>
  ...
  if(fd < 0){
    ...
    2496:	e8 22 29 00 00       	call   4dbd <printf>
    exit();
  ...
  if(write(fd, "hello", 5) != 5){
    ...
    24cf:	e8 e9 28 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link("lf1", "lf2") < 0){
    ...
    250b:	e8 ad 28 00 00       	call   4dbd <printf>
    exit();
  ...
  if(open("lf1", 0) >= 0){
    ...
    2548:	e8 70 28 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    257e:	e8 3a 28 00 00       	call   4dbd <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 5){
    ...
    258f:	00 
    2590:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    2597:	00 
    ...
    25b7:	e8 01 28 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link("lf2", "lf2") >= 0){
    ...
    25f3:	e8 c5 27 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link("lf2", "lf1") >= 0){
    ...
    2630:	e8 88 27 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link(".", "lf1") >= 0){
    ...
    2661:	e8 57 27 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "linktest ok\n");
    ...
    267a:	e8 3e 27 00 00       	call   4dbd <printf>
}
    267f:	c9                   	leave  
    2680:	c3                   	ret    
...
concreate(void)
{
  ...
  printf(1, "concreate test\n");
    ...
    2696:	e8 22 27 00 00       	call   4dbd <printf>
  file[0] = 'C';
  ...
  for(i = 0; i < 40; i++){
    ...
    277d:	e8 3b 26 00 00       	call   4dbd <printf>
        exit();
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    2843:	e8 75 25 00 00       	call   4dbd <printf>
        exit();
    ...
    2872:	e8 46 25 00 00       	call   4dbd <printf>
        exit();
  ...
  if(n != 40){
    ...
    28cd:	e8 eb 24 00 00       	call   4dbd <printf>
    exit();
  ...
  for(i = 0; i < 40; i++){
    ...
    2909:	e8 af 24 00 00       	call   4dbd <printf>
      exit();
  ...
  printf(1, "concreate ok\n");
    ...
    2a29:	e8 8f 23 00 00       	call   4dbd <printf>
}
    2a2e:	c9                   	leave  
    2a2f:	c3                   	ret    
...
linkunlink()
{
  ...
  printf(1, "linkunlink test\n");
    ...
    2a45:	e8 73 23 00 00       	call   4dbd <printf>
  ...
  if(pid < 0){
    ...
    2a73:	e8 45 23 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "linkunlink ok\n");
    ...
    2b50:	e8 68 22 00 00       	call   4dbd <printf>
}
    2b55:	c9                   	leave  
    2b56:	c3                   	ret    
  }
...
bigdir(void)
{
  ...
  printf(1, "bigdir test\n");
    ...
    2b71:	e8 47 22 00 00       	call   4dbd <printf>
  unlink("bd");
  ...
  if(fd < 0){
    ...
    2bae:	e8 0a 22 00 00       	call   4dbd <printf>
    exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    2c26:	e8 92 21 00 00       	call   4dbd <printf>
      exit();
  ...
  for(i = 0; i < 500; i++){
    ...
    2ca4:	e8 14 21 00 00       	call   4dbd <printf>
      exit();
  ...
  printf(1, "bigdir ok\n");
    ...
    2cca:	e8 ee 20 00 00       	call   4dbd <printf>
}
    2ccf:	c9                   	leave  
    2cd0:	c3                   	ret    
...
subdir(void)
{
  ...
  printf(1, "subdir test\n");
    ...
    2ce6:	e8 d2 20 00 00       	call   4dbd <printf>
  ...
  if(mkdir("dd") != 0){
    ...
    2d16:	e8 a2 20 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2d4c:	e8 6c 20 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd") >= 0){
    ...
    2d9b:	e8 1d 20 00 00       	call   4dbd <printf>
    exit();
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    2dc4:	e8 f4 1f 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2dfa:	e8 be 1f 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    2e56:	e8 62 1f 00 00       	call   4dbd <printf>
    exit();
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    2e67:	00 
    2e68:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    2e6f:	00 
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    2e84:	0f b6 05 00 93 00 00 	movzbl 0x9300,%eax
    ...
    2e9e:	e8 1a 1f 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    2eda:	e8 de 1e 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    2f03:	e8 b5 1e 00 00       	call   4dbd <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2f34:	e8 84 1e 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("dd") != 0){
    ...
    2f5d:	e8 5b 1e 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    2f86:	e8 32 1e 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    2faf:	e8 09 1e 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("./..") != 0){
    ...
    2fd8:	e8 e0 1d 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    300e:	e8 aa 1d 00 00       	call   4dbd <printf>
    exit();
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    301f:	00 
    3020:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    3027:	00 
    ...
    3047:	e8 71 1d 00 00       	call   4dbd <printf>
    exit();
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3083:	e8 35 1d 00 00       	call   4dbd <printf>
    exit();
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    30b4:	e8 04 1d 00 00       	call   4dbd <printf>
    exit();
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    30e5:	e8 d3 1c 00 00       	call   4dbd <printf>
    exit();
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3116:	e8 a2 1c 00 00       	call   4dbd <printf>
    exit();
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3147:	e8 71 1c 00 00       	call   4dbd <printf>
    exit();
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3178:	e8 40 1c 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    31a9:	e8 0f 1c 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    31da:	e8 de 1b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    320b:	e8 ad 1b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3234:	e8 84 1b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    325d:	e8 5b 1b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3286:	e8 32 1b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    32af:	e8 09 1b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    32d8:	e8 e0 1a 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("dd/ff") == 0){
    ...
    3301:	e8 b7 1a 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("dd/xx") == 0){
    ...
    332a:	e8 8e 1a 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3353:	e8 65 1a 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd/ff") != 0){
    ...
    337c:	e8 3c 1a 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd") == 0){
    ...
    33a5:	e8 13 1a 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd/dd") < 0){
    ...
    33ce:	e8 ea 19 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dd") < 0){
    ...
    33f7:	e8 c1 19 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "subdir ok\n");
    ...
    3410:	e8 a8 19 00 00       	call   4dbd <printf>
}
    3415:	c9                   	leave  
    3416:	c3                   	ret    
...
bigwrite(void)
{
  ...
  printf(1, "bigwrite test\n");
    ...
    342c:	e8 8c 19 00 00       	call   4dbd <printf>
  ...
  for(sz = 499; sz < 12*512; sz += 471){
    ...
    3475:	e8 43 19 00 00       	call   4dbd <printf>
      exit();
    ...
    348f:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    3496:	00 
    ...
    34ca:	e8 ee 18 00 00       	call   4dbd <printf>
        exit();
  ...
  printf(1, "bigwrite ok\n");
    ...
    3518:	e8 a0 18 00 00       	call   4dbd <printf>
}
    351d:	c9                   	leave  
    351e:	c3                   	ret    
...
bigfile(void)
{
  ...
  printf(1, "bigfile test\n");
    ...
    3534:	e8 84 18 00 00       	call   4dbd <printf>
  ...
  if(fd < 0){
    ...
    3571:	e8 47 18 00 00       	call   4dbd <printf>
    exit();
  ...
  for(i = 0; i < 20; i++){
    ...
    3593:	c7 04 24 00 93 00 00 	movl   $0x9300,(%esp)
    359a:	e8 d7 14 00 00       	call   4a76 <memset>
    if(write(fd, buf, 600) != 600){
    359f:	c7 44 24 08 58 02 00 	movl   $0x258,0x8(%esp)
    35a6:	00 
    35a7:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    35ae:	00 
    ...
    35d0:	e8 e8 17 00 00       	call   4dbd <printf>
      exit();
  ...
  if(fd < 0){
    ...
    361b:	e8 9d 17 00 00       	call   4dbd <printf>
    exit();
  ...
  for(i = 0; ; i++){
    ...
    363a:	00 
    363b:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    3642:	00 
    ...
    3666:	e8 52 17 00 00       	call   4dbd <printf>
      exit();
    ...
    3692:	e8 26 17 00 00       	call   4dbd <printf>
      exit();
    3697:	e8 80 15 00 00       	call   4c1c <exit>
    }
    if(buf[0] != i/2 || buf[299] != i/2){
    369c:	0f b6 05 00 93 00 00 	movzbl 0x9300,%eax
    ...
    36b7:	0f b6 05 2b 94 00 00 	movzbl 0x942b,%eax
    ...
    36e1:	e8 d7 16 00 00       	call   4dbd <printf>
      exit();
  ...
  if(total != 20*600){
    ...
    371e:	e8 9a 16 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "bigfile test ok\n");
    ...
    3743:	e8 75 16 00 00       	call   4dbd <printf>
}
    3748:	c9                   	leave  
    3749:	c3                   	ret    
...
fourteen(void)
{
  ...
  printf(1, "fourteen test\n");
    ...
    375f:	e8 59 16 00 00       	call   4dbd <printf>
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3783:	e8 35 16 00 00       	call   4dbd <printf>
    exit();
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    37ac:	e8 0c 16 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    37e2:	e8 d6 15 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    3823:	e8 95 15 00 00       	call   4dbd <printf>
    exit();
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3857:	e8 61 15 00 00       	call   4dbd <printf>
    exit();
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    3880:	e8 38 15 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "fourteen ok\n");
    ...
    3899:	e8 1f 15 00 00       	call   4dbd <printf>
}
    389e:	c9                   	leave  
    389f:	c3                   	ret    
...
rmdot(void)
{
  ...
  printf(1, "rmdot test\n");
    ...
    38b5:	e8 03 15 00 00       	call   4dbd <printf>
  if(mkdir("dots") != 0){
    ...
    38d9:	e8 df 14 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("dots") != 0){
    ...
    3902:	e8 b6 14 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink(".") == 0){
    ...
    392b:	e8 8d 14 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("..") == 0){
    ...
    3954:	e8 64 14 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("/") != 0){
    ...
    397d:	e8 3b 14 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dots/.") == 0){
    ...
    39a6:	e8 12 14 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dots/..") == 0){
    ...
    39cf:	e8 e9 13 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dots") != 0){
    ...
    39f8:	e8 c0 13 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "rmdot ok\n");
    ...
    3a11:	e8 a7 13 00 00       	call   4dbd <printf>
}
    3a16:	c9                   	leave  
    3a17:	c3                   	ret    
...
dirfile(void)
{
  ...
  printf(1, "dir vs file\n");
    ...
    3a2d:	e8 8b 13 00 00       	call   4dbd <printf>
  ...
  if(fd < 0){
    ...
    3a5e:	e8 5a 13 00 00       	call   4dbd <printf>
    exit();
  ...
  if(chdir("dirfile") == 0){
    ...
    3a92:	e8 26 13 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    3ac8:	e8 f0 12 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    3afe:	e8 ba 12 00 00       	call   4dbd <printf>
    exit();
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3b27:	e8 91 12 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3b50:	e8 68 12 00 00       	call   4dbd <printf>
    exit();
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3b81:	e8 37 12 00 00       	call   4dbd <printf>
    exit();
  ...
  if(unlink("dirfile") != 0){
    ...
    3baa:	e8 0e 12 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd >= 0){
    ...
    3be0:	e8 d8 11 00 00       	call   4dbd <printf>
    exit();
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c2f:	e8 89 11 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "dir vs file OK\n");
    ...
    3c53:	e8 65 11 00 00       	call   4dbd <printf>
}
    3c58:	c9                   	leave  
    3c59:	c3                   	ret    
...
iref(void)
{
  ...
  printf(1, "empty file name\n");
    ...
    3c6f:	e8 49 11 00 00       	call   4dbd <printf>
  ...
  for(i = 0; i < 50 + 1; i++){
    ...
    3c9f:	e8 19 11 00 00       	call   4dbd <printf>
      exit();
    ...
    3cc8:	e8 f0 10 00 00       	call   4dbd <printf>
      exit();
  ...
  printf(1, "empty file name OK\n");
    ...
    3d77:	e8 41 10 00 00       	call   4dbd <printf>
}
    3d7c:	c9                   	leave  
    3d7d:	c3                   	ret    
...
forktest(void)
{
  ...
  printf(1, "fork test\n");
    ...
    3d93:	e8 25 10 00 00       	call   4dbd <printf>
    ...
    3db5:	e8 62 0e 00 00       	call   4c1c <exit>
{
  ...
  if(n == 1000){
    ...
    3de2:	e8 d6 0f 00 00       	call   4dbd <printf>
    exit();
  ...
  for(; n > 0; n--){
    ...
    3e04:	e8 b4 0f 00 00       	call   4dbd <printf>
      exit();
  ...
  if(wait() != -1){
    ...
    3e31:	e8 87 0f 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(1, "fork test OK\n");
    ...
    3e4a:	e8 6e 0f 00 00       	call   4dbd <printf>
}
    3e4f:	c9                   	leave  
    3e50:	c3                   	ret    
...
sbrktest(void)
{
  ...
  printf(stdout, "sbrk test\n");
    3e5b:	a1 04 6b 00 00       	mov    0x6b04,%eax
    3e60:	c7 44 24 04 d7 66 00 	movl   $0x66d7,0x4(%esp)
    3e67:	00 
    3e68:	89 04 24             	mov    %eax,(%esp)
    3e6b:	e8 4d 0f 00 00       	call   4dbd <printf>
  oldbrk = sbrk(0);
  ...
  for(i = 0; i < 5000; i++){ 
    ...
    3eae:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    3ed3:	e8 e5 0e 00 00       	call   4dbd <printf>
      exit();
  ...
  if(pid < 0){
    ...
    3f07:	a1 04 6b 00 00       	mov    0x6b04,%eax
    3f0c:	c7 44 24 04 fd 66 00 	movl   $0x66fd,0x4(%esp)
    3f13:	00 
    3f14:	89 04 24             	mov    %eax,(%esp)
    3f17:	e8 a1 0e 00 00       	call   4dbd <printf>
    exit();
  ...
  if(c != a + 1){
    ...
    3f4a:	a1 04 6b 00 00       	mov    0x6b04,%eax
    3f4f:	c7 44 24 04 14 67 00 	movl   $0x6714,0x4(%esp)
    3f56:	00 
    3f57:	89 04 24             	mov    %eax,(%esp)
    3f5a:	e8 5e 0e 00 00       	call   4dbd <printf>
    exit();
...
#define BIG (100*1024*1024)
  ...
  if (p != a) { 
    ...
    3faa:	a1 04 6b 00 00       	mov    0x6b04,%eax
    3faf:	c7 44 24 04 30 67 00 	movl   $0x6730,0x4(%esp)
    3fb6:	00 
    3fb7:	89 04 24             	mov    %eax,(%esp)
    3fba:	e8 fe 0d 00 00       	call   4dbd <printf>
    exit();
  ...
  *lastaddr = 99;
  ...
  if(c == (char*)0xffffffff){
    ...
    3ff5:	a1 04 6b 00 00       	mov    0x6b04,%eax
    3ffa:	c7 44 24 04 6e 67 00 	movl   $0x676e,0x4(%esp)
    4001:	00 
    4002:	89 04 24             	mov    %eax,(%esp)
    4005:	e8 b3 0d 00 00       	call   4dbd <printf>
    exit();
  ...
  if(c != a - 4096){
    ...
    402b:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    4049:	e8 6f 0d 00 00       	call   4dbd <printf>
    exit();
  ...
  if(c != a || sbrk(0) != a + 4096){
    ...
    4092:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    40b0:	e8 08 0d 00 00       	call   4dbd <printf>
    exit();
  ...
  if(*lastaddr == 99){
    ...
    40c4:	a1 04 6b 00 00       	mov    0x6b04,%eax
    40c9:	c7 44 24 04 ec 67 00 	movl   $0x67ec,0x4(%esp)
    40d0:	00 
    40d1:	89 04 24             	mov    %eax,(%esp)
    40d4:	e8 e4 0c 00 00       	call   4dbd <printf>
    exit();
  ...
  if(c != a){
    ...
    4115:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    4133:	e8 85 0c 00 00       	call   4dbd <printf>
    exit();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    415c:	a1 04 6b 00 00       	mov    0x6b04,%eax
    4161:	c7 44 24 04 e5 57 00 	movl   $0x57e5,0x4(%esp)
    4168:	00 
    4169:	89 04 24             	mov    %eax,(%esp)
    416c:	e8 4c 0c 00 00       	call   4dbd <printf>
      exit();
    ...
    4185:	a1 04 6b 00 00       	mov    0x6b04,%eax
    ...
    41a0:	e8 18 0c 00 00       	call   4dbd <printf>
      kill(ppid);
  ...
  if(pipe(fds) != 0){
    ...
    41ec:	e8 cc 0b 00 00       	call   4dbd <printf>
    exit();
  ...
  if(c == (char*)0xffffffff){
    ...
    42e1:	a1 04 6b 00 00       	mov    0x6b04,%eax
    42e6:	c7 44 24 04 56 68 00 	movl   $0x6856,0x4(%esp)
    42ed:	00 
    42ee:	89 04 24             	mov    %eax,(%esp)
    42f1:	e8 c7 0a 00 00       	call   4dbd <printf>
    exit();
  ...
  printf(stdout, "sbrk test OK\n");
    4329:	a1 04 6b 00 00       	mov    0x6b04,%eax
    432e:	c7 44 24 04 71 68 00 	movl   $0x6871,0x4(%esp)
    4335:	00 
    4336:	89 04 24             	mov    %eax,(%esp)
    4339:	e8 7f 0a 00 00       	call   4dbd <printf>
}
...
validatetest(void)
{
  ...
  printf(stdout, "validate test\n");
    436f:	a1 04 6b 00 00       	mov    0x6b04,%eax
    4374:	c7 44 24 04 7f 68 00 	movl   $0x687f,0x4(%esp)
    437b:	00 
    437c:	89 04 24             	mov    %eax,(%esp)
    437f:	e8 39 0a 00 00       	call   4dbd <printf>
  hi = 1100*1024;
  ...
  for(p = 0; p <= (uint)hi; p += 4096){
    ...
    43f2:	a1 04 6b 00 00       	mov    0x6b04,%eax
    43f7:	c7 44 24 04 99 68 00 	movl   $0x6899,0x4(%esp)
    43fe:	00 
    43ff:	89 04 24             	mov    %eax,(%esp)
    4402:	e8 b6 09 00 00       	call   4dbd <printf>
      exit();
  ...
  printf(stdout, "validate ok\n");
    441f:	a1 04 6b 00 00       	mov    0x6b04,%eax
    4424:	c7 44 24 04 b2 68 00 	movl   $0x68b2,0x4(%esp)
    442b:	00 
    442c:	89 04 24             	mov    %eax,(%esp)
    442f:	e8 89 09 00 00       	call   4dbd <printf>
}
    4434:	c9                   	leave  
    4435:	c3                   	ret    
...
bsstest(void)
{
  ...
  printf(stdout, "bss test ok\n");
    4490:	a1 04 6b 00 00       	mov    0x6b04,%eax
    4495:	c7 44 24 04 da 68 00 	movl   $0x68da,0x4(%esp)
    449c:	00 
    449d:	89 04 24             	mov    %eax,(%esp)
    44a0:	e8 18 09 00 00       	call   4dbd <printf>
}
    44a5:	c9                   	leave  
    44a6:	c3                   	ret    
...
bigargtest(void)
{
  ...
  if(pid == 0){
    ...
    44d7:	c7 04 85 40 6b 00 00 	movl   $0x68f4,0x6b40(,%eax,4)
    44de:	f4 68 00 00 
  unlink("bigarg-ok");
  pid = fork();
  if(pid == 0){
    ...
    44ea:	7e e8                	jle    44d4 <bigargtest+0x2d>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    args[MAXARG-1] = 0;
    44ec:	c7 05 bc 6b 00 00 00 	movl   $0x0,0x6bbc
    44f3:	00 00 00 
    printf(stdout, "bigarg test\n");
    44f6:	a1 04 6b 00 00       	mov    0x6b04,%eax
    44fb:	c7 44 24 04 d1 69 00 	movl   $0x69d1,0x4(%esp)
    4502:	00 
    4503:	89 04 24             	mov    %eax,(%esp)
    4506:	e8 b2 08 00 00       	call   4dbd <printf>
    exec("echo", args);
    450b:	c7 44 24 04 40 6b 00 	movl   $0x6b40,0x4(%esp)
    4512:	00 
    4513:	c7 04 24 f8 53 00 00 	movl   $0x53f8,(%esp)
    451a:	e8 35 07 00 00       	call   4c54 <exec>
    printf(stdout, "bigarg test ok\n");
    451f:	a1 04 6b 00 00       	mov    0x6b04,%eax
    4524:	c7 44 24 04 de 69 00 	movl   $0x69de,0x4(%esp)
    452b:	00 
    452c:	89 04 24             	mov    %eax,(%esp)
    452f:	e8 89 08 00 00       	call   4dbd <printf>
    ...
    4561:	a1 04 6b 00 00       	mov    0x6b04,%eax
    4566:	c7 44 24 04 ee 69 00 	movl   $0x69ee,0x4(%esp)
    456d:	00 
    456e:	89 04 24             	mov    %eax,(%esp)
    4571:	e8 47 08 00 00       	call   4dbd <printf>
    exit();
  ...
  if(fd < 0){
    ...
    459d:	a1 04 6b 00 00       	mov    0x6b04,%eax
    45a2:	c7 44 24 04 07 6a 00 	movl   $0x6a07,0x4(%esp)
    45a9:	00 
    45aa:	89 04 24             	mov    %eax,(%esp)
    45ad:	e8 0b 08 00 00       	call   4dbd <printf>
    exit();
...
fsfull()
{
  ...
  printf(1, "fsfull test\n");
    ...
    45ed:	e8 cb 07 00 00       	call   4dbd <printf>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    46dd:	e8 db 06 00 00       	call   4dbd <printf>
    ...
    4714:	e8 a4 06 00 00       	call   4dbd <printf>
      break;
    ...
    4729:	00 
    472a:	c7 44 24 04 00 93 00 	movl   $0x9300,0x4(%esp)
    4731:	00 
    ...
    476c:	e8 4c 06 00 00       	call   4dbd <printf>
    close(fd);
  ...
  printf(1, "fsfull test finished\n");
    ...
    4888:	e8 30 05 00 00       	call   4dbd <printf>
}
...
rand()
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    4896:	a1 08 6b 00 00       	mov    0x6b08,%eax
    489b:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    48a1:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
    48a6:	a3 08 6b 00 00       	mov    %eax,0x6b08
  return randstate;
    48ab:	a1 08 6b 00 00       	mov    0x6b08,%eax
}
    48b0:	5d                   	pop    %ebp
    48b1:	c3                   	ret    
...
main(int argc, char *argv[])
{
  ...
  printf(1, "usertests starting\n");
    ...
    48ca:	e8 ee 04 00 00       	call   4dbd <printf>
  ...
  if(open("usertests.ran", 0) >= 0){
    ...
    48f6:	e8 c2 04 00 00       	call   4dbd <printf>
    exit();
...
00004cdc <thread_yield>:
SYSCALL(thread_yield)
    4cdc:	b8 1a 00 00 00       	mov    $0x1a,%eax
    4ce1:	cd 40                	int    $0x40
    4ce3:	c3                   	ret    
...
{
    4ce4:	55                   	push   %ebp
    4ce5:	89 e5                	mov    %esp,%ebp
    4ce7:	83 ec 28             	sub    $0x28,%esp
    4cea:	8b 45 0c             	mov    0xc(%ebp),%eax
    4ced:	88 45 f4             	mov    %al,-0xc(%ebp)
  write(fd, &c, 1);
    4cf0:	c7 44 24 08 01 00 00 	movl   $0x1,0x8(%esp)
    4cf7:	00 
    4cf8:	8d 45 f4             	lea    -0xc(%ebp),%eax
    4cfb:	89 44 24 04          	mov    %eax,0x4(%esp)
    4cff:	8b 45 08             	mov    0x8(%ebp),%eax
    4d02:	89 04 24             	mov    %eax,(%esp)
    4d05:	e8 32 ff ff ff       	call   4c3c <write>
}
    4d0a:	c9                   	leave  
    4d0b:	c3                   	ret    
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
    4d13:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  if(sgn && xx < 0){
    4d1a:	83 7d 14 00          	cmpl   $0x0,0x14(%ebp)
    4d1e:	74 17                	je     4d37 <printint+0x2b>
    4d20:	83 7d 0c 00          	cmpl   $0x0,0xc(%ebp)
    4d24:	79 11                	jns    4d37 <printint+0x2b>
    neg = 1;
    4d26:	c7 45 f0 01 00 00 00 	movl   $0x1,-0x10(%ebp)
    x = -xx;
    4d2d:	8b 45 0c             	mov    0xc(%ebp),%eax
    4d30:	f7 d8                	neg    %eax
  ...
  neg = 0;
  if(sgn && xx < 0){
    4d35:	eb 06                	jmp    4d3d <printint+0x31>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    4d37:	8b 45 0c             	mov    0xc(%ebp),%eax
    4d3a:	89 45 f4             	mov    %eax,-0xc(%ebp)
  }

  i = 0;
    4d3d:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
  do{
    buf[i++] = digits[x % base];
    4d44:	8b 4d ec             	mov    -0x14(%ebp),%ecx
    4d47:	8b 5d 10             	mov    0x10(%ebp),%ebx
    4d4a:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4d4d:	ba 00 00 00 00       	mov    $0x0,%edx
    4d52:	f7 f3                	div    %ebx
    4d54:	89 d0                	mov    %edx,%eax
    4d56:	0f b6 80 0c 6b 00 00 	movzbl 0x6b0c(%eax),%eax
    4d5d:	88 44 0d dc          	mov    %al,-0x24(%ebp,%ecx,1)
    4d61:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
  }while((x /= base) != 0);
    4d65:	8b 45 10             	mov    0x10(%ebp),%eax
    4d68:	89 45 d4             	mov    %eax,-0x2c(%ebp)
    4d6b:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4d6e:	ba 00 00 00 00       	mov    $0x0,%edx
    4d73:	f7 75 d4             	divl   -0x2c(%ebp)
    4d76:	89 45 f4             	mov    %eax,-0xc(%ebp)
    4d79:	83 7d f4 00          	cmpl   $0x0,-0xc(%ebp)
    4d7d:	75 c5                	jne    4d44 <printint+0x38>
  if(neg)
    4d7f:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4d83:	74 28                	je     4dad <printint+0xa1>
    buf[i++] = '-';
    4d85:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4d88:	c6 44 05 dc 2d       	movb   $0x2d,-0x24(%ebp,%eax,1)
    4d8d:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)

  while(--i >= 0)
    4d91:	eb 1a                	jmp    4dad <printint+0xa1>
    putc(fd, buf[i]);
    4d93:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4d96:	0f b6 44 05 dc       	movzbl -0x24(%ebp,%eax,1),%eax
    4d9b:	0f be c0             	movsbl %al,%eax
    4d9e:	89 44 24 04          	mov    %eax,0x4(%esp)
    4da2:	8b 45 08             	mov    0x8(%ebp),%eax
    4da5:	89 04 24             	mov    %eax,(%esp)
    4da8:	e8 37 ff ff ff       	call   4ce4 <putc>
    buf[i++] = digits[x % base];
  }while((x /= base) != 0);
  if(neg)
    buf[i++] = '-';
  ...
  while(--i >= 0)
    4dad:	83 6d ec 01          	subl   $0x1,-0x14(%ebp)
    4db1:	83 7d ec 00          	cmpl   $0x0,-0x14(%ebp)
    4db5:	79 dc                	jns    4d93 <printint+0x87>
    putc(fd, buf[i]);
}
    4db7:	83 c4 44             	add    $0x44,%esp
    4dba:	5b                   	pop    %ebx
    4dbb:	5d                   	pop    %ebp
    4dbc:	c3                   	ret    
...
{
    4dbd:	55                   	push   %ebp
    4dbe:	89 e5                	mov    %esp,%ebp
    4dc0:	83 ec 38             	sub    $0x38,%esp
  char *s;
  int c, i, state;
  uint *ap;

  state = 0;
    4dc3:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  ap = (uint*)(void*)&fmt + 1;
    4dca:	8d 45 0c             	lea    0xc(%ebp),%eax
    4dcd:	83 c0 04             	add    $0x4,%eax
    4dd0:	89 45 f4             	mov    %eax,-0xc(%ebp)
  for(i = 0; fmt[i]; i++){
    4dd3:	c7 45 ec 00 00 00 00 	movl   $0x0,-0x14(%ebp)
    4dda:	e9 7e 01 00 00       	jmp    4f5d <printf+0x1a0>
    c = fmt[i] & 0xff;
    4ddf:	8b 55 0c             	mov    0xc(%ebp),%edx
    4de2:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4de5:	8d 04 02             	lea    (%edx,%eax,1),%eax
    4de8:	0f b6 00             	movzbl (%eax),%eax
    4deb:	0f be c0             	movsbl %al,%eax
    4dee:	25 ff 00 00 00       	and    $0xff,%eax
    4df3:	89 45 e8             	mov    %eax,-0x18(%ebp)
    if(state == 0){
    4df6:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    4dfa:	75 2c                	jne    4e28 <printf+0x6b>
      if(c == '%'){
    4dfc:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    4e00:	75 0c                	jne    4e0e <printf+0x51>
        state = '%';
    4e02:	c7 45 f0 25 00 00 00 	movl   $0x25,-0x10(%ebp)
    4e09:	e9 4b 01 00 00       	jmp    4f59 <printf+0x19c>
      } else {
        putc(fd, c);
    4e0e:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4e11:	0f be c0             	movsbl %al,%eax
    4e14:	89 44 24 04          	mov    %eax,0x4(%esp)
    4e18:	8b 45 08             	mov    0x8(%ebp),%eax
    4e1b:	89 04 24             	mov    %eax,(%esp)
    4e1e:	e8 c1 fe ff ff       	call   4ce4 <putc>
    4e23:	e9 31 01 00 00       	jmp    4f59 <printf+0x19c>
      }
    } else if(state == '%'){
    4e28:	83 7d f0 25          	cmpl   $0x25,-0x10(%ebp)
    4e2c:	0f 85 27 01 00 00    	jne    4f59 <printf+0x19c>
      if(c == 'd'){
    4e32:	83 7d e8 64          	cmpl   $0x64,-0x18(%ebp)
    4e36:	75 2d                	jne    4e65 <printf+0xa8>
        printint(fd, *ap, 10, 1);
    4e38:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4e3b:	8b 00                	mov    (%eax),%eax
    4e3d:	c7 44 24 0c 01 00 00 	movl   $0x1,0xc(%esp)
    4e44:	00 
    4e45:	c7 44 24 08 0a 00 00 	movl   $0xa,0x8(%esp)
    4e4c:	00 
    4e4d:	89 44 24 04          	mov    %eax,0x4(%esp)
    4e51:	8b 45 08             	mov    0x8(%ebp),%eax
    4e54:	89 04 24             	mov    %eax,(%esp)
    4e57:	e8 b0 fe ff ff       	call   4d0c <printint>
        ap++;
    4e5c:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    4e60:	e9 ed 00 00 00       	jmp    4f52 <printf+0x195>
      } else if(c == 'x' || c == 'p'){
    4e65:	83 7d e8 78          	cmpl   $0x78,-0x18(%ebp)
    4e69:	74 06                	je     4e71 <printf+0xb4>
    4e6b:	83 7d e8 70          	cmpl   $0x70,-0x18(%ebp)
    4e6f:	75 2d                	jne    4e9e <printf+0xe1>
        printint(fd, *ap, 16, 0);
    4e71:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4e74:	8b 00                	mov    (%eax),%eax
    4e76:	c7 44 24 0c 00 00 00 	movl   $0x0,0xc(%esp)
    4e7d:	00 
    4e7e:	c7 44 24 08 10 00 00 	movl   $0x10,0x8(%esp)
    4e85:	00 
    4e86:	89 44 24 04          	mov    %eax,0x4(%esp)
    4e8a:	8b 45 08             	mov    0x8(%ebp),%eax
    4e8d:	89 04 24             	mov    %eax,(%esp)
    4e90:	e8 77 fe ff ff       	call   4d0c <printint>
        ap++;
    4e95:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
      }
    } else if(state == '%'){
      if(c == 'd'){
        printint(fd, *ap, 10, 1);
    ...
    4e99:	e9 b4 00 00 00       	jmp    4f52 <printf+0x195>
        printint(fd, *ap, 16, 0);
        ap++;
      } else if(c == 's'){
    4e9e:	83 7d e8 73          	cmpl   $0x73,-0x18(%ebp)
    4ea2:	75 46                	jne    4eea <printf+0x12d>
        s = (char*)*ap;
    4ea4:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4ea7:	8b 00                	mov    (%eax),%eax
    4ea9:	89 45 e4             	mov    %eax,-0x1c(%ebp)
        ap++;
    4eac:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
        if(s == 0)
    4eb0:	83 7d e4 00          	cmpl   $0x0,-0x1c(%ebp)
    4eb4:	75 27                	jne    4edd <printf+0x120>
          s = "(null)";
    4eb6:	c7 45 e4 ba 6a 00 00 	movl   $0x6aba,-0x1c(%ebp)
        while(*s != 0){
    4ebd:	eb 1f                	jmp    4ede <printf+0x121>
          putc(fd, *s);
    4ebf:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4ec2:	0f b6 00             	movzbl (%eax),%eax
    4ec5:	0f be c0             	movsbl %al,%eax
    4ec8:	89 44 24 04          	mov    %eax,0x4(%esp)
    4ecc:	8b 45 08             	mov    0x8(%ebp),%eax
    4ecf:	89 04 24             	mov    %eax,(%esp)
    4ed2:	e8 0d fe ff ff       	call   4ce4 <putc>
          s++;
    4ed7:	83 45 e4 01          	addl   $0x1,-0x1c(%ebp)
    4edb:	eb 01                	jmp    4ede <printf+0x121>
      } else if(c == 's'){
        s = (char*)*ap;
        ap++;
        if(s == 0)
        ...
        while(*s != 0){
    4edd:	90                   	nop
    4ede:	8b 45 e4             	mov    -0x1c(%ebp),%eax
    4ee1:	0f b6 00             	movzbl (%eax),%eax
    4ee4:	84 c0                	test   %al,%al
    4ee6:	75 d7                	jne    4ebf <printf+0x102>
    4ee8:	eb 68                	jmp    4f52 <printf+0x195>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
    4eea:	83 7d e8 63          	cmpl   $0x63,-0x18(%ebp)
    4eee:	75 1d                	jne    4f0d <printf+0x150>
        putc(fd, *ap);
    4ef0:	8b 45 f4             	mov    -0xc(%ebp),%eax
    4ef3:	8b 00                	mov    (%eax),%eax
    4ef5:	0f be c0             	movsbl %al,%eax
    4ef8:	89 44 24 04          	mov    %eax,0x4(%esp)
    4efc:	8b 45 08             	mov    0x8(%ebp),%eax
    4eff:	89 04 24             	mov    %eax,(%esp)
    4f02:	e8 dd fd ff ff       	call   4ce4 <putc>
        ap++;
    4f07:	83 45 f4 04          	addl   $0x4,-0xc(%ebp)
    4f0b:	eb 45                	jmp    4f52 <printf+0x195>
      } else if(c == '%'){
    4f0d:	83 7d e8 25          	cmpl   $0x25,-0x18(%ebp)
    4f11:	75 17                	jne    4f2a <printf+0x16d>
        putc(fd, c);
    4f13:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4f16:	0f be c0             	movsbl %al,%eax
    4f19:	89 44 24 04          	mov    %eax,0x4(%esp)
    4f1d:	8b 45 08             	mov    0x8(%ebp),%eax
    4f20:	89 04 24             	mov    %eax,(%esp)
    4f23:	e8 bc fd ff ff       	call   4ce4 <putc>
    4f28:	eb 28                	jmp    4f52 <printf+0x195>
      } else {
        // Unknown % sequence.  Print it to draw attention.
        putc(fd, '%');
    4f2a:	c7 44 24 04 25 00 00 	movl   $0x25,0x4(%esp)
    4f31:	00 
    4f32:	8b 45 08             	mov    0x8(%ebp),%eax
    4f35:	89 04 24             	mov    %eax,(%esp)
    4f38:	e8 a7 fd ff ff       	call   4ce4 <putc>
        putc(fd, c);
    4f3d:	8b 45 e8             	mov    -0x18(%ebp),%eax
    4f40:	0f be c0             	movsbl %al,%eax
    4f43:	89 44 24 04          	mov    %eax,0x4(%esp)
    4f47:	8b 45 08             	mov    0x8(%ebp),%eax
    4f4a:	89 04 24             	mov    %eax,(%esp)
    4f4d:	e8 92 fd ff ff       	call   4ce4 <putc>
      }
      state = 0;
    4f52:	c7 45 f0 00 00 00 00 	movl   $0x0,-0x10(%ebp)
  int c, i, state;
  uint *ap;
  ...
  ap = (uint*)(void*)&fmt + 1;
  for(i = 0; fmt[i]; i++){
    4f59:	83 45 ec 01          	addl   $0x1,-0x14(%ebp)
    4f5d:	8b 55 0c             	mov    0xc(%ebp),%edx
    4f60:	8b 45 ec             	mov    -0x14(%ebp),%eax
    4f63:	8d 04 02             	lea    (%edx,%eax,1),%eax
    4f66:	0f b6 00             	movzbl (%eax),%eax
    4f69:	84 c0                	test   %al,%al
    4f6b:	0f 85 6e fe ff ff    	jne    4ddf <printf+0x22>
        putc(fd, c);
      }
      state = 0;
    }
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    4f83:	a1 c8 6b 00 00       	mov    0x6bc8,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    5044:	a3 c8 6b 00 00       	mov    %eax,0x6bc8
}
    5049:	c9                   	leave  
    504a:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    506a:	e8 35 fc ff ff       	call   4ca4 <sbrk>
  ...
  return freep;
    509c:	a1 c8 6b 00 00       	mov    0x6bc8,%eax
}
    50a1:	c9                   	leave  
    50a2:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    50b8:	a1 c8 6b 00 00       	mov    0x6bc8,%eax
    50bd:	89 45 f0             	mov    %eax,-0x10(%ebp)
    50c0:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    50c4:	75 23                	jne    50e9 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    50c6:	c7 45 f0 c0 6b 00 00 	movl   $0x6bc0,-0x10(%ebp)
    50cd:	8b 45 f0             	mov    -0x10(%ebp),%eax
    50d0:	a3 c8 6b 00 00       	mov    %eax,0x6bc8
    50d5:	a1 c8 6b 00 00       	mov    0x6bc8,%eax
    50da:	a3 c0 6b 00 00       	mov    %eax,0x6bc0
    base.s.size = 0;
    50df:	c7 05 c4 6b 00 00 00 	movl   $0x0,0x6bc4
    50e6:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    513c:	a3 c8 6b 00 00       	mov    %eax,0x6bc8
      return (void*)(p + 1);
    ...
    if(p == freep)
    5149:	a1 c8 6b 00 00       	mov    0x6bc8,%eax
...
void lock_acquire(lock_t *lock){
    ...
    51b5:	c7 44 24 04 01 00 00 	movl   $0x1,0x4(%esp)
    51bc:	00 
    51bd:	89 04 24             	mov    %eax,(%esp)
    51c0:	e8 bf ff ff ff       	call   5184 <xchg>
    51c5:	85 c0                	test   %eax,%eax
    51c7:	75 e9                	jne    51b2 <lock_acquire+0x6>
}
    51c9:	c9                   	leave  
    51ca:	c3                   	ret    

000051cb <lock_release>:
void lock_release(lock_t *lock){
    51cb:	55                   	push   %ebp
    51cc:	89 e5                	mov    %esp,%ebp
    51ce:	83 ec 08             	sub    $0x8,%esp
    xchg(&lock->locked,0);
    51d1:	8b 45 08             	mov    0x8(%ebp),%eax
    51d4:	c7 44 24 04 00 00 00 	movl   $0x0,0x4(%esp)
    51db:	00 
    51dc:	89 04 24             	mov    %eax,(%esp)
    51df:	e8 a0 ff ff ff       	call   5184 <xchg>
}
    51e4:	c9                   	leave  
    51e5:	c3                   	ret    

000051e6 <thread_create>:


void *thread_create(void(*start_routine)(void*), void *arg){
    51e6:	55                   	push   %ebp
    51e7:	89 e5                	mov    %esp,%ebp
    51e9:	83 ec 28             	sub    $0x28,%esp
    int tid;
    void * stack = malloc(2 * 4096);
    51ec:	c7 04 24 00 20 00 00 	movl   $0x2000,(%esp)
    51f3:	e8 ab fe ff ff       	call   50a3 <malloc>
    51f8:	89 45 f0             	mov    %eax,-0x10(%ebp)
    void *garbage_stack = stack; 
    51fb:	8b 45 f0             	mov    -0x10(%ebp),%eax
    51fe:	89 45 f4             	mov    %eax,-0xc(%ebp)
   // printf(1,"start routine addr : %d\n",(uint)start_routine);


    if((uint)stack % 4096){
    5201:	8b 45 f0             	mov    -0x10(%ebp),%eax
    5204:	25 ff 0f 00 00       	and    $0xfff,%eax
    5209:	85 c0                	test   %eax,%eax
    520b:	74 15                	je     5222 <thread_create+0x3c>
        stack = stack + (4096 - (uint)stack % 4096);
    520d:	8b 45 f0             	mov    -0x10(%ebp),%eax
    5210:	89 c2                	mov    %eax,%edx
    5212:	81 e2 ff 0f 00 00    	and    $0xfff,%edx
    5218:	b8 00 10 00 00       	mov    $0x1000,%eax
    521d:	29 d0                	sub    %edx,%eax
    521f:	01 45 f0             	add    %eax,-0x10(%ebp)
    }
    if (stack == 0){
    5222:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    5226:	75 1b                	jne    5243 <thread_create+0x5d>

        printf(1,"malloc fail \n");
    5228:	c7 44 24 04 c1 6a 00 	movl   $0x6ac1,0x4(%esp)
    522f:	00 
    5230:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
    5237:	e8 81 fb ff ff       	call   4dbd <printf>
        return 0;
    523c:	b8 00 00 00 00       	mov    $0x0,%eax
    5241:	eb 6f                	jmp    52b2 <thread_create+0xcc>
    }

    tid = clone((uint)stack,PSIZE,(uint)start_routine,(int)arg);
    5243:	8b 4d 0c             	mov    0xc(%ebp),%ecx
    5246:	8b 55 08             	mov    0x8(%ebp),%edx
    5249:	8b 45 f0             	mov    -0x10(%ebp),%eax
...
int random(int max){
    ...
    52b7:	a1 20 6b 00 00       	mov    0x6b20,%eax
    52bc:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    52c2:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    52c7:	a3 20 6b 00 00       	mov    %eax,0x6b20
    return (int)(rands % max);
    52cc:	a1 20 6b 00 00       	mov    0x6b20,%eax
...
int pop_q(struct queue *q){
    ...
    5399:	89 45 f0             	mov    %eax,-0x10(%ebp)
       destroy = q->head;
