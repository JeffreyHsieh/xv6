...
int main(){
    ...
    1020:	e8 87 09 00 00       	call   19ac <init_q>
    for(i=0;i<10;i++){
    ...
    103e:	e8 8b 09 00 00       	call   19ce <add_q>
...
int main(){
    ...
    1058:	e8 eb 09 00 00       	call   1a48 <pop_q>
    105d:	89 44 24 08          	mov    %eax,0x8(%esp)
    1061:	c7 44 24 04 c1 1a 00 	movl   $0x1ac1,0x4(%esp)
    1068:	00 
    ...
    107c:	e8 ad 09 00 00       	call   1a2e <empty_q>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1422:	0f b6 80 fc 1a 00 00 	movzbl 0x1afc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1580:	75 27                	jne    15a9 <printf+0x120>
          s = "(null)";
    1582:	c7 45 e4 c9 1a 00 00 	movl   $0x1ac9,-0x1c(%ebp)
        while(*s != 0){
...
00001640 <free>:
    ...
    164f:	a1 1c 1b 00 00       	mov    0x1b1c,%eax
    ...
    1710:	a3 1c 1b 00 00       	mov    %eax,0x1b1c
    1715:	c9                   	leave  
    1716:	c3                   	ret    
...
00001717 <morecore>:
    ...
    1768:	a1 1c 1b 00 00       	mov    0x1b1c,%eax
    176d:	c9                   	leave  
    176e:	c3                   	ret    
...
0000176f <malloc>:
    ...
    1784:	a1 1c 1b 00 00       	mov    0x1b1c,%eax
    1789:	89 45 f0             	mov    %eax,-0x10(%ebp)
    178c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1790:	75 23                	jne    17b5 <malloc+0x46>
    1792:	c7 45 f0 14 1b 00 00 	movl   $0x1b14,-0x10(%ebp)
    1799:	8b 45 f0             	mov    -0x10(%ebp),%eax
    179c:	a3 1c 1b 00 00       	mov    %eax,0x1b1c
    17a1:	a1 1c 1b 00 00       	mov    0x1b1c,%eax
    17a6:	a3 14 1b 00 00       	mov    %eax,0x1b14
    17ab:	c7 05 18 1b 00 00 00 	movl   $0x0,0x1b18
    17b2:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    18f4:	c7 44 24 04 d0 1a 00 	movl   $0x1ad0,0x4(%esp)
    18fb:	00 
    ...
    1939:	c7 44 24 04 de 1a 00 	movl   $0x1ade,0x4(%esp)
    1940:	00 
    ...
    1965:	c7 44 24 04 eb 1a 00 	movl   $0x1aeb,0x4(%esp)
    196c:	00 
...
int random(int max){
    ...
    1983:	a1 10 1b 00 00       	mov    0x1b10,%eax
    1988:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    198e:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1993:	a3 10 1b 00 00       	mov    %eax,0x1b10
    return (int)(rands % max);
    1998:	a1 10 1b 00 00       	mov    0x1b10,%eax
