...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++)
    ...
    101f:	b8 9d 1a 00 00       	mov    $0x1a9d,%eax
    1024:	eb 05                	jmp    102b <main+0x2b>
    1026:	b8 9f 1a 00 00       	mov    $0x1a9f,%eax
    ...
    103f:	c7 44 24 04 a1 1a 00 	movl   $0x1aa1,0x4(%esp)
    1046:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    13fe:	0f b6 80 dc 1a 00 00 	movzbl 0x1adc(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    155c:	75 27                	jne    1585 <printf+0x120>
          s = "(null)";
    155e:	c7 45 e4 a6 1a 00 00 	movl   $0x1aa6,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    162b:	a1 fc 1a 00 00       	mov    0x1afc,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    16ec:	a3 fc 1a 00 00       	mov    %eax,0x1afc
}
    16f1:	c9                   	leave  
    16f2:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1744:	a1 fc 1a 00 00       	mov    0x1afc,%eax
}
    1749:	c9                   	leave  
    174a:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1760:	a1 fc 1a 00 00       	mov    0x1afc,%eax
    1765:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1768:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    176c:	75 23                	jne    1791 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    176e:	c7 45 f0 f4 1a 00 00 	movl   $0x1af4,-0x10(%ebp)
    1775:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1778:	a3 fc 1a 00 00       	mov    %eax,0x1afc
    177d:	a1 fc 1a 00 00       	mov    0x1afc,%eax
    1782:	a3 f4 1a 00 00       	mov    %eax,0x1af4
    base.s.size = 0;
    1787:	c7 05 f8 1a 00 00 00 	movl   $0x0,0x1af8
    178e:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    17e4:	a3 fc 1a 00 00       	mov    %eax,0x1afc
      return (void*)(p + 1);
    ...
    if(p == freep)
    17f1:	a1 fc 1a 00 00       	mov    0x1afc,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    18d0:	c7 44 24 04 ad 1a 00 	movl   $0x1aad,0x4(%esp)
    18d7:	00 
    ...
    1915:	c7 44 24 04 bb 1a 00 	movl   $0x1abb,0x4(%esp)
    191c:	00 
    ...
    1941:	c7 44 24 04 c8 1a 00 	movl   $0x1ac8,0x4(%esp)
    1948:	00 
...
int random(int max){
    ...
    195f:	a1 f0 1a 00 00       	mov    0x1af0,%eax
    1964:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    196a:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    196f:	a3 f0 1a 00 00       	mov    %eax,0x1af0
    return (int)(rands % max);
    1974:	a1 f0 1a 00 00       	mov    0x1af0,%eax
    1979:	8b 4d 08             	mov    0x8(%ebp),%ecx
    197c:	ba 00 00 00 00       	mov    $0x0,%edx
    1981:	f7 f1                	div    %ecx
    1983:	89 d0                	mov    %edx,%eax
}
    1985:	5d                   	pop    %ebp
    1986:	c3                   	ret    
    1987:	90                   	nop
...
void init_q(struct queue *q){
    ...
    198e:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    1994:	8b 45 08             	mov    0x8(%ebp),%eax
    1997:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    199e:	8b 45 08             	mov    0x8(%ebp),%eax
    19a1:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    19a8:	5d                   	pop    %ebp
    19a9:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    19ad:	83 ec 28             	sub    $0x28,%esp
    struct node * n = malloc(sizeof(struct node));
    19b0:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    19b7:	e8 8f fd ff ff       	call   174b <malloc>
    19bc:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    19bf:	8b 45 f4             	mov    -0xc(%ebp),%eax
    19c2:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    19c9:	8b 45 f4             	mov    -0xc(%ebp),%eax
    19cc:	8b 55 0c             	mov    0xc(%ebp),%edx
    19cf:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    19d1:	8b 45 08             	mov    0x8(%ebp),%eax
    19d4:	8b 40 04             	mov    0x4(%eax),%eax
    19d7:	85 c0                	test   %eax,%eax
    19d9:	75 0b                	jne    19e6 <add_q+0x3c>
        q->head = n;
    19db:	8b 45 08             	mov    0x8(%ebp),%eax
    19de:	8b 55 f4             	mov    -0xc(%ebp),%edx
    19e1:	89 50 04             	mov    %edx,0x4(%eax)
    19e4:	eb 0c                	jmp    19f2 <add_q+0x48>
    }else{
        q->tail->next = n;
    19e6:	8b 45 08             	mov    0x8(%ebp),%eax
    19e9:	8b 40 08             	mov    0x8(%eax),%eax
    19ec:	8b 55 f4             	mov    -0xc(%ebp),%edx
    19ef:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    19f2:	8b 45 08             	mov    0x8(%ebp),%eax
    19f5:	8b 55 f4             	mov    -0xc(%ebp),%edx
    19f8:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    19fb:	8b 45 08             	mov    0x8(%ebp),%eax
    19fe:	8b 00                	mov    (%eax),%eax
    1a00:	8d 50 01             	lea    0x1(%eax),%edx
...
int empty_q(struct queue *q){
    ...
    1a14:	75 07                	jne    1a1d <empty_q+0x13>
        return 1;
    1a16:	b8 01 00 00 00       	mov    $0x1,%eax
    1a1b:	eb 05                	jmp    1a22 <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    ...
    1a2d:	89 04 24             	mov    %eax,(%esp)
    1a30:	e8 d5 ff ff ff       	call   1a0a <empty_q>
    1a35:	85 c0                	test   %eax,%eax
    1a37:	75 5d                	jne    1a96 <pop_q+0x72>
       val = q->head->value; 
    ...
    1a53:	8b 50 04             	mov    0x4(%eax),%edx
    1a56:	8b 45 08             	mov    0x8(%ebp),%eax
    1a59:	89 50 04             	mov    %edx,0x4(%eax)
       free(destroy);
    1a5c:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1a5f:	89 04 24             	mov    %eax,(%esp)
    1a62:	e8 b5 fb ff ff       	call   161c <free>
       q->size--;
    1a67:	8b 45 08             	mov    0x8(%ebp),%eax
    1a6a:	8b 00                	mov    (%eax),%eax
    1a6c:	8d 50 ff             	lea    -0x1(%eax),%edx
    ...
    1a7b:	75 14                	jne    1a91 <pop_q+0x6d>
            q->head = 0;
    1a7d:	8b 45 08             	mov    0x8(%ebp),%eax
    1a80:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
            q->tail = 0;
    1a87:	8b 45 08             	mov    0x8(%ebp),%eax
    1a8a:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
       }
       return val;
    1a91:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1a94:	eb 05                	jmp    1a9b <pop_q+0x77>
    }
    return -1;
    1a96:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
}
    1a9b:	c9                   	leave  
    1a9c:	c3                   	ret    
