...
fmtname(char *path)
{
  ...
  memmove(buf, p, strlen(p));
    ...
    105f:	c7 04 24 20 1e 00 00 	movl   $0x1e20,(%esp)
  ...
  memset(buf+strlen(p), ' ', DIRSIZ-strlen(p));
    ...
    108a:	05 20 1e 00 00       	add    $0x1e20,%eax
  ...
  return buf;
    10a3:	b8 20 1e 00 00       	mov    $0x1e20,%eax
}
...
ls(char *path)
{
  ...
  if((fd = open(path, 0)) < 0){
    ...
    10dd:	c7 44 24 04 89 1d 00 	movl   $0x1d89,0x4(%esp)
    10e4:	00 
  ...
  if(fstat(fd, &st) < 0){
    ...
    1116:	c7 44 24 04 9d 1d 00 	movl   $0x1d9d,0x4(%esp)
    111d:	00 
  ...
  case T_FILE:
    ...
    1181:	c7 44 24 04 b1 1d 00 	movl   $0x1db1,0x4(%esp)
    1188:	00 
  ...
  case T_DIR:
    ...
    11af:	c7 44 24 04 be 1d 00 	movl   $0x1dbe,0x4(%esp)
    11b6:	00 
    ...
    *p++ = '/';
    ...
    1265:	c7 44 24 04 9d 1d 00 	movl   $0x1d9d,0x4(%esp)
    126c:	00 
    ...
    12af:	c7 44 24 04 b1 1d 00 	movl   $0x1db1,0x4(%esp)
    12b6:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    ...
    ls(".");
    1311:	c7 04 24 d1 1d 00 00 	movl   $0x1dd1,(%esp)
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    16ea:	0f b6 80 08 1e 00 00 	movzbl 0x1e08(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1848:	75 27                	jne    1871 <printf+0x120>
          s = "(null)";
    184a:	c7 45 e4 d3 1d 00 00 	movl   $0x1dd3,-0x1c(%ebp)
        while(*s != 0){
...
00001908 <free>:
    ...
    1917:	a1 38 1e 00 00       	mov    0x1e38,%eax
    ...
    19d8:	a3 38 1e 00 00       	mov    %eax,0x1e38
    19dd:	c9                   	leave  
    19de:	c3                   	ret    
...
000019df <morecore>:
    ...
    1a30:	a1 38 1e 00 00       	mov    0x1e38,%eax
    1a35:	c9                   	leave  
    1a36:	c3                   	ret    
...
00001a37 <malloc>:
    ...
    1a4c:	a1 38 1e 00 00       	mov    0x1e38,%eax
    1a51:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1a54:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1a58:	75 23                	jne    1a7d <malloc+0x46>
    1a5a:	c7 45 f0 30 1e 00 00 	movl   $0x1e30,-0x10(%ebp)
    1a61:	8b 45 f0             	mov    -0x10(%ebp),%eax
    1a64:	a3 38 1e 00 00       	mov    %eax,0x1e38
    1a69:	a1 38 1e 00 00       	mov    0x1e38,%eax
    1a6e:	a3 30 1e 00 00       	mov    %eax,0x1e30
    1a73:	c7 05 34 1e 00 00 00 	movl   $0x0,0x1e34
    1a7a:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1bbc:	c7 44 24 04 da 1d 00 	movl   $0x1dda,0x4(%esp)
    1bc3:	00 
    ...
    1c01:	c7 44 24 04 e8 1d 00 	movl   $0x1de8,0x4(%esp)
    1c08:	00 
    ...
    1c2d:	c7 44 24 04 f5 1d 00 	movl   $0x1df5,0x4(%esp)
    1c34:	00 
...
int random(int max){
    ...
    1c4b:	a1 1c 1e 00 00       	mov    0x1e1c,%eax
    1c50:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    1c56:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1c5b:	a3 1c 1e 00 00       	mov    %eax,0x1e1c
    return (int)(rands % max);
    1c60:	a1 1c 1e 00 00       	mov    0x1e1c,%eax
    1c65:	8b 4d 08             	mov    0x8(%ebp),%ecx
    1c68:	ba 00 00 00 00       	mov    $0x0,%edx
    1c6d:	f7 f1                	div    %ecx
    1c6f:	89 d0                	mov    %edx,%eax
}
    1c71:	5d                   	pop    %ebp
    1c72:	c3                   	ret    
    1c73:	90                   	nop
...
void init_q(struct queue *q){
    ...
    1c7a:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
    q->head = 0;
    1c80:	8b 45 08             	mov    0x8(%ebp),%eax
    1c83:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    q->tail = 0;
    1c8a:	8b 45 08             	mov    0x8(%ebp),%eax
    1c8d:	c7 40 08 00 00 00 00 	movl   $0x0,0x8(%eax)
}
    1c94:	5d                   	pop    %ebp
    1c95:	c3                   	ret    
...
void add_q(struct queue *q, int v){
    ...
    1c9c:	c7 04 24 08 00 00 00 	movl   $0x8,(%esp)
    1ca3:	e8 8f fd ff ff       	call   1a37 <malloc>
    1ca8:	89 45 f4             	mov    %eax,-0xc(%ebp)
    n->next = 0;
    1cab:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1cae:	c7 40 04 00 00 00 00 	movl   $0x0,0x4(%eax)
    n->value = v;
    1cb5:	8b 45 f4             	mov    -0xc(%ebp),%eax
    1cb8:	8b 55 0c             	mov    0xc(%ebp),%edx
    1cbb:	89 10                	mov    %edx,(%eax)
    if(q->head == 0){
    1cbd:	8b 45 08             	mov    0x8(%ebp),%eax
    1cc0:	8b 40 04             	mov    0x4(%eax),%eax
    1cc3:	85 c0                	test   %eax,%eax
    1cc5:	75 0b                	jne    1cd2 <add_q+0x3c>
        q->head = n;
    1cc7:	8b 45 08             	mov    0x8(%ebp),%eax
    1cca:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1ccd:	89 50 04             	mov    %edx,0x4(%eax)
    1cd0:	eb 0c                	jmp    1cde <add_q+0x48>
    }else{
        q->tail->next = n;
    1cd2:	8b 45 08             	mov    0x8(%ebp),%eax
    1cd5:	8b 40 08             	mov    0x8(%eax),%eax
    1cd8:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1cdb:	89 50 04             	mov    %edx,0x4(%eax)
    }
    q->tail = n;
    1cde:	8b 45 08             	mov    0x8(%ebp),%eax
    1ce1:	8b 55 f4             	mov    -0xc(%ebp),%edx
    1ce4:	89 50 08             	mov    %edx,0x8(%eax)
    q->size++;
    1ce7:	8b 45 08             	mov    0x8(%ebp),%eax
    1cea:	8b 00                	mov    (%eax),%eax
    1cec:	8d 50 01             	lea    0x1(%eax),%edx
    1cef:	8b 45 08             	mov    0x8(%ebp),%eax
    1cf2:	89 10                	mov    %edx,(%eax)
}
    1cf4:	c9                   	leave  
    1cf5:	c3                   	ret    
...
int empty_q(struct queue *q){
    ...
    1d00:	75 07                	jne    1d09 <empty_q+0x13>
        return 1;
    1d02:	b8 01 00 00 00       	mov    $0x1,%eax
    1d07:	eb 05                	jmp    1d0e <empty_q+0x18>
    else
        return 0;
...
int pop_q(struct queue *q){
    ...
    1d13:	83 ec 28             	sub    $0x28,%esp
    int val;
    struct node *destroy;
    if(!empty_q(q)){
    1d16:	8b 45 08             	mov    0x8(%ebp),%eax
    1d19:	89 04 24             	mov    %eax,(%esp)
    1d1c:	e8 d5 ff ff ff       	call   1cf6 <empty_q>
    1d21:	85 c0                	test   %eax,%eax
    1d23:	75 5d                	jne    1d82 <pop_q+0x72>
       val = q->head->value; 
