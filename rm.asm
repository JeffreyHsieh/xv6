...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    105a:	c7 44 24 04 d5 1a 00 	movl   $0x1ad5,0x4(%esp)
    1061:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1422:	0f b6 80 24 1b 00 00 	movzbl 0x1b24(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1580:	75 27                	jne    15a9 <printf+0x120>
          s = "(null)";
    1582:	c7 45 e4 ee 1a 00 00 	movl   $0x1aee,-0x1c(%ebp)
        while(*s != 0){
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    164f:	a1 44 1b 00 00       	mov    0x1b44,%eax
...
free(void *ap)
{
  ...
  freep = p;
    ...
    1710:	a3 44 1b 00 00       	mov    %eax,0x1b44
}
    1715:	c9                   	leave  
    1716:	c3                   	ret    
...
morecore(uint nu)
{
  ...
  return freep;
    1768:	a1 44 1b 00 00       	mov    0x1b44,%eax
}
    176d:	c9                   	leave  
    176e:	c3                   	ret    
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    1784:	a1 44 1b 00 00       	mov    0x1b44,%eax
    1789:	89 45 f0             	mov    %eax,-0x10(%ebp)
    178c:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    1790:	75 23                	jne    17b5 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
    1792:	c7 45 f0 3c 1b 00 00 	movl   $0x1b3c,-0x10(%ebp)
    1799:	8b 45 f0             	mov    -0x10(%ebp),%eax
    179c:	a3 44 1b 00 00       	mov    %eax,0x1b44
    17a1:	a1 44 1b 00 00       	mov    0x1b44,%eax
    17a6:	a3 3c 1b 00 00       	mov    %eax,0x1b3c
    base.s.size = 0;
    17ab:	c7 05 40 1b 00 00 00 	movl   $0x0,0x1b40
    17b2:	00 00 00 
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1808:	a3 44 1b 00 00       	mov    %eax,0x1b44
      return (void*)(p + 1);
    ...
    if(p == freep)
    1815:	a1 44 1b 00 00       	mov    0x1b44,%eax
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    18f4:	c7 44 24 04 f5 1a 00 	movl   $0x1af5,0x4(%esp)
    18fb:	00 
    ...
    1939:	c7 44 24 04 03 1b 00 	movl   $0x1b03,0x4(%esp)
    1940:	00 
    ...
    1965:	c7 44 24 04 10 1b 00 	movl   $0x1b10,0x4(%esp)
    196c:	00 
...
int random(int max){
    ...
    1983:	a1 38 1b 00 00       	mov    0x1b38,%eax
    1988:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    198e:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    1993:	a3 38 1b 00 00       	mov    %eax,0x1b38
    return (int)(rands % max);
    1998:	a1 38 1b 00 00       	mov    0x1b38,%eax
