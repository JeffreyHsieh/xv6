...
main(int argc, char *argv[])
{
  ...
  for(i = 1; i < argc; i++){
    ...
    1066:	c7 44 24 04 e1 1a 00 	movl   $0x1ae1,0x4(%esp)
    106d:	00 
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    1431:	0f b6 80 54 1e 00 00 	movzbl 0x1e54(%eax),%eax
...
printf(int fd, char *fmt, ...)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    158e:	75 09                	jne    1599 <printf+0x101>
          s = "(null)";
    1590:	c7 45 f4 fa 1a 00 00 	movl   $0x1afa,-0xc(%ebp)
        while(*s != 0){
...
0000164c <free>:
    ...
    165b:	a1 74 1e 00 00       	mov    0x1e74,%eax
    ...
    171c:	a3 74 1e 00 00       	mov    %eax,0x1e74
    1721:	c9                   	leave  
    1722:	c3                   	ret    
...
00001723 <morecore>:
    ...
    1774:	a1 74 1e 00 00       	mov    0x1e74,%eax
    1779:	c9                   	leave  
    177a:	c3                   	ret    
...
0000177b <malloc>:
    ...
    1790:	a1 74 1e 00 00       	mov    0x1e74,%eax
    1795:	89 45 f0             	mov    %eax,-0x10(%ebp)
    1798:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
    179c:	75 23                	jne    17c1 <malloc+0x46>
    179e:	c7 45 f0 6c 1e 00 00 	movl   $0x1e6c,-0x10(%ebp)
    17a5:	8b 45 f0             	mov    -0x10(%ebp),%eax
    17a8:	a3 74 1e 00 00       	mov    %eax,0x1e74
    17ad:	a1 74 1e 00 00       	mov    0x1e74,%eax
    17b2:	a3 6c 1e 00 00       	mov    %eax,0x1e6c
    17b7:	c7 05 70 1e 00 00 00 	movl   $0x0,0x1e70
    17be:	00 00 00 
...
void *thread_create(void(*start_routine)(void*), void *arg){
   ...
   // printf(1,"start routine addr : %d\n",(uint)start_routine);
    ...
    1900:	c7 44 24 04 01 1b 00 	movl   $0x1b01,0x4(%esp)
    1907:	00 
    ...
    1945:	c7 44 24 04 0f 1b 00 	movl   $0x1b0f,0x4(%esp)
    194c:	00 
    ...
    1971:	c7 44 24 04 1c 1b 00 	movl   $0x1b1c,0x4(%esp)
    1978:	00 
...
int random(int max){
    ...
    198f:	a1 68 1e 00 00       	mov    0x1e68,%eax
    1994:	69 c0 0d 66 19 00    	imul   $0x19660d,%eax,%eax
    199a:	05 69 f3 6e 3c       	add    $0x3c6ef369,%eax
    199f:	a3 68 1e 00 00       	mov    %eax,0x1e68
    return (int)(rands % max);
    19a4:	a1 68 1e 00 00       	mov    0x1e68,%eax
